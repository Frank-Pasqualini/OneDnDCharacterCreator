    ...
    def __init__(self):
        super().__init__(name="Acid Splash",
                         ...
                         description="You hurl a bubble of acid. Choose one creature within range, " +
                                    ...
                                    "or take 1d6 acid damage.first\n" +
                                    "Thissecondspell's damage increases by 1d6 when you reach 5th " +
    ...
    def __init__(self):
        super().__init__(name="Aid",
                         ...
                         description="Your spell bolsters your allies with toughness and resolve. " +
                                    "Choose up to three creatures within range.first\n" +
                                    "Eachsecondtarget's hit point maximum and current hit points " +
...
class Alarm(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Alarm",
                         ...
                         duration="8 hours",
                         description=You set an alarm against unwanted intrusion.first\n +
                                    "Chooseseconda door, a window, or an area within range that is " +
                                    "no larger than a 20-foot cube. Until the spell ends, an alarm " +
                                    ...
                                    "choose whether the alarm is mental or audible.first\n" +
                                    "Asecondmental alarm alerts you with a ping in your mind if you " +
                                    "are within 1 mile of the warded area.first\n" +
                                    "Thissecondping awakens you if you are sleeping.first\n" +
                                    "Ansecondaudible alarm produces the sound of a hand bell for 10 " +
    ...
    def __init__(self):
        super().__init__(name="Alter Self",
                         ...
                         description="You assume a different form. When you cast the spell, choose " +
                                    ...
                                    "equal to your walking speed.first\n" +
                                    "ChangesecondAppearance. You transform your appearance. You " +
                                    ...
                                    "your statistics change. You also can't appear as a creature of " +
                                    "a different size than you, and your basic shape stays the " +
                                    "same; if you're bipedal, you can't use this spell to become " +
                                    "quadrupedal, for instance. At any time for the duration of the " +
                                    "spell, you can use your action to change your appearance in " +
                                    "this way again.first\n" +
                                    "NaturalsecondWeapons. You grow claws, fangs, spines, horns, or " +
                                    "a different natural weapon of your choice.first\n" +
                                    "Yoursecondunarmed strikes deal 1d6 bludgeoning, piercing, or " +
    ...
    def __init__(self):
        super().__init__(name="Animal Shapes",
                         ...
                         description="Your magic turns others into beasts. Choose any number of " +
                                    ...
                                    "target, or until the target drops to 0 hit points or dies.first\n" +
                                    "Yousecondcan choose a different form for each target. A " +
                                    "target's game statistics are replaced by the statistics of the " +
                                    "chosen beast, though the target retains its alignment and " +
                                    ...
                                    "cast spells.first\n" +
                                    "Thesecondtarget's gear melds into the new form. The target " +
    ...
    def __init__(self):
        super().__init__(name="Animate Dead",
                         ...
                         description="This spell creates an undead servant. Choose a pile of bones " +
                                    ...
                                    "it as an undead creature.first\n" +
                                    "Thesecondtarget becomes a skeleton if you chose bones or a " +
                                    ...
                                    "follow it until its task is complete.first\n" +
                                    "Thesecondcreature is under your control for 24 hours, after " +
    ...
    def __init__(self):
        super().__init__(name="Animate Objects",
                         ...
                         description="Objects come to life at your command. Choose up to ten " +
                                    ...
                                    "spell ends or until reduced to 0 hit points.first\n" +
                                    "Asseconda bonus action, you can mentally command any creature " +
                                    "you made with this spell if the creature is within 500 feet of " +
                                    "you (if you control multiple creatures, you can command any or " +
                                    "all of them at the same time, issuing the same command to each " +
                                    "one).\n" +
                                    ...
                                    "continues to follow it until its task is complete.first\n" +
                                    "AnimatedsecondObject Statistics Size HP AC Attack Str Dex Tiny " +
                                    "20 18 +8 to hit, 1d4 + 4 damage 4 18 Small 25 16 +6 to hit, " +
                                    "1d8 + 2 damage 6 14 Medium 40 13 +5 to hit, 2d6 + 1 damage 10 " +
                                    "12 Large 50 10 +6 to hit, 2d10 + 2 damage 14 10 Huge 80 10 +8 " +
                                    "to hit, 2d12 + 4 damage 18 6 An animated object is a construct " +
                                    ...
                                    "any remaining damage carries over to its original object " +
                                    "form.\n" +
    ...
    def __init__(self):
        super().__init__(name="Antilife Shell",
                         ...
                         description="A shimmering barrier extends out from you in a 10- foot radius " +
                                    ...
                                    "for the duration.first\n" +
                                    "Thesecondbarrier prevents an affected creature from passing or " +
                                    "reaching through. An affected creature can cast spells or make " +
                                    "attacks with ranged or reach weapons through the barrier.first\n" +
                                    "Ifsecondyou move so that an affected creature is forced to " +
    ...
    def __init__(self):
        super().__init__(name="Antimagic Field",
                         ...
                         description="A 10-foot-radius invisible sphere of antimagic surrounds you. " +
                                    ...
                                    "centered on you.first\n" +
                                    "Spellssecondand other magical effects, except those created by " +
                                    "an artifact or a deity, are suppressed in the sphere and can't " +
                                    "protrude into it. A slot expended to cast a suppressed spell " +
                                    "is consumed.first\n" +
                                    "Whilesecondan effect is suppressed, it doesn't function, but " +
                                    ...
                                    "creature or object is in it.first\n" +
                                    "MagicsecondItems. The properties and powers of magic items are " +
                                    "suppressed in the sphere. For example, a +1 longsword in the " +
                                    "sphere functions as a nonmagical longsword.first\n" +
                                    "Asecondmagic weapon's properties and powers are suppressed if " +
                                    "it is used against a target in the sphere or wielded by an " +
                                    "attacker in the sphere. If a magic weapon or a piece of magic " +
                                    ...
                                    "as it exits.first\n" +
                                    "MagicalsecondTravel. Teleportation and planar travel fail to " +
                                    "work in the sphere, whether the sphere is the destination or " +
                                    "the departure point for such magical travel. A portal to " +
                                    "another location, world, or plane of existence, as well as an " +
                                    "opening to an extradimensional space such as that created by " +
                                    "the rope trick spell, temporarily closes while in the " +
                                    "sphere.\n" +
                                    "Creatures and Objects. A creature or object summoned " +
                                    "or created by magic temporarily winks out of existence in the " +
                                    "sphere. Such a creature instantly reappears once the space the " +
                                    "creature occupied is no longer within the sphere.first\n" +
                                    "DispelsecondMagic. Spells and magical effects such as dispel " +
                                    "magic have no effect on the sphere. Likewise, the spheres " +
                                    "created by different antimagic field spells don't nullify each " +
                                    "other. ",
                         at_higher_levels="")
...
class AntipathySympathy(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Antipathy/Sympathy",
                         ...
                         duration="10 days",
                         description=This spell attracts or repels creatures of your choice.first\n +
                                    "Yousecondtarget something within range, either a Huge or " +
                                    "smaller object or creature or an area that is no larger than a " +
                                    ...
                                    "sympathy as the aura's effect.first\n" +
                                    "Antipathy.secondThe enchantment causes creatures of the kind " +
                                    "you designated to feel an intense urge to leave the area and " +
                                    "avoid the target. When such a creature can see the target or " +
                                    ...
                                    "feet of it or able to see it.first\n" +
                                    "Whensecondsuch a creature can see the target or comes within " +
                                    "60 feet of it, the creature must succeed on a Wisdom saving " +
                                    "throw or use its movement on each of its turns to enter the " +
                                    "area or move within reach of the target. When the creature has " +
                                    "done so, it can't willingly move away from the target.first\n" +
                                    "Ifsecondthe target damages or otherwise harms an affected " +
                                    "creature, the affected creature can make a Wisdom saving throw " +
                                    "to end the effect, as described below.first\n" +
                                    "Endingsecondthe Effect. If an affected creature ends its turn " +
                                    "while not within 60 feet of the target or able to see it, the " +
                                    "creature makes a Wisdom saving throw.first\n" +
                                    "Onseconda successful save, the creature is no longer affected " +
                                    "by the target and recognizes the feeling of repugnance or " +
                                    "attraction as magical. In addition, a creature affected by the " +
                                    "spell is allowed another Wisdom saving throw every 24 hours " +
                                    "while the spell persists.first\n" +
                                    "Asecondcreature that successfully saves against this effect is " +
    ...
    def __init__(self):
        super().__init__(name="Arcane Eye",
                         ...
                         description="You create an invisible, magical eye within range that hovers " +
                                    "in the air for the duration.first\n" +
                                    "Yousecondmentally receive visual information from the eye, " +
                                    "which has normal vision and darkvision out to 30 feet. The eye " +
                                    "can look in every direction.first\n" +
                                    "Assecondan action, you can move the eye up to 30 feet in any " +
    ...
    def __init__(self):
        super().__init__(name="Arcane Hand",
                         ...
                         description="You create a Large hand of shimmering, translucent force in an " +
                                    ...
                                    "mimicking the movements of your own hand.first\n" +
                                    "Thesecondhand is an object that has AC 20 and hit points equal " +
                                    "to your hit point maximum. If it drops to 0 hit points, the " +
                                    "spell ends. It has a Strength of 26 (+8) and a Dexterity of 10 " +
                                    "(+0). The hand doesn't fill its space.first\n" +
                                    "Whensecondyou cast the spell and as a bonus action on your " +
                                    "subsequent turns, you can move the hand up to 60 feet and then " +
                                    "cause one of the following effects with it.first\n" +
                                    "ClenchedsecondFist. The hand strikes one creature or object " +
                                    "within 5 feet of it. Make a melee spell attack for the hand " +
                                    "using your game statistics. On a hit, the target takes 4d8 " +
                                    "force damage.first\n" +
                                    "ForcefulsecondHand. The hand attempts to push a creature " +
                                    "within 5 feet of it in a direction you choose.first\n" +
                                    "Makeseconda check with the hand's Strength contested by the " +
                                    ...
                                    "feet of it.first\n" +
                                    "GraspingsecondHand. The hand attempts to grapple a Huge or " +
                                    ...
                                    "hand crush it.first\n" +
                                    "Whensecondyou do so, the target takes bludgeoning damage equal " +
                                    "to 2d6 + your spellcasting ability modifier.first\n" +
                                    "InterposingsecondHand. The hand interposes itself between you " +
    ...
    def __init__(self):
        super().__init__(name="Arcane Lock",
                         ...
                         description="You touch a closed door, window, gate, chest, or other " +
                                    ...
                                    "suppresses arcane lock for 10 minutes.first\n" +
                                    "Whilesecondaffected by this spell, the object is more " +
                                    "difficult to break or force open; the DC to break it or pick " +
                                    "any locks on it increases by 10. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Arcane Sword",
                         ...
                         description="You create a sword-shaped plane of force that hovers within " +
                                    "range. It lasts for the duration.first\n" +
                                    "Whensecondthe sword appears, you make a melee spell attack " +
                                    "against a target of your choice within 5 feet of the sword. On " +
                                    "a hit, the target takes 3d10 force damage. Until the spell " +
                                    "ends, you can use a bonus action on each of your turns to move " +
                                    "the sword up to 20 feet to a spot you can see and repeat this " +
    ...
    def __init__(self):
        super().__init__(name="Arcanist's Magic Aura",
                         ...
                         description="You place an illusion on a creature or an object you touch so " +
                                    ...
                                    "carried or worn by another creature.first\n" +
                                    "Whensecondyou cast the spell, choose one or both of the " +
                                    "following effects. The effect lasts for the duration. If you " +
                                    "cast this spell on the same creature or object every day for " +
                                    "30 days, placing the same effect on it each time, the illusion " +
                                    "lasts until it is dispelled.first\n" +
                                    "FalsesecondAura. You change the way the target appears to " +
                                    "spells and magical effects, such as detect magic, that detect " +
                                    "magical auras. You can make a nonmagical object appear " +
                                    "magical, a magical object appear nonmagical, or change the " +
                                    "object's magical aura so that it appears to belong to a " +
                                    "specific school of magic that you choose. When you use this " +
                                    "effect on an object, you can make the false magic apparent to " +
                                    "any creature that handles the item.first\n" +
                                    "Mask.secondYou change the way the target appears to spells and " +
    ...
    def __init__(self):
        super().__init__(name="Astral Projection",
                         ...
                         description="You and up to eight willing creatures within range project " +
                                    ...
                                    "doesn't age.first\n" +
                                    "Yoursecondastral body resembles your mortal form in almost " +
                                    "every way, replicating your game statistics and possessions. " +
                                    ...
                                    "remains intact, you can find your way home. If the cord is " +
                                    ...
                                    "you instantly.first\n" +
                                    "Yoursecondastral form can freely travel through the Astral " +
                                    "Plane and can pass through portals there leading to any other " +
                                    ...
                                    "persist when you return to it.first\n" +
                                    "Thesecondspell ends for you and your companions when you use " +
                                    "your action to dismiss it. When the spell ends, the affected " +
                                    "creature returns to its physical body, and it awakens.first\n" +
                                    "Thesecondspell might also end early for you or one of your " +
    ...
    def __init__(self):
        super().__init__(name="Augury",
                         ...
                         description="By casting gem-inlaid sticks, rolling dragon bones, laying out " +
                                    ...
                                    "additional spells or the loss or gain of a companion.first\n" +
                                    "Ifsecondyou cast the spell two or more times before completing " +
                                    "your next long rest, there is a cumulative 25 percent chance " +
                                    "for each casting after the first that you get a random " +
                                    "reading. The GM makes this roll in secret. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Awaken",
                         ...
                         description="After spending the casting time tracing magical pathways " +
                                    ...
                                    "the awakened shrub or the awakened tree.first\n" +
                                    "Thesecondawakened beast or plant is charmed by you for 30 days " +
                                    "or until you or your companions do anything harmful to it. " +
                                    "When the charmed condition ends, the awakened creature chooses " +
    ...
    def __init__(self):
        super().__init__(name="Bane",
                         ...
                         description="Up to three creatures of your choice that you can see within " +
                                    "range must make Charisma saving throws.first\n" +
                                    "Wheneverseconda target that fails this saving throw makes an " +
                                    "attack roll or a saving throw before the spell ends, the " +
                                    "target must roll a d4 and subtract the number rolled from the " +
    ...
    def __init__(self):
        super().__init__(name="Banishment",
                         ...
                         description="You attempt to send one creature that you can see within range " +
                                    ...
                                    "Charisma saving throw or be banished.first\n" +
                                    "Ifsecondthe target is native to the plane of existence you're " +
                                    "on, you banish the target to a harmless demiplane. While " +
                                    "there, the target is incapacitated.first\n" +
                                    "Thesecondtarget remains there until the spell ends, at which " +
                                    "point the target reappears in the space it left or in the " +
                                    "nearest unoccupied space if that space is occupied.first\n" +
                                    "Ifsecondthe target is native to a different plane of existence " +
                                    "than the one you're on, the target is banished with a faint " +
                                    "popping noise, returning to its home plane. If the spell ends " +
                                    "before 1 minute has passed, the target reappears in the space " +
    ...
    def __init__(self):
        super().__init__(name="Bestow Curse",
                         ...
                         description="You touch a creature, and that creature must succeed on a " +
                                    ...
                                    "and saving throws made with that ability score.first\n" +
                                    "•secondWhile cursed, the target has disadvantage on attack " +
                                    "rolls against you.first\n" +
                                    "•secondWhile cursed, the target must make a Wisdom saving " +
                                    "throw at the start of each of its turns. If it fails, it " +
                                    "wastes its action that turn doing nothing.first\n" +
                                    "•secondWhile the target is cursed, your attacks and spells " +
                                    "deal an extra 1d8 necrotic damage to the target.first\n" +
                                    "Asecondremove curse spell ends this effect. At the GM's " +
                                    "option, you may choose an alternative curse effect, but it " +
                                    "should be no more powerful than those described above. The GM " +
    ...
    def __init__(self):
        super().__init__(name="Black Tentacles",
                         ...
                         description="Squirming, ebony tentacles fill a 20-foot square on ground " +
                                    ...
                                    "bludgeoning damage.first\n" +
                                    "Asecondcreature restrained by the tentacles can use its action " +
                                    "to make a Strength or Dexterity check (its choice) against " +
    ...
    def __init__(self):
        super().__init__(name="Blade Barrier",
                         ...
                         description="You create a vertical wall of whirling, razor-sharp blades " +
                                    ...
                                    "its space is difficult terrain.first\n" +
                                    "Whenseconda creature enters the wall's area for the first time " +
                                    "on a turn or starts its turn there, the creature must make a " +
    ...
    def __init__(self):
        super().__init__(name="Blight",
                         ...
                         description="Necromantic energy washes over a creature of your choice that " +
                                    ...
                                    "undead or constructs.first\n" +
                                    "Ifsecondyou target a plant creature or a magical plant, it " +
                                    "makes the saving throw with disadvantage, and the spell deals " +
                                    "maximum damage to it.first\n" +
                                    "Ifsecondyou target a nonmagical plant that isn't a creature, " +
    ...
    def __init__(self):
        super().__init__(name="Blink",
                         ...
                         description="Roll a d20 at the end of each of your turns for the duration " +
                                    ...
                                    "on that plane).first\n" +
                                    "Atsecondthe start of your next turn, and when the spell ends " +
                                    "if you are on the Ethereal Plane, you return to an unoccupied " +
                                    "space of your choice that you can see within 10 feet of the " +
                                    "space you vanished from. If no unoccupied space is available " +
                                    "within that range, you appear in the nearest unoccupied space " +
                                    "(chosen at random if more than one space is equally near). You " +
                                    "can dismiss this spell as an action.first\n" +
                                    "Whilesecondon the Ethereal Plane, you can see and hear the " +
                                    "plane you originated from, which is cast in shades of gray, " +
                                    "and you can't see anything there more than 60 feet away. You " +
                                    "can only affect and be affected by other creatures on the " +
                                    "Ethereal Plane.first\n" +
                                    "Creaturessecondthat aren't there can't perceive you or " +
    ...
    def __init__(self):
        super().__init__(name="Blur",
                         ...
                         description="Your body becomes blurred, shifting and wavering to all who " +
                                    ...
                                    "on attack rolls against you.first\n" +
                                    "Ansecondattacker is immune to this effect if it doesn't rely " +
                                    "on sight, as with blindsight, or can see through illusions, as " +
                                    "with truesight. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Burning Hands",
                         ...
                         description="As you hold your hands with thumbs touching and fingers " +
                                    ...
                                    "Thesecondfire ignites any flammable objects in the area that " +
    ...
    def __init__(self):
        super().__init__(name="Call Lightning",
                         ...
                         description="A storm cloud appears in the shape of a cylinder that is 10 " +
                                    ...
                                    "again, targeting the same point or a different one.first\n" +
                                    "Ifsecondyou are outdoors in stormy conditions when you cast " +
                                    "this spell, the spell gives you control over the existing " +
                                    "storm instead of creating a new one. Under such conditions, " +
    ...
    def __init__(self):
        super().__init__(name="Calm Emotions",
                         ...
                         description="You attempt to suppress strong emotions in a group of people. " +
                                    ...
                                    "two effects.first\n" +
                                    "Yousecondcan suppress any effect causing a target to be " +
                                    "charmed or frightened. When this spell ends, any suppressed " +
                                    "effect resumes, provided that its duration has not expired in " +
                                    "the meantime.first\n" +
                                    "Alternatively,secondyou can make a target indifferent about " +
    ...
    def __init__(self):
        super().__init__(name="Chain Lightning",
                         ...
                         description="You create a bolt of lightning that arcs toward a target of " +
                                    "your choice that you can see within range.first\n" +
                                    "Threesecondbolts then leap from that target to as many as " +
                                    "three other targets, each of which must be within 30 feet of " +
                                    "the first target. A target can be a creature or an object and " +
                                    "can be targeted by only one of the bolts.first\n" +
                                    "Asecondtarget must make a Dexterity saving throw. The target " +
    ...
    def __init__(self):
        super().__init__(name="Chill Touch",
                         ...
                         description="You create a ghostly, skeletal hand in the space of a creature " +
                                    ...
                                    "to the target.first\n" +
                                    "Ifsecondyou hit an undead target, it also has disadvantage on " +
                                    "attack rolls against you until the end of your next turn.first\n" +
                                    "Thissecondspell's damage increases by 1d8 when you reach 5th " +
    ...
    def __init__(self):
        super().__init__(name="Clairvoyance",
                         ...
                         description="You create an invisible sensor within range in a location " +
                                    ...
                                    "attacked or otherwise interacted with.first\n" +
                                    "Whensecondyou cast the spell, you choose seeing or hearing. " +
                                    "You can use the chosen sense through the sensor as if you were " +
                                    "in its space. As your action, you can switch between seeing " +
                                    "and hearing.first\n" +
                                    "Asecondcreature that can see the sensor (such as a creature " +
    ...
    def __init__(self):
        super().__init__(name="Clone",
                         ...
                         description="This spell grows an inert duplicate of a living creature as a " +
                                    ...
                                    "long as its vessel remains undisturbed.first\n" +
                                    "Atsecondany time after the clone matures, if the original " +
                                    "creature dies, its soul transfers to the clone, provided that " +
                                    "the soul is free and willing to return.first\n" +
                                    "Thesecondclone is physically identical to the original and has " +
                                    "the same personality, memories, and abilities, but none of the " +
    ...
    def __init__(self):
        super().__init__(name="Cloudkill",
                         ...
                         description="You create a 20-foot-radius sphere of poisonous, yellow-green " +
                                    ...
                                    "heavily obscured.first\n" +
                                    "Whenseconda creature enters the spell's area for the first " +
                                    "time on a turn or starts its turn there, that creature must " +
                                    "make a Constitution saving throw. The creature takes 5d8 " +
                                    "poison damage on a failed save, or half as much damage on a " +
                                    "successful one.first\n" +
                                    "Creaturessecondare affected even if they hold their breath or " +
                                    "don't need to breathe.first\n" +
                                    "Thesecondfog moves 10 feet away from you at the start of each " +
                                    "of your turns, rolling along the surface of the ground. The " +
    ...
    def __init__(self):
        super().__init__(name="Color Spray",
                         ...
                         description="A dazzling array of flashing, colored light springs from your " +
                                    ...
                                    "can't see).first\n" +
                                    "Startingsecondwith the creature that has the lowest current " +
                                    "hit points, each creature affected by this spell is blinded " +
                                    "until the spell ends. Subtract each creature's hit points from " +
    ...
    def __init__(self):
        super().__init__(name="Command",
                         ...
                         description="You speak a one-word command to a creature you can see within " +
                                    ...
                                    "language, or if your command is directly harmful to it.first\n" +
                                    "Somesecondtypical commands and their effects follow.first\n" +
                                    "Yousecondmight issue a command other than one described here. " +
                                    "If you do so, the GM determines how the target behaves. If the " +
                                    "target can't follow your command, the spell ends.first\n" +
                                    "Approach.secondThe target moves toward you by the shortest and " +
                                    "most direct route, ending its turn if it moves within 5 feet " +
                                    "of you.first\n" +
                                    "Drop.secondThe target drops whatever it is holding and then " +
                                    "ends its turn.first\n" +
                                    "Flee.secondThe target spends its turn moving away from you by " +
                                    "the fastest available means.first\n" +
                                    "Grovel.secondThe target falls prone and then ends its " +
                                    "turn.\n" +
                                    "Halt. The target doesn't move and takes no actions.first\n" +
                                    "Asecondflying creature stays aloft, provided that it is able " +
    ...
    def __init__(self):
        super().__init__(name="Commune",
                         ...
                         description="You contact your deity or a divine proxy and ask up to three " +
                                    ...
                                    "answer for each question.first\n" +
                                    "Divinesecondbeings aren't necessarily omniscient, so you might " +
                                    ...
                                    "answer instead.first\n" +
                                    "Ifsecondyou cast the spell two or more times before finishing " +
                                    "your next long rest, there is a cumulative 25 percent chance " +
                                    "for each casting after the first that you get no answer. The " +
    ...
    def __init__(self):
        super().__init__(name="Commune with Nature",
                         ...
                         description="You briefly become one with nature and gain knowledge of the " +
                                    ...
                                    "replaced by construction, such as in dungeons and towns.first\n" +
                                    "Yousecondinstantly gain knowledge of up to three facts of your " +
    ...
    def __init__(self):
        super().__init__(name="Comprehend Languages",
                         ...
                         description="For the duration, you understand the literal meaning of any " +
                                    ...
                                    "one page of text.first\n" +
                                    "Thissecondspell doesn't decode secret messages in a text or a " +
    ...
    def __init__(self):
        super().__init__(name="Compulsion",
                         ...
                         description="Creatures of your choice that you can see within range and " +
                                    ...
                                    "take its action before it moves.first\n" +
                                    "Aftersecondmoving in this way, it can make another Wisdom " +
                                    "saving to try to end the effect.first\n" +
                                    "Asecondtarget isn't compelled to move into an obviously deadly " +
    ...
    def __init__(self):
        super().__init__(name="Cone of Cold",
                         ...
                         description="A blast of cold air erupts from your hands. Each creature in a " +
                                    ...
                                    "on a successful one.first\n" +
                                    "Asecondcreature killed by this spell becomes a frozen statue " +
                                    "until it thaws. ",
                         at_higher_levels="When you cast this spell using a spell slot of 6th level or " +
                                          "higher, the damage increases by 1d8 for each slot level above " +
                                          "5th. ")
    ...
    def __init__(self):
        super().__init__(name="Confusion",
                         ...
                         description="This spell assaults and twists creatures' minds, spawning " +
                                    ...
                                    "spell or be affected by it.first\n" +
                                    "Ansecondaffected target can't take reactions and must roll a " +
                                    "d10 at the start of each of its turns to determine its " +
                                    "behavior for that turn.first\n" +
                                    "d10secondBehavior 1 The creature uses all its movement to move " +
                                    "in a random direction. To determine the direction, roll a d8 " +
                                    "and assign a direction to each die face. The creature doesn't " +
                                    "take an action this turn.first\n" +
                                    "2–6secondThe creature doesn't move or take actions this " +
                                    "turn.\n" +
                                    ...
                                    "nothing this turn.first\n" +
                                    "9–10secondThe creature can act and move normally.first\n" +
                                    "Atsecondthe end of each of its turns, an affected target can " +
                                    "make a Wisdom saving throw. If it succeeds, this effect ends " +
                                    "for that target. ",
                         at_higher_levels="When you cast this spell using a spell slot of 5th level or " +
    ...
    def __init__(self):
        super().__init__(name="Conjure Animals",
                         ...
                         description="You summon fey spirits that take the form of beasts and appear " +
                                    ...
                                    "points or when the spell ends.first\n" +
                                    "Thesecondsummoned creatures are friendly to you and your " +
                                    ...
                                    "hostile creatures, but otherwise take no actions.first\n" +
                                    "ThesecondGM has the creatures' statistics. ",
    ...
    def __init__(self):
        super().__init__(name="Conjure Celestial",
                         ...
                         description="You summon a celestial of challenge rating 4 or lower, which " +
                                    ...
                                    "the spell ends.first\n" +
                                    "Thesecondcelestial is friendly to you and your companions for " +
                                    ...
                                    "no actions.first\n" +
                                    "ThesecondGM has the celestial's statistics. ",
    ...
    def __init__(self):
        super().__init__(name="Conjure Elemental",
                         ...
                         description="You call forth an elemental servant. Choose an area of air, " +
                                    ...
                                    "and an earth elemental rises up from the ground.first\n" +
                                    "Thesecondelemental disappears when it drops to 0 hit points or " +
                                    "when the spell ends.first\n" +
                                    "Thesecondelemental is friendly to you and your companions for " +
                                    ...
                                    "otherwise takes no actions.first\n" +
                                    "Ifsecondyour concentration is broken, the elemental doesn't " +
                                    ...
                                    "and it disappears 1 hour after you summoned it.first\n" +
                                    "ThesecondGM has the elemental's statistics. ",
                         at_higher_levels="When you cast this spell using a spell slot of 6th level or " +
    ...
    def __init__(self):
        super().__init__(name="Conjure Fey",
                         ...
                         description="You summon a fey creature of challenge rating 6 or lower, or a " +
                                    ...
                                    "hit points or when the spell ends.first\n" +
                                    "Thesecondfey creature is friendly to you and your companions " +
                                    "for the duration. Roll initiative for the creature, which has " +
                                    "its own turns. It obeys any verbal commands that you issue to " +
                                    "it (no action required by you), as long as they don't violate " +
                                    "its alignment. If you don't issue any commands to the fey " +
                                    "creature, it defends itself from hostile creatures but " +
                                    "otherwise takes no actions.first\n" +
                                    "Ifsecondyour concentration is broken, the fey creature doesn't " +
                                    "disappear. Instead, you lose control of the fey creature, it " +
                                    "becomes hostile toward you and your companions, and it might " +
                                    "attack. An uncontrolled fey creature can't be dismissed by " +
                                    "you, and it disappears 1 hour after you summoned it.first\n" +
                                    "ThesecondGM has the fey creature's statistics. ",
                         at_higher_levels="When you cast this spell using a spell slot of 7th level or " +
                                          "higher, the challenge rating increases by 1 for each slot " +
                                          "level above 6th. ")
    ...
    def __init__(self):
        super().__init__(name="Conjure Minor Elementals",
                         ...
                         description="You summon elementals that appear in unoccupied spaces that " +
                                    ...
                                    "of challenge rating 1/4 or lower.first\n" +
                                    "Ansecondelemental summoned by this spell disappears when it " +
                                    "drops to 0 hit points or when the spell ends.first\n" +
                                    "Thesecondsummoned creatures are friendly to you and your " +
                                    "companions. Roll initiative for the summoned creatures as a " +
                                    "group, which has its own turns. They obey any verbal commands " +
                                    "that you issue to them (no action required by you). If you " +
    ...
    def __init__(self):
        super().__init__(name="Conjure Woodland Beings",
                         ...
                         description="You summon fey creatures that appear in unoccupied spaces that " +
                                    "you can see within range.first\n" +
                                    "Choosesecondone of the following options for what appears: • " +
                                    "One fey creature of challenge rating 2 or lower • Two fey " +
                                    ...
                                    "when it drops to 0 hit points or when the spell ends.first\n" +
                                    "Thesecondsummoned creatures are friendly to you and your " +
                                    "companions. Roll initiative for the summoned creatures as a " +
                                    "group, which have their own turns.first\n" +
                                    "Theysecondobey any verbal commands that you issue to them (no " +
                                    "action required by you). If you don't issue any commands to " +
                                    "them, they defend themselves from hostile creatures, but " +
                                    "otherwise take no actions.first\n" +
                                    "ThesecondGM has the creatures' statistics. ",
                         at_higher_levels="When you cast this spell using certain higher-level spell " +
                                          "slots, you choose one of the summoning options above, and more " +
                                          "creatures appear: twice as many with a 6th-level slot and " +
    ...
    def __init__(self):
        super().__init__(name="Contact Other Plane",
                         ...
                         description="You mentally contact a demigod, the spirit of a longdead sage, " +
                                    ...
                                    "are insane until you finish a long rest.first\n" +
                                    "Whilesecondinsane, you can't take actions, can't understand " +
                                    "what other creatures say, can't read, and speak only in " +
                                    "gibberish. A greater restoration spell cast on you ends this " +
                                    "effect.\n" +
                                    "On a successful save, you can ask the entity up to " +
                                    "five questions. You must ask your questions before the spell " +
                                    "ends. The GM answers each question with one word, such as " +
                                    "“yes,” “no,” “maybe,” “never,” “irrelevant,” or “unclear” (if " +
                                    "the entity doesn't know the answer to the question). If a " +
                                    "one-word answer would be misleading, the GM might instead " +
    ...
    def __init__(self):
        super().__init__(name="Contagion",
                         ...
                         description="Your touch inflicts disease. Make a melee spell attack against " +
                                    ...
                                    "Atsecondthe end of each of the target's turns, it must make a " +
                                    ...
                                    "disease, and the spell ends.first\n" +
                                    "Sincesecondthis spell induces a natural disease in its target, " +
                                    "any effect that removes a disease or otherwise ameliorates a " +
                                    "disease's effects apply to it.first\n" +
                                    "BlindingsecondSickness. Pain grips the creature's mind, and " +
                                    "its eyes turn milky white. The creature has disadvantage on " +
                                    "Wisdom checks and Wisdom saving throws and is blinded.first\n" +
                                    "FilthsecondFever. A raging fever sweeps through the creature's " +
                                    ...
                                    "damage.\n" +
                                    "Mindfire. The creature's mind becomes feverish.first\n" +
                                    "Thesecondcreature has disadvantage on Intelligence checks and " +
                                    "Intelligence saving throws, and the creature behaves as if " +
                                    "under the effects of the confusion spell during " +
                                    "combat.\n" +
                                    "Seizure. The creature is overcome with shaking.first\n" +
                                    "Thesecondcreature has disadvantage on Dexterity checks, " +
                                    ...
                                    "checks and Constitution saving throws.first\n" +
                                    "Insecondaddition, whenever the creature takes damage, it is " +
    ...
    def __init__(self):
        super().__init__(name="Contingency",
                         ...
                         description="Choose a spell of 5th level or lower that you can cast, that " +
                                    ...
                                    "water or a similar liquid.first\n" +
                                    "Thesecondcontingent spell takes effect immediately after the " +
                                    "circumstance is met for the first time, whether or not you " +
                                    "want it to, and then contingency ends.first\n" +
                                    "Thesecondcontingent spell takes effect only on you, even if it " +
                                    "can normally target others. You can use only one contingency " +
                                    "spell at a time. If you cast this spell again, the effect of " +
                                    "another contingency spell on you ends.first\n" +
                                    "Also,secondcontingency ends on you if its material component " +
    ...
    def __init__(self):
        super().__init__(name="Control Water",
                         ...
                         description="Until the spell ends, you control any freestanding water " +
                                    ...
                                    "the same effect or choose a different one.first\n" +
                                    "Flood.secondYou cause the water level of all standing water in " +
                                    "the area to rise by as much as 20 feet. If the area includes a " +
                                    "shore, the flooding water spills over onto dry land.first\n" +
                                    "Ifsecondyou choose an area in a large body of water, you " +
                                    "instead create a 20-foot tall wave that travels from one side " +
                                    "of the area to the other and then crashes down. Any Huge or " +
                                    "smaller vehicles in the wave's path are carried with it to the " +
                                    "other side. Any Huge or smaller vehicles struck by the wave " +
                                    "have a 25 percent chance of capsizing.first\n" +
                                    "Thesecondwater level remains elevated until the spell ends or " +
                                    "you choose a different effect. If this effect produced a wave, " +
                                    "the wave repeats on the start of your next turn while the " +
                                    "flood effect lasts.first\n" +
                                    "PartsecondWater. You cause water in the area to move apart and " +
                                    ...
                                    "a different effect.first\n" +
                                    "Whirlpool.secondThis effect requires a body of water at least " +
                                    "50 feet square and 25 feet deep. You cause a whirlpool to form " +
                                    "in the center of the area. The whirlpool forms a vortex that " +
                                    "is 5 feet wide at the base, up to 50 feet wide at the top, and " +
                                    "25 feet tall.first\n" +
                                    "Anysecondcreature or object in the water and within 25 feet of " +
                                    "the vortex is pulled 10 feet toward it. A creature can swim " +
                                    "away from the vortex by making a Strength (Athletics) check " +
                                    "against your spell save DC.first\n" +
                                    "Whenseconda creature enters the vortex for the first time on a " +
                                    ...
                                    "to do so.first\n" +
                                    "Thesecondfirst time each turn that an object enters the " +
    ...
    def __init__(self):
        super().__init__(name="Control Weather",
                         ...
                         description="You take control of the weather within 5 miles of you for the " +
                                    ...
                                    "spell early.first\n" +
                                    "Whensecondyou cast the spell, you change the current weather " +
                                    ...
                                    "take effect.first\n" +
                                    "Oncesecondthey do so, you can change the conditions " +
                                    "again.\n" +
    ...
    def __init__(self):
        super().__init__(name="Create Undead",
                         ...
                         description="You can cast this spell only at night. Choose up to three " +
                                    ...
                                    "maintain control of the creature for another 24 hours, you " +
                                    "must cast this spell on the creature before the current " +
                                    "24-hour period ends.first\n" +
                                    "Thisseconduse of the spell reasserts your control over up to " +
...
class CreateOrDestroyWater(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Create or Destroy Water",
                         ...
                         description=You either create or destroy water.first\n +
                                    "CreatesecondWater. You create up to 10 gallons of clean water " +
                                    "within range in an open container.first\n" +
                                    "Alternatively,secondthe water falls as rain in a 30-foot cube " +
                                    "within range, extinguishing exposed flames in the " +
                                    "area.\n" +
                                    "Destroy Water. You destroy up to 10 gallons of water in " +
                                    "an open container within range.first\n" +
                                    "Alternatively,secondyou destroy fog in a 30-foot cube within " +
                                    "range. ",
                         at_higher_levels="When you cast this spell using a spell slot of 2nd level or " +
    ...
    def __init__(self):
        super().__init__(name="Creation",
                         ...
                         description="You pull wisps of shadow material from the Shadowfell to " +
                                    ...
                                    "have seen before.first\n" +
                                    "Thesecondduration depends on the object's material. If the " +
                                    "object is composed of multiple materials, use the shortest " +
                                    "duration.\n" +
    ...
    def __init__(self):
        super().__init__(name="Cure Wounds",
                         ...
                         description="A creature you touch regains a number of hit points equal to " +
                                    "1d8 + your spellcasting ability modifier.first\n" +
                                    "Thissecondspell has no effect on undead or constructs. ",
                         at_higher_levels="When you cast this spell using a spell slot of 2nd level or " +
    ...
    def __init__(self):
        super().__init__(name="Dancing Lights",
                         ...
                         description="You create up to four torch-sized lights within range, making " +
                                    ...
                                    "foot radius.first\n" +
                                    "Asseconda bonus action on your turn, you can move the lights " +
                                    "up to 60 feet to a new spot within range. A light must be " +
                                    "within 20 feet of another light created by this spell, and a " +
    ...
    def __init__(self):
        super().__init__(name="Darkness",
                         ...
                         description="Magical darkness spreads from a point you choose within range " +
                                    ...
                                    "or a helm, blocks the darkness.first\n" +
                                    "Ifsecondany of this spell's area overlaps with an area of " +
    ...
    def __init__(self):
        super().__init__(name="Daylight",
                         ...
                         description="A 60-foot-radius sphere of light spreads out from a point you " +
                                    ...
                                    "light for an additional 60 feet.first\n" +
                                    "Ifsecondyou chose a point on an object you are holding or one " +
                                    "that isn't being worn or carried, the light shines from the " +
                                    "object and moves with it. Completely covering the affected " +
                                    "object with an opaque object, such as a bowl or a helm, blocks " +
                                    "the light.first\n" +
                                    "Ifsecondany of this spell's area overlaps with an area of " +
    ...
    def __init__(self):
        super().__init__(name="Death Ward",
                         ...
                         description="You touch a creature and grant it a measure of protection from " +
                                    ...
                                    "point, and the spell ends.first\n" +
                                    "Ifsecondthe spell is still in effect when the target is " +
                                    "subjected to an effect that would kill it instantaneously " +
                                    "without dealing damage, that effect is instead negated against " +
    ...
    def __init__(self):
        super().__init__(name="Delayed Blast Fireball",
                         ...
                         description="A beam of yellow light flashes from your pointing finger, then " +
                                    ...
                                    "glowing bead for the duration.first\n" +
                                    "Whensecondthe spell ends, either because your concentration is " +
                                    ...
                                    "failed save, or half as much damage on a successful one.first\n" +
                                    "Thesecondspell's base damage is 12d6. If at the end of your " +
                                    "turn the bead has not yet detonated, the damage increases by " +
                                    "1d6.\n" +
                                    ...
                                    "the bead to erupt in flame.first\n" +
                                    "Onseconda successful save, the creature can throw the bead up " +
                                    "to 40 feet. When it strikes a creature or a solid object, the " +
                                    "spell ends, and the bead explodes.first\n" +
                                    "Thesecondfire damages objects in the area and ignites " +
    ...
    def __init__(self):
        super().__init__(name="Demiplane",
                         ...
                         description="You create a shadowy door on a flat solid surface that you can " +
                                    ...
                                    "Eachsecondtime you cast this spell, you can create a new " +
                                    "demiplane, or have the shadowy door connect to a demiplane you " +
                                    "created with a previous casting of this spell. Additionally, " +
                                    "if you know the nature and contents of a demiplane created by " +
                                    "a casting of this spell by another creature, you can have the " +
    ...
    def __init__(self):
        super().__init__(name="Detect Evil and Good",
                         ...
                         description="For the duration, you know if there is an aberration, " +
                                    ...
                                    "you, as well as where the creature is located.first\n" +
                                    "Similarly,secondyou know if there is a place or object within " +
    ...
    def __init__(self):
        super().__init__(name="Detect Magic",
                         ...
                         description="For the duration, you sense the presence of magic within 30 " +
                                    ...
                                    "of magic, if any.first\n" +
                                    "Thesecondspell can penetrate most barriers, but it is blocked " +
    ...
    def __init__(self):
        super().__init__(name="Detect Thoughts",
                         ...
                         description="For the duration, you can read the thoughts of certain " +
                                    ...
                                    "doesn't speak any language, the creature is unaffected.first\n" +
                                    "Yousecondinitially learn the surface thoughts of the " +
                                    "creature—what is most on its mind in that moment.first\n" +
                                    "Assecondan action, you can either shift your attention to " +
                                    "another creature's thoughts or attempt to probe deeper into " +
                                    "the same creature's mind. If you probe deeper, the target must " +
                                    "make a Wisdom saving throw. If it fails, you gain insight into " +
                                    "its reasoning (if any), its emotional state, and something " +
                                    "that looms large in its mind (such as something it worries " +
                                    "over, loves, or hates). If it succeeds, the spell ends. Either " +
                                    ...
                                    "it succeeds, the spell ends.first\n" +
                                    "Questionssecondverbally directed at the target creature " +
                                    "naturally shape the course of its thoughts, so this spell is " +
                                    "particularly effective as part of an interrogation.first\n" +
                                    "Yousecondcan also use this spell to detect the presence of " +
                                    ...
                                    "doesn't speak any language.first\n" +
                                    "Oncesecondyou detect the presence of a creature in this way, " +
    ...
    def __init__(self):
        super().__init__(name="Dimension Door",
                         ...
                         description="You teleport yourself from your current location to any other " +
                                    ...
                                    "be within 5 feet of you when you cast this spell.first\n" +
                                    "Ifsecondyou would arrive in a place already occupied by an " +
                                    "object or a creature, you and any creature traveling with you " +
                                    "each take 4d6 force damage, and the spell fails to teleport " +
                                    "you. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Disguise Self",
                         ...
                         description="You make yourself—including your clothing, armor, weapons, and " +
                                    ...
                                    "form that has the same basic arrangement of limbs.first\n" +
                                    "Otherwise,secondthe extent of the illusion is up to you.first\n" +
                                    "Thesecondchanges wrought by this spell fail to hold up to " +
                                    "physical inspection. For example, if you use this spell to add " +
                                    "a hat to your outfit, objects pass through the hat, and anyone " +
                                    "who touches it would feel nothing or would feel your head and " +
                                    "hair. If you use this spell to appear thinner than you are, " +
                                    "the hand of someone who reaches out to touch you would bump " +
                                    "into you while it was seemingly still in midair.first\n" +
                                    "Toseconddiscern that you are disguised, a creature can use its " +
    ...
    def __init__(self):
        super().__init__(name="Disintegrate",
                         ...
                         description="A thin green ray springs from your pointing finger to a target " +
                                    ...
                                    "created by wall of force.first\n" +
                                    "Asecondcreature targeted by this spell must make a Dexterity " +
                                    "saving throw. On a failed save, the target takes 10d6 + 40 " +
                                    "force damage. If this damage reduces the target to 0 hit " +
                                    "points, it is disintegrated.first\n" +
                                    "Aseconddisintegrated creature and everything it is wearing and " +
                                    "carrying, except magic items, are reduced to a pile of fine " +
                                    "gray dust. The creature can be restored to life only by means " +
                                    "of a true resurrection or a wish spell.first\n" +
                                    "Thissecondspell automatically disintegrates a Large or smaller " +
    ...
    def __init__(self):
        super().__init__(name="Dispel Evil and Good",
                         ...
                         description="Shimmering energy surrounds and protects you from fey, undead, " +
                                    ...
                                    "have disadvantage on attack rolls against you.first\n" +
                                    "Yousecondcan end the spell early by using either of the " +
                                    "following special functions.first\n" +
                                    "BreaksecondEnchantment. As your action, you touch a creature " +
                                    "you can reach that is charmed, frightened, or possessed by a " +
                                    "celestial, an elemental, a fey, a fiend, or an undead. The " +
                                    "creature you touch is no longer charmed, frightened, or " +
                                    "possessed by such creatures.first\n" +
                                    "Dismissal.secondAs your action, make a melee spell attack " +
                                    "against a celestial, an elemental, a fey, a fiend, or an " +
                                    "undead you can reach. On a hit, you attempt to drive the " +
                                    "creature back to its home plane. The creature must succeed on " +
                                    "a Charisma saving throw or be sent back to its home plane (if " +
                                    "it isn't there already). If they aren't on their home plane, " +
                                    "undead are sent to the Shadowfell, and fey are sent to the " +
                                    "Feywild. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Divination",
                         ...
                         description="Your magic and an offering put you in contact with a god or a " +
                                    ...
                                    "a cryptic rhyme, or an omen.first\n" +
                                    "Thesecondspell doesn't take into account any possible " +
                                    ...
                                    "finishing your next long rest, there is a cumulative 25 " +
...
class DivineFavor(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Divine Favor",
                         ...
                         material_components_list=None,
                         duration="1 minute",
                         description=Your prayer empowers you with divine radiance.first\n +
                                    "Untilsecondthe spell ends, your weapon attacks deal an extra " +
    ...
    def __init__(self):
        super().__init__(name="Divine Word",
                         ...
                         description="You utter a divine word, imbued with the power that shaped the " +
                                    ...
                                    "you can see within range.first\n" +
                                    "Eachsecondcreature that can hear you must make a Charisma " +
                                    "saving throw. On a failed save, a creature suffers an effect " +
                                    "based on its current hit points: • 50 hit points or fewer: " +
                                    "deafened for 1 minute • 40 hit points or fewer: deafened and " +
                                    "blinded for 10 minutes • 30 hit points or fewer: blinded, " +
                                    "deafened, and stunned for 1 hour • 20 hit points or fewer: " +
                                    "killed instantly Regardless of its current hit points, a " +
                                    "celestial, an elemental, a fey, or a fiend that fails its save " +
                                    "is forced back to its plane of origin (if it isn't there " +
                                    "already) and can't return to your current plane for 24 hours " +
    ...
    def __init__(self):
        super().__init__(name="Dominate Beast",
                         ...
                         description="You attempt to beguile a beast that you can see within range. " +
                                    ...
                                    "are fighting it, it has advantage on the saving throw.first\n" +
                                    "Whilesecondthe beast is charmed, you have a telepathic link " +
                                    ...
                                    "defends and preserves itself to the best of its ability.first\n" +
                                    "Yousecondcan use your action to take total and precise control " +
                                    "of the target. Until the end of your next turn, the creature " +
                                    "takes only the actions you choose, and doesn't do anything " +
                                    "that you don't allow it to do.first\n" +
                                    "Duringsecondthis time, you can also cause the creature to use " +
    ...
    def __init__(self):
        super().__init__(name="Dominate Person",
                         ...
                         description="You attempt to beguile a humanoid that you can see within " +
                                    ...
                                    "takes only the actions you choose, and doesn't do anything " +
                                    "that you don't allow it to do.first\n" +
                                    "Duringsecondthis time you can also cause the creature to use a " +
    ...
    def __init__(self):
        super().__init__(name="Dream",
                         ...
                         description="This spell shapes a creature's dreams. Choose a creature known " +
                                    ...
                                    "same plane of existence as you.first\n" +
                                    "Creaturessecondthat don't sleep, such as elves, can't be " +
                                    "contacted by this spell. You, or a willing creature you touch, " +
                                    "enters a trance state, acting as a messenger.first\n" +
                                    "Whilesecondin the trance, the messenger is aware of his or her " +
                                    "surroundings, but can't take actions or move.first\n" +
                                    "Ifsecondthe target is asleep, the messenger appears in the " +
                                    "target's dreams and can converse with the target as long as it " +
                                    "remains asleep, through the duration of the spell. The " +
                                    "messenger can also shape the environment of the dream, " +
                                    "creating landscapes, objects, and other images. The messenger " +
                                    "can emerge from the trance at any time, ending the effect of " +
                                    "the spell early. The target recalls the dream perfectly upon " +
                                    "waking. If the target is awake when you cast the spell, the " +
                                    "messenger knows it, and can either end the trance (and the " +
                                    "spell) or wait for the target to fall asleep, at which point " +
                                    "the messenger appears in the target's dreams.first\n" +
                                    "Yousecondcan make the messenger appear monstrous and " +
                                    "terrifying to the target. If you do, the messenger can deliver " +
                                    "a message of no more than ten words and then the target must " +
                                    "make a Wisdom saving throw. On a failed save, echoes of the " +
                                    ...
                                    "target wakes up, it takes 3d6 psychic damage.first\n" +
                                    "Ifsecondyou have a body part, lock of hair, clipping from a " +
    ...
    def __init__(self):
        super().__init__(name="Druidcraft",
                         ...
                         description="Whispering to the spirits of nature, you create one of the " +
                                    ...
                                    "or a leaf bud bloom.first\n" +
                                    "•secondYou create an instantaneous, harmless sensory effect, " +
                                    "such as falling leaves, a puff of wind, the sound of a small " +
                                    "animal, or the faint odor of skunk.first\n" +
                                    "Thesecondeffect must fit in a 5-foot cube.first\n" +
                                    "•secondYou instantly light or snuff out a candle, a torch, or " +
                                    "a small campfire. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Earthquake",
                         ...
                         description="You create a seismic disturbance at a point on the ground that " +
                                    ...
                                    "with the ground in that area.first\n" +
                                    "Thesecondground in the area becomes difficult terrain.first\n" +
                                    "Eachsecondcreature on the ground that is concentrating must " +
                                    "make a Constitution saving throw. On a failed save, the " +
                                    "creature's concentration is broken.first\n" +
                                    "Whensecondyou cast this spell and at the end of each turn you " +
                                    "spend concentrating on it, each creature on the ground in the " +
                                    "area must make a Dexterity saving throw. On a failed save, the " +
                                    "creature is knocked prone.first\n" +
                                    "Thissecondspell can have additional effects depending on the " +
                                    "terrain in the area, as determined by the GM.first\n" +
                                    "Fissures.secondFissures open throughout the spell's area at " +
                                    ...
                                    "automatically collapse (see below).first\n" +
                                    "Structures.secondThe tremor deals 50 bludgeoning damage to any " +
                                    ...
                                    "action to escape.first\n" +
                                    "ThesecondGM can adjust the DC higher or lower, depending on " +
                                    "the nature of the rubble. On a successful save, the creature " +
                                    "takes half as much damage and doesn't fall prone or become " +
                                    "buried. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Enhance Ability",
                         ...
                         description="You touch a creature and bestow upon it a magical enhancement. " +
                                    ...
                                    "effect until the spell ends.first\n" +
                                    "Bear'ssecondEndurance. The target has advantage on " +
                                    "Constitution checks. It also gains 2d6 temporary hit points, " +
                                    "which are lost when the spell ends.first\n" +
                                    "Bull'ssecondStrength. The target has advantage on Strength " +
                                    "checks, and his or her carrying capacity doubles.first\n" +
                                    "Cat'ssecondGrace. The target has advantage on Dexterity " +
                                    "checks. It also doesn't take damage from falling 20 feet or " +
                                    "less if it isn't incapacitated.first\n" +
                                    "Eagle'ssecondSplendor. The target has advantage on Charisma " +
                                    "checks.\n" +
                                    "Fox's Cunning. The target has advantage on " +
                                    "Intelligence checks.first\n" +
                                    "Owl'ssecondWisdom. The target has advantage on Wisdom checks. ",
                         at_higher_levels="When you cast this spell using a spell slot of 3rd level or " +
                                          "higher, you can target one additional creature for each slot " +
                                          "level above 2nd. ")
    ...
    def __init__(self):
        super().__init__(name="Enlarge/Reduce",
                         ...
                         description="You cause a creature or an object you can see within range to " +
                                    "grow larger or smaller for the duration.first\n" +
                                    "Choosesecondeither a creature or an object that is neither " +
                                    "worn nor carried. If the target is unwilling, it can make a " +
                                    ...
                                    "affected creature returns to normal size at once.first\n" +
                                    "Enlarge.secondThe target's size doubles in all dimensions, and " +
                                    "its weight is multiplied by eight.first\n" +
                                    "Thissecondgrowth increases its size by one category— from " +
                                    "Medium to Large, for example. If there isn't enough room for " +
                                    "the target to double its size, the creature or object attains " +
                                    "the maximum possible size in the space available. Until the " +
                                    "spell ends, the target also has advantage on Strength checks " +
                                    "and Strength saving throws. The target's weapons also grow to " +
                                    "match its new size. While these weapons are enlarged, the " +
                                    "target's attacks with them deal 1d4 extra damage.first\n" +
                                    "Reduce.secondThe target's size is halved in all dimensions, " +
                                    "and its weight is reduced to one-eighth of normal. This " +
                                    "reduction decreases its size by one category—from Medium to " +
                                    "Small, for example. Until the spell ends, the target also has " +
                                    "disadvantage on Strength checks and Strength saving throws. " +
                                    "The target's weapons also shrink to match its new size.first\n" +
                                    "Whilesecondthese weapons are reduced, the target's attacks " +
                                    "with them deal 1d4 less damage (this can't reduce the damage " +
                                    "below 1). ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Entangle",
                         ...
                         description="Grasping weeds and vines sprout from the ground in a 20-foot " +
                                    "square starting from a point within range.first\n" +
                                    "Forsecondthe duration, these plants turn the ground in the " +
                                    "area into difficult terrain.first\n" +
                                    "Asecondcreature in the area when you cast the spell must " +
    ...
    def __init__(self):
        super().__init__(name="Etherealness",
                         ...
                         description="You step into the border regions of the Ethereal Plane, in the " +
                                    ...
                                    "can't see anything more than 60 feet away.first\n" +
                                    "Whilesecondon the Ethereal Plane, you can only affect and be " +
                                    "affected by other creatures on that plane.first\n" +
                                    "Creaturessecondthat aren't on the Ethereal Plane can't " +
                                    "perceive you and can't interact with you, unless a special " +
                                    "ability or magic has given them the ability to do so.first\n" +
                                    "Yousecondignore all objects and effects that aren't on the " +
                                    "Ethereal Plane, allowing you to move through objects you " +
                                    "perceive on the plane you originated from.first\n" +
                                    "Whensecondthe spell ends, you immediately return to the plane " +
                                    "you originated from in the spot you currently occupy. If you " +
                                    ...
                                    "the number of feet you are moved.first\n" +
                                    "Thissecondspell has no effect if you cast it while you are on " +
                                    "the Ethereal Plane or a plane that doesn't border it, such as " +
...
class ExpeditiousRetreat(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Expeditious Retreat",
                         ...
                         material_components_list=None,
                         duration="10 minutes",
                         description=This spell allows you to move at an incredible pace.first\n +
                                    "Whensecondyou cast this spell, and then as a bonus action on " +
                                    "each of your turns until the spell ends, you can take the Dash " +
                                    "action. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Eyebite",
                         ...
                         description="For the spell's duration, your eyes become an inky void imbued " +
                                    ...
                                    "against this casting of eyebite.first\n" +
                                    "Asleep.secondThe target falls unconscious. It wakes up if it " +
                                    "takes any damage or if another creature uses its action to " +
                                    "shake the sleeper awake.first\n" +
                                    "Panicked.secondThe target is frightened of you. On each of its " +
                                    ...
                                    "see you, this effect ends.first\n" +
                                    "Sickened.secondThe target has disadvantage on attack rolls and " +
    ...
    def __init__(self):
        super().__init__(name="Faerie Fire",
                         ...
                         description="Each object in a 20-foot cube within range is outlined in " +
                                    "blue, green, or violet light (your choice).first\n" +
                                    "Anysecondcreature in the area when the spell is cast is also " +
                                    "outlined in light if it fails a Dexterity saving throw.first\n" +
                                    "Forsecondthe duration, objects and affected creatures shed dim " +
                                    "light in a 10-foot radius.first\n" +
                                    "Anysecondattack roll against an affected creature or object " +
    ...
    def __init__(self):
        super().__init__(name="Faithful Hound",
                         ...
                         description="You conjure a phantom watchdog in an unoccupied space that you " +
                                    ...
                                    "feet away from it.first\n" +
                                    "Thesecondhound is invisible to all creatures except you and " +
                                    "can't be harmed. When a Small or larger creature comes within " +
                                    "30 feet of it without first speaking the password that you " +
                                    "specify when you cast this spell, the hound starts barking " +
                                    "loudly. The hound sees invisible creatures and can see into " +
                                    "the Ethereal Plane. It ignores illusions.first\n" +
                                    "Atsecondthe start of each of your turns, the hound attempts to " +
                                    "bite one creature within 5 feet of it that is hostile to you. " +
                                    "The hound's attack bonus is equal to your spellcasting ability " +
    ...
    def __init__(self):
        super().__init__(name="Fear",
                         ...
                         description="You project a phantasmal image of a creature's worst fears. " +
                                    ...
                                    "frightened for the duration.first\n" +
                                    "Whilesecondfrightened by this spell, a creature must take the " +
                                    "Dash action and move away from you by the safest available " +
                                    "route on each of its turns, unless there is nowhere to move. " +
                                    "If the creature ends its turn in a location where it doesn't " +
                                    "have line of sight to you, the creature can make a Wisdom " +
                                    "saving throw. On a successful save, the spell ends for that " +
                                    "creature. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Feeblemind",
                         ...
                         description="You blast the mind of a creature that you can see within " +
                                    ...
                                    "Intelligence saving throw.first\n" +
                                    "Onseconda failed save, the creature's Intelligence and " +
                                    "Charisma scores become 1. The creature can't cast spells, " +
                                    "activate magic items, understand language, or communicate in " +
                                    "any intelligible way. The creature can, however, identify its " +
                                    "friends, follow them, and even protect them.first\n" +
                                    "Atsecondthe end of every 30 days, the creature can repeat its " +
                                    "saving throw against this spell. If it succeeds on its saving " +
                                    "throw, the spell ends.first\n" +
                                    "Thesecondspell can also be ended by greater restoration, heal, " +
                                    "or wish. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Find Familiar",
                         ...
                         description="You gain the service of a familiar, a spirit that takes an " +
                                    ...
                                    "raven, sea horse, spider, or weasel.first\n" +
                                    "Appearingsecondin an unoccupied space within range, the " +
                                    "familiar has the statistics of the chosen form, though it is a " +
                                    "celestial, fey, or fiend (your choice) instead of a " +
                                    "beast.\n" +
                                    "Your familiar acts independently of you, but it always " +
                                    "obeys your commands. In combat, it rolls its own initiative " +
                                    "and acts on its own turn. A familiar can't attack, but it can " +
                                    "take other actions as normal.first\n" +
                                    "Whensecondthe familiar drops to 0 hit points, it disappears, " +
                                    ...
                                    "own senses.first\n" +
                                    "Assecondan action, you can temporarily dismiss your familiar. " +
                                    "It disappears into a pocket dimension where it awaits your " +
                                    "summons. Alternatively, you can dismiss it forever. As an " +
                                    "action while it is temporarily dismissed, you can cause it to " +
                                    "reappear in any unoccupied space within 30 feet of you.first\n" +
                                    "Yousecondcan't have more than one familiar at a time. If you " +
                                    "cast this spell while you already have a familiar, you instead " +
    ...
    def __init__(self):
        super().__init__(name="Find Steed",
                         ...
                         description="You summon a spirit that assumes the form of an unusually " +
                                    ...
                                    "understand one language of your choice that you speak.first\n" +
                                    "Yoursecondsteed serves you as a mount, both in combat and out, " +
                                    "and you have an instinctive bond with it that allows you to " +
                                    "fight as a seamless unit. While mounted on your steed, you can " +
                                    ...
                                    "restored to its hit point maximum.first\n" +
                                    "Whilesecondyour steed is within 1 mile of you, you can " +
                                    "communicate with it telepathically.first\n" +
                                    "Yousecondcan't have more than one steed bonded by this spell " +
    ...
    def __init__(self):
        super().__init__(name="Finger of Death",
                         ...
                         description="You send negative energy coursing through a creature that you " +
                                    ...
                                    "damage on a failed save, or half as much damage on a " +
                                    "successful one.first\n" +
                                    "Asecondhumanoid killed by this spell rises at the start of " +
                                    "your next turn as a zombie that is permanently under your " +
                                    "command, following your verbal orders to the best of its " +
                                    "ability. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Fire Bolt",
                         ...
                         description="You hurl a mote of fire at a creature or object within range. " +
                                    "Make a ranged spell attack against the target.first\n" +
                                    "Onseconda hit, the target takes 1d10 fire damage. A flammable " +
    ...
    def __init__(self):
        super().__init__(name="Fire Shield",
                         ...
                         description="Thin and wispy flames wreathe your body for the duration, " +
                                    ...
                                    "action to dismiss it.first\n" +
                                    "Thesecondflames provide you with a warm shield or a chill " +
                                    "shield, as you choose. The warm shield grants you resistance " +
                                    "to cold damage, and the chill shield grants you resistance to " +
                                    "fire damage.first\n" +
                                    "Insecondaddition, whenever a creature within 5 feet of you " +
    ...
    def __init__(self):
        super().__init__(name="Fire Storm",
                         ...
                         description="A storm made up of sheets of roaring flame appears in a " +
                                    ...
                                    "the face of another cube.first\n" +
                                    "Eachsecondcreature in the area must make a Dexterity saving " +
                                    "throw. It takes 7d10 fire damage on a failed save, or half as " +
                                    "much damage on a successful one.first\n" +
                                    "Thesecondfire damages objects in the area and ignites " +
                                    "flammable objects that aren't being worn or carried.first\n" +
                                    "Ifsecondyou choose, plant life in the area is unaffected by " +
                                    "this spell. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Fireball",
                         ...
                         description="A bright streak flashes from your pointing finger to a point " +
                                    ...
                                    "half as much damage on a successful one.first\n" +
                                    "Thesecondfire spreads around corners. It ignites flammable " +
    ...
    def __init__(self):
        super().__init__(name="Flame Blade",
                         ...
                         description="You evoke a fiery blade in your free hand. The blade is " +
                                    ...
                                    "can evoke the blade again as a bonus action.first\n" +
                                    "Yousecondcan use your action to make a melee spell attack with " +
                                    "the fiery blade. On a hit, the target takes 3d6 fire " +
                                    "damage.\n" +
    ...
    def __init__(self):
        super().__init__(name="Flaming Sphere",
                         ...
                         description="A 5-foot-diameter sphere of fire appears in an unoccupied " +
                                    ...
                                    "successful one.first\n" +
                                    "Asseconda bonus action, you can move the sphere up to 30 feet. " +
                                    "If you ram the sphere into a creature, that creature must make " +
                                    "the saving throw against the sphere's damage, and the sphere " +
                                    "stops moving this turn.first\n" +
                                    "Whensecondyou move the sphere, you can direct it over barriers " +
                                    "up to 5 feet tall and jump it across pits up to 10 feet wide. " +
                                    "The sphere ignites flammable objects not being worn or " +
    ...
    def __init__(self):
        super().__init__(name="Flesh to Stone",
                         ...
                         description="You attempt to turn one creature that you can see within range " +
                                    ...
                                    "successful save, the creature isn't affected.first\n" +
                                    "Asecondcreature restrained by this spell must make another " +
                                    ...
                                    "three of a kind.first\n" +
                                    "Ifsecondthe creature is physically broken while petrified, it " +
    ...
    def __init__(self):
        super().__init__(name="Forbiddance",
                         ...
                         description="You create a ward against magical travel that protects up to " +
                                    ...
                                    "Shadowfell, or the plane shift spell.first\n" +
                                    "Insecondaddition, the spell damages types of creatures that " +
                                    "you choose when you cast it. Choose one or more of the " +
                                    "following: celestials, elementals, fey, fiends, and undead. " +
                                    "When a chosen creature enters the spell's area for the first " +
                                    "time on a turn or starts its turn there, the creature takes " +
                                    "5d10 radiant or necrotic damage (your choice when you cast " +
                                    "this spell).first\n" +
                                    "Whensecondyou cast this spell, you can designate a password. A " +
                                    "creature that speaks the password as it enters the area takes " +
                                    "no damage from the spell.first\n" +
                                    "Thesecondspell's area can't overlap with the area of another " +
    ...
    def __init__(self):
        super().__init__(name="Forcecage",
                         ...
                         description="An immobile, invisible, cube-shaped prison composed of magical " +
                                    ...
                                    "inch apart.first\n" +
                                    "Asecondprison in the shape of a box can be up to 10 feet on a " +
                                    "side, creating a solid barrier that prevents any matter from " +
                                    "passing through it and blocking any spells cast into or out " +
                                    "from the area.first\n" +
                                    "Whensecondyou cast the spell, any creature that is completely " +
                                    "inside the cage's area is trapped.first\n" +
                                    "Creaturessecondonly partially within the area, or those too " +
                                    "large to fit inside the area, are pushed away from the center " +
                                    "of the area until they are completely outside the area.first\n" +
                                    "Asecondcreature inside the cage can't leave it by nonmagical " +
                                    "means. If the creature tries to use teleportation or " +
                                    "interplanar travel to leave the cage, it must first make a " +
                                    "Charisma saving throw. On a success, the creature can use that " +
                                    "magic to exit the cage. On a failure, the creature can't exit " +
                                    "the cage and wastes the use of the spell or effect. The cage " +
                                    "also extends into the Ethereal Plane, blocking ethereal " +
                                    "travel.\n" +
    ...
    def __init__(self):
        super().__init__(name="Freedom of Movement",
                         ...
                         description="You touch a willing creature. For the duration, the target's " +
                                    ...
                                    "nor cause the target to be paralyzed or restrained.first\n" +
                                    "Thesecondtarget can also spend 5 feet of movement to " +
                                    "automatically escape from nonmagical restraints, such as " +
                                    "manacles or a creature that has it grappled.first\n" +
                                    "Finally,secondbeing underwater imposes no penalties on the " +
    ...
    def __init__(self):
        super().__init__(name="Freezing Sphere",
                         ...
                         description="A frigid globe of cold energy streaks from your fingertips to " +
                                    ...
                                    "much damage.first\n" +
                                    "Ifsecondthe globe strikes a body of water or a liquid that is " +
                                    ...
                                    "check against your spell save DC to break free.first\n" +
                                    "Yousecondcan refrain from firing the globe after completing " +
                                    "the spell, if you wish. A small globe about the size of a " +
                                    "sling stone, cool to the touch, appears in your hand. At any " +
                                    "time, you or a creature you give the globe to can throw the " +
                                    "globe (to a range of 40 feet) or hurl it with a sling (to the " +
    ...
    def __init__(self):
        super().__init__(name="Gaseous Form",
                         ...
                         description="You transform a willing creature you touch, along with " +
                                    ...
                                    "points. An incorporeal creature isn't affected.first\n" +
                                    "Whilesecondin this form, the target's only method of movement " +
                                    "is a flying speed of 10 feet. The target can enter and occupy " +
                                    ...
                                    "when stunned or otherwise incapacitated.first\n" +
                                    "Whilesecondin the form of a misty cloud, the target can't talk " +
                                    "or manipulate objects, and any objects it was carrying or " +
                                    "holding can't be dropped, used, or otherwise interacted with. " +
    ...
    def __init__(self):
        super().__init__(name="Gate",
                         ...
                         description="You conjure a portal linking an unoccupied space you can see " +
                                    ...
                                    "unoccupied space nearest to the portal.first\n" +
                                    "Deitiessecondand other planar rulers can prevent portals " +
                                    "created by this spell from opening in their presence or " +
                                    "anywhere within their domains.first\n" +
                                    "Whensecondyou cast this spell, you can speak the name of a " +
                                    "specific creature (a pseudonym, title, or nickname doesn't " +
                                    "work). If that creature is on a plane other than the one you " +
                                    "are on, the portal opens in the named creature's immediate " +
                                    "vicinity and draws the creature through it to the nearest " +
                                    "unoccupied space on your side of the portal. You gain no " +
                                    "special power over the creature, and it is free to act as the " +
                                    "GM deems appropriate. It might leave, attack you, or help you. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Geas",
                         ...
                         description="You place a magical command on a creature that you can see " +
                                    ...
                                    "can't understand you is unaffected by the spell.first\n" +
                                    "Yousecondcan issue any command you choose, short of an " +
                                    "activity that would result in certain death. Should you issue " +
                                    "a suicidal command, the spell ends.first\n" +
                                    "Yousecondcan end the spell early by using an action to dismiss " +
                                    "it. A remove curse, greater restoration, or wish spell also " +
                                    "ends it. ",
                         at_higher_levels="When you cast this spell using a spell slot of 7th or 8th " +
                                          "level, the duration is 1 year.first\n" +
                                          "Whensecondyou cast this spell using a spell slot of 9th level, " +
    ...
    def __init__(self):
        super().__init__(name="Gentle Repose",
                         ...
                         description="You touch a corpse or other remains. For the duration, the " +
                                    "target is protected from decay and can't become undead.first\n" +
                                    "Thesecondspell also effectively extends the time limit on " +
                                    "raising the target from the dead, since days spent under the " +
    ...
    def __init__(self):
        super().__init__(name="Giant Insect",
                         ...
                         description="You transform up to ten centipedes, three spiders, five wasps, " +
                                    ...
                                    "giant wasp, and a scorpion becomes a giant scorpion.first\n" +
                                    "Eachsecondcreature obeys your verbal commands, and in combat, " +
                                    "they act on your turn each round. The GM has the statistics " +
                                    "for these creatures and resolves their actions and movement.first\n" +
                                    "Asecondcreature remains in its giant size for the duration, " +
                                    "until it drops to 0 hit points, or until you use an action to " +
                                    "dismiss the effect on it.first\n" +
                                    "ThesecondGM might allow you to choose different targets. For " +
    ...
    def __init__(self):
        super().__init__(name="Glibness",
                         ...
                         description="Until the spell ends, when you make a Charisma check, you can " +
                                    "replace the number you roll with a 15.first\n" +
                                    "Additionally,secondno matter what you say, magic that would " +
    ...
    def __init__(self):
        super().__init__(name="Globe of Invulnerability",
                         ...
                         description="An immobile, faintly shimmering barrier springs into existence " +
                                    ...
                                    "if the spell is cast using a higher level spell slot.first\n" +
                                    "Suchseconda spell can target creatures and objects within the " +
                                    "barrier, but the spell has no effect on them.first\n" +
                                    "Similarly,secondthe area within the barrier is excluded from " +
    ...
    def __init__(self):
        super().__init__(name="Glyph of Warding",
                         ...
                         description="When you cast this spell, you inscribe a glyph that harms " +
                                    ...
                                    "without being triggered.first\n" +
                                    "Thesecondglyph is nearly invisible and requires a successful " +
                                    "Intelligence (Investigation) check against your spell save DC " +
                                    "to be found.first\n" +
                                    "Youseconddecide what triggers the glyph when you cast the " +
                                    "spell. For glyphs inscribed on a surface, the most typical " +
                                    "triggers include touching or standing on the glyph, removing " +
                                    ...
                                    "or reading the glyph. Once a glyph is triggered, this spell " +
                                    "ends.\n" +
                                    "You can further refine the trigger so the spell " +
                                    "activates only under certain circumstances or according to " +
                                    "physical characteristics (such as height or weight), creature " +
                                    "kind (for example, the ward could be set to affect aberrations " +
                                    "or drow), or alignment. You can also set conditions for " +
                                    "creatures that don't trigger the glyph, such as those who say " +
                                    "a certain password.first\n" +
                                    "Whensecondyou inscribe the glyph, choose explosive runes or a " +
                                    "spell glyph.first\n" +
                                    "ExplosivesecondRunes. When triggered, the glyph erupts with " +
                                    ...
                                    "as much damage on a successful one.first\n" +
                                    "SpellsecondGlyph. You can store a prepared spell of 3rd level " +
                                    "or lower in the glyph by casting it as part of creating the " +
    ...
    def __init__(self):
        super().__init__(name="Grease",
                         ...
                         description="Slick grease covers the ground in a 10-foot square centered on " +
                                    ...
                                    "the duration.first\n" +
                                    "Whensecondthe grease appears, each creature standing in its " +
    ...
    def __init__(self):
        super().__init__(name="Guardian of Faith",
                         ...
                         description="A Large spectral guardian appears and hovers for the duration " +
                                    ...
                                    "symbol of your deity.first\n" +
                                    "Anysecondcreature hostile to you that moves to a space within " +
                                    "10 feet of the guardian for the first time on a turn must " +
                                    "succeed on a Dexterity saving throw. The creature takes 20 " +
    ...
    def __init__(self):
        super().__init__(name="Guards and Wards",
                         ...
                         description="You create a ward that protects up to 2,500 square feet of " +
                                    ...
                                    "you are casting the spell.first\n" +
                                    "Whensecondyou cast this spell, you can specify individuals " +
                                    "that are unaffected by any or all of the effects that you " +
                                    "choose. You can also specify a password that, when spoken " +
                                    "aloud, makes the speaker immune to these effects.first\n" +
                                    "Guardssecondand wards creates the following effects within the " +
                                    "warded area.first\n" +
                                    "Corridors.secondFog fills all the warded corridors, making " +
                                    "them heavily obscured. In addition, at each intersection or " +
                                    ...
                                    "them appear as plain sections of wall.first\n" +
                                    "Stairs.secondWebs fill all stairs in the warded area from top " +
                                    "to bottom, as the web spell. These strands regrow in 10 " +
                                    "minutes if they are burned or torn away while guards and wards " +
                                    "lasts.\n" +
                                    ...
                                    "guards and wards lasts.first\n" +
                                    "•secondPlace magic mouth in two locations.first\n" +
                                    "•secondPlace stinking cloud in two locations. The vapors " +
                                    "appear in the places you designate; they return within 10 " +
                                    "minutes if dispersed by wind while guards and wards lasts.first\n" +
                                    "•secondPlace a constant gust of wind in one corridor or " +
                                    "room.\n" +
                                    "• Place a suggestion in one location. You select an area " +
                                    "of up to 5 feet square, and any creature that enters or passes " +
                                    "through the area receives the suggestion mentally.first\n" +
                                    "Thesecondwhole warded area radiates magic. A dispel magic cast " +
                                    "on a specific effect, if successful, removes only that " +
                                    "effect.\n" +
    ...
    def __init__(self):
        super().__init__(name="Gust of Wind",
                         ...
                         description="A line of strong wind 60 feet long and 10 feet wide blasts " +
                                    ...
                                    "a direction following the line.first\n" +
                                    "Anysecondcreature in the line must spend 2 feet of movement " +
                                    "for every 1 foot it moves when moving closer to you.first\n" +
                                    "Thesecondgust disperses gas or vapor, and it extinguishes " +
                                    "candles, torches, and similar unprotected flames in the area. " +
                                    "It causes protected flames, such as those of lanterns, to " +
                                    "dance wildly and has a 50 percent chance to extinguish " +
                                    "them.\n" +
    ...
    def __init__(self):
        super().__init__(name="Hallow",
                         ...
                         description="You touch a point and infuse an area around it with holy (or " +
                                    ...
                                    "following effects.first\n" +
                                    "First,secondcelestials, elementals, fey, fiends, and undead " +
                                    "can't enter the area, nor can such creatures charm, frighten, " +
                                    "or possess creatures within it. Any creature charmed, " +
                                    "frightened, or possessed by such a creature is no longer " +
                                    "charmed, frightened, or possessed upon entering the area. You " +
                                    ...
                                    "the area.first\n" +
                                    "Darkness.secondDarkness fills the area. Normal light, as well " +
                                    "as magical light created by spells of a lower level than the " +
                                    "slot you used to cast this spell, can't illuminate the " +
                                    "area.\n" +
                                    "Daylight. Bright light fills the area. Magical darkness " +
                                    "created by spells of a lower level than the slot you used to " +
                                    "cast this spell can't extinguish the light.first\n" +
                                    "EnergysecondProtection. Affected creatures in the area have " +
                                    "resistance to one damage type of your choice, except for " +
                                    "bludgeoning, piercing, or slashing.first\n" +
                                    "EnergysecondVulnerability. Affected creatures in the area have " +
                                    "vulnerability to one damage type of your choice, except for " +
                                    "bludgeoning, piercing, or slashing.first\n" +
                                    "EverlastingsecondRest. Dead bodies interred in the area can't " +
                                    "be turned into undead.first\n" +
                                    "ExtradimensionalsecondInterference. Affected creatures can't " +
                                    "move or travel using teleportation or by extradimensional or " +
                                    "interplanar means.first\n" +
                                    "Fear.secondAffected creatures are frightened while in the " +
                                    "area.\n" +
                                    "Silence. No sound can emanate from within the area, and " +
                                    "no sound can reach into it.first\n" +
                                    "Tongues.secondAffected creatures can communicate with any " +
    ...
    def __init__(self):
        super().__init__(name="Hallucinatory Terrain",
                         ...
                         description="You make natural terrain in a 150-foot cube in range look, " +
                                    ...
                                    "within the area aren't changed in appearance.first\n" +
                                    "Thesecondtactile characteristics of the terrain are unchanged, " +
                                    "so creatures entering the area are likely to see through the " +
    ...
    def __init__(self):
        super().__init__(name="Haste",
                         ...
                         description="Choose a willing creature that you can see within range. Until " +
                                    ...
                                    "only), Dash, Disengage, Hide, or Use an Object action.first\n" +
                                    "Whensecondthe spell ends, the target can't move or take " +
    ...
    def __init__(self):
        super().__init__(name="Heroes' Feast",
                         ...
                         description="You bring forth a great feast, including magnificent food and " +
                                    ...
                                    "until this hour is over.first\n" +
                                    "Upsecondto twelve other creatures can partake of the feast.first\n" +
                                    "Asecondcreature that partakes of the feast gains several " +
                                    "benefits. The creature is cured of all diseases and poison, " +
                                    "becomes immune to poison and being frightened, and makes all " +
                                    "Wisdom saving throws with advantage. Its hit point maximum " +
                                    "also increases by 2d10, and it gains the same number of hit " +
...
class Heroism(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Heroism",
                         ...
                         material_components_list=None,
                         duration="1 minute",
                         description=A willing creature you touch is imbued with bravery.first\n +
                                    "Untilsecondthe spell ends, the creature is immune to being " +
    ...
    def __init__(self):
        super().__init__(name="Hideous Laughter",
                         ...
                         description="A creature of your choice that you can see within range " +
                                    ...
                                    "Intelligence score of 4 or less isn't affected.first\n" +
                                    "Atsecondthe end of each of its turns, and each time it takes " +
...
class HoldPerson(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Hold Person",
                         ...
                         material_components_list="a small, straight piece of iron",
                         duration="1 minute",
                         description=Choose a humanoid that you can see within range.first\n +
                                    "Thesecondtarget must succeed on a Wisdom saving throw or be " +
                         ...
                         at_higher_levels="When you cast this spell using a spell slot of 3rd level or " +
                                          ...
                                          "level above 2nd.first\n" +
                                          "Thesecondhumanoids must be within 30 feet of each other when " +
                                          "you target them. ")
    ...
    def __init__(self):
        super().__init__(name="Holy Aura",
                         ...
                         description="Divine light washes out from you and coalesces in a soft " +
                                    "radiance in a 30-foot radius around you.first\n" +
                                    "Creaturessecondof your choice in that radius when you cast " +
                                    "this spell shed dim light in a 5-foot radius and have " +
                                    "advantage on all saving throws, and other creatures have " +
                                    "disadvantage on attack rolls against them until the spell " +
                                    "ends. In addition, when a fiend or an undead hits an affected " +
                                    "creature with a melee attack, the aura flashes with brilliant " +
                                    "light. The attacker must succeed on a Constitution saving " +
    ...
    def __init__(self):
        super().__init__(name="Hypnotic Pattern",
                         ...
                         description="You create a twisting pattern of colors that weaves through " +
                                    "the air inside a 30-foot cube within range.first\n" +
                                    "Thesecondpattern appears for a moment and vanishes.first\n" +
                                    "Eachsecondcreature in the area who sees the pattern must make " +
                                    "a Wisdom saving throw. On a failed save, the creature becomes " +
                                    "charmed for the duration. While charmed by this spell, the " +
                                    "creature is incapacitated and has a speed of 0.first\n" +
                                    "Thesecondspell ends for an affected creature if it takes any " +
                                    "damage or if someone else uses an action to shake the creature " +
                                    "out of its stupor. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Ice Storm",
                         ...
                         description="A hail of rock-hard ice pounds to the ground in a 20- " +
                                    ...
                                    "successful one.first\n" +
                                    "Hailstonessecondturn the storm's area of effect into difficult " +
    ...
    def __init__(self):
        super().__init__(name="Identify",
                         ...
                         description="You choose one object that you must touch throughout the " +
                                    ...
                                    "by a spell, you learn which spell created it.first\n" +
                                    "Ifsecondyou instead touch a creature throughout the casting, " +
    ...
    def __init__(self):
        super().__init__(name="Illusory Script",
                         ...
                         description="You write on parchment, paper, or some other suitable writing " +
                                    ...
                                    "the duration.first\n" +
                                    "Tosecondyou and any creatures you designate when you cast the " +
                                    ...
                                    "language, though the language must be one you know.first\n" +
                                    "Shouldsecondthe spell be dispelled, the original script and " +
                                    "the illusion both disappear.first\n" +
                                    "Asecondcreature with truesight can read the hidden message. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Imprisonment",
                         ...
                         description="You create a magical restraint to hold a creature that you can " +
                                    ...
                                    "the target.first\n" +
                                    "Whensecondyou cast the spell, you choose one of the following " +
                                    "forms of imprisonment.first\n" +
                                    "Burial.secondThe target is entombed far beneath the earth in a " +
                                    ...
                                    "small mithral orb.first\n" +
                                    "Chaining.secondHeavy chains, firmly rooted in the ground, hold " +
                                    "the target in place. The target is restrained until the spell " +
                                    "ends, and it can't move or be moved by any means until " +
                                    "then.\n" +
                                    "The special component for this version of the spell is a " +
                                    "fine chain of precious metal.first\n" +
                                    "HedgedsecondPrison. The spell transports the target into a " +
                                    "tiny demiplane that is warded against teleportation and planar " +
                                    "travel. The demiplane can be a labyrinth, a cage, a tower, or " +
                                    "any similar confined structure or area of your choice.first\n" +
                                    "Thesecondspecial component for this version of the spell is a " +
                                    "miniature representation of the prison made from jade.first\n" +
                                    "MinimussecondContainment. The target shrinks to a height of 1 " +
                                    "inch and is imprisoned inside a gemstone or similar object. " +
                                    "Light can pass through the gemstone normally (allowing the " +
                                    "target to see out and other creatures to see in), but nothing " +
                                    "else can pass through, even by means of teleportation or " +
                                    "planar travel. The gemstone can't be cut or broken while the " +
                                    "spell remains in effect.first\n" +
                                    "Thesecondspecial component for this version of the spell is a " +
                                    ...
                                    "of rare soporific herbs.first\n" +
                                    "Endingsecondthe Spell. During the casting of the spell, in any " +
                                    "of its versions, you can specify a condition that will cause " +
                                    "the spell to end and release the target. The condition can be " +
                                    ...
                                    "Thesecondconditions can be based on a creature's name, " +
                                    "identity, or deity but otherwise must be based on observable " +
                                    "actions or qualities and not based on intangibles such as " +
                                    "level, class, or hit points.first\n" +
                                    "Aseconddispel magic spell can end the spell only if it is cast " +
                                    "as a 9th-level spell, targeting either the prison or the " +
                                    "special component used to create it.first\n" +
                                    "Yousecondcan use a particular special component to create only " +
                                    "one prison at a time. If you cast the spell again using the " +
                                    "same component, the target of the first casting is immediately " +
    ...
    def __init__(self):
        super().__init__(name="Incendiary Cloud",
                         ...
                         description="A swirling cloud of smoke shot through with whitehot embers " +
                                    ...
                                    "disperses it.first\n" +
                                    "Whensecondthe cloud appears, each creature in it must make a " +
    ...
    def __init__(self):
        super().__init__(name="Insect Plague",
                         ...
                         description="Swarming, biting locusts fill a 20-foot-radius sphere centered " +
                                    ...
                                    "lightly obscured. The sphere's area is difficult terrain.first\n" +
                                    "Whensecondthe area appears, each creature in it must make a " +
    ...
    def __init__(self):
        super().__init__(name="Instant Summons",
                         ...
                         description="You touch an object weighing 10 pounds or less whose longest " +
                                    ...
                                    "planar distances, and the spell ends.first\n" +
                                    "Ifsecondanother creature is holding or carrying the item, " +
                                    "crushing the sapphire doesn't transport the item to you, but " +
                                    "instead you learn who the creature possessing the object is " +
                                    "and roughly where that creature is located at that " +
                                    "moment.\n" +
                                    "Dispel magic or a similar effect successfully applied " +
                                    "to the sapphire ends this spell's effect. ",
                         at_higher_levels="")
...
class IrresistibleDance(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Irresistible Dance",
                         ...
                         material_components_list=None,
                         duration="1 minute",
                         description=Choose one creature that you can see within range.first\n +
                                    "Thesecondtarget begins a comic dance in place: shuffling, " +
                                    "tapping its feet, and capering for the duration.first\n" +
                                    "Creaturessecondthat can't be charmed are immune to this " +
                                    "spell.\n" +
                                    "A dancing creature must use all its movement to dance " +
                                    "without leaving its space and has disadvantage on Dexterity " +
                                    "saving throws and attack rolls. While the target is affected " +
                                    "by this spell, other creatures have advantage on attack rolls " +
                                    "against it.first\n" +
                                    "Assecondan action, a dancing creature makes a Wisdom saving " +
    ...
    def __init__(self):
        super().__init__(name="Knock",
                         ...
                         description="Choose an object that you can see within range. The object can " +
                                    ...
                                    "prevents access.first\n" +
                                    "Asecondtarget that is held shut by a mundane lock or that is " +
                                    "stuck or barred becomes unlocked, unstuck, or unbarred. If the " +
                                    "object has multiple locks, only one of them is unlocked.first\n" +
                                    "Ifsecondyou choose a target that is held shut with arcane " +
                                    "lock, that spell is suppressed for 10 minutes, during which " +
                                    "time the target can be opened and shut normally.first\n" +
                                    "Whensecondyou cast the spell, a loud knock, audible from as " +
    ...
    def __init__(self):
        super().__init__(name="Legend Lore",
                         ...
                         description="Name or describe a person, place, or object. The spell brings " +
                                    ...
                                    "widely known.first\n" +
                                    "Ifsecondthe thing you named isn't of legendary importance, you " +
                                    "gain no information. The more information you already have " +
                                    "about the thing, the more precise and detailed the information " +
                                    "you receive is.first\n" +
                                    "Thesecondinformation you learn is accurate but might be " +
                                    "couched in figurative language. For example, if you have a " +
                                    "mysterious magic axe on hand, the spell might yield this " +
                                    "information: “Woe to the evildoer whose hand touches the axe, " +
                                    "for even the haft slices the hand of the evil ones. Only a " +
                                    "true Child of Stone, lover and beloved of Moradin, may awaken " +
                                    "the true powers of the axe, and only with the sacred word " +
                                    "Rudnogg on the lips.” ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Levitate",
                         ...
                         description="One creature or object of your choice that you can see within " +
                                    ...
                                    "weighs up to 500 pounds.first\n" +
                                    "Ansecondunwilling creature that succeeds on a Constitution " +
                                    "saving throw is unaffected.first\n" +
                                    "Thesecondtarget can move only by pushing or pulling against a " +
                                    "fixed object or surface within reach (such as a wall or a " +
                                    "ceiling), which allows it to move as if it were climbing. You " +
                                    "can change the target's altitude by up to 20 feet in either " +
                                    "direction on your turn. If you are the target, you can move up " +
                                    "or down as part of your move. Otherwise, you can use your " +
                                    "action to move the target, which must remain within the " +
                                    "spell's range.first\n" +
                                    "Whensecondthe spell ends, the target floats gently to the " +
    ...
    def __init__(self):
        super().__init__(name="Light",
                         ...
                         description="You touch one object that is no larger than 10 feet in any " +
                                    ...
                                    "if you cast it again or dismiss it as an action.first\n" +
                                    "Ifsecondyou target an object held or worn by a hostile " +
    ...
    def __init__(self):
        super().__init__(name="Lightning Bolt",
                         ...
                         description="A stroke of lightning forming a line 100 feet long and 5 feet " +
                                    ...
                                    "as much damage on a successful one.first\n" +
                                    "Thesecondlightning ignites flammable objects in the area that " +
                                    "aren't being worn or carried. ",
                         at_higher_levels="When you cast this spell using a spell slot of 4th level or " +
                                          "higher, the damage increases by 1d6 for each slot level above " +
                                          "3rd. ")
...
class LocateCreature(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Locate Creature",
                         ...
                         material_components_list="a bit of fur from a bloodhound",
                         duration="1 hour",
                         description=Describe or name a creature that is familiar to you.first\n +
                                    "Yousecondsense the direction to the creature's location, as " +
                                    "long as that creature is within 1,000 feet of you. If the " +
                                    "creature is moving, you know the direction of its " +
                                    "movement.\n" +
                                    "The spell can locate a specific creature known to " +
                                    "you, or the nearest creature of a specific kind (such as a " +
                                    "human or a unicorn), so long as you have seen such a creature " +
                                    "up close—within 30 feet—at least once. If the creature you " +
                                    "described or named is in a different form, such as being under " +
                                    "the effects of a polymorph spell, this spell doesn't locate " +
                                    "the creature.first\n" +
                                    "Thissecondspell can't locate a creature if running water at " +
...
class LocateObject(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Locate Object",
                         ...
                         duration="10 minutes",
                         description=Describe or name an object that is familiar to you.first\n +
                                    "Yousecondsense the direction to the object's location, as long " +
                                    "as that object is within 1,000 feet of you. If the object is " +
                                    "in motion, you know the direction of its movement.first\n" +
                                    "Thesecondspell can locate a specific object known to you, as " +
                                    "long as you have seen it up close—within 30 feet—at least " +
                                    "once. Alternatively, the spell can locate the nearest object " +
                                    "of a particular kind, such as a certain kind of apparel, " +
                                    "jewelry, furniture, tool, or weapon.first\n" +
                                    "Thissecondspell can't locate an object if any thickness of " +
                                    "lead, even a thin sheet, blocks a direct path between you and " +
                                    "the object. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Mage Hand",
                         ...
                         description="A spectral, floating hand appears at a point you choose within " +
                                    ...
                                    "feet away from you or if you cast this spell again.first\n" +
                                    "Yousecondcan use your action to control the hand. You can use " +
                                    ...
                                    "30 feet each time you use it.first\n" +
                                    "Thesecondhand can't attack, activate magic items, or carry " +
                                    "more than 10 pounds. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Magic Circle",
                         ...
                         description="You create a 10-foot-radius, 20-foot-tall cylinder of magical " +
                                    ...
                                    "intersects with the floor or other surface.first\n" +
                                    "Choosesecondone or more of the following types of creatures: " +
                                    ...
                                    "Charisma saving throw.first\n" +
                                    "•secondThe creature has disadvantage on attack rolls against " +
                                    "targets within the cylinder.first\n" +
                                    "•secondTargets within the cylinder can't be charmed, " +
                                    "frightened, or possessed by the creature.first\n" +
                                    "Whensecondyou cast this spell, you can elect to cause its " +
                                    "magic to operate in the reverse direction, preventing a " +
                                    "creature of the specified type from leaving the cylinder and " +
    ...
    def __init__(self):
        super().__init__(name="Magic Jar",
                         ...
                         description="Your body falls into a catatonic state as your soul leaves it " +
                                    ...
                                    "the spell) or attempting to possess a humanoids body.first\n" +
                                    "Yousecondcan attempt to possess any humanoid within 100 feet " +
                                    "of you that you can see (creatures warded by a protection from " +
                                    "evil and good or magic circle spell can't be possessed). The " +
                                    "target must make a Charisma saving throw. On a failure, your " +
                                    "soul moves into the target's body, and the target's soul " +
                                    "becomes trapped in the container. On a success, the target " +
                                    "resists your efforts to possess it, and you can't attempt to " +
                                    "possess it again for 24 hours.first\n" +
                                    "Oncesecondyou possess a creature's body, you control it.first\n" +
                                    "Yoursecondgame statistics are replaced by the statistics of " +
                                    "the creature, though you retain your alignment and your " +
                                    ...
                                    "move or take actions at all.first\n" +
                                    "Whilesecondpossessing a body, you can use your action to " +
                                    "return from the host body to the container if it is within 100 " +
                                    "feet of you, returning the host creature's soul to its body. " +
                                    "If the host body dies while you're in it, the creature dies, " +
                                    "and you must make a Charisma saving throw against your own " +
                                    "spellcasting DC. On a success, you return to the container if " +
                                    "it is within 100 feet of you. Otherwise, you die.first\n" +
                                    "Ifsecondthe container is destroyed or the spell ends, your " +
                                    ...
                                    "feet.\n" +
                                    "Otherwise, that creature dies.first\n" +
                                    "Whensecondthe spell ends, the container is destroyed. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Magic Mouth",
                         ...
                         description="You implant a message within an object in range, a message " +
                                    ...
                                    "the spell to deliver your message.first\n" +
                                    "Whensecondthat circumstance occurs, a magical mouth appears on " +
                                    "the object and recites the message in your voice and at the " +
                                    "same volume you spoke. If the object you chose has a mouth or " +
                                    "something that looks like a mouth (for example, the mouth of a " +
                                    "statue), the magical mouth appears there so that the words " +
                                    "appear to come from the object's mouth.first\n" +
                                    "Whensecondyou cast this spell, you can have the spell end " +
                                    "after it delivers its message, or it can remain and repeat its " +
                                    "message whenever the trigger occurs.first\n" +
                                    "Thesecondtriggering circumstance can be as general or as " +
                                    "detailed as you like, though it must be based on visual or " +
                                    "audible conditions that occur within 30 feet of the object. " +
                                    "For example, you could instruct the mouth to speak when any " +
    ...
    def __init__(self):
        super().__init__(name="Magnificent Mansion",
                         ...
                         description="You conjure an extradimensional dwelling in range that lasts " +
                                    ...
                                    "attends all who enter.first\n" +
                                    "Youseconddecide the visual appearance of these servants and " +
                                    "their attire. They are completely obedient to your orders. " +
    ...
    def __init__(self):
        super().__init__(name="Major Image",
                         ...
                         description="You create the image of an object, a creature, or some other " +
                                    ...
                                    "lasts for the duration.first\n" +
                                    "Itsecondseems completely real, including sounds, smells, and " +
                                    "temperature appropriate to the thing depicted.first\n" +
                                    "Yousecondcan't create sufficient heat or cold to cause damage, " +
                                    "a sound loud enough to deal thunder damage or deafen a " +
                                    "creature, or a smell that might sicken a creature (like a " +
                                    "troglodyte's stench).first\n" +
                                    "Assecondlong as you are within range of the illusion, you can " +
                                    "use your action to cause the image to move to any other spot " +
                                    ...
                                    "for example.first\n" +
                                    "Physicalsecondinteraction with the image reveals it to be an " +
    ...
    def __init__(self):
        super().__init__(name="Mass Cure Wounds",
                         ...
                         description="A wave of healing energy washes out from a point of your " +
                                    ...
                                    "30-foot-radius sphere centered on that point.first\n" +
                                    "Eachsecondtarget regains hit points equal to 3d8 + your " +
    ...
    def __init__(self):
        super().__init__(name="Mass Suggestion",
                         ...
                         description="You suggest a course of activity (limited to a sentence or " +
                                    ...
                                    "Creaturessecondthat can't be charmed are immune to this " +
                                    "effect. The suggestion must be worded in such a manner as to " +
                                    ...
                                    "negates the effect of the spell.first\n" +
                                    "Eachsecondtarget must make a Wisdom saving throw.first\n" +
                                    "Onseconda failed save, it pursues the course of action you " +
                                    "described to the best of its ability. The suggested course of " +
                                    "action can continue for the entire duration.first\n" +
                                    "Ifsecondthe suggested activity can be completed in a shorter " +
                                    "time, the spell ends when the subject finishes what it was " +
                                    "asked to do.first\n" +
                                    "Yousecondcan also specify conditions that will trigger a " +
                                    ...
                                    "spell ends, the activity isn't performed.first\n" +
                                    "Ifsecondyou or any of your companions damage a creature " +
    ...
    def __init__(self):
        super().__init__(name="Maze",
                         ...
                         description="You banish a creature that you can see within range into a " +
                                    ...
                                    "duration or until it escapes the maze.first\n" +
                                    "Thesecondtarget can use its action to attempt to escape.first\n" +
                                    "Whensecondit does so, it makes a DC 20 Intelligence check.first\n" +
                                    "Ifsecondit succeeds, it escapes, and the spell ends (a " +
                                    "minotaur or goristro demon automatically succeeds).first\n" +
                                    "Whensecondthe spell ends, the target reappears in the space it " +
                                    "left or, if that space is occupied, in the nearest unoccupied " +
                                    "space. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Meld into Stone",
                         ...
                         description="You step into a stone object or surface large enough to fully " +
                                    ...
                                    "nonmagical senses.first\n" +
                                    "Whilesecondmerged with the stone, you can't see what occurs " +
                                    "outside it, and any Wisdom (Perception) checks you make to " +
                                    "hear sounds outside it are made with disadvantage. You remain " +
                                    "aware of the passage of time and can cast spells on yourself " +
                                    "while merged in the stone. You can use your movement to leave " +
                                    "the stone where you entered it, which ends the spell.first\n" +
                                    "Yousecondotherwise can't move.first\n" +
                                    "Minorsecondphysical damage to the stone doesn't harm you, but " +
                                    "its partial destruction or a change in its shape (to the " +
    ...
    def __init__(self):
        super().__init__(name="Mending",
                         ...
                         description="This spell repairs a single break or tear in an object you " +
                                    ...
                                    "it, leaving no trace of the former damage.first\n" +
                                    "Thissecondspell can physically repair a magic item or " +
    ...
    def __init__(self):
        super().__init__(name="Message",
                         ...
                         description="You point your finger toward a creature within range and " +
                                    ...
                                    "message and can reply in a whisper that only you can hear.first\n" +
                                    "Yousecondcan cast this spell through solid objects if you are " +
    ...
    def __init__(self):
        super().__init__(name="Meteor Swarm",
                         ...
                         description="Blazing orbs of fire plummet to the ground at four different " +
                                    ...
                                    "fiery burst is affected only once.first\n" +
                                    "Thesecondspell damages objects in the area and ignites " +
                                    "flammable objects that aren't being worn or carried. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Minor Illusion",
                         ...
                         description="You create a sound or an image of an object within range that " +
                                    ...
                                    "it as an action or cast this spell again.first\n" +
                                    "Ifsecondyou create a sound, its volume can range from a " +
                                    "whisper to a scream. It can be your voice, someone else's " +
                                    "voice, a lion's roar, a beating of drums, or any other sound " +
                                    "you choose. The sound continues unabated throughout the " +
                                    "duration, or you can make discrete sounds at different times " +
                                    "before the spell ends.first\n" +
                                    "Ifsecondyou create an image of an object—such as a chair, " +
                                    "muddy footprints, or a small chest—it must be no larger than a " +
                                    "5-foot cube. The image can't create sound, light, smell, or " +
                                    "any other sensory effect.first\n" +
                                    "Physicalsecondinteraction with the image reveals it to be an " +
                                    "illusion, because things can pass through it.first\n" +
                                    "Ifseconda creature uses its action to examine the sound or " +
    ...
    def __init__(self):
        super().__init__(name="Mirage Arcane",
                         ...
                         description="You make terrain in an area up to 1 mile square look, sound, " +
                                    ...
                                    "disguise, conceal, or add creatures.first\n" +
                                    "Thesecondillusion includes audible, visual, tactile, and " +
                                    "olfactory elements, so it can turn clear ground into difficult " +
                                    "terrain (or vice versa) or otherwise impede movement through " +
                                    "the area. Any piece of the illusory terrain (such as a rock or " +
                                    "stick) that is removed from the spell's area disappears " +
                                    "immediately.\n" +
    ...
    def __init__(self):
        super().__init__(name="Mirror Image",
                         ...
                         description="Three illusory duplicates of yourself appear in your space. " +
                                    ...
                                    "illusory duplicates.first\n" +
                                    "Eachsecondtime a creature targets you with an attack during " +
                                    "the spell's duration, roll a d20 to determine whether the " +
                                    "attack instead targets one of your duplicates.first\n" +
                                    "Ifsecondyou have three duplicates, you must roll a 6 or higher " +
                                    "to change the attack's target to a duplicate.first\n" +
                                    "Withsecondtwo duplicates, you must roll an 8 or higher.first\n" +
                                    "Withsecondone duplicate, you must roll an 11 or higher.first\n" +
                                    "Asecondduplicate's AC equals 10 + your Dexterity modifier. If " +
                                    "an attack hits a duplicate, the duplicate is destroyed. A " +
                                    "duplicate can be destroyed only by an attack that hits it. It " +
                                    "ignores all other damage and effects. The spell ends when all " +
                                    "three duplicates are destroyed.first\n" +
                                    "Asecondcreature is unaffected by this spell if it can't see, " +
    ...
    def __init__(self):
        super().__init__(name="Mislead",
                         ...
                         description="You become invisible at the same time that an illusory double " +
                                    ...
                                    "a spell.first\n" +
                                    "Yousecondcan use your action to move your illusory double up " +
                                    "to twice your speed and make it gesture, speak, and behave in " +
                                    "whatever way you choose.first\n" +
                                    "Yousecondcan see through its eyes and hear through its ears as " +
                                    "if you were located where it is. On each of your turns as a " +
                                    "bonus action, you can switch from using its senses to using " +
                                    "your own, or back again.first\n" +
                                    "Whilesecondyou are using its senses, you are blinded and " +
...
class ModifyMemory(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Modify Memory",
                         ...
                         material_components_list=None,
                         duration="1 minute",
                         description=You attempt to reshape another creature's memories.first\n +
                                    "Onesecondcreature that you can see must make a Wisdom saving " +
                                    "throw. If you are fighting the creature, it has advantage on " +
                                    "the saving throw. On a failed save, the target becomes charmed " +
                                    "by you for the duration.first\n" +
                                    "Thesecondcharmed target is incapacitated and unaware of its " +
                                    "surroundings, though it can still hear you. If it takes any " +
                                    "damage or is targeted by another spell, this spell ends, and " +
                                    "none of the target's memories are modified.first\n" +
                                    "Whilesecondthis charm lasts, you can affect the target's " +
                                    "memory of an event that it experienced within the last 24 " +
                                    "hours and that lasted no more than 10 minutes. You can " +
                                    "permanently eliminate all memory of the event, allow the " +
                                    "target to recall the event with perfect clarity and exacting " +
                                    "detail, change its memory of the details of the event, or " +
                                    "create a memory of some other event.first\n" +
                                    "Yousecondmust speak to the target to describe how its memories " +
                                    "are affected, and it must be able to understand your language " +
                                    "for the modified memories to take root. Its mind fills in any " +
                                    "gaps in the details of your description. If the spell ends " +
                                    "before you have finished describing the modified memories, the " +
                                    "creature's memory isn't altered.first\n" +
                                    "Otherwise,secondthe modified memories take hold when the spell " +
                                    "ends.\n" +
                                    ...
                                    "significant manner.first\n" +
                                    "Asecondremove curse or greater restoration spell cast on the " +
    ...
    def __init__(self):
        super().__init__(name="Moonbeam",
                         ...
                         description="A silvery beam of pale light shines down in a 5-footradius, " +
                                    ...
                                    "the spell ends, dim light fills the cylinder.first\n" +
                                    "Whenseconda creature enters the spell's area for the first " +
                                    "time on a turn or starts its turn there, it is engulfed in " +
                                    "ghostly flames that cause searing pain, and it must make a " +
                                    "Constitution saving throw. It takes 2d10 radiant damage on a " +
                                    "failed save, or half as much damage on a successful one.first\n" +
                                    "Asecondshapechanger makes its saving throw with disadvantage. " +
                                    "If it fails, it also instantly reverts to its original form " +
                                    "and can't assume a different form until it leaves the spell's " +
                                    "light.\n" +
    ...
    def __init__(self):
        super().__init__(name="Move Earth",
                         ...
                         description="Choose an area of terrain no larger than 40 feet on a side " +
                                    ...
                                    "minutes for these changes to complete.first\n" +
                                    "Atsecondthe end of every 10 minutes you spend concentrating on " +
                                    "the spell, you can choose a new area of terrain to " +
                                    "affect.\n" +
                                    "Because the terrain's transformation occurs slowly, " +
                                    "creatures in the area can't usually be trapped or injured by " +
                                    "the ground's movement.first\n" +
                                    "Thissecondspell can't manipulate natural stone or stone " +
                                    "construction. Rocks and structures shift to accommodate the " +
                                    "new terrain. If the way you shape the terrain would make a " +
                                    "structure unstable, it might collapse.first\n" +
                                    "Similarly,secondthis spell doesn't directly affect plant " +
    ...
    def __init__(self):
        super().__init__(name="Pass without Trace",
                         ...
                         description="A veil of shadows and silence radiates from you, masking you " +
                                    "and your companions from detection.first\n" +
                                    "Forsecondthe duration, each creature you choose within 30 feet " +
                                    "of you (including you) has a +10 bonus to Dexterity (Stealth) " +
    ...
    def __init__(self):
        super().__init__(name="Passwall",
                         ...
                         description="A passage appears at a point of your choice that you can see " +
                                    ...
                                    "a structure surrounding it.first\n" +
                                    "Whensecondthe opening disappears, any creatures or objects " +
                                    "still in the passage created by the spell are safely ejected " +
                                    "to an unoccupied space nearest to the surface on which you " +
                                    "cast the spell. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Phantom Steed",
                         ...
                         description="A Large quasi-real, horselike creature appears on the ground " +
                                    ...
                                    "away from the steed.first\n" +
                                    "Forsecondthe duration, you or a creature you choose can ride " +
                                    "the steed. The creature uses the statistics for a riding " +
                                    "horse, except it has a speed of 100 feet and can travel 10 " +
                                    "miles in an hour, or 13 miles at a fast pace. When the spell " +
                                    "ends, the steed gradually fades, giving the rider 1 minute to " +
                                    "dismount. The spell ends if you use an action to dismiss it or " +
    ...
    def __init__(self):
        super().__init__(name="Planar Ally",
                         ...
                         description="You beseech an otherworldly entity for aid. The being must be " +
                                    ...
                                    "other being of cosmic power.first\n" +
                                    "Thatsecondentity sends a celestial, an elemental, or a fiend " +
                                    "loyal to it to aid you, making the creature appear in an " +
                                    "unoccupied space within range. If you know a specific " +
                                    "creature's name, you can speak that name when you cast this " +
                                    "spell to request that creature, though you might get a " +
                                    "different creature anyway (GM's choice).first\n" +
                                    "Whensecondthe creature appears, it is under no compulsion to " +
                                    "behave in any particular way. You can ask the creature to " +
                                    "perform a service in exchange for payment, but it isn't " +
                                    "obliged to do so. The requested task could range from simple " +
                                    "(fly us across the chasm, or help us fight a battle) to " +
                                    "complex (spy on our enemies, or protect us during our foray " +
                                    "into the dungeon). You must be able to communicate with the " +
                                    "creature to bargain for its services.first\n" +
                                    "Paymentsecondcan take a variety of forms. A celestial might " +
                                    "require a sizable donation of gold or magic items to an allied " +
                                    "temple, while a fiend might demand a living sacrifice or a " +
                                    "gift of treasure. Some creatures might exchange their service " +
                                    "for a quest undertaken by you.first\n" +
                                    "Asseconda rule of thumb, a task that can be measured in " +
                                    "minutes requires a payment worth 100 gp per minute. A task " +
                                    "measured in hours requires 1,000 gp per hour. And a task " +
                                    "measured in days (up to 10 days) requires 10,000 gp per day. " +
                                    "The GM can adjust these payments based on the circumstances " +
                                    "under which you cast the spell. If the task is aligned with " +
                                    "the creature's ethos, the payment might be halved or even " +
                                    "waived. Nonhazardous tasks typically require only half the " +
                                    "suggested payment, while especially dangerous tasks might " +
                                    "require a greater gift.first\n" +
                                    "Creaturessecondrarely accept tasks that seem suicidal.first\n" +
                                    "Aftersecondthe creature completes the task, or when the " +
                                    "agreed-upon duration of service expires, the creature returns " +
                                    "to its home plane after reporting back to you, if appropriate " +
                                    "to the task and if possible.first\n" +
                                    "Ifsecondyou are unable to agree on a price for the creature's " +
                                    "service, the creature immediately returns to its home plane.first\n" +
                                    "Asecondcreature enlisted to join your group counts as a member " +
                                    "of it, receiving a full share of experience points awarded. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Planar Binding",
                         ...
                         description="With this spell, you attempt to bind a celestial, an " +
                                    ...
                                    "extended to match the duration of this spell.first\n" +
                                    "Asecondbound creature must follow your instructions to the " +
                                    "best of its ability. You might command the creature to " +
                                    "accompany you on an adventure, to guard a location, or to " +
                                    "deliver a message. The creature obeys the letter of your " +
                                    "instructions, but if the creature is hostile to you, it " +
                                    "strives to twist your words to achieve its own objectives. If " +
                                    "the creature carries out your instructions completely before " +
                                    "the spell ends, it travels to you to report this fact if you " +
                                    "are on the same plane of existence. If you are on a different " +
                                    "plane of existence, it returns to the place where you bound it " +
    ...
    def __init__(self):
        super().__init__(name="Plane Shift",
                         ...
                         description="You and up to eight willing creatures who link hands in a " +
                                    ...
                                    "across the Sea of Fire, at the GM's discretion.first\n" +
                                    "Alternatively,secondif you know the sigil sequence of a " +
                                    ...
                                    "a melee spell attack against it.first\n" +
                                    "Onseconda hit, the creature must make a Charisma saving throw. " +
                                    "If the creature fails this save, it is transported to a random " +
    ...
    def __init__(self):
        super().__init__(name="Plant Growth",
                         ...
                         description="This spell channels vitality into plants within a specific " +
                                    ...
                                    "either immediate or long-term benefits.first\n" +
                                    "Ifsecondyou cast this spell using 1 action, choose a point " +
                                    "within range. All normal plants in a 100-foot radius centered " +
                                    "on that point become thick and overgrown.first\n" +
                                    "Asecondcreature moving through the area must spend 4 feet of " +
                                    "movement for every 1 foot it moves.first\n" +
                                    "Yousecondcan exclude one or more areas of any size within the " +
                                    "spell's area from being affected.first\n" +
                                    "Ifsecondyou cast this spell over 8 hours, you enrich the land. " +
                                    "All plants in a half-mile radius centered on a point within " +
                                    "range become enriched for 1 year. The plants yield twice the " +
    ...
    def __init__(self):
        super().__init__(name="Poison Spray",
                         ...
                         description="You extend your hand toward a creature you can see within " +
                                    ...
                                    "1d12 poison damage.first\n" +
                                    "Thissecondspell's damage increases by 1d12 when you reach 5th " +
    ...
    def __init__(self):
        super().__init__(name="Polymorph",
                         ...
                         description="This spell transforms a creature that you can see within range " +
                                    ...
                                    "shapechanger or a creature with 0 hit points.first\n" +
                                    "Thesecondtransformation lasts for the duration, or until the " +
                                    "target drops to 0 hit points or dies. The new form can be any " +
                                    "beast whose challenge rating is equal to or less than the " +
                                    "target's (or the target's level, if it doesn't have a " +
                                    "challenge rating). The target's game statistics, including " +
                                    "mental ability scores, are replaced by the statistics of the " +
                                    "chosen beast. It retains its alignment and personality.first\n" +
                                    "Thesecondtarget assumes the hit points of its new form.first\n" +
                                    "Whensecondit reverts to its normal form, the creature returns " +
                                    ...
                                    "points, it isn't knocked unconscious.first\n" +
                                    "Thesecondcreature is limited in the actions it can perform by " +
                                    "the nature of its new form, and it can't speak, cast spells, " +
                                    "or take any other action that requires hands or speech.first\n" +
                                    "Thesecondtarget's gear melds into the new form. The creature " +
    ...
    def __init__(self):
        super().__init__(name="Power Word Stun",
                         ...
                         description="You speak a word of power that can overwhelm the mind of one " +
                                    ...
                                    "Otherwise, the spell has no effect.first\n" +
                                    "Thesecondstunned target must make a Constitution saving throw " +
    ...
    def __init__(self):
        super().__init__(name="Prestidigitation",
                         ...
                         description="This spell is a minor magical trick that novice spellcasters " +
                                    ...
                                    "faint musical notes, or an odd odor.first\n" +
                                    "•secondYou instantaneously light or snuff out a candle, a " +
                                    "torch, or a small campfire.first\n" +
                                    "•secondYou instantaneously clean or soil an object no larger " +
                                    "than 1 cubic foot.first\n" +
                                    "•secondYou chill, warm, or flavor up to 1 cubic foot of " +
                                    "nonliving material for 1 hour.first\n" +
                                    "•secondYou make a color, a small mark, or a symbol appear on " +
                                    "an object or a surface for 1 hour.first\n" +
                                    "•secondYou create a nonmagical trinket or an illusory image " +
                                    "that can fit in your hand and that lasts until the end of your " +
                                    "next turn.first\n" +
                                    "Ifsecondyou cast this spell multiple times, you can have up to " +
...
class PrismaticSpray(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Prismatic Spray",
                         ...
                         somatic_components=True,
                         material_components_list=None,
                         description=Eight multicolored rays of light flash from your hand.first\n +
                                    "Eachsecondray is a different color and has a different power " +
                                    "and purpose. Each creature in a 60-foot cone must make a " +
                                    "Dexterity saving throw. For each target, roll a d8 to " +
                                    "determine which color ray affects it.first\n" +
                                    "1.secondRed. The target takes 10d6 fire damage on a failed " +
                                    "save, or half as much damage on a successful one.first\n" +
                                    "2.secondOrange. The target takes 10d6 acid damage on a failed " +
                                    "save, or half as much damage on a successful one.first\n" +
                                    "3.secondYellow. The target takes 10d6 lightning damage on a " +
                                    "failed save, or half as much damage on a successful one.first\n" +
                                    "4.secondGreen. The target takes 10d6 poison damage on a failed " +
                                    "save, or half as much damage on a successful one.first\n" +
                                    "5.secondBlue. The target takes 10d6 cold damage on a failed " +
                                    "save, or half as much damage on a successful one.first\n" +
                                    "6.secondIndigo. On a failed save, the target is restrained.first\n" +
                                    "Itsecondmust then make a Constitution saving throw at the end " +
                                    ...
                                    "consecutive; keep track of both until the target collects " +
                                    "three of a kind.first\n" +
                                    "7.secondViolet. On a failed save, the target is blinded. It " +
                                    "must then make a Wisdom saving throw at the start of your next " +
    ...
    def __init__(self):
        super().__init__(name="Prismatic Wall",
                         ...
                         description="A shimmering, multicolored plane of light forms a vertical " +
                                    ...
                                    "are wasted.first\n" +
                                    "Thesecondwall sheds bright light out to a range of 100 feet " +
                                    "and dim light for an additional 100 feet. You and creatures " +
                                    "you designate at the time you cast the spell can pass through " +
                                    "and remain near the wall without harm. If another creature " +
                                    "that can see the wall moves to within 20 feet of it or starts " +
                                    "its turn there, the creature must succeed on a Constitution " +
                                    "saving throw or become blinded for 1 minute.first\n" +
                                    "Thesecondwall consists of seven layers, each with a different " +
                                    ...
                                    "that layer's properties as described below.first\n" +
                                    "Thesecondwall can be destroyed, also one layer at a time, in " +
                                    "order from red to violet, by means specific to each layer. " +
                                    "Once a layer is destroyed, it remains so for the duration of " +
                                    "the spell. A rod of cancellation destroys a prismatic wall, " +
                                    "but an antimagic field has no effect on it.first\n" +
                                    "1.secondRed. The creature takes 10d6 fire damage on a failed " +
                                    "save, or half as much damage on a successful one. While this " +
                                    "layer is in place, nonmagical ranged attacks can't pass " +
                                    "through the wall. The layer can be destroyed by dealing at " +
                                    "least 25 cold damage to it.first\n" +
                                    "2.secondOrange. The creature takes 10d6 acid damage on a " +
                                    "failed save, or half as much damage on a successful one. While " +
                                    "this layer is in place, magical ranged attacks can't pass " +
                                    "through the wall. The layer is destroyed by a strong wind.first\n" +
                                    "3.secondYellow. The creature takes 10d6 lightning damage on a " +
                                    "failed save, or half as much damage on a successful one. This " +
                                    "layer can be destroyed by dealing at least 60 force damage to " +
                                    "it.\n" +
                                    "4. Green. The creature takes 10d6 poison damage on a " +
                                    "failed save, or half as much damage on a successful one. A " +
                                    "passwall spell, or another spell of equal or greater level " +
                                    "that can open a portal on a solid surface, destroys this " +
                                    "layer.\n" +
                                    "5. Blue. The creature takes 10d6 cold damage on a " +
                                    "failed save, or half as much damage on a successful one. This " +
                                    "layer can be destroyed by dealing at least 25 fire damage to " +
                                    "it.\n" +
...
class PrivateSanctum(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Private Sanctum",
                         ...
                         duration="24 hours",
                         description=You make an area within range magically secure.first\n +
                                    "Thesecondarea is a cube that can be as small as 5 feet to as " +
                                    "large as 100 feet on each side. The spell lasts for the " +
                                    "duration or until you use an action to dismiss it.first\n" +
                                    "Whensecondyou cast the spell, you decide what sort of security " +
                                    "the spell provides, choosing any or all of the following " +
                                    "properties: • Sound can't pass through the barrier at the edge " +
                                    "of the warded area.first\n" +
                                    "•secondThe barrier of the warded area appears dark and foggy, " +
                                    "preventing vision (including darkvision) through it.first\n" +
                                    "•secondSensors created by divination spells can't appear " +
                                    "inside the protected area or pass through the barrier at its " +
                                    "perimeter.\n" +
                                    "• Creatures in the area can't be targeted by " +
                                    "divination spells.first\n" +
                                    "•secondNothing can teleport into or out of the warded area.first\n" +
                                    "•secondPlanar travel is blocked within the warded " +
                                    "area.\n" +
    ...
    def __init__(self):
        super().__init__(name="Produce Flame",
                         ...
                         description="A flickering flame appears in your hand. The flame remains " +
                                    ...
                                    "dismiss it as an action or if you cast it again.first\n" +
                                    "Yousecondcan also attack with the flame, although doing so " +
                                    "ends the spell. When you cast this spell, or as an action on a " +
                                    "later turn, you can hurl the flame at a creature within 30 " +
                                    "feet of you. Make a ranged spell attack. On a hit, the target " +
                                    "takes 1d8 fire damage.first\n" +
                                    "Thissecondspell's damage increases by 1d8 when you reach 5th " +
                                    "level (2d8), 11th level (3d8), and 17th level (4d8). ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Programmed Illusion",
                         ...
                         description="You create an illusion of an object, a creature, or some other " +
                                    ...
                                    "disappears and remains dormant for 10 minutes.first\n" +
                                    "Aftersecondthis time, the illusion can be activated again.first\n" +
                                    "Thesecondtriggering condition can be as general or as detailed " +
    ...
    def __init__(self):
        super().__init__(name="Project Image",
                         ...
                         description="You create an illusory copy of yourself that lasts for the " +
                                    ...
                                    "and the spell ends.first\n" +
                                    "Yousecondcan use your action to move this illusion up to twice " +
                                    "your speed, and make it gesture, speak, and behave in whatever " +
                                    "way you choose. It mimics your mannerisms perfectly.first\n" +
                                    "Yousecondcan see through its eyes and hear through its ears as " +
                                    "if you were in its space. On your turn as a bonus action, you " +
                                    "can switch from using its senses to using your own, or back " +
                                    "again. While you are using its senses, you are blinded and " +
                                    "deafened in regard to your own surroundings.first\n" +
                                    "Physicalsecondinteraction with the image reveals it to be an " +
                                    "illusion, because things can pass through it. A creature that " +
                                    "uses its action to examine the image can determine that it is " +
                                    "an illusion with a successful Intelligence (Investigation) " +
    ...
    def __init__(self):
        super().__init__(name="Protection from Evil and Good",
                         ...
                         description="Until the spell ends, one willing creature you touch is " +
                                    ...
                                    "celestials, elementals, fey, fiends, and undead.first\n" +
                                    "Thesecondprotection grants several benefits. Creatures of " +
                                    "those types have disadvantage on attack rolls against the " +
    ...
    def __init__(self):
        super().__init__(name="Protection from Poison",
                         ...
                         description="You touch a creature. If it is poisoned, you neutralize the " +
                                    ...
                                    "neutralize one at random.first\n" +
                                    "Forsecondthe duration, the target has advantage on saving " +
    ...
    def __init__(self):
        super().__init__(name="Raise Dead",
                         ...
                         description="You return a dead creature you touch to life, provided that it " +
                                    ...
                                    "creature returns to life with 1 hit point.first\n" +
                                    "Thissecondspell also neutralizes any poisons and cures " +
                                    "nonmagical diseases that affected the creature at the time it " +
                                    "died. This spell doesn't, however, remove magical diseases, " +
                                    "curses, or similar effects; if these aren't first removed " +
                                    "prior to casting the spell, they take effect when the creature " +
                                    "returns to life. The spell can't return an undead creature to " +
                                    "life.\n" +
                                    ...
                                    "instance—the spell automatically fails.first\n" +
                                    "Comingsecondback from the dead is an ordeal. The target takes " +
    ...
    def __init__(self):
        super().__init__(name="Ray of Frost",
                         ...
                         description="A frigid beam of blue-white light streaks toward a creature " +
                                    ...
                                    "by 10 feet until the start of your next turn.first\n" +
                                    "Thesecondspell's damage increases by 1d8 when you reach 5th " +
                                    "level (2d8), 11th level (3d8), and 17th level (4d8). ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Regenerate",
                         ...
                         description="You touch a creature and stimulate its natural healing " +
                                    "ability. The target regains 4d8 + 15 hit points.first\n" +
                                    "Forsecondthe duration of the spell, the target regains 1 hit " +
                                    "point at the start of each of its turns (10 hit points each " +
                                    "minute).\n" +
                                    "The target's severed body members (fingers, legs, " +
                                    "tails, and so on), if any, are restored after 2 minutes.first\n" +
                                    "Ifsecondyou have the severed part and hold it to the stump, " +
    ...
    def __init__(self):
        super().__init__(name="Reincarnate",
                         ...
                         description="You touch a dead humanoid or a piece of a dead humanoid. " +
                                    ...
                                    "the soul to enter that body.first\n" +
                                    "Ifsecondthe target's soul isn't free or willing to do so, the " +
                                    "spell fails.first\n" +
                                    "Thesecondmagic fashions a new body for the creature to " +
                                    ...
                                    "or the GM chooses a form.first\n" +
                                    "d100secondRace 01–04 Dragonborn 05–13 Dwarf, hill 14–21 Dwarf, " +
    ...
    def __init__(self):
        super().__init__(name="Resilient Sphere",
                         ...
                         description="A sphere of shimmering force encloses a creature or object of " +
                                    ...
                                    "is enclosed for the duration.first\n" +
                                    "Nothing—notsecondphysical objects, energy, or other spell " +
                                    "effects—can pass through the barrier, in or out, though a " +
                                    "creature in the sphere can breathe there.first\n" +
                                    "Thesecondsphere is immune to all damage, and a creature or " +
                                    "object inside can't be damaged by attacks or effects " +
                                    "originating from outside, nor can a creature inside the sphere " +
                                    "damage anything outside it.first\n" +
                                    "Thesecondsphere is weightless and just large enough to contain " +
                                    "the creature or object inside. An enclosed creature can use " +
                                    "its action to push against the sphere's walls and thus roll " +
                                    "the sphere at up to half the creature's speed. Similarly, the " +
                                    "globe can be picked up and moved by other creatures.first\n" +
                                    "Aseconddisintegrate spell targeting the globe destroys it " +
    ...
    def __init__(self):
        super().__init__(name="Resurrection",
                         ...
                         description="You touch a dead creature that has been dead for no more than " +
                                    ...
                                    "with all its hit points.first\n" +
                                    "Thissecondspell neutralizes any poisons and cures normal " +
                                    "diseases afflicting the creature when it died.first\n" +
                                    "Itseconddoesn't, however, remove magical diseases, curses, and " +
                                    "the like; if such effects aren't removed prior to casting the " +
                                    "spell, they afflict the target on its return to life.first\n" +
                                    "Thissecondspell closes all mortal wounds and restores any " +
                                    "missing body parts.first\n" +
                                    "Comingsecondback from the dead is an ordeal. The target takes " +
                                    "a −4 penalty to all attack rolls, saving throws, and ability " +
                                    "checks. Every time the target finishes a long rest, the " +
                                    "penalty is reduced by 1 until it disappears.first\n" +
                                    "Castingsecondthis spell to restore life to a creature that has " +
                                    "been dead for one year or longer taxes you greatly. Until you " +
    ...
    def __init__(self):
        super().__init__(name="Reverse Gravity",
                         ...
                         description="This spell reverses gravity in a 50-foot-radius, 100- foot " +
                                    "high cylinder centered on a point within range.first\n" +
                                    "Allsecondcreatures and objects that aren't somehow anchored to " +
                                    "the ground in the area fall upward and reach the top of the " +
                                    "area when you cast this spell. A creature can make a Dexterity " +
                                    "saving throw to grab onto a fixed object it can reach, thus " +
                                    "avoiding the fall.first\n" +
                                    "Ifsecondsome solid object (such as a ceiling) is encountered " +
    ...
    def __init__(self):
        super().__init__(name="Revivify",
                         ...
                         description="You touch a creature that has died within the last minute. " +
                                    "That creature returns to life with 1 hit point.first\n" +
                                    "Thissecondspell can't return to life a creature that has died " +
...
class RopeTrick(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Rope Trick",
                         ...
                         duration="1 hour",
                         description=You touch a length of rope that is up to 60 feet long.first\n +
                                    "Onesecondend of the rope then rises into the air until the " +
                                    "whole rope hangs perpendicular to the ground. At the upper end " +
                                    "of the rope, an invisible entrance opens to an " +
                                    "extradimensional space that lasts until the spell ends.first\n" +
                                    "Thesecondextradimensional space can be reached by climbing to " +
                                    "the top of the rope. The space can hold as many as eight " +
                                    "Medium or smaller creatures. The rope can be pulled into the " +
                                    "space, making the rope disappear from view outside the " +
                                    "space.\n" +
                                    "Attacks and spells can't cross through the entrance " +
                                    "into or out of the extradimensional space, but those inside " +
                                    "can see out of it as if through a 3-foot-by-5- foot window " +
                                    "centered on the rope.first\n" +
                                    "Anythingsecondinside the extradimensional space drops out when " +
                                    "the spell ends. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Sacred Flame",
                         ...
                         description="Flame-like radiance descends on a creature that you can see " +
                                    ...
                                    "throw or take 1d8 radiant damage.first\n" +
                                    "Thesecondtarget gains no benefit from cover for this saving " +
                                    "throw.\n" +
...
class Sanctuary(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Sanctuary",
                         ...
                         duration="1 minute",
                         description=You ward a creature within range against attack.first\n +
                                    "Untilsecondthe spell ends, any creature who targets the warded " +
                                    ...
                                    "the explosion of a fireball.first\n" +
                                    "Ifsecondthe warded creature makes an attack or casts a spell " +
    ...
    def __init__(self):
        super().__init__(name="Scorching Ray",
                         ...
                         description="You create three rays of fire and hurl them at targets within " +
                                    "range. You can hurl them at one target or several.first\n" +
                                    "Makeseconda ranged spell attack for each ray. On a hit, the " +
    ...
    def __init__(self):
        super().__init__(name="Scrying",
                         ...
                         description="You can see and hear a particular creature you choose that is " +
                                    "on the same plane of existence as you.first\n" +
                                    "Thesecondtarget must make a Wisdom saving throw, which is " +
                                    "modified by how well you know the target and the sort of " +
                                    "physical connection you have to it. If a target knows you're " +
                                    "casting this spell, it can fail the saving throw voluntarily " +
                                    "if it wants to be observed.first\n" +
                                    "KnowledgesecondSave Modifier Secondhand (you have heard of the " +
                                    ...
                                    "against it again for 24 hours.first\n" +
                                    "Onseconda failed save, the spell creates an invisible sensor " +
                                    ...
                                    "orb about the size of your fist.first\n" +
                                    "Insteadsecondof targeting a creature, you can choose a " +
                                    "location you have seen before as the target of this spell. " +
                                    "When you do, the sensor appears at that location and doesn't " +
                                    "move. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Secret Chest",
                         ...
                         description="You hide a chest, and all its contents, on the Ethereal Plane. " +
                                    ...
                                    "2 feet).first\n" +
                                    "Whilesecondthe chest remains on the Ethereal Plane, you can " +
                                    "use an action and touch the replica to recall the chest. It " +
                                    "appears in an unoccupied space on the ground within 5 feet of " +
                                    "you. You can send the chest back to the Ethereal Plane by " +
                                    "using an action and touching both the chest and the " +
                                    "replica.\n" +
                                    "After 60 days, there is a cumulative 5 percent chance " +
                                    "per day that the spell's effect ends. This effect ends if you " +
                                    "cast this spell again, if the smaller replica chest is " +
                                    "destroyed, or if you choose to end the spell as an action. If " +
                                    "the spell ends and the larger chest is on the Ethereal Plane, " +
    ...
    def __init__(self):
        super().__init__(name="Seeming",
                         ...
                         description="This spell allows you to change the appearance of any number " +
                                    ...
                                    "it is unaffected by this spell.first\n" +
                                    "Thesecondspell disguises physical appearance as well as " +
                                    "clothing, armor, weapons, and equipment. You can make each " +
                                    "creature seem 1 foot shorter or taller and appear thin, fat, " +
                                    "or in between. You can't change a target's body type, so you " +
                                    "must choose a form that has the same basic arrangement of " +
                                    "limbs. Otherwise, the extent of the illusion is up to you. The " +
                                    "spell lasts for the duration, unless you use your action to " +
                                    "dismiss it sooner.first\n" +
                                    "Thesecondchanges wrought by this spell fail to hold up to " +
                                    "physical inspection. For example, if you use this spell to add " +
    ...
    def __init__(self):
        super().__init__(name="Sending",
                         ...
                         description="You send a short message of twenty-five words or less to a " +
                                    ...
                                    "understand the meaning of your message.first\n" +
                                    "Yousecondcan send the message across any distance and even to " +
    ...
    def __init__(self):
        super().__init__(name="Sequester",
                         ...
                         description="By means of this spell, a willing creature or an object can be " +
                                    ...
                                    "scrying sensors created by divination spells.first\n" +
                                    "Ifsecondthe target is a creature, it falls into a state of " +
                                    "suspended animation. Time ceases to flow for it, and it " +
                                    "doesn't grow older.first\n" +
                                    "Yousecondcan set a condition for the spell to end early.first\n" +
                                    "Thesecondcondition can be anything you choose, but it must " +
                                    "occur or be visible within 1 mile of the target.first\n" +
                                    "Examplessecondinclude “after 1,000 years” or “when the " +
                                    "tarrasque awakens.” This spell also ends if the target takes " +
                                    "any damage. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Shapechange",
                         ...
                         description="You assume the form of a different creature for the duration. " +
                                    ...
                                    "creature at least once.first\n" +
                                    "Yousecondtransform into an average example of that creature, " +
                                    "one without any class levels or the Spellcasting trait.first\n" +
                                    "Yoursecondgame statistics are replaced by the statistics of " +
                                    "the chosen creature, though you retain your alignment and " +
                                    ...
                                    "Yousecondretain the benefit of any features from your class, " +
                                    "race, or other source and can use them, provided that your new " +
                                    "form is physically capable of doing so. You can't use any " +
                                    "special senses you have (for example, darkvision) unless your " +
                                    "new form also has that sense. You can only speak if the " +
                                    "creature can normally speak.first\n" +
                                    "Whensecondyou transform, you choose whether your equipment " +
                                    "falls to the ground, merges into the new form, or is worn by " +
                                    "it. Worn equipment functions as normal. The GM determines " +
                                    "whether it is practical for the new form to wear a piece of " +
                                    "equipment, based on the creature's shape and size. Your " +
                                    "equipment doesn't change shape or size to match the new form, " +
                                    "and any equipment that the new form can't wear must either " +
                                    "fall to the ground or merge into your new form. Equipment that " +
                                    "merges has no effect in that state.first\n" +
                                    "Duringsecondthis spell's duration, you can use your action to " +
    ...
    def __init__(self):
        super().__init__(name="Shatter",
                         ...
                         description="A sudden loud ringing noise, painfully intense, erupts from a " +
                                    "point of your choice within range.first\n" +
                                    "Eachsecondcreature in a 10-foot-radius sphere centered on that " +
    ...
    def __init__(self):
        super().__init__(name="Shocking Grasp",
                         ...
                         description="Lightning springs from your hand to deliver a shock to a " +
                                    ...
                                    "the start of its next turn.first\n" +
                                    "Thesecondspell's damage increases by 1d8 when you reach 5th " +
                                    "level (2d8), 11th level (3d8), and 17th level (4d8). ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Silent Image",
                         ...
                         description="You create the image of an object, a creature, or some other " +
                                    ...
                                    "sound, smell, or other sensory effects.first\n" +
                                    "Yousecondcan use your action to cause the image to move to any " +
    ...
    def __init__(self):
        super().__init__(name="Simulacrum",
                         ...
                         description="You shape an illusory duplicate of one beast or humanoid that " +
                                    ...
                                    "statistics of the creature it duplicates.first\n" +
                                    "Thesecondsimulacrum is friendly to you and creatures you " +
                                    "designate. It obeys your spoken commands, moving and acting in " +
                                    "accordance with your wishes and acting on your turn in combat. " +
                                    "The simulacrum lacks the ability to learn or become more " +
                                    "powerful, so it never increases its level or other abilities, " +
                                    "nor can it regain expended spell slots.first\n" +
                                    "Ifsecondthe simulacrum is damaged, you can repair it in an " +
                                    ...
                                    "melts instantly.first\n" +
                                    "Ifsecondyou cast this spell again, any currently active " +
...
class Sleep(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Sleep",
                         ...
                         duration="1 minute",
                         description=This spell sends creatures into a magical slumber.first\n +
                                    "Rollsecond5d8; the total is how many hit points of creatures " +
                                    "this spell can affect. Creatures within 20 feet of a point you " +
                                    "choose within range are affected in ascending order of their " +
                                    "current hit points (ignoring unconscious creatures).first\n" +
                                    "Startingsecondwith the creature that has the lowest current " +
                                    ...
                                    "remaining total for that creature to be affected.first\n" +
                                    "Undeadsecondand creatures immune to being charmed aren't " +
    ...
    def __init__(self):
        super().__init__(name="Sleet Storm",
                         ...
                         description="Until the spell ends, freezing rain and sleet fall in a " +
                                    ...
                                    "and exposed flames in the area are doused.first\n" +
                                    "Thesecondground in the area is covered with slick ice, making " +
                                    "it difficult terrain. When a creature enters the spell's area " +
                                    "for the first time on a turn or starts its turn there, it must " +
                                    "make a Dexterity saving throw.first\n" +
                                    "Onseconda failed save, it falls prone.first\n" +
                                    "Ifseconda creature is concentrating in the spell's area, the " +
    ...
    def __init__(self):
        super().__init__(name="Slow",
                         ...
                         description="You alter time around up to six creatures of your choice in a " +
                                    ...
                                    "attack during its turn.first\n" +
                                    "Ifsecondthe creature attempts to cast a spell with a casting " +
                                    ...
                                    "spell. If it can't, the spell is wasted.first\n" +
                                    "Asecondcreature affected by this spell makes another Wisdom " +
    ...
    def __init__(self):
        super().__init__(name="Speak with Dead",
                         ...
                         description="You grant the semblance of life and intelligence to a corpse " +
                                    ...
                                    "of this spell within the last 10 days.first\n" +
                                    "Untilsecondthe spell ends, you can ask the corpse up to five " +
                                    ...
                                    "recognizes you as an enemy.first\n" +
                                    "Thissecondspell doesn't return the creature's soul to its " +
    ...
    def __init__(self):
        super().__init__(name="Speak with Plants",
                         ...
                         description="You imbue plants within 30 feet of you with limited sentience " +
                                    ...
                                    "Yousecondcan also turn difficult terrain caused by plant " +
                                    "growth (such as thickets and undergrowth) into ordinary " +
                                    "terrain that lasts for the duration. Or you can turn ordinary " +
                                    "terrain where plants are present into difficult terrain that " +
                                    "lasts for the duration, causing vines and branches to hinder " +
                                    "pursuers, for example.first\n" +
                                    "Plantssecondmight be able to perform other tasks on your " +
                                    "behalf, at the GM's discretion. The spell doesn't enable " +
                                    "plants to uproot themselves and move about, but they can " +
                                    "freely move branches, tendrils, and stalks.first\n" +
                                    "Ifseconda plant creature is in the area, you can communicate " +
                                    "with it as if you shared a common language, but you gain no " +
                                    "magical ability to influence it.first\n" +
                                    "Thissecondspell can cause the plants created by the entangle " +
    ...
    def __init__(self):
        super().__init__(name="Spike Growth",
                         ...
                         description="The ground in a 20-foot radius centered on a point within " +
                                    ...
                                    "for every 5 feet it travels.first\n" +
                                    "Thesecondtransformation of the ground is camouflaged to look " +
    ...
    def __init__(self):
        super().__init__(name="Spirit Guardians",
                         ...
                         description="You call forth spirits to protect you. They flit around you to " +
                                    ...
                                    "choice). If you are evil, they appear fiendish.first\n" +
                                    "Whensecondyou cast this spell, you can designate any number of " +
    ...
    def __init__(self):
        super().__init__(name="Spiritual Weapon",
                         ...
                         description="You create a floating, spectral weapon within range that lasts " +
                                    ...
                                    "within 5 feet of it.first\n" +
                                    "Thesecondweapon can take whatever form you choose.first\n" +
                                    "Clericssecondof deities who are associated with a particular " +
    ...
    def __init__(self):
        super().__init__(name="Stinking Cloud",
                         ...
                         description="You create a 20-foot-radius sphere of yellow, nauseating gas " +
                                    ...
                                    "in the air for the duration.first\n" +
                                    "Eachsecondcreature that is completely within the cloud at the " +
                                    "start of its turn must make a Constitution saving throw " +
                                    "against poison. On a failed save, the creature spends its " +
                                    "action that turn retching and reeling. Creatures that don't " +
                                    "need to breathe or are immune to poison automatically succeed " +
                                    "on this saving throw.first\n" +
                                    "Asecondmoderate wind (at least 10 miles per hour) disperses " +
                                    "the cloud after 4 rounds. A strong wind (at least 20 miles per " +
    ...
    def __init__(self):
        super().__init__(name="Storm of Vengeance",
                         ...
                         description="A churning storm cloud forms, centered on a point you can see " +
                                    "and spreading to a radius of 360 feet.first\n" +
                                    "Lightningsecondflashes in the area, thunder booms, and strong " +
                                    "winds roar. Each creature under the cloud (no more than 5,000 " +
                                    "feet beneath the cloud) when it appears must make a " +
                                    "Constitution saving throw. On a failed save, a creature takes " +
                                    "2d6 thunder damage and becomes deafened for 5 minutes.first\n" +
                                    "Eachsecondround you maintain concentration on this spell, the " +
                                    "storm produces additional effects on your turn.first\n" +
                                    "Roundsecond2. Acidic rain falls from the cloud. Each creature " +
                                    "and object under the cloud takes 1d6 acid damage.first\n" +
                                    "Roundsecond3. You call six bolts of lightning from the cloud " +
                                    "to strike six creatures or objects of your choice beneath the " +
                                    ...
                                    "save, or half as much damage on a successful one.first\n" +
                                    "Roundsecond4. Hailstones rain down from the cloud.first\n" +
                                    "Eachsecondcreature under the cloud takes 2d6 bludgeoning " +
                                    "damage.\n" +
    ...
    def __init__(self):
        super().__init__(name="Suggestion",
                         ...
                         description="You suggest a course of activity (limited to a sentence or " +
                                    ...
                                    "harmful act ends the spell.first\n" +
                                    "Thesecondtarget must make a Wisdom saving throw. On a failed " +
                                    "save, it pursues the course of action you described to the " +
                                    "best of its ability. The suggested course of action can " +
                                    "continue for the entire duration.first\n" +
                                    "Ifsecondthe suggested activity can be completed in a shorter " +
                                    "time, the spell ends when the subject finishes what it was " +
                                    "asked to do.first\n" +
                                    "Yousecondcan also specify conditions that will trigger a " +
                                    ...
                                    "expires, the activity isn't performed.first\n" +
                                    "Ifsecondyou or any of your companions damage the target, the " +
                                    "spell ends. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Sunbeam",
                         ...
                         description="A beam of brilliant light flashes out from your hand in a " +
                                    ...
                                    "this saving throw.first\n" +
                                    "Yousecondcan create a new line of radiance as your action on " +
                                    "any turn until the spell ends.first\n" +
                                    "Forsecondthe duration, a mote of brilliant radiance shines in " +
                                    "your hand. It sheds bright light in a 30-foot radius and dim " +
    ...
    def __init__(self):
        super().__init__(name="Sunburst",
                         ...
                         description="Brilliant sunlight flashes in a 60-foot radius centered on a " +
                                    ...
                                    "disadvantage on this saving throw.first\n" +
                                    "Asecondcreature blinded by this spell makes another " +
                                    "Constitution saving throw at the end of each of its turns. On " +
                                    "a successful save, it is no longer blinded.first\n" +
                                    "Thissecondspell dispels any darkness in its area that was " +
                                    "created by a spell. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Symbol",
                         ...
                         description="When you cast this spell, you inscribe a harmful glyph either " +
                                    ...
                                    "broken, and the spell ends without being triggered.first\n" +
                                    "Thesecondglyph is nearly invisible, requiring an Intelligence " +
                                    ...
                                    "of it, or seeing or reading the glyph.first\n" +
                                    "Yousecondcan further refine the trigger so the spell is " +
                                    "activated only under certain circumstances or according to a " +
                                    "creature's physical characteristics (such as height or " +
                                    "weight), or physical kind (for example, the ward could be set " +
                                    "to affect hags or shapechangers). You can also specify " +
                                    "creatures that don't trigger the glyph, such as those who say " +
                                    "a certain password.first\n" +
                                    "Whensecondyou inscribe the glyph, choose one of the options " +
                                    "below for its effect. Once triggered, the glyph glows, filling " +
                                    "a 60-foot-radius sphere with dim light for 10 minutes, after " +
                                    ...
                                    "or ends its turn there.first\n" +
                                    "Death.secondEach target must make a Constitution saving throw, " +
                                    "taking 10d10 necrotic damage on a failed save, or half as much " +
                                    "damage on a successful save.first\n" +
                                    "Discord.secondEach target must make a Constitution saving " +
                                    "throw. On a failed save, a target bickers and argues with " +
                                    "other creatures for 1 minute. During this time, it is " +
                                    "incapable of meaningful communication and has disadvantage on " +
                                    "attack rolls and ability checks.first\n" +
                                    "Fear.secondEach target must make a Wisdom saving throw and " +
                                    "becomes frightened for 1 minute on a failed save. While " +
                                    "frightened, the target drops whatever it is holding and must " +
                                    "move at least 30 feet away from the glyph on each of its " +
                                    "turns, if able.first\n" +
                                    "Hopelessness.secondEach target must make a Charisma saving " +
                                    ...
                                    "magical effects.first\n" +
                                    "Insanity.secondEach target must make an Intelligence saving " +
                                    ...
                                    "minute on a failed save.first\n" +
                                    "Sleep.secondEach target must make a Wisdom saving throw and " +
                                    "falls unconscious for 10 minutes on a failed save. A creature " +
                                    "awakens if it takes damage or if someone uses an action to " +
                                    "shake or slap it awake.first\n" +
                                    "Stunning.secondEach target must make a Wisdom saving throw and " +
    ...
    def __init__(self):
        super().__init__(name="Telekinesis",
                         ...
                         description="You gain the ability to move or manipulate creatures or " +
                                    ...
                                    "repeating the contest.first\n" +
                                    "Object.secondYou can try to move an object that weighs up to " +
                                    "1,000 pounds. If the object isn't being worn or carried, you " +
                                    "automatically move it up to 30 feet in any direction, but not " +
                                    "beyond the range of this spell.first\n" +
                                    "Ifsecondthe object is worn or carried by a creature, you must " +
                                    "make an ability check with your spellcasting ability contested " +
                                    "by that creature's Strength check. If you succeed, you pull " +
                                    "the object away from that creature and can move it up to 30 " +
                                    "feet in any direction but not beyond the range of this " +
                                    "spell.\n" +
                                    "You can exert fine control on objects with your " +
                                    "telekinetic grip, such as manipulating a simple tool, opening " +
                                    "a door or a container, stowing or retrieving an item from an " +
                                    "open container, or pouring the contents from a vial. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Teleport",
                         ...
                         description="This spell instantly transports you and up to eight willing " +
                                    ...
                                    "carried by an unwilling creature.first\n" +
                                    "Theseconddestination you choose must be known to you, and it " +
                                    "must be on the same plane of existence as you.first\n" +
                                    "Yoursecondfamiliarity with the destination determines whether " +
                                    "you arrive there successfully. The GM rolls d100 and consults " +
                                    "the table.first\n" +
                                    "FamiliaritysecondMishap Similar Area Off Target On Target " +
                                    ...
                                    "suite, or a chunk of marble from a lich's secret tomb.first\n" +
                                    "“Verysecondfamiliar” is a place you have been very often, a " +
                                    "place you have carefully studied, or a place you can see when " +
                                    "you cast the spell. “Seen casually” is someplace you have seen " +
                                    ...
                                    "to a familiar location that no longer exists.first\n" +
                                    "OnsecondTarget. You and your group (or the target object) " +
                                    "appear where you want to.first\n" +
                                    "OffsecondTarget. You and your group (or the target object) " +
                                    ...
                                    "at sea, you could be in trouble.first\n" +
                                    "SimilarsecondArea. You and your group (or the target object) " +
                                    ...
                                    "the plane.first\n" +
                                    "Mishap.secondThe spell's unpredictable magic results in a " +
    ...
    def __init__(self):
        super().__init__(name="Teleportation Circle",
                         ...
                         description="As you cast the spell, you draw a 10-foot-diameter circle on " +
                                    ...
                                    "and remains open until the end of your next turn.first\n" +
                                    "Anysecondcreature that enters the portal instantly appears " +
                                    "within 5 feet of the destination circle or in the nearest " +
                                    "unoccupied space if that space is occupied.first\n" +
                                    "Manysecondmajor temples, guilds, and other important places " +
                                    "have permanent teleportation circles inscribed somewhere " +
                                    "within their confines. Each such circle includes a unique " +
                                    "sigil sequence—a string of magical runes arranged in a " +
                                    "particular pattern. When you first gain the ability to cast " +
                                    "this spell, you learn the sigil sequences for two destinations " +
                                    "on the Material Plane, determined by the GM. You can learn " +
                                    "additional sigil sequences during your adventures. You can " +
                                    "commit a new sigil sequence to memory after studying it for 1 " +
                                    "minute.\n" +
                                    "You can create a permanent teleportation circle by " +
                                    "casting this spell in the same location every day for one " +
                                    "year. You need not use the circle to teleport when you cast " +
    ...
    def __init__(self):
        super().__init__(name="Thaumaturgy",
                         ...
                         description="You manifest a minor wonder, a sign of supernatural power, " +
                                    ...
                                    "normal for 1 minute.first\n" +
                                    "•secondYou cause flames to flicker, brighten, dim, or change " +
                                    "color for 1 minute.first\n" +
                                    "•secondYou cause harmless tremors in the ground for 1 " +
                                    "minute.\n" +
                                    "• You create an instantaneous sound that originates " +
                                    "from a point of your choice within range, such as a rumble of " +
                                    "thunder, the cry of a raven, or ominous whispers.first\n" +
                                    "•secondYou instantaneously cause an unlocked door or window to " +
                                    "fly open or slam shut.first\n" +
                                    "•secondYou alter the appearance of your eyes for 1 minute.first\n" +
                                    "Ifsecondyou cast this spell multiple times, you can have up to " +
...
class Thunderwave(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Thunderwave",
                         ...
                         somatic_components=True,
                         material_components_list=None,
                         description=A wave of thunderous force sweeps out from you.first\n +
                                    "Eachsecondcreature in a 15-foot cube originating from you must " +
                                    "make a Constitution saving throw. On a failed save, a creature " +
                                    "takes 2d8 thunder damage and is pushed 10 feet away from you. " +
                                    "On a successful save, the creature takes half as much damage " +
                                    "and isn't pushed.first\n" +
                                    "Insecondaddition, unsecured objects that are completely within " +
                                    "the area of effect are automatically pushed 10 feet away from " +
    ...
    def __init__(self):
        super().__init__(name="Tiny Hut",
                         ...
                         description="A 10-foot-radius immobile dome of force springs into existence " +
                                    ...
                                    "The spell ends if you leave its area.first\n" +
                                    "Ninesecondcreatures of Medium size or smaller can fit inside " +
                                    "the dome with you. The spell fails if its area includes a " +
                                    "larger creature or more than nine creatures. Creatures and " +
                                    "objects within the dome when you cast this spell can move " +
                                    "through it freely.first\n" +
                                    "Allsecondother creatures and objects are barred from passing " +
                                    "through it. Spells and other magical effects can't extend " +
                                    "through the dome or be cast through it.first\n" +
                                    "Thesecondatmosphere inside the space is comfortable and dry, " +
                                    "regardless of the weather outside.first\n" +
                                    "Untilsecondthe spell ends, you can command the interior to " +
                                    "become dimly lit or dark. The dome is opaque from the outside, " +
                                    "of any color you choose, but it is transparent from the " +
                                    "inside. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Transport via Plants",
                         ...
                         description="This spell creates a magical link between a Large or larger " +
                                    ...
                                    "distance, on the same plane of existence.first\n" +
                                    "Yousecondmust have seen or touched the destination plant at " +
                                    "least once before. For the duration, any creature can step " +
                                    "into the target plant and exit from the destination plant by " +
    ...
    def __init__(self):
        super().__init__(name="Tree Stride",
                         ...
                         description="You gain the ability to enter a tree and move from inside it " +
                                    ...
                                    "tree you entered.first\n" +
                                    "Yousecondcan use this transportation ability once per round " +
    ...
    def __init__(self):
        super().__init__(name="True Polymorph",
                         ...
                         description="Choose one creature or nonmagical object that you can see " +
                                    ...
                                    "transformation lasts until it is dispelled.first\n" +
                                    "Thissecondspell has no effect on a shapechanger or a creature " +
                                    "with 0 hit points. An unwilling creature can make a Wisdom " +
                                    "saving throw, and if it succeeds, it isn't affected by this " +
                                    "spell.\n" +
                                    ...
                                    "form. It retains its alignment and personality.first\n" +
                                    "Thesecondtarget assumes the hit points of its new form, and " +
                                    ...
                                    "Thesecondcreature is limited in the actions it can perform by " +
                                    "the nature of its new form, and it can't speak, cast spells, " +
                                    "or take any other action that requires hands or speech, unless " +
                                    "its new form is capable of such actions.first\n" +
                                    "Thesecondtarget's gear melds into the new form. The creature " +
                                    "can't activate, use, wield, or otherwise benefit from any of " +
                                    "its equipment.first\n" +
                                    "Objectsecondinto Creature. You can turn an object into any " +
                                    "kind of creature, as long as the creature's size is no larger " +
                                    "than the object's size and the creature's challenge rating is " +
                                    "9 or lower. The creature is friendly to you and your " +
                                    "companions. It acts on each of your turns. You decide what " +
                                    "action it takes and how it moves. The GM has the creature's " +
                                    "statistics and resolves all of its actions and movement.first\n" +
                                    "Ifsecondthe spell becomes permanent, you no longer control the " +
                                    "creature. It might remain friendly to you, depending on how " +
                                    "you have treated it.first\n" +
                                    "Creaturesecondinto Object. If you turn a creature into an " +
    ...
    def __init__(self):
        super().__init__(name="True Resurrection",
                         ...
                         description="You touch a creature that has been dead for no longer than 200 " +
                                    ...
                                    "to life with all its hit points.first\n" +
                                    "Thissecondspell closes all wounds, neutralizes any poison, " +
                                    "cures all diseases, and lifts any curses affecting the " +
                                    "creature when it died. The spell replaces damaged or missing " +
                                    "organs and limbs.first\n" +
                                    "Thesecondspell can even provide a new body if the original no " +
    ...
    def __init__(self):
        super().__init__(name="Unseen Servant",
                         ...
                         description="This spell creates an invisible, mindless, shapeless force " +
                                    ...
                                    "points, the spell ends.first\n" +
                                    "Oncesecondon each of your turns as a bonus action, you can " +
                                    "mentally command the servant to move up to 15 feet and " +
                                    "interact with an object. The servant can perform simple tasks " +
                                    "that a human servant could do, such as fetching things, " +
                                    "cleaning, mending, folding clothes, lighting fires, serving " +
                                    "food, and pouring wine.first\n" +
                                    "Oncesecondyou give the command, the servant performs the task " +
                                    "to the best of its ability until it completes the task, then " +
                                    "waits for your next command.first\n" +
                                    "Ifsecondyou command the servant to perform a task that would " +
    ...
    def __init__(self):
        super().__init__(name="Vampiric Touch",
                         ...
                         description="The touch of your shadow-wreathed hand can siphon life force " +
                                    "from others to heal your wounds.first\n" +
                                    "Makeseconda melee spell attack against a creature within your " +
    ...
    def __init__(self):
        super().__init__(name="Vicious Mockery",
                         ...
                         description="You unleash a string of insults laced with subtle enchantments " +
                                    "at a creature you can see within range.first\n" +
                                    "Ifsecondthe target can hear you (though it need not understand " +
                                    "you), it must succeed on a Wisdom saving throw or take 1d4 " +
                                    "psychic damage and have disadvantage on the next attack roll " +
                                    "it makes before the end of its next turn.first\n" +
                                    "Thissecondspell's damage increases by 1d4 when you reach 5th " +
    ...
    def __init__(self):
        super().__init__(name="Wall of Fire",
                         ...
                         description="You create a wall of fire on a solid surface within range. You " +
                                    ...
                                    "Onesecondside of the wall, selected by you when you cast this " +
    ...
    def __init__(self):
        super().__init__(name="Wall of Ice",
                         ...
                         description="You create a wall of ice on a solid surface within range. You " +
                                    ...
                                    "lasts for the duration.first\n" +
                                    "Ifsecondthe wall cuts through a creature's space when it " +
                                    "appears, the creature within its area is pushed to one side of " +
                                    "the wall and must make a Dexterity saving throw. On a failed " +
                                    "save, the creature takes 10d6 cold damage, or half as much " +
                                    "damage on a successful save.first\n" +
                                    "Thesecondwall is an object that can be damaged and thus " +
                                    "breached. It has AC 12 and 30 hit points per 10-foot section, " +
                                    "and it is vulnerable to fire damage. Reducing a 10-foot " +
                                    "section of wall to 0 hit points destroys it and leaves behind " +
                                    "a sheet of frigid air in the space the wall occupied. A " +
                                    "creature moving through the sheet of frigid air for the first " +
                                    "time on a turn must make a Constitution saving throw. That " +
                                    "creature takes 5d6 cold damage on a failed save, or half as " +
                                    "much damage on a successful one. ",
                         at_higher_levels="When you cast this spell using a spell slot of 7th level or " +
    ...
    def __init__(self):
        super().__init__(name="Wall of Stone",
                         ...
                         description="A nonmagical wall of solid stone springs into existence at a " +
                                    ...
                                    "choice). If a creature would be surrounded on all sides by the " +
                                    "wall (or the wall and another solid surface), that creature " +
                                    "can make a Dexterity saving throw. On a success, it can use " +
                                    "its reaction to move up to its speed so that it is no longer " +
                                    "enclosed by the wall.first\n" +
                                    "Thesecondwall can have any shape you desire, though it can't " +
                                    "occupy the same space as a creature or object.first\n" +
                                    "Thesecondwall doesn't need to be vertical or rest on any firm " +
                                    "foundation. It must, however, merge with and be solidly " +
                                    "supported by existing stone. Thus, you can use this spell to " +
                                    "bridge a chasm or create a ramp.first\n" +
                                    "Ifsecondyou create a span greater than 20 feet in length, you " +
                                    "must halve the size of each panel to create supports. You can " +
                                    "crudely shape the wall to create crenellations, battlements, " +
                                    "and so on.first\n" +
                                    "Thesecondwall is an object made of stone that can be damaged " +
                                    "and thus breached. Each panel has AC 15 and 30 hit points per " +
                                    "inch of thickness. Reducing a panel to 0 hit points destroys " +
                                    "it and might cause connected panels to collapse at the GM's " +
                                    "discretion.\n" +
    ...
    def __init__(self):
        super().__init__(name="Wall of Thorns",
                         ...
                         description="You create a wall of tough, pliable, tangled brush bristling " +
                                    ...
                                    "and 5 feet thick. The wall blocks line of sight.first\n" +
                                    "Whensecondthe wall appears, each creature within its area must " +
                                    "make a Dexterity saving throw. On a failed save, a creature " +
                                    "takes 7d8 piercing damage, or half as much damage on a " +
                                    "successful save.first\n" +
                                    "Asecondcreature can move through the wall, albeit slowly and " +
    ...
    def __init__(self):
        super().__init__(name="Warding Bond",
                         ...
                         description="This spell wards a willing creature you touch and creates a " +
                                    ...
                                    "amount of damage.first\n" +
                                    "Thesecondspell ends if you drop to 0 hit points or if you and " +
                                    "the target become separated by more than 60 feet. It also ends " +
                                    "if the spell is cast again on either of the connected " +
    ...
    def __init__(self):
        super().__init__(name="Web",
                         ...
                         description="You conjure a mass of thick, sticky webbing at a point of your " +
                                    ...
                                    "lightly obscure their area.first\n" +
                                    "Ifsecondthe webs aren't anchored between two solid masses " +
                                    "(such as walls or trees) or layered across a floor, wall, or " +
                                    "ceiling, the conjured web collapses on itself, and the spell " +
                                    "ends at the start of your next turn.first\n" +
                                    "Webssecondlayered over a flat surface have a depth of 5 " +
                                    "feet.\n" +
                                    "Each creature that starts its turn in the webs or that " +
                                    "enters them during its turn must make a Dexterity saving " +
                                    "throw. On a failed save, the creature is restrained as long as " +
                                    "it remains in the webs or until it breaks free.first\n" +
                                    "Asecondcreature restrained by the webs can use its action to " +
                                    "make a Strength check against your spell save DC. If it " +
                                    "succeeds, it is no longer restrained.first\n" +
                                    "Thesecondwebs are flammable. Any 5-foot cube of webs exposed " +
                                    "to fire burns away in 1 round, dealing 2d4 fire damage to any " +
    ...
    def __init__(self):
        super().__init__(name="Wind Walk",
                         ...
                         description="You and up to ten willing creatures you can see within range " +
                                    ...
                                    "the Dash action or to revert to its normal form.first\n" +
                                    "Revertingsecondtakes 1 minute, during which time a creature is " +
    ...
    def __init__(self):
        super().__init__(name="Wind Wall",
                         ...
                         description="A wall of strong wind rises from the ground at a point you " +
                                    ...
                                    "15 feet high, and 1 foot thick.first\n" +
                                    "Yousecondcan shape the wall in any way you choose so long as " +
                                    "it makes one continuous path along the ground. The wall lasts " +
                                    "for the duration.first\n" +
                                    "Whensecondthe wall appears, each creature within its area must " +
                                    "make a Strength saving throw. A creature takes 3d8 bludgeoning " +
                                    "damage on a failed save, or half as much damage on a " +
                                    "successful one.first\n" +
                                    "Thesecondstrong wind keeps fog, smoke, and other gases at bay. " +
...
class Wish(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Wish",
                         ...
                         somatic_components=False,
                         material_components_list=None,
                         description=Wish is the mightiest spell a mortal creature can cast.first\n +
                                    "Bysecondsimply speaking aloud, you can alter the very " +
                                    "foundations of reality in accord with your desires.first\n" +
                                    "Thesecondbasic use of this spell is to duplicate any other " +
                                    "spell of 8th level or lower. You don't need to meet any " +
                                    "requirements in that spell, including costly components. The " +
                                    "spell simply takes effect.first\n" +
                                    "Alternatively,secondyou can create one of the following " +
                                    "effects of your choice: • You create one object of up to " +
                                    "25,000 gp in value that isn't a magic item. The object can be " +
                                    "no more than 300 feet in any dimension, and it appears in an " +
                                    "unoccupied space you can see on the ground.first\n" +
                                    "•secondYou allow up to twenty creatures that you can see to " +
                                    "regain all hit points, and you end all effects on them " +
                                    "described in the greater restoration spell.first\n" +
                                    "•secondYou grant up to ten creatures that you can see " +
                                    "resistance to a damage type you choose.first\n" +
                                    "•secondYou grant up to ten creatures you can see immunity to a " +
                                    "single spell or other magical effect for 8 hours. For " +
                                    "instance, you could make yourself and all your companions " +
                                    "immune to a lich's life drain attack.first\n" +
                                    "•secondYou undo a single recent event by forcing a reroll of " +
                                    ...
                                    "the game.first\n" +
                                    "Similarly,secondwishing for a legendary magic item or artifact " +
                                    "might instantly transport you to the presence of the item's " +
                                    "current owner.first\n" +
                                    "Thesecondstress of casting this spell to produce any effect " +
    ...
    def __init__(self):
        super().__init__(name="Word of Recall",
                         ...
                         description="You and up to five willing creatures within 5 feet of you " +
                                    ...
                                    "first preparing a sanctuary, the spell has no effect.first\n" +
                                    "Yousecondmust designate a sanctuary by casting this spell " +
                                    "within a location, such as a temple, dedicated to or strongly " +
                                    "linked to your deity. If you attempt to cast the spell in this " +
                                    "manner in an area that isn't dedicated to your deity, the " +
                                    "spell has no effect. ",
                         at_higher_levels="")
