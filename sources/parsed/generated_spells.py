    ...
    def __init__(self):
        super().__init__(name="Acid Arrow",
                         ...
                         description="A shimmering green arrow streaks toward a target \nwithin " +
                                    "range and bursts in a spray of acid. Make a \nranged spell " +
                                    "attack against the target. On a hit, the \ntarget takes 4d4 " +
                                    "acid damage immediately and 2d4 \nacid damage at the end of " +
                                    "its next turn. On a miss, \nthe arrow splashes the target with " +
    ...
    def __init__(self):
        super().__init__(name="Acid Splash",
                         ...
                         description="You hurl a bubble of acid. Choose one creature \nwithin range, " +
                                    ...
                                    "increases by 1d6 when you \nreach 5th level (2d6), 11th level " +
                                    "(3d6), and 17th \nlevel (4d6). ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Alarm",
                         ...
                         description="You set an alarm against unwanted intrusion. \nChoose a door, " +
                                    "a window, or an area within range \nthat is no larger than a " +
    ...
    def __init__(self):
        super().__init__(name="Alter Self",
                         ...
                         description="You assume a different form. When you cast the spell, \nchoose " +
                                    ...
                                    "end one option as an action to \ngain the benefits of a " +
                                    "different one.\nAquatic Adaptation. You adapt your body to an " +
                                    "\naquatic environment, sprouting gills and growing \nwebbing " +
                                    "between your fingers. You can breathe \nunderwater and gain a " +
                                    "swimming speed equal to \nyour walking speed.\nChange " +
                                    "Appearance. You transform your \nappearance. You decide what " +
                                    "you look like, including \nyour height, weight, facial " +
                                    "features, sound of your \nvoice, hair length, coloration, and " +
                                    "distinguishing \ncharacteristics, if any. You can make " +
                                    ...
                                    "the same; if you're bipedal, you can't use this \nspell to " +
                                    "become quadrupedal, for instance. At any \ntime for the " +
                                    "duration of the spell, you can use your \naction to change " +
                                    "your appearance in this way again.\nNatural Weapons. You grow " +
                                    "claws, fangs, spines, \nhorns, or a different natural weapon " +
                                    ...
                                    "unarmed strikes. Finally, the natural \nweapon is magic and " +
                                    "you have a +1 bonus to the \nattack and damage rolls you make " +
                                    "using it. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Animal Friendship",
                         ...
                         description="This spell lets you convince a beast that you mean it \nno " +
                                    ...
                                    "see and hear you. If the beast's \nIntelligence is 4 or " +
                                    "higher, the spell fails. Otherwise, \nthe beast must succeed " +
                                    "on a Wisdom saving throw \nor be charmed by you for the " +
                                    "spell's duration. If you \nor one of your companions harms the " +
                                    "target, the \nspells ends. ",
    ...
    def __init__(self):
        super().__init__(name="Animal Messenger",
                         ...
                         description="By means of this spell, you use an animal to deliver a " +
                                    ...
                                    "before the spell ends, the message is lost, \nand the beast " +
                                    "makes its way back to where you cast \nthis spell. ",
    ...
    def __init__(self):
        super().__init__(name="Animal Shapes",
                         ...
                         description="Your magic turns others into beasts. Choose any \nnumber of " +
                                    ...
                                    "and when it reverts to its normal form, it \nreturns to the " +
                                    "number of hit points it had before it \ntransformed. If it " +
                                    "reverts as a result of dropping to 0 \nhit points, any excess " +
                                    "damage carries over to its \nnormal form. As long as the " +
                                    "excess damage doesn't \nreduce the creature's normal form to 0 " +
                                    "hit points, it \nisn't knocked unconscious. The creature is " +
                                    "limited in \nthe actions it can perform by the nature of its " +
                                    "new \nform, and it can't speak or cast spells.\nThe target's " +
                                    "gear melds into the new form. The \ntarget can't activate, " +
                                    "wield, or otherwise benefit \nfrom any of its equipment. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Animate Dead",
                         ...
                         description="This spell creates an undead servant. Choose a pile \nof bones " +
                                    ...
                                    "you chose bones or \na zombie if you chose a corpse (the GM " +
                                    "has the \ncreature's game statistics).\nOn each of your turns, " +
                                    "you can use a bonus action \nto mentally command any creature " +
                                    "you made with \nthis spell if the creature is within 60 feet " +
                                    ...
                                    "will take and where it will move during its \nnext turn, or " +
                                    "you can issue a general command, such \nas to guard a " +
                                    "particular chamber or corridor. If you \nissue no commands, " +
                                    "the creature only defends itself \nagainst hostile creatures. " +
                                    "Once given an order, the \ncreature continues to follow it " +
                                    ...
                                    "This use of the spell reasserts your control \nover up to four " +
                                    "creatures you have animated with \nthis spell, rather than " +
                                    "animating a new one. ",
    ...
    def __init__(self):
        super().__init__(name="Animate Objects",
                         ...
                         description="Objects come to life at your command. Choose up to \nten " +
                                    ...
                                    "Strength, and Dexterity determined \nby its size. Its " +
                                    "Constitution is 10 and its Intelligence \nand Wisdom are 3, " +
                                    "and its Charisma is 1. Its speed is \n30 feet; if the object " +
                                    "lacks legs or other appendages it \ncan use for locomotion, it " +
                                    "instead has a flying speed \nof 30 feet and can hover. If the " +
                                    "object is securely \nattached to a surface or a larger object, " +
                                    ...
                                    "it reverts to its original object form, and any \nremaining " +
                                    "damage carries over to its original object \nform.\nIf you " +
                                    "command an object to attack, it can make a \nsingle melee " +
                                    "attack against a creature within 5 feet \nof it. It makes a " +
                                    "slam attack with an attack bonus and \nbludgeoning damage " +
                                    "determined by its size. The GM \nmight rule that a specific " +
                                    "object inflicts slashing or \npiercing damage based on its " +
                                    "form. ",
    ...
    def __init__(self):
        super().__init__(name="Antilife Shell",
                         ...
                         description="A shimmering barrier extends out from you in a 10-\nfoot " +
                                    ...
                                    "affected creature \ncan cast spells or make attacks with " +
                                    "ranged or reach \nweapons through the barrier.\nIf you move so " +
                                    "that an affected creature is forced \nto pass through the " +
    ...
    def __init__(self):
        super().__init__(name="Antimagic Field",
                         ...
                         description="A 10-foot-radius invisible sphere of antimagic \nsurrounds " +
                                    "you. This area is divorced from the \nmagical energy that " +
                                    "suffuses the multiverse. Within \nthe sphere, spells can't be " +
                                    "cast, summoned creatures \ndisappear, and even magic items " +
                                    ...
                                    "effect is suppressed, it doesn't function, but \nthe time it " +
                                    "spends suppressed counts against its \nduration.\nTargeted " +
                                    "Effects. Spells and other magical effects, \nsuch as magic " +
                                    "missile and charm person, that target a \ncreature or an " +
                                    "object in the sphere have no effect on \nthat target.\nAreas " +
                                    "of Magic. The area of another spell or \nmagical effect, such " +
                                    "as fireball, can't extend into the \nsphere. If the sphere " +
    ...
    def __init__(self):
        super().__init__(name="Antipathy/Sympathy",
                         ...
                         description="This spell attracts or repels creatures of your choice. \nYou " +
                                    ...
                                    "or become frightened. The creature remains \nfrightened while " +
                                    "it can see the target or is within 60 \nfeet of it. While " +
                                    "frightened by the target, the creature \nmust use its movement " +
                                    "to move to the nearest safe \nspot from which it can't see the " +
                                    "target. If the creature \nmoves more than 60 feet from the " +
                                    "target and can't \nsee it, the creature is no longer " +
                                    "frightened, but the \ncreature becomes frightened again if it " +
                                    "regains sight \nof the target or moves within 60 feet of " +
                                    "it.\nSympathy. The enchantment causes the specified " +
                                    "\ncreatures to feel an intense urge to approach the \ntarget " +
                                    "while within 60 feet of it or able to see it. \nWhen such a " +
                                    "creature can see the target or comes \nwithin 60 feet of it, " +
                                    "the creature must succeed on a \nWisdom saving throw or use " +
                                    "its movement on each \nof its turns to enter the area or move " +
                                    "within reach of \nthe target. When the creature has done so, " +
                                    "it can't \nwillingly move away from the target.\nIf the target " +
                                    "damages or otherwise harms an \naffected creature, the " +
                                    "affected creature can make a \nWisdom saving throw to end the " +
                                    "effect, as described \nbelow.\nEnding the Effect. If an " +
                                    "affected creature ends its \nturn while not within 60 feet of " +
                                    "the target or able to \nsee it, the creature makes a Wisdom " +
                                    "saving throw. \nOn a successful save, the creature is no " +
                                    ...
                                    "saving throw every 24 hours while the spell \npersists.\nA " +
                                    "creature that successfully saves against this \neffect is " +
                                    "immune to it for 1 minute, after which time \nit can be " +
                                    "affected again. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Arcane Eye",
                         ...
                         description="You create an invisible, magical eye within range \nthat " +
                                    ...
                                    "the eye can pass through an opening \nas small as 1 inch in " +
                                    "diameter. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Arcane Hand",
                         ...
                         description="You create a Large hand of shimmering, translucent \nforce in " +
                                    ...
                                    "the hand using your game statistics. On a hit, the \ntarget " +
                                    "takes 4d8 force damage.\nForceful Hand. The hand attempts to " +
                                    "push a \ncreature within 5 feet of it in a direction you " +
                                    ...
                                    "equal to 2d6 + your spellcasting ability " +
                                    "\nmodifier.\nInterposing Hand. The hand interposes itself " +
                                    "\nbetween you and a creature you choose until you \ngive the " +
                                    "hand a different command. The hand moves \nto stay between you " +
                                    "and the target, providing you \nwith half cover against the " +
                                    "target. The target can't \nmove through the hand's space if " +
                                    "its Strength score \nis less than or equal to the hand's " +
                                    "Strength score. If \nits Strength score is higher than the " +
                                    "hand's Strength \nscore, the target can move toward you " +
                                    "through the \nhand's space, but that space is difficult " +
                                    "terrain for the \ntarget. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 6th level or " +
                                          "higher, the damage from the \nclenched fist option increases " +
                                          "by 2d8 and the \ndamage from the grasping hand increases by " +
    ...
    def __init__(self):
        super().__init__(name="Arcane Lock",
                         ...
                         description="You touch a closed door, window, gate, chest, or \nother " +
                                    ...
                                    "the creatures you designate when \nyou cast this spell can " +
                                    "open the object normally. You \ncan also set a password that, " +
                                    "when spoken within 5 \nfeet of the object, suppresses this " +
                                    "spell for 1 minute. \nOtherwise, it is impassable until it is " +
                                    "broken or the \nspell is dispelled or suppressed. Casting " +
                                    "knock on the \nobject suppresses arcane lock for 10 " +
    ...
    def __init__(self):
        super().__init__(name="Arcanist's Magic Aura",
                         ...
                         description="You place an illusion on a creature or an object you \ntouch " +
                                    "so that divination spells reveal false \ninformation about it. " +
                                    "The target can be a willing \ncreature or an object that isn't " +
                                    "being carried or worn \nby another creature.\nWhen you cast " +
                                    "the spell, choose one or both of the \nfollowing effects. The " +
                                    ...
                                    "appears to belong to a specific school \nof magic that you " +
                                    "choose. When you use this effect \non an object, you can make " +
                                    "the false magic apparent \nto any creature that handles the " +
                                    "item.\nMask. You change the way the target appears to \nspells " +
                                    "and magical effects that detect creature types, \nsuch as a " +
                                    "paladin's Divine Sense or the trigger of a \nsymbol spell. You " +
                                    "choose a creature type and other \nspells and magical effects " +
                                    "treat the target as if it \nwere a creature of that type or of " +
                                    "that alignment. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Astral Projection",
                         ...
                         description="You and up to eight willing creatures within range \nproject " +
                                    ...
                                    "and the casting is wasted if you are already \non that plane). " +
                                    "The material body you leave behind \nis unconscious and in a " +
                                    "state of suspended \nanimation; it doesn't need food or air " +
                                    "and doesn't \nage.\nYour astral body resembles your mortal " +
                                    "form in \nalmost every way, replicating your game statistics " +
                                    "\nand possessions. The principal difference is the \naddition " +
                                    "of a silvery cord that extends from between \nyour shoulder " +
                                    "blades and trails behind you, fading to \ninvisibility after 1 " +
                                    "foot. This cord is your tether to \nyour material body. As " +
                                    "long as the tether remains \nintact, you can find your way " +
                                    "home. If the cord is \ncut—something that can happen only when " +
                                    ...
                                    "apply to it have no effect on your physical body, \nnor do " +
                                    "they persist when you return to it.\nThe spell ends for you " +
                                    "and your companions when \nyou use your action to dismiss it. " +
    ...
    def __init__(self):
        super().__init__(name="Augury",
                         ...
                         description="By casting gem-inlaid sticks, rolling dragon bones, \nlaying " +
                                    ...
                                    "receive an omen from an \notherworldly entity about the " +
                                    "results of a specific \ncourse of action that you plan to take " +
                                    ...
                                    "casting of additional spells or the loss or gain \nof a " +
                                    "companion.\nIf you cast the spell two or more times before " +
                                    "\ncompleting your next long rest, there is a cumulative \n25 " +
                                    "percent chance for each casting after the first that \nyou get " +
                                    "a random reading. The GM makes this roll in \nsecret. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Awaken",
                         ...
                         description="After spending the casting time tracing magical \npathways " +
                                    ...
                                    "beast or plant. The target must have \neither no Intelligence " +
                                    "score or an Intelligence of 3 or \nless. The target gains an " +
                                    ...
                                    "harmful to it. When the charmed condition \nends, the awakened " +
                                    "creature chooses whether to \nremain friendly to you, based on " +
    ...
    def __init__(self):
        super().__init__(name="Bane",
                         ...
                         description="Up to three creatures of your choice that you can see \nwithin " +
                                    ...
                                    "saving throw before the spell ends, \nthe target must roll a " +
                                    "d4 and subtract the number \nrolled from the attack roll or " +
                                    "saving throw. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 2nd level or " +
    ...
    def __init__(self):
        super().__init__(name="Banishment",
                         ...
                         description="You attempt to send one creature that you can see \nwithin " +
                                    ...
                                    "incapacitated. \nThe target remains there until the spell " +
    ...
    def __init__(self):
        super().__init__(name="Black Tentacles",
                         ...
                         description="Squirming, ebony tentacles fill a 20-foot square on \nground " +
                                    ...
                                    "until the spell ends. A creature that \nstarts its turn in the " +
                                    "area and is already restrained \nby the tentacles takes 3d6 " +
    ...
    def __init__(self):
        super().__init__(name="Blight",
                         ...
                         description="Necromantic energy washes over a creature of your \nchoice " +
                                    "that you can see within range, draining \nmoisture and " +
                                    "vitality from it. The target must make a \nConstitution saving " +
                                    "throw. The target takes 8d8 \nnecrotic damage on a failed " +
                                    "save, or half as much \ndamage on a successful one. This spell " +
                                    "has no effect \non undead or constructs.\nIf you target a " +
                                    "plant creature or a magical plant, it \nmakes the saving throw " +
                                    "with disadvantage, and the \nspell deals maximum damage to " +
                                    "it.\nIf you target a nonmagical plant that isn't a \ncreature, " +
                                    "such as a tree or shrub, it doesn't make a \nsaving throw; it " +
    ...
    def __init__(self):
        super().__init__(name="Blink",
                         ...
                         description="Roll a d20 at the end of each of your turns for the \nduration " +
                                    ...
                                    "your current plane of existence and \nappear in the Ethereal " +
                                    "Plane (the spell fails and the \ncasting is wasted if you were " +
                                    ...
                                    "60 feet away. You can only affect and be \naffected by other " +
                                    "creatures on the Ethereal Plane. \nCreatures that aren't there " +
                                    "can't perceive you or \ninteract with you, unless they have " +
                                    "the ability to do \nso. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Burning Hands",
                         ...
                         description="As you hold your hands with thumbs touching and \nfingers " +
                                    ...
                                    "fire damage on a failed save, or \nhalf as much damage on a " +
    ...
    def __init__(self):
        super().__init__(name="Call Lightning",
                         ...
                         description="A storm cloud appears in the shape of a cylinder that \nis 10 " +
                                    ...
                                    "can't see a point in the air where the \nstorm cloud could " +
                                    "appear (for example, if you are in \na room that can't " +
                                    "accommodate the cloud).\nWhen you cast the spell, choose a " +
                                    "point you can \nsee within range. A bolt of lightning flashes " +
                                    ...
                                    "turns until the spell ends, you \ncan use your action to call " +
                                    "down lightning in this way \nagain, targeting the same point " +
                                    "or a different one.\nIf you are outdoors in stormy conditions " +
                                    "when you \ncast this spell, the spell gives you control over " +
    ...
    def __init__(self):
        super().__init__(name="Calm Emotions",
                         ...
                         description="You attempt to suppress strong emotions in a group \nof " +
                                    "people. Each humanoid in a 20-foot-radius sphere \ncentered on " +
                                    "a point you choose within range must \nmake a Charisma saving " +
                                    "throw; a creature can \nchoose to fail this saving throw if it " +
                                    "wishes. If a \ncreature fails its saving throw, choose one of " +
                                    "the \nfollowing two effects.\nYou can suppress any effect " +
                                    "causing a target to be \ncharmed or frightened. When this " +
    ...
    def __init__(self):
        super().__init__(name="Chain Lightning",
                         ...
                         description="You create a bolt of lightning that arcs toward a \ntarget of " +
                                    ...
                                    "each of which must be within 30 \nfeet of the first target. A " +
                                    "target can be a creature or \nan object and can be targeted by " +
                                    "only one of the \nbolts.\nA target must make a Dexterity " +
                                    "saving throw. The \ntarget takes 10d8 lightning damage on a " +
    ...
    def __init__(self):
        super().__init__(name="Clairvoyance",
                         ...
                         description="You create an invisible sensor within range in a \nlocation " +
                                    ...
                                    "sense through the \nsensor as if you were in its space. As " +
    ...
    def __init__(self):
        super().__init__(name="Clone",
                         ...
                         description="This spell grows an inert duplicate of a living \ncreature as " +
                                    ...
                                    "soul is free and willing to return. \nThe clone is physically " +
                                    ...
                                    "still exist, \nbecome inert and can't thereafter be restored " +
    ...
    def __init__(self):
        super().__init__(name="Cloudkill",
                         ...
                         description="You create a 20-foot-radius sphere of poisonous, " +
                                    ...
                                    "range. The fog spreads around corners. It \nlasts for the " +
                                    "duration or until strong wind disperses \nthe fog, ending the " +
                                    "spell. Its area is heavily obscured.\nWhen a creature enters " +
                                    "the spell's area for the first \ntime on a turn or starts its " +
                                    "turn there, that creature \nmust make a Constitution saving " +
                                    "throw. The \ncreature takes 5d8 poison damage on a failed " +
                                    "save, \nor half as much damage on a successful one. " +
                                    "\nCreatures are affected even if they hold their breath \nor " +
                                    "don't need to breathe.\nThe fog moves 10 feet away from you at " +
                                    "the start \nof each of your turns, rolling along the surface " +
    ...
    def __init__(self):
        super().__init__(name="Color Spray",
                         ...
                         description="A dazzling array of flashing, colored light springs \nfrom " +
                                    ...
                                    "hit points must be equal to or less than \nthe remaining total " +
    ...
    def __init__(self):
        super().__init__(name="Command",
                         ...
                         description="You speak a one-word command to a creature you \ncan see " +
                                    ...
                                    "throw or follow the command on its \nnext turn. The spell has " +
                                    "no effect if the target is \nundead, if it doesn't understand " +
                                    "your language, or if \nyour command is directly harmful to " +
                                    "it.\nSome typical commands and their effects follow. \nYou " +
                                    "might issue a command other than one \ndescribed here. If you " +
                                    "do so, the GM determines how \nthe target behaves. If the " +
                                    "target can't follow your \ncommand, the spell ends.\nApproach. " +
                                    "The target moves toward you by the \nshortest and most direct " +
                                    "route, ending its turn if it \nmoves within 5 feet of " +
                                    ...
                                    "falls prone and then ends its \nturn.\nHalt. The target " +
                                    "doesn't move and takes no actions. \nA flying creature stays " +
                                    "aloft, provided that it is able \nto do so. If it must move to " +
                                    "stay aloft, it flies the \nminimum distance needed to remain " +
                                    "in the air. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 2nd level or " +
                                          "higher, you can affect one \nadditional creature for each slot " +
                                          "level above 1st. The \ncreatures must be within 30 feet of " +
    ...
    def __init__(self):
        super().__init__(name="Commune",
                         ...
                         description="You contact your deity or a divine proxy and ask up \nto three " +
                                    ...
                                    "ask your questions before the spell \nends. You receive a " +
                                    "correct answer for each question.\nDivine beings aren't " +
                                    "necessarily omniscient, so \nyou might receive “unclear” as an " +
                                    "answer if a \nquestion pertains to information that lies " +
                                    "beyond the \ndeity's knowledge. In a case where a one-word " +
                                    "\nanswer could be misleading or contrary to the \ndeity's " +
                                    "interests, the GM might offer a short phrase \nas an answer " +
                                    "instead.\nIf you cast the spell two or more times before " +
                                    "\nfinishing your next long rest, there is a cumulative \n25 " +
                                    "percent chance for each casting after the first that \nyou get " +
                                    "no answer. The GM makes this roll in secret. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Commune with Nature",
                         ...
                         description="You briefly become one with nature and gain \nknowledge of the " +
                                    ...
                                    "your choice about any of the following subjects as \nthey " +
                                    "relate to the area:\n• terrain and bodies of water\n• " +
                                    "prevalent plants, minerals, animals, or peoples\n• powerful " +
                                    "celestials, fey, fiends, elementals, or \nundead\n• influence " +
                                    "from other planes of existence\n• buildings\nFor example, you " +
                                    "could determine the location of \npowerful undead in the area, " +
                                    "the location of major \nsources of safe drinking water, and " +
                                    "the location of \nany nearby towns. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Confusion",
                         ...
                         description="This spell assaults and twists creatures' minds, \nspawning " +
                                    ...
                                    "doesn't take an action this turn.\n2–6 The creature doesn't " +
                                    "move or take actions this \nturn.\n7–8 The creature uses its " +
                         ...
                         at_higher_levels="When you cast this spell using a \nspell slot of 5th level or " +
                                          "higher, the radius of the \nsphere increases by 5 feet for " +
    ...
    def __init__(self):
        super().__init__(name="Conjure Animals",
                         ...
                         description="You summon fey spirits that take the form of beasts \nand " +
                                    ...
                                    "summoned creatures are friendly to you and \nyour companions. " +
                                    "Roll initiative for the summoned \ncreatures as a group, which " +
                                    "has its own turns. They \nobey any verbal commands that you " +
    ...
    def __init__(self):
        super().__init__(name="Conjure Celestial",
                         ...
                         description="You summon a celestial of challenge rating 4 or \nlower, which " +
                                    ...
                                    "range. The celestial disappears \nwhen it drops to 0 hit " +
    ...
    def __init__(self):
        super().__init__(name="Conjure Elemental",
                         ...
                         description="You call forth an elemental servant. Choose an area of \nair, " +
                                    ...
                                    "range. An elemental of challenge rating 5 or \nlower " +
                                    "appropriate to the area you chose appears in \nan unoccupied " +
                                    "space within 10 feet of it. For\nexample, a fire elemental " +
                                    "emerges from a bonfire, \nand an earth elemental rises up from " +
                                    "the ground. \nThe elemental disappears when it drops to 0 hit " +
                                    "\npoints or when the spell ends.\nThe elemental is friendly to " +
                                    "you and your \ncompanions for the duration. Roll initiative " +
                                    ...
                                    "it defends itself from hostile \ncreatures but otherwise takes " +
                                    ...
                                    "can't be dismissed by you, and it \ndisappears 1 hour after " +
    ...
    def __init__(self):
        super().__init__(name="Conjure Fey",
                         ...
                         description="You summon a fey creature of challenge rating 6 or \nlower, or " +
                                    ...
                                    "you can see within range. The \nfey creature disappears when " +
                                    "it drops to 0 hit points \nor when the spell ends.\nThe fey " +
                                    "creature is friendly to you and your \ncompanions for the " +
                                    "duration. Roll initiative for the \ncreature, which has its " +
                                    "own turns. It obeys any \nverbal commands that you issue to it " +
                                    ...
                                    "control of the \nfey creature, it becomes hostile toward you " +
                                    "and your \ncompanions, and it might attack. An uncontrolled " +
...
class Contagion(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Contagion",
                         ...
                         material_components_list=None,
                         duration="7 days",
                         description="Your touch inflicts disease. Make a melee spell attack " +
                                    ...
                                    "milky white. The creature has \ndisadvantage on Wisdom checks " +
                                    "and Wisdom saving \nthrows and is blinded.\nFilth Fever. A " +
                                    "raging fever sweeps through the \ncreature's body. The " +
                                    ...
                                    "creature has disadvantage on Intelligence \nchecks and " +
                                    "Intelligence saving throws, and the \ncreature behaves as if " +
                                    ...
                                    "creature takes damage, it \nis stunned until the end of its " +
                                    "next turn. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Continual Flame",
                         ...
                         description="A flame, equivalent in brightness to a torch, springs \nforth " +
                                    ...
                                    "oxygen. A continual flame can be covered \nor hidden but not " +
    ...
    def __init__(self):
        super().__init__(name="Control Water",
                         ...
                         description="Until the spell ends, you control any freestanding \nwater " +
                                    ...
                                    "to rise by as much as 20 feet. If the \narea includes a shore, " +
                                    "the flooding water spills over \nonto dry land.\nIf you choose " +
                                    "an area in a large body of water, you \ninstead create a " +
                                    "20-foot tall wave that travels from \none side of the area to " +
                                    "the other and then crashes \ndown. Any Huge or smaller " +
                                    "vehicles in the wave's \npath are carried with it to the other " +
                                    ...
                                    "spell's area, and the separated water forms a \nwall to either " +
                                    "side. The trench remains until the spell \nends or you choose " +
                                    "a different effect. The water then \nslowly fills in the " +
                                    "trench over the course of the next \nround until the normal " +
                                    ...
                                    "the area. The \nwhirlpool forms a vortex that is 5 feet wide " +
                                    ...
                                    "can swim away from the vortex by making a \nStrength " +
                                    "(Athletics) check against your spell save DC.\nWhen a creature " +
                                    "enters the vortex for the first \ntime on a turn or starts its " +
                                    "turn there, it must make a \nStrength saving throw. On a " +
                                    "failed save, the creature \ntakes 2d8 bludgeoning damage and " +
                                    "is caught in the \nvortex until the spell ends. On a " +
                                    "successful save, the \ncreature takes half damage, and isn't " +
                                    "caught in the \nvortex. A creature caught in the vortex can " +
    ...
    def __init__(self):
        super().__init__(name="Control Weather",
                         ...
                         description="You take control of the weather within 5 miles of you \nfor " +
                                    "the duration. You must be outdoors to cast this \nspell. " +
                                    "Moving to a place where you don't have a clear \npath to the " +
                                    "sky ends the spell early.\nWhen you cast the spell, you change " +
                                    ...
                                    "so, you can change the conditions again. \nWhen the spell " +
                                    "ends, the weather gradually returns \nto normal.\nWhen you " +
                                    "change the weather conditions, find a \ncurrent condition on " +
                                    "the following tables and change \nits stage by one, up or " +
    ...
    def __init__(self):
        super().__init__(name="Create Food and Water",
                         ...
                         description="You create 45 pounds of food and 30 gallons of \nwater on the " +
                                    "ground or in containers within range, \nenough to sustain up " +
                                    "to fifteen humanoids or five \nsteeds for 24 hours. The food " +
                                    "is bland but nourishing, \nand spoils if uneaten after 24 " +
...
class CreateOrDestroyWater(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Create or Destroy Water",
                         ...
                         at_higher_levels="When you cast this spell using a \nspell slot of 2nd level or " +
                                          "higher, you create or \ndestroy 10 additional gallons of " +
                                          "water, or the size of \nthe cube increases by 5 feet, for each " +
                                          "slot level above \n1st. ")
    ...
    def __init__(self):
        super().__init__(name="Creation",
                         ...
                         description="You pull wisps of shadow material from the \nShadowfell to " +
                                    ...
                                    "the object's material. If \nthe object is composed of multiple " +
                                    "materials, use the \nshortest duration.\nMaterial " +
                                    "\nDuration\nVegetable matter 1 day\nStone or crystal 12 " +
                                    "hours\nPrecious metals 1 hour\nGems 10 minutes\nAdamantine or " +
                                    "mithral 1 minute\nUsing any material created by this spell as " +
                                    "another \nspell's material component causes that spell to " +
                                    "fail. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 6th level or " +
    ...
    def __init__(self):
        super().__init__(name="Dancing Lights",
                         ...
                         description="You create up to four torch-sized lights within range, " +
                                    ...
                                    "that hover in the air for the duration. You can \nalso combine " +
                                    "the four lights into one glowing \nvaguely humanoid form of " +
                                    "Medium size. Whichever \nform you choose, each light sheds dim " +
                                    "light in a 10-\nfoot radius.\nAs a bonus action on your turn, " +
                                    "you can move the \nlights up to 60 feet to a new spot within " +
                                    "range. A \nlight must be within 20 feet of another light " +
                                    "created \nby this spell, and a light winks out if it exceeds " +
                                    "the \nspell's range. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Darkness",
                         ...
                         description="Magical darkness spreads from a point you choose \nwithin " +
                                    "range to fill a 15-foot-radius sphere for the \nduration. The " +
                                    ...
                                    "opaque object, such as a bowl or a helm, \nblocks the " +
    ...
    def __init__(self):
        super().__init__(name="Daylight",
                         ...
                         description="A 60-foot-radius sphere of light spreads out from a \npoint " +
                                    "you choose within range. The sphere is bright \nlight and " +
                                    "sheds dim light for an additional 60 feet.\nIf you chose a " +
                                    "point on an object you are holding \nor one that isn't being " +
                                    "worn or carried, the light \nshines from the object and moves " +
                                    "with it. Completely \ncovering the affected object with an " +
                                    "opaque object, \nsuch as a bowl or a helm, blocks the " +
    ...
    def __init__(self):
        super().__init__(name="Demiplane",
                         ...
                         description="You create a shadowy door on a flat solid surface \nthat you " +
                                    ...
                                    "Medium creatures to pass through \nunhindered. When opened, " +
                                    "the door leads to a \ndemiplane that appears to be an empty " +
                                    ...
                                    "previous casting of \nthis spell. Additionally, if you know " +
                                    "the nature and \ncontents of a demiplane created by a casting " +
    ...
    def __init__(self):
        super().__init__(name="Detect Evil and Good",
                         ...
                         description="For the duration, you know if there is an aberration, " +
                                    ...
                                    "you know if there is a place or object \nwithin 30 feet of you " +
                                    "that has been magically \nconsecrated or desecrated.\nThe " +
                                    "spell can penetrate most barriers, but it is \nblocked by 1 " +
                                    "foot of stone, 1 inch of common metal, a \nthin sheet of lead, " +
    ...
    def __init__(self):
        super().__init__(name="Detect Magic",
                         ...
                         description="For the duration, you sense the presence of magic \nwithin 30 " +
                                    ...
                                    "your action to see a faint aura around \nany visible creature " +
                                    "or object in the area that bears \nmagic, and you learn its " +
                                    "school of magic, if any.\nThe spell can penetrate most " +
                                    "barriers, but it is \nblocked by 1 foot of stone, 1 inch of " +
    ...
    def __init__(self):
        super().__init__(name="Detect Thoughts",
                         ...
                         description="For the duration, you can read the thoughts of \ncertain " +
                                    ...
                                    "each turn until the spell ends, you can \nfocus your mind on " +
                                    "any one creature that you can \nsee within 30 feet of you. If " +
                                    "the creature you choose \nhas an Intelligence of 3 or lower or " +
                                    ...
                                    "either shift your attention to \nanother creature's thoughts " +
                                    "or attempt to probe \ndeeper into the same creature's mind. If " +
                                    ...
                                    "hates). If it succeeds, the spell ends. Either \nway, the " +
                                    "target knows that you are probing into its \nmind, and unless " +
                                    "you shift your attention to another \ncreature's thoughts, the " +
                                    "creature can use its action\non its turn to make an " +
                                    "Intelligence check contested \nby your Intelligence check; if " +
                                    "it succeeds, the spell \nends.\nQuestions verbally directed at " +
                                    "the target creature \nnaturally shape the course of its " +
                                    ...
                                    "search for thoughts within 30 feet of you. The \nspell can " +
                                    ...
                                    "above, even if you can't see it, \nbut it must still be within " +
                                    "range. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Dimension Door",
                         ...
                         description="You teleport yourself from your current location to \nany " +
                                    "other spot within range. You arrive at exactly \nthe spot " +
                                    "desired. It can be a place you can see, one \nyou can " +
                                    "visualize, or one you can describe by stating \ndistance and " +
                                    "direction, such as “200 feet straight \ndownward” or “upward " +
                                    "to the northwest at a 45-\ndegree angle, 300 feet.”\nYou can " +
                                    "bring along objects as long as their weight \ndoesn't exceed " +
                                    "what you can carry. You can also \nbring one willing creature " +
                                    "of your size or smaller \nwho is carrying gear up to its " +
                                    "carrying capacity. The \ncreature must be within 5 feet of you " +
                                    "when you cast \nthis spell.\nIf you would arrive in a place " +
                                    "already occupied by \nan object or a creature, you and any " +
    ...
    def __init__(self):
        super().__init__(name="Disguise Self",
                         ...
                         description="You make yourself—including your clothing, armor, \nweapons, " +
                                    ...
                                    "changes wrought by this spell fail to hold up \nto physical " +
                                    "inspection. For example, if you use this \nspell to add a hat " +
                                    "to your outfit, objects pass through \nthe hat, and anyone who " +
                                    "touches it would feel \nnothing or would feel your head and " +
                                    ...
                                    "that you are disguised, a creature can \nuse its action to " +
                                    "inspect your appearance and must \nsucceed on an Intelligence " +
    ...
    def __init__(self):
        super().__init__(name="Disintegrate",
                         ...
                         description="A thin green ray springs from your pointing finger to \na " +
                                    ...
                                    "pile of fine gray dust. The creature can \nbe restored to life " +
                                    "only by means of a true \nresurrection or a wish spell.\nThis " +
                                    "spell automatically disintegrates a Large or \nsmaller " +
                                    "nonmagical object or a creation of magical \nforce. If the " +
                                    "target is a Huge or larger object or \ncreation of force, this " +
                                    "spell disintegrates a 10-footcube portion of it. A magic item " +
                                    "is unaffected by this \nspell. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 7th level or " +
                                          "higher, the damage increases \nby 3d6 for each slot level " +
                                          "above 6th. ")
    ...
    def __init__(self):
        super().__init__(name="Dispel Evil and Good",
                         ...
                         description="Shimmering energy surrounds and protects you \nfrom fey, " +
                                    ...
                                    "frightened, \nor possessed by a celestial, an elemental, a " +
                                    ...
                                    "the creature back to its home plane. The \ncreature must " +
                                    "succeed on a Charisma saving throw \nor be sent back to its " +
                                    "home plane (if it isn't there \nalready). If they aren't on " +
    ...
    def __init__(self):
        super().__init__(name="Divine Word",
                         ...
                         description="You utter a divine word, imbued with the power that \nshaped " +
                                    ...
                                    "of origin (if it isn't there already) \nand can't return to " +
                                    "your current plane for 24 hours \nby any means short of a wish " +
                                    "spell. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Dominate Beast",
                         ...
                         description="You attempt to beguile a beast that you can see \nwithin " +
                                    ...
                                    "charmed by you for the duration. If you \nor creatures that " +
                                    "are friendly to you are fighting it, it \nhas advantage on the " +
                                    ...
                                    "action required), which it does its best \nto obey. You can " +
    ...
    def __init__(self):
        super().__init__(name="Dominate Monster",
                         ...
                         description="You attempt to beguile a creature that you can see \nwithin " +
                                    ...
                                    "link to issue commands to the creature \nwhile you are " +
                                    "conscious (no action required), which \nit does its best to " +
                                    "obey. You can specify a simple and \ngeneral course of action, " +
                                    "such as “Attack that \ncreature,” “Run over there,” or “Fetch " +
                                    "that object.” If \nthe creature completes the order and " +
                                    ...
                                    "creature to \nuse a reaction, but this requires you to use " +
                                    "your own \nreaction as well.\nEach time the target takes " +
                                    "damage, it makes a new \nWisdom saving throw against the " +
                                    "spell. If the saving \nthrow succeeds, the spell ends. ",
    ...
    def __init__(self):
        super().__init__(name="Dream",
                         ...
                         description="This spell shapes a creature's dreams. Choose a \ncreature " +
                                    ...
                                    "creating landscapes, \nobjects, and other images. The " +
                                    "messenger can \nemerge from the trance at any time, ending the " +
                                    "effect \nof the spell early. The target recalls the dream " +
                                    "\nperfectly upon waking. If the target is awake when \nyou " +
                                    "cast the spell, the messenger knows it, and can \neither end " +
                                    "the trance (and the spell) or wait for the \ntarget to fall " +
                                    "asleep, at which point the messenger \nappears in the target's " +
                                    "dreams.\nYou can make the messenger appear monstrous \nand " +
                                    "terrifying to the target. If you do, the messenger \ncan " +
                                    "deliver a message of no more than ten words \nand then the " +
                                    "target must make a Wisdom saving \nthrow. On a failed save, " +
                                    "echoes of the phantasmal \nmonstrosity spawn a nightmare that " +
                                    ...
                                    "you have a body part, lock of hair, clipping from \na nail, or " +
                                    "similar portion of the target's body, the \ntarget makes its " +
    ...
    def __init__(self):
        super().__init__(name="Druidcraft",
                         ...
                         description="Whispering to the spirits of nature, you create one of \nthe " +
                                    ...
                                    "sensory effect that \npredicts what the weather will be at " +
                                    "your location \nfor the next 24 hours. The effect might " +
    ...
    def __init__(self):
        super().__init__(name="Earthquake",
                         ...
                         description="You create a seismic disturbance at a point on the \nground " +
                                    ...
                                    "centered on that point \nand shakes creatures and structures " +
                                    "in contact with \nthe ground in that area.\nThe ground in the " +
                                    "area becomes difficult terrain. \nEach creature on the ground " +
                                    "that is concentrating \nmust make a Constitution saving throw. " +
                                    "On a failed \nsave, the creature's concentration is " +
                                    "broken.\nWhen you cast this spell and at the end of each " +
                                    "\nturn you spend concentrating on it, each creature on \nthe " +
                                    "ground in the area must make a Dexterity saving \nthrow. On a " +
                                    "failed save, the creature is knocked \nprone.\nThis spell can " +
                                    "have additional effects depending \non the terrain in the " +
                                    "area, as determined by the GM.\nFissures. Fissures open " +
                                    "throughout the spell's \narea at the start of your next turn " +
                                    "after you cast the \nspell. A total of 1d6 such fissures open " +
                                    ...
                                    "where a fissure opens must succeed on a \nDexterity saving " +
                                    "throw or fall in. A creature that \nsuccessfully saves moves " +
                                    "with the fissure's edge as it \nopens.\nA fissure that opens " +
                                    "beneath a structure causes it \nto automatically collapse (see " +
    ...
    def __init__(self):
        super().__init__(name="Enhance Ability",
                         ...
                         description="You touch a creature and bestow upon it a magical " +
                                    ...
                                    "It also gains 2d6 temporary hit \npoints, which are lost when " +
    ...
    def __init__(self):
        super().__init__(name="Enlarge/Reduce",
                         ...
                         description="You cause a creature or an object you can see within \nrange " +
                                    "to grow larger or smaller for the duration. \nChoose either a " +
                                    ...
                                    "Until the spell ends, the target \nalso has advantage on " +
                                    "Strength checks and Strength \nsaving throws. The target's " +
                                    "weapons also grow to \nmatch its new size. While these weapons " +
                                    ...
                                    "normal. This reduction decreases its size by one " +
                                    "\ncategory—from Medium to Small, for example. Until \nthe " +
                                    "spell ends, the target also has disadvantage on \nStrength " +
                                    "checks and Strength saving throws. The \ntarget's weapons also " +
                                    "shrink to match its new size. \nWhile these weapons are " +
                                    "reduced, the target's \nattacks with them deal 1d4 less damage " +
    ...
    def __init__(self):
        super().__init__(name="Entangle",
                         ...
                         description="Grasping weeds and vines sprout from the ground in \na 20-foot " +
                                    ...
                                    "by the entangling plants until the spell \nends. A creature " +
                                    "restrained by the plants can use its \naction to make a " +
                                    "Strength check against your spell \nsave DC. On a success, it " +
    ...
    def __init__(self):
        super().__init__(name="Enthrall",
                         ...
                         description="You weave a distracting string of words, causing \ncreatures " +
                                    "of your choice that you can see within \nrange and that can " +
                                    "hear you to make a Wisdom \nsaving throw. Any creature that " +
                                    "can't be charmed \nsucceeds on this saving throw " +
                                    "automatically, and if \nyou or your companions are fighting a " +
                                    "creature, it \nhas advantage on the save. On a failed save, " +
                                    "the \ntarget has disadvantage on Wisdom (Perception) \nchecks " +
                                    "made to perceive any creature other than you \nuntil the spell " +
                                    "ends or until the target can no longer \nhear you. The spell " +
                                    "ends if you are incapacitated or \ncan no longer speak. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Etherealness",
                         ...
                         description="You step into the border regions of the Ethereal \nPlane, in " +
                                    ...
                                    "can move in any \ndirection. If you move up or down, every " +
                                    "foot of \nmovement costs an extra foot. You can see and hear " +
                                    "\nthe plane you originated from, but everything there \nlooks " +
                                    "gray, and you can't see anything more than 60 \nfeet " +
                                    "away.\nWhile on the Ethereal Plane, you can only affect \nand " +
                                    "be affected by other creatures on that plane. \nCreatures that " +
                                    "aren't on the Ethereal Plane can't \nperceive you and can't " +
                                    "interact with you, unless a \nspecial ability or magic has " +
                                    "given them the ability to \ndo so.\nYou ignore all objects and " +
                                    "effects that aren't on the \nEthereal Plane, allowing you to " +
                                    ...
                                    "and take force damage \nequal to twice the number of feet you " +
    ...
    def __init__(self):
        super().__init__(name="Expeditious Retreat",
                         ...
                         description="This spell allows you to move at an incredible pace. \nWhen " +
                                    "you cast this spell, and then as a bonus action \non each of " +
                                    "your turns until the spell ends, you can \ntake the Dash " +
                                    "action. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Fabricate",
                         ...
                         description="You convert raw materials into products of the same " +
                                    ...
                                    "from a clump of trees, a rope from a patch of \nhemp, and " +
                                    "clothes from flax or wool.\nChoose raw materials that you can " +
                                    ...
                                    "larger than Medium (contained \nwithin a single 5-foot cube). " +
                                    "The quality of objects \nmade by the spell is commensurate " +
                                    "with the quality \nof the raw materials.\nCreatures or magic " +
                                    "items can't be created or \ntransmuted by this spell. You also " +
                                    "can't use it to \ncreate items that ordinarily require a high " +
    ...
    def __init__(self):
        super().__init__(name="Faithful Hound",
                         ...
                         description="You conjure a phantom watchdog in an unoccupied \nspace that " +
                                    ...
                                    "spell, the hound starts barking loudly. The \nhound sees " +
    ...
    def __init__(self):
        super().__init__(name="Fear",
                         ...
                         description="You project a phantasmal image of a creature's \nworst fears. " +
                                    ...
                                    "spell, a creature must \ntake the Dash action and move away " +
                                    ...
                                    "you, the creature can make a Wisdom saving \nthrow. On a " +
    ...
    def __init__(self):
        super().__init__(name="Feeblemind",
                         ...
                         description="You blast the mind of a creature that you can see \nwithin " +
                                    ...
                                    "Intelligence and \nCharisma scores become 1. The creature " +
                                    "can't cast \nspells, activate magic items, understand " +
                                    "language, or \ncommunicate in any intelligible way. The " +
                                    "creature \ncan, however, identify its friends, follow them, " +
                                    "and \neven protect them.\nAt the end of every 30 days, the " +
                                    "creature can \nrepeat its saving throw against this spell. If " +
                                    "it \nsucceeds on its saving throw, the spell ends.\nThe spell " +
                                    "can also be ended by greater restoration,\nheal, or wish. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Find Familiar",
                         ...
                         description="You gain the service of a familiar, a spirit that takes \nan " +
                                    ...
                                    "commands. In combat, it rolls its \nown initiative and acts on " +
                                    "its own turn. A familiar \ncan't attack, but it can take other " +
                                    ...
                                    "familiar is within 100 feet of you, you \ncan communicate with " +
                                    "it telepathically. Additionally, \nas an action, you can see " +
                                    "through your familiar's \neyes and hear what it hears until " +
                                    "the start of your \nnext turn, gaining the benefits of any " +
                                    "special senses \nthat the familiar has. During this time, you " +
                                    "are deaf \nand blind with regard to your own senses.\nAs an " +
                                    "action, you can temporarily dismiss your \nfamiliar. It " +
                                    "disappears into a pocket dimension \nwhere it awaits your " +
                                    "summons. Alternatively, you \ncan dismiss it forever. As an " +
                                    "action while it is \ntemporarily dismissed, you can cause it " +
                                    "to reappear \nin any unoccupied space within 30 feet of " +
                                    "you.\nYou can't have more than one familiar at a time. If " +
                                    "\nyou cast this spell while you already have a familiar, \nyou " +
                                    "instead cause it to adopt a new form. Choose one \nof the " +
                                    ...
                                    "cast the \nspell. Your familiar must be within 100 feet of " +
    ...
    def __init__(self):
        super().__init__(name="Find Steed",
                         ...
                         description="You summon a spirit that assumes the form of an \nunusually " +
                                    ...
                                    "long-lasting bond with it. Appearing in an \nunoccupied space " +
                                    "within range, the steed takes on a \nform that you choose: a " +
                                    "warhorse, a pony, a camel, \nan elk, or a mastiff. (Your GM " +
                                    "might allow other \nanimals to be summoned as steeds.) The " +
                                    ...
                                    "it gains the ability to understand one language of \nyour " +
                                    "choice that you speak.\nYour steed serves you as a mount, both " +
                                    "in combat \nand out, and you have an instinctive bond with it " +
                                    "\nthat allows you to fight as a seamless unit. While \nmounted " +
                                    "on your steed, you can make any spell you \ncast that targets " +
                                    "only you also target your steed.\nWhen the steed drops to 0 " +
                                    "hit points, it disappears, \nleaving behind no physical form. " +
                                    "You can also \ndismiss your steed at any time as an action, " +
    ...
    def __init__(self):
        super().__init__(name="Find Traps",
                         ...
                         description="You sense the presence of any trap within range that \nis " +
                                    ...
                                    "specifically intended as such \nby its creator. Thus, the " +
                                    "spell would sense an area \naffected by the alarm spell, a " +
                                    "glyph of warding, or a \nmechanical pit trap, but it would not " +
                                    "reveal a natural \nweakness in the floor, an unstable ceiling, " +
                                    "or a \nhidden sinkhole.\nThis spell merely reveals that a trap " +
                                    "is present. \nYou don't learn the location of each trap, but " +
    ...
    def __init__(self):
        super().__init__(name="Find the Path",
                         ...
                         description="This spell allows you to find the shortest, most direct " +
                                    ...
                                    "familiar with on the same plane of existence. If \nyou name a " +
                                    "destination on another plane of \nexistence, a destination " +
                                    "that moves (such as a mobile \nfortress), or a destination " +
                                    "that isn't specific (such as \n“a green dragon's lair”), the " +
                                    "spell fails.\nFor the duration, as long as you are on the same " +
                                    "\nplane of existence as the destination, you know how \nfar it " +
                                    "is and in what direction it lies. While you are \ntraveling " +
                                    "there, whenever you are presented with a \nchoice of paths " +
                                    "along the way, you automatically \ndetermine which path is the " +
                                    "shortest and most direct \nroute (but not necessarily the " +
                                    "safest route) to the \ndestination. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Finger of Death",
                         ...
                         description="You send negative energy coursing through a \ncreature that " +
                                    "you can see within range, causing it \nsearing pain. The " +
                                    "target must make a Constitution \nsaving throw. It takes 7d8 + " +
                                    "30 necrotic damage on a \nfailed save, or half as much damage " +
                                    "on a successful \none.\nA humanoid killed by this spell rises " +
    ...
    def __init__(self):
        super().__init__(name="Fire Bolt",
                         ...
                         description="You hurl a mote of fire at a creature or object within " +
                                    ...
                                    "hit, the target takes 1d10 fire damage. A \nflammable object " +
    ...
    def __init__(self):
        super().__init__(name="Fire Shield",
                         ...
                         description="Thin and wispy flames wreathe your body for the \nduration, " +
                                    ...
                                    "a creature within 5 feet of \nyou hits you with a melee " +
                                    "attack, the shield erupts\nwith flame. The attacker takes 2d8 " +
                                    "fire damage from \na warm shield, or 2d8 cold damage from a " +
                                    "cold \nshield. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Fire Storm",
                         ...
                         description="A storm made up of sheets of roaring flame appears \nin a " +
                                    ...
                                    "as you wish. Each cube must have at \nleast one face adjacent " +
                                    "to the face of another cube. \nEach creature in the area must " +
                                    "make a Dexterity \nsaving throw. It takes 7d10 fire damage on " +
                                    "a failed \nsave, or half as much damage on a successful " +
                                    "one.\nThe fire damages objects in the area and ignites " +
                                    "\nflammable objects that aren't being worn or carried. \nIf " +
                                    "you choose, plant life in the area is unaffected by \nthis " +
                                    "spell. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Fireball",
                         ...
                         description="A bright streak flashes from your pointing finger to a \npoint " +
                                    ...
                                    "Dexterity saving throw. A target \ntakes 8d6 fire damage on a " +
                                    "failed save, or half as \nmuch damage on a successful " +
                                    "one.\nThe fire spreads around corners. It ignites \nflammable " +
                                    "objects in the area that aren't being worn \nor carried. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 4th level or " +
    ...
    def __init__(self):
        super().__init__(name="Flame Blade",
                         ...
                         description="You evoke a fiery blade in your free hand. The blade \nis " +
                                    ...
                                    "the duration. If you let go of the blade, it \ndisappears, but " +
                                    "you can evoke the blade again as a \nbonus action.\nYou can " +
                                    "use your action to make a melee spell \nattack with the fiery " +
                                    "blade. On a hit, the target takes \n3d6 fire damage.\nThe " +
                                    "flaming blade sheds bright light in a 10-foot \nradius and dim " +
                                    "light for an additional 10 feet. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 4th level or " +
                                          "higher, the damage increases \nby 1d6 for every two slot " +
                                          "levels above 2nd. ")
    ...
    def __init__(self):
        super().__init__(name="Flame Strike",
                         ...
                         description="A vertical column of divine fire roars down from the \nheavens " +
                                    ...
                                    "takes 4d6 fire damage and 4d6 \nradiant damage on a failed " +
    ...
    def __init__(self):
        super().__init__(name="Flaming Sphere",
                         ...
                         description="A 5-foot-diameter sphere of fire appears in an \nunoccupied " +
                                    ...
                                    "duration. Any creature that ends its turn \nwithin 5 feet of " +
                                    "the sphere must make a Dexterity \nsaving throw. The creature " +
                                    "takes 2d6 fire damage on \na failed save, or half as much " +
                                    "damage on a successful \none.\nAs a bonus action, you can move " +
                                    "the sphere up to \n30 feet. If you ram the sphere into a " +
    ...
    def __init__(self):
        super().__init__(name="Floating Disk",
                         ...
                         description="This spell creates a circular, horizontal plane of force, \n3 " +
                                    ...
                                    "can see within range. The disk \nremains for the duration, and " +
                                    ...
                                    "It can move across uneven terrain, up or down \nstairs, slopes " +
                                    "and the like, but it can't cross an \nelevation change of 10 " +
                                    "feet or more. For example, the \ndisk can't move across a " +
                                    "10-foot-deep pit, nor could \nit leave such a pit if it was " +
                                    "created at the bottom.\nIf you move more than 100 feet from " +
    ...
    def __init__(self):
        super().__init__(name="Fly",
                         ...
                         description="You touch a willing creature. The target gains a \nflying " +
                                    "speed of 60 feet for the duration. When the \nspell ends, the " +
                                    "target falls if it is still aloft, unless it \ncan stop the " +
                                    "fall. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 4th level or " +
                                          "higher, you can target one \nadditional creature for each slot " +
                                          "level above 3rd. ")
    ...
    def __init__(self):
        super().__init__(name="Fog Cloud",
                         ...
                         description="You create a 20-foot-radius sphere of fog centered \non a " +
                                    "point within range. The sphere spreads around \ncorners, and " +
                                    "its area is heavily obscured. It lasts for \nthe duration or " +
                                    "until a wind of moderate or greater \nspeed (at least 10 miles " +
    ...
    def __init__(self):
        super().__init__(name="Forbiddance",
                         ...
                         description="You create a ward against magical travel that \nprotects up to " +
                                    ...
                                    "following: celestials, elementals, fey, \nfiends, and undead. " +
                                    "When a chosen creature enters \nthe spell's area for the first " +
                                    "time on a turn or starts \nits turn there, the creature takes " +
    ...
    def __init__(self):
        super().__init__(name="Forcecage",
                         ...
                         description="An immobile, invisible, cube-shaped prison \ncomposed of " +
                                    ...
                                    "spell, any creature that is \ncompletely inside the cage's " +
                                    "area is trapped. \nCreatures only partially within the area, " +
                                    "or those too \nlarge to fit inside the area, are pushed away " +
                                    ...
                                    "must first make a Charisma saving throw. On a \nsuccess, the " +
                                    "creature can use that magic to exit the \ncage. On a failure, " +
                                    "the creature can't exit the cage and \nwastes the use of the " +
                                    "spell or effect. The cage also \nextends into the Ethereal " +
                                    "Plane, blocking ethereal \ntravel.\nThis spell can't be " +
    ...
    def __init__(self):
        super().__init__(name="Freezing Sphere",
                         ...
                         description="A frigid globe of cold energy streaks from your \nfingertips " +
                                    "to a point of your choice within range, \nwhere it explodes in " +
                                    "a 60-foot-radius sphere. Each \ncreature within the area must " +
                                    ...
                                    "water-based \ncreatures), it freezes the liquid to a depth of " +
                                    ...
                                    "save DC to break \nfree.\nYou can refrain from firing the " +
                                    ...
                                    "on impact, with the same effect as \nthe normal casting of the " +
                                    "spell. You can also set the \nglobe down without shattering " +
                                    "it. After 1 minute, if \nthe globe hasn't already shattered, " +
                                    "it explodes. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 7th level or " +
                                          "higher, the damage increases \nby 1d6 for each slot level " +
                                          "above 6th. ")
    ...
    def __init__(self):
        super().__init__(name="Gaseous Form",
                         ...
                         description="You transform a willing creature you touch, along \nwith " +
                                    ...
                                    "it treats liquids as though they \nwere solid surfaces. The " +
                                    "target can't fall and remains \nhovering in the air even when " +
                                    "stunned or otherwise \nincapacitated.\nWhile in the form of a " +
                                    "misty cloud, the target can't \ntalk or manipulate objects, " +
                                    "and any objects it was \ncarrying or holding can't be dropped, " +
    ...
    def __init__(self):
        super().__init__(name="Gate",
                         ...
                         description="You conjure a portal linking an unoccupied space \nyou can see " +
                                    ...
                                    "only by moving through its front. Anything \nthat does so is " +
                                    "instantly transported to the other \nplane, appearing in the " +
                                    "unoccupied space nearest to \nthe portal.\nDeities and other " +
                                    "planar rulers can prevent portals \ncreated by this spell from " +
                                    "opening in their presence \nor anywhere within their " +
                                    "domains.\nWhen you cast this spell, you can speak the name " +
                                    "\nof a specific creature (a pseudonym, title, or \nnickname " +
                                    "doesn't work). If that creature is on a \nplane other than the " +
                                    "one you are on, the portal opens \nin the named creature's " +
                                    "immediate vicinity and \ndraws the creature through it to the " +
                                    "nearest \nunoccupied space on your side of the portal. You " +
    ...
    def __init__(self):
        super().__init__(name="Geas",
                         ...
                         description="You place a magical command on a creature that you \ncan see " +
                                    ...
                                    "refrain from some action or course of \nactivity as you " +
                                    "decide. If the creature can understand \nyou, it must succeed " +
                                    "on a Wisdom saving throw or \nbecome charmed by you for the " +
                                    "duration. While the \ncreature is charmed by you, it takes " +
                                    "5d10 psychic \ndamage each time it acts in a manner directly " +
                                    "\ncounter to your instructions, but no more than once \neach " +
                                    "day. A creature that can't understand you is \nunaffected by " +
                                    ...
                                    "spell early by using an action to \ndismiss it. A remove " +
                                    "curse, greater restoration, or \nwish spell also ends it. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 7th or 8th " +
                                          "level, the duration is 1 year. \nWhen you cast this spell " +
                                          "using a spell slot of 9th level, \nthe spell lasts until it is " +
                                          "ended by one of the spells \nmentioned above. ")
    ...
    def __init__(self):
        super().__init__(name="Gentle Repose",
                         ...
                         description="You touch a corpse or other remains. For the \nduration, the " +
                                    ...
                                    "of this spell don't count against \nthe time limit of spells " +
                                    "such as raise dead. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Giant Insect",
                         ...
                         description="You transform up to ten centipedes, three spiders, \nfive " +
                                    ...
                                    "an action to dismiss the effect on it.\nThe GM might allow you " +
                                    "to choose different \ntargets. For example, if you transform a " +
                                    "bee, its giant \nversion might have the same statistics as a " +
                                    "giant \nwasp. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Glibness",
                         ...
                         description="Until the spell ends, when you make a Charisma \ncheck, you " +
                                    "can replace the number you roll with a 15. \nAdditionally, no " +
    ...
    def __init__(self):
        super().__init__(name="Glyph of Warding",
                         ...
                         description="When you cast this spell, you inscribe a glyph that \nharms " +
                                    ...
                                    "weight), creature kind (for example, the ward \ncould be set " +
                                    "to affect aberrations or drow), or \nalignment. You can also " +
                                    "set conditions for creatures \nthat don't trigger the glyph, " +
                                    "such as those who say a \ncertain password.\nWhen you inscribe " +
                                    "the glyph, choose explosive \nrunes or a spell " +
                                    "glyph.\nExplosive Runes. When triggered, the glyph \nerupts " +
                                    "with magical energy in a 20-foot-radius \nsphere centered on " +
                                    "the glyph. The sphere spreads \naround corners. Each creature " +
                                    "in the area must \nmake a Dexterity saving throw. A creature " +
                                    "takes 5d8 \nacid, cold, fire, lightning, or thunder damage on " +
                                    "a \nfailed saving throw (your choice when you create \nthe " +
                                    "glyph), or half as much damage on a successful \none.\nSpell " +
                                    "Glyph. You can store a prepared spell of 3rd \nlevel or lower " +
                                    "in the glyph by casting it as part of \ncreating the glyph. " +
                                    "The spell must target a single \ncreature or an area. The " +
                                    "spell being stored has no \nimmediate effect when cast in this " +
                                    "way. When the \nglyph is triggered, the stored spell is cast. " +
                                    "If the spell \nhas a target, it targets the creature that " +
                                    "triggered the \nglyph. If the spell affects an area, the area " +
                                    "is centered \non that creature. If the spell summons hostile " +
                                    "\ncreatures or creates harmful objects or traps, they \nappear " +
                                    "as close as possible to the intruder and attack \nit. If the " +
                                    "spell requires concentration, it lasts until the \nend of its " +
                                    "full duration. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 4th level or " +
                                          "higher, the damage of an \nexplosive runes glyph increases by " +
                                          "1d8 for each slot \nlevel above 3rd. If you create a spell " +
                                          "glyph, you can \nstore any spell of up to the same level as " +
    ...
    def __init__(self):
        super().__init__(name="Greater Restoration",
                         ...
                         description="You imbue a creature you touch with positive energy \nto undo " +
                                    "a debilitating effect. You can reduce the \ntarget's " +
                                    "exhaustion level by one, or end one of the \nfollowing effects " +
    ...
    def __init__(self):
        super().__init__(name="Guardian of Faith",
                         ...
                         description="A Large spectral guardian appears and hovers for \nthe " +
                                    "duration in an unoccupied space of your choice \nthat you can " +
                                    "see within range. The guardian occupies \nthat space and is " +
                                    "indistinct except for a gleaming \nsword and shield emblazoned " +
                                    "with the symbol of \nyour deity.\nAny creature hostile to you " +
                                    "that moves to a space \nwithin 10 feet of the guardian for the " +
                                    "first time on a \nturn must succeed on a Dexterity saving " +
                                    "throw. The \ncreature takes 20 radiant damage on a failed " +
    ...
    def __init__(self):
        super().__init__(name="Guards and Wards",
                         ...
                         description="You create a ward that protects up to 2,500 square \nfeet of " +
                                    ...
                                    "be up to 20 feet tall, \nand shaped as you desire. You can " +
                                    ...
                                    "spell, you can specify \nindividuals that are unaffected by " +
                                    "any or all of the \neffects that you choose. You can also " +
                                    "specify a \npassword that, when spoken aloud, makes the " +
                                    "\nspeaker immune to these effects.\nGuards and wards creates " +
                                    "the following effects \nwithin the warded area.\nCorridors. " +
                                    "Fog fills all the warded corridors, \nmaking them heavily " +
                                    "obscured. In addition, at each \nintersection or branching " +
                                    "passage offering a choice \nof direction, there is a 50 " +
                                    ...
                                    "you can cover up to ten doors with an \nillusion (equivalent " +
                                    "to the illusory object function of \nthe minor illusion spell) " +
                                    "to make them appear as \nplain sections of wall.\nStairs. Webs " +
                                    "fill all stairs in the warded area from \ntop to bottom, as " +
                                    "the web spell. These strands \nregrow in 10 minutes if they " +
                                    "are burned or torn \naway while guards and wards lasts.\nOther " +
                                    "Spell Effect. You can place your choice of \none of the " +
                                    "following magical effects within the \nwarded area of the " +
                                    "stronghold.\n• Place dancing lights in four corridors. You can " +
                                    "\ndesignate a simple program that the lights repeat \nas long " +
                                    "as guards and wards lasts.\n• Place magic mouth in two " +
                                    ...
                                    "wards lasts.\n• Place a constant gust of wind in one corridor " +
    ...
    def __init__(self):
        super().__init__(name="Gust of Wind",
                         ...
                         description="A line of strong wind 60 feet long and 10 feet wide \nblasts " +
                                    ...
                                    "each of your turns before the \nspell ends, you can change the " +
    ...
    def __init__(self):
        super().__init__(name="Hallow",
                         ...
                         description="You touch a point and infuse an area around it with \nholy (or " +
                                    ...
                                    "you used to cast this spell can't extinguish the " +
                                    ...
                                    "Affected creatures in the \narea have vulnerability to one " +
                                    "damage type of your \nchoice, except for bludgeoning, " +
                                    "piercing, or slashing.\nEverlasting Rest. Dead bodies interred " +
    ...
    def __init__(self):
        super().__init__(name="Harm",
                         ...
                         description="You unleash a virulent disease on a creature that you \ncan " +
                                    "see within range. The target must make a \nConstitution saving " +
                                    ...
                                    "the saving throw, \nits hit point maximum is reduced for 1 " +
    ...
    def __init__(self):
        super().__init__(name="Haste",
                         ...
                         description="Choose a willing creature that you can see within \nrange. " +
                                    ...
                                    "gains a +2 bonus to AC, it has advantage \non Dexterity saving " +
    ...
    def __init__(self):
        super().__init__(name="Hellish Rebuke",
                         ...
                         description="You point your finger, and the creature that \ndamaged you is " +
                                    ...
                                    "make a Dexterity saving \nthrow. It takes 2d10 fire damage on " +
    ...
    def __init__(self):
        super().__init__(name="Heroes' Feast",
                         ...
                         description="You bring forth a great feast, including magnificent \nfood " +
                                    "and drink. The feast takes 1 hour to consume\nand disappears " +
                                    "at the end of that time, and the \nbeneficial effects don't " +
                                    "set in until this hour is over. \nUp to twelve other creatures " +
                                    "can partake of the feast.\nA creature that partakes of the " +
                                    "feast gains several \nbenefits. The creature is cured of all " +
                                    "diseases and \npoison, becomes immune to poison and being " +
                                    "\nfrightened, and makes all Wisdom saving throws \nwith " +
                                    "advantage. Its hit point maximum also \nincreases by 2d10, and " +
                                    "it gains the same number of \nhit points. These benefits last " +
                                    "for 24 hours. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Hideous Laughter",
                         ...
                         description="A creature of your choice that you can see within \nrange " +
                                    ...
                                    "fits of laughter if this spell affects it. The \ntarget must " +
    ...
    def __init__(self):
        super().__init__(name="Hold Monster",
                         ...
                         description="Choose a creature that you can see within range. The \ntarget " +
                                    ...
                                    "the duration. This spell has no effect \non undead. At the end " +
                                    "of each of its turns, the target \ncan make another Wisdom " +
    ...
    def __init__(self):
        super().__init__(name="Hold Person",
                         ...
                         description="Choose a humanoid that you can see within range. \nThe target " +
                                    ...
                                    "the duration. At the end of each \nof its turns, the target " +
                                    "can make another Wisdom \nsaving throw. On a success, the " +
                                    "spell ends on the \ntarget. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 3rd level or " +
                                          "higher, you can target one \nadditional humanoid for each slot " +
                                          "level above 2nd. \nThe humanoids must be within 30 feet of " +
    ...
    def __init__(self):
        super().__init__(name="Holy Aura",
                         ...
                         description="Divine light washes out from you and coalesces in a \nsoft " +
                                    ...
                                    "choice in that radius when you \ncast this spell shed dim " +
                                    "light in a 5-foot radius and \nhave advantage on all saving " +
                                    "throws, and other \ncreatures have disadvantage on attack " +
    ...
    def __init__(self):
        super().__init__(name="Hunter's Mark",
                         ...
                         description="You choose a creature you can see within range and " +
                                    ...
                                    "you deal an extra 1d6 damage to the target \nwhenever you hit " +
                                    "it with a weapon attack, and you \nhave advantage on any " +
                                    "Wisdom (Perception) or \nWisdom (Survival) check you make to " +
                                    "find it. If the \ntarget drops to 0 hit points before this " +
    ...
    def __init__(self):
        super().__init__(name="Hypnotic Pattern",
                         ...
                         description="You create a twisting pattern of colors that weaves \nthrough " +
                                    ...
                                    "\nand has a speed of 0.\nThe spell ends for an affected " +
                                    "creature if it takes \nany damage or if someone else uses an " +
    ...
    def __init__(self):
        super().__init__(name="Ice Storm",
                         ...
                         description="A hail of rock-hard ice pounds to the ground in a " +
                                    ...
                                    "damage on a \nsuccessful one.\nHailstones turn the storm's " +
                                    "area of effect into \ndifficult terrain until the end of your " +
                                    "next turn. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 5th level or " +
    ...
    def __init__(self):
        super().__init__(name="Illusory Script",
                         ...
                         description="You write on parchment, paper, or some other \nsuitable " +
                                    "writing material and imbue it with a potent \nillusion that " +
                                    "lasts for the duration.\nTo you and any creatures you " +
                                    "designate when you \ncast the spell, the writing appears " +
                                    "normal, written in \nyour hand, and conveys whatever meaning " +
                                    "you \nintended when you wrote the text. To all others, the " +
                                    "\nwriting appears as if it were written in an unknown \nor " +
                                    "magical script that is unintelligible. Alternatively, \nyou " +
                                    "can cause the writing to appear to be an entirely \ndifferent " +
                                    "message, written in a different hand and \nlanguage, though " +
                                    "the language must be one you \nknow.\nShould the spell be " +
                                    "dispelled, the original script \nand the illusion both " +
    ...
    def __init__(self):
        super().__init__(name="Imprisonment",
                         ...
                         description="You create a magical restraint to hold a creature that \nyou " +
                                    ...
                                    "target is entombed far beneath the \nearth in a sphere of " +
                                    "magical force that is just large \nenough to contain the " +
                                    "target. Nothing can pass \nthrough the sphere, nor can any " +
                                    "creature teleport or \nuse planar travel to get into or out of " +
                                    ...
                                    "a tiny demiplane that is warded against \nteleportation and " +
                                    ...
                                    "of 1 inch and is imprisoned inside a gemstone \nor similar " +
                                    "object. Light can pass through the \ngemstone normally " +
                                    "(allowing the target to see out \nand other creatures to see " +
                                    "in), but nothing else can \npass through, even by means of " +
                                    "teleportation or \nplanar travel. The gemstone can't be cut or " +
                                    "broken \nwhile the spell remains in effect.\nThe special " +
                                    "component for this version of the spell \nis a large, " +
                                    "transparent gemstone, such as a corundum, \ndiamond, or " +
                                    "ruby.\nSlumber. The target falls asleep and can't be \nawoken. " +
                                    "The special component for this version of \nthe spell consists " +
                                    "of rare soporific herbs.\nEnding the Spell. During the casting " +
                                    "of the spell, in \nany of its versions, you can specify a " +
                                    "condition that \nwill cause the spell to end and release the " +
                                    ...
                                    "particular special component to \ncreate only one prison at a " +
                                    "time. If you cast the spell \nagain using the same component, " +
                                    "the target of the \nfirst casting is immediately freed from " +
                                    "its binding. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Incendiary Cloud",
                         ...
                         description="A swirling cloud of smoke shot through with whitehot embers " +
                                    ...
                                    "within range. The cloud spreads \naround corners and is " +
                                    "heavily obscured. It lasts for \nthe duration or until a wind " +
    ...
    def __init__(self):
        super().__init__(name="Insect Plague",
                         ...
                         description="Swarming, biting locusts fill a 20-foot-radius sphere " +
                                    ...
                                    "spreads around corners. The sphere remains \nfor the duration, " +
                                    "and its area is lightly obscured. The \nsphere's area is " +
                                    "difficult terrain.\nWhen the area appears, each creature in it " +
                                    "must \nmake a Constitution saving throw. A creature takes " +
                                    "\n4d10 piercing damage on a failed save, or half as \nmuch " +
                                    "damage on a successful one. A creature must \nalso make this " +
                                    "saving throw when it enters the \nspell's area for the first " +
                                    "time on a turn or ends its \nturn there. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 6th level or " +
                                          "higher, the damage increases \nby 1d10 for each slot level " +
                                          "above 5th. ")
    ...
    def __init__(self):
        super().__init__(name="Irresistible Dance",
                         ...
                         description="Choose one creature that you can see within range. \nThe " +
                                    ...
                                    "feet, and capering for the duration. \nCreatures that can't be " +
                                    ...
                                    "action, a dancing creature makes a Wisdom \nsaving throw to " +
                                    "regain control of itself. On a \nsuccessful save, the spell " +
                                    "ends. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Knock",
                         ...
                         description="Choose an object that you can see within range. The \nobject " +
                                    ...
                                    "with arcane \nlock, that spell is suppressed for 10 minutes, " +
    ...
    def __init__(self):
        super().__init__(name="Legend Lore",
                         ...
                         description="Name or describe a person, place, or object. The spell " +
                                    ...
                                    "lore about the thing you named. The lore \nmight consist of " +
                                    "current tales, forgotten stories, or \neven secret lore that " +
                                    "has never been widely known. \nIf the thing you named isn't of " +
                                    "legendary importance, \nyou gain no information. The more " +
                                    "information you \nalready have about the thing, the more " +
                                    "precise and \ndetailed the information you receive is.\nThe " +
                                    "information you learn is accurate but might be \ncouched in " +
                                    "figurative language. For example, if you \nhave a mysterious " +
                                    "magic axe on hand, the spell \nmight yield this information: " +
                                    "“Woe to the evildoer \nwhose hand touches the axe, for even " +
                                    "the haft slices \nthe hand of the evil ones. Only a true Child " +
    ...
    def __init__(self):
        super().__init__(name="Levitate",
                         ...
                         description="One creature or object of your choice that you can \nsee " +
                                    ...
                                    "suspended there for the duration. The spell \ncan levitate a " +
                                    "target that weighs up to 500 pounds. \nAn unwilling creature " +
                                    "that succeeds on a \nConstitution saving throw is " +
                                    "unaffected.\nThe target can move only by pushing or pulling " +
                                    "\nagainst a fixed object or surface within reach (such \nas a " +
                                    "wall or a ceiling), which allows it to move as if it \nwere " +
                                    "climbing. You can change the target's altitude \nby up to 20 " +
                                    "feet in either direction on your turn. If \nyou are the " +
                                    "target, you can move up or down as part \nof your move. " +
                                    "Otherwise, you can use your action to \nmove the target, which " +
                                    "must remain within the \nspell's range.\nWhen the spell ends, " +
                                    "the target floats gently to the \nground if it is still aloft. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Lightning Bolt",
                         ...
                         description="A stroke of lightning forming a line 100 feet long and \n5 " +
                                    "feet wide blasts out from you in a direction you \nchoose. " +
                                    "Each creature in the line must make a \nDexterity saving " +
    ...
    def __init__(self):
        super().__init__(name="Locate Animals or Plants",
                         ...
                         description="Describe or name a specific kind of beast or plant. " +
                                    ...
                                    "you learn the direction and distance \nto the closest creature " +
                                    "or plant of that kind within 5 \nmiles, if any are present. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Locate Creature",
                         ...
                         description="Describe or name a creature that is familiar to you. \nYou " +
                                    ...
                                    "spell can locate a specific creature known to \nyou, or the " +
                                    "nearest creature of a specific kind (such \nas a human or a " +
                                    "unicorn), so long as you have seen \nsuch a creature up " +
                                    "close—within 30 feet—at least \nonce. If the creature you " +
                                    "described or named is in a \ndifferent form, such as being " +
                                    "under the effects of a \npolymorph spell, this spell doesn't " +
                                    "locate the creature.\nThis spell can't locate a creature if " +
    ...
    def __init__(self):
        super().__init__(name="Locate Object",
                         ...
                         description="Describe or name an object that is familiar to you. \nYou " +
                                    "sense the direction to the object's location, as \nlong as " +
                                    "that object is within 1,000 feet of you. If the \nobject is in " +
    ...
    def __init__(self):
        super().__init__(name="Magic Circle",
                         ...
                         description="You create a 10-foot-radius, 20-foot-tall cylinder of " +
                                    ...
                                    "cylinder intersects with the floor or \nother surface.\nChoose " +
                                    ...
                                    "elect to cause its \nmagic to operate in the reverse " +
                                    "direction, preventing \na creature of the specified type from " +
    ...
    def __init__(self):
        super().__init__(name="Magic Jar",
                         ...
                         description="Your body falls into a catatonic state as your soul \nleaves " +
                                    "it and enters the container you used for the \nspell's " +
                                    "material component. While your soul inhabits \nthe container, " +
                                    "you are aware of your surroundings as \nif you were in the " +
                                    "container's space. You can't move \nor use reactions. The only " +
                                    "action you can take is to \nproject your soul up to 100 feet " +
                                    "out of the container, \neither returning to your living body " +
                                    "(and ending the \nspell) or attempting to possess a humanoids " +
                                    "body.\nYou can attempt to possess any humanoid within \n100 " +
                                    "feet of you that you can see (creatures warded \nby a " +
                                    "protection from evil and good or magic circle\nspell can't be " +
                                    "possessed). The target must make a \nCharisma saving throw. On " +
                                    "a failure, your soul \nmoves into the target's body, and the " +
                                    "target's soul \nbecomes trapped in the container. On a " +
                                    "success, the \ntarget resists your efforts to possess it, and " +
                                    "you can't \nattempt to possess it again for 24 hours.\nOnce " +
                                    "you possess a creature's body, you control it. \nYour game " +
                                    ...
                                    "is in the container \nwhen it is destroyed, the creature's " +
    ...
    def __init__(self):
        super().__init__(name="Magic Missile",
                         ...
                         description="You create three glowing darts of magical force. Each \ndart " +
                                    ...
                                    "range. A dart deals 1d4 + 1 force damage to \nits target. The " +
    ...
    def __init__(self):
        super().__init__(name="Magic Mouth",
                         ...
                         description="You implant a message within an object in range, a \nmessage " +
                                    ...
                                    "by another creature. Then \nspeak the message, which must be " +
                                    ...
                                    "message, or it can remain and \nrepeat its message whenever " +
                                    "the trigger occurs.\nThe triggering circumstance can be as " +
                                    ...
                                    "to speak when any creature moves within 30 \nfeet of the " +
                                    "object or when a silver bell rings within \n30 feet of it. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Magnificent Mansion",
                         ...
                         description="You conjure an extradimensional dwelling in range \nthat lasts " +
                                    ...
                                    "and 10 feet tall. You and any \ncreature you designate when " +
                                    "you cast the spell can \nenter the extradimensional dwelling " +
                                    ...
                                    "like, but the \nspace can't exceed 50 cubes, each cube being " +
                                    ...
                                    "They are completely obedient to \nyour orders. Each servant " +
                                    "can perform any task a \nnormal human servant could perform, " +
    ...
    def __init__(self):
        super().__init__(name="Major Image",
                         ...
                         description="You create the image of an object, a creature, or \nsome other " +
                                    ...
                                    "The image appears at a spot that \nyou can see within range " +
                                    "and lasts for the duration. \nIt seems completely real, " +
                                    "including sounds, smells, \nand temperature appropriate to the " +
                                    "thing depicted. \nYou can't create sufficient heat or cold to " +
                                    "cause \ndamage, a sound loud enough to deal thunder \ndamage " +
                                    "or deafen a creature, or a smell that might \nsicken a " +
                                    "creature (like a troglodyte's stench).\nAs long as you are " +
                                    "within range of the illusion, you \ncan use your action to " +
                                    "cause the image to move to \nany other spot within range. As " +
                                    "the image changes \nlocation, you can alter its appearance so " +
                                    ...
                                    "Similarly, you can cause the illusion to \nmake different " +
                                    "sounds at different times, even \nmaking it carry on a " +
                                    "conversation, for example.\nPhysical interaction with the " +
                                    "image reveals it to be \nan illusion, because things can pass " +
                                    ...
                                    "creature can see through the image, and its \nother sensory " +
    ...
    def __init__(self):
        super().__init__(name="Mass Heal",
                         ...
                         description="A flood of healing energy flows from you into injured " +
                                    ...
                                    "can see within range. Creatures \nhealed by this spell are " +
                                    "also cured of all diseases and \nany effect making them " +
                                    "blinded or deafened. This \nspell has no effect on undead or " +
                                    "constructs. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Mass Healing Word",
                         ...
                         description="As you call out words of restoration, up to six \ncreatures of " +
                                    ...
                                    "equal to 1d4 + your \nspellcasting ability modifier. This " +
                                    "spell has no effect \non undead or constructs. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 4th level or " +
                                          "higher, the healing increases \nby 1d4 for each slot level " +
                                          "above 3rd. ")
    ...
    def __init__(self):
        super().__init__(name="Mass Suggestion",
                         ...
                         description="You suggest a course of activity (limited to a \nsentence or " +
                                    ...
                                    "Asking the creature to stab itself, throw \nitself onto a " +
                                    "spear, immolate itself, or do some other \nobviously harmful " +
                                    "act automatically negates the \neffect of the spell.\nEach " +
                                    "target must make a Wisdom saving throw. \nOn a failed save, it " +
                                    "pursues the course of action you \ndescribed to the best of " +
                                    "its ability. The suggested \ncourse of action can continue for " +
                                    "the entire duration. \nIf the suggested activity can be " +
                                    ...
                                    "duration. For example, \nyou might suggest that a group of " +
                                    "soldiers give all \ntheir money to the first beggar they meet. " +
                         ...
                         at_higher_levels="When you cast this spell using a \n7th-level spell slot, the " +
                                          ...
                                          "the duration is 30 \ndays. When you use a 9th-level spell " +
    ...
    def __init__(self):
        super().__init__(name="Meld into Stone",
                         ...
                         description="You step into a stone object or surface large enough \nto " +
                                    "fully contain your body, melding yourself and all \nthe " +
                                    "equipment you carry with the stone for the \nduration. Using " +
                                    "your movement, you step into the \nstone at a point you can " +
                                    "touch. Nothing of your \npresence remains visible or otherwise " +
                                    "detectable by \nnonmagical senses.\nWhile merged with the " +
                                    "stone, you can't see what \noccurs outside it, and any Wisdom " +
                                    ...
                                    "you entered it, which ends the spell. \nYou otherwise can't " +
                                    ...
                                    "deals 6d6 bludgeoning damage to \nyou. The stone's complete " +
    ...
    def __init__(self):
        super().__init__(name="Message",
                         ...
                         description="You point your finger toward a creature within \nrange and " +
                                    ...
                                    "the message and can reply in a \nwhisper that only you can " +
    ...
    def __init__(self):
        super().__init__(name="Meteor Swarm",
                         ...
                         description="Blazing orbs of fire plummet to the ground at four \ndifferent " +
                                    ...
                                    "objects in the area and ignites \nflammable objects that " +
    ...
    def __init__(self):
        super().__init__(name="Minor Illusion",
                         ...
                         description="You create a sound or an image of an object within \nrange " +
                                    "that lasts for the duration. The illusion also \nends if you " +
                                    "dismiss it as an action or cast this spell \nagain.\nIf you " +
                                    "create a sound, its volume can range from a \nwhisper to a " +
                                    "scream. It can be your voice, someone \nelse's voice, a lion's " +
                                    "roar, a beating of drums, or any \nother sound you choose. The " +
    ...
    def __init__(self):
        super().__init__(name="Mirage Arcane",
                         ...
                         description="You make terrain in an area up to 1 mile square look, \nsound, " +
                                    ...
                                    "so it can turn clear ground into \ndifficult terrain (or vice " +
                                    ...
                                    "aware of the illusion's presence, the \ncreature can still " +
    ...
    def __init__(self):
        super().__init__(name="Mirror Image",
                         ...
                         description="Three illusory duplicates of yourself appear in your \nspace. " +
                                    ...
                                    "AC equals 10 + your Dexterity \nmodifier. If an attack hits a " +
                                    "duplicate, the duplicate is \ndestroyed. A duplicate can be " +
                                    "destroyed only by an \nattack that hits it. It ignores all " +
                                    "other damage and \neffects. The spell ends when all three " +
                                    "duplicates are \ndestroyed.\nA creature is unaffected by this " +
                                    "spell if it can't see, \nif it relies on senses other than " +
                                    "sight, such as \nblindsight, or if it can perceive illusions " +
                                    "as false, as \nwith truesight. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Mislead",
                         ...
                         description="You become invisible at the same time that an \nillusory " +
                                    "double of you appears where you are \nstanding. The double " +
                                    "lasts for the duration, but the \ninvisibility ends if you " +
                                    ...
                                    "through its eyes and hear through its \nears as if you were " +
                                    "located where it is. On each of \nyour turns as a bonus " +
    ...
    def __init__(self):
        super().__init__(name="Modify Memory",
                         ...
                         description="You attempt to reshape another creature's memories. \nOne " +
                                    ...
                                    "If you are fighting the creature, it has \nadvantage on the " +
                                    "saving throw. On a failed save, the \ntarget becomes charmed " +
                                    "by you for the duration. \nThe charmed target is incapacitated " +
                                    "and unaware of \nits surroundings, though it can still hear " +
                                    ...
                                    "hours and that lasted no more than 10 \nminutes. You can " +
                                    "permanently eliminate all memory \nof the event, allow the " +
                                    "target to recall the event with \nperfect clarity and exacting " +
                                    "detail, change its \nmemory of the details of the event, or " +
                                    "create a \nmemory of some other event.\nYou must speak to the " +
                                    "target to describe how its \nmemories are affected, and it " +
                                    "must be able to \nunderstand your language for the modified " +
                                    "\nmemories to take root. Its mind fills in any gaps in \nthe " +
                                    "details of your description. If the spell ends \nbefore you " +
                                    "have finished describing the modified \nmemories, the " +
                                    "creature's memory isn't altered. \nOtherwise, the modified " +
                                    "memories take hold when \nthe spell ends.\nA modified memory " +
                                    "doesn't necessarily affect how \na creature behaves, " +
                                    "particularly if the memory \ncontradicts the creature's " +
                                    "natural inclinations, \nalignment, or beliefs. An illogical " +
    ...
    def __init__(self):
        super().__init__(name="Moonbeam",
                         ...
                         description="A silvery beam of pale light shines down in a 5-footradius, " +
                                    ...
                                    "Until the spell ends, dim light fills the \ncylinder.\nWhen a " +
                                    "creature enters the spell's area for the first \ntime on a " +
                                    "turn or starts its turn there, it is engulfed \nin ghostly " +
                                    "flames that cause searing pain, and it must \nmake a " +
                                    "Constitution saving throw. It takes 2d10 \nradiant damage on a " +
                                    "failed save, or half as much \ndamage on a successful one.\nA " +
                                    "shapechanger makes its saving throw with \ndisadvantage. If it " +
                                    "fails, it also instantly reverts to its \noriginal form and " +
                                    "can't assume a different form until \nit leaves the spell's " +
    ...
    def __init__(self):
        super().__init__(name="Move Earth",
                         ...
                         description="Choose an area of terrain no larger than 40 feet on a \nside " +
                                    ...
                                    "area in any manner you choose for the \nduration. You can " +
                                    "raise or lower the area's elevation, \ncreate or fill in a " +
                                    "trench, erect or flatten a wall, or\nform a pillar. The extent " +
                                    "of any such changes can't \nexceed half the area's largest " +
                                    "dimension. So, if you \naffect a 40-foot square, you can " +
                                    "create a pillar up to \n20 feet high, raise or lower the " +
                                    "square's elevation by \nup to 20 feet, dig a trench up to 20 " +
                                    "feet deep, and so \non. It takes 10 minutes for these changes " +
                                    ...
                                    "can't manipulate natural stone or stone \nconstruction. Rocks " +
                                    "and structures shift to \naccommodate the new terrain. If the " +
                                    "way you shape \nthe terrain would make a structure unstable, " +
    ...
    def __init__(self):
        super().__init__(name="Phantom Steed",
                         ...
                         description="A Large quasi-real, horselike creature appears on the \nground " +
                                    ...
                                    "creature you choose can \nride the steed. The creature uses " +
                                    "the statistics for a \nriding horse, except it has a speed of " +
                                    "100 feet and \ncan travel 10 miles in an hour, or 13 miles at " +
                                    "a fast \npace. When the spell ends, the steed gradually fades, " +
                                    "\ngiving the rider 1 minute to dismount. The spell ends \nif " +
                                    "you use an action to dismiss it or if the steed takes \nany " +
                                    "damage. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Planar Ally",
                         ...
                         description="You beseech an otherworldly entity for aid. The \nbeing must " +
                                    "be known to you: a god, a primordial, a \ndemon prince, or " +
                                    "some other being of cosmic power. \nThat entity sends a " +
                                    "celestial, an elemental, or a fiend \nloyal to it to aid you, " +
                                    "making the creature appear in \nan unoccupied space within " +
                                    "range. If you know a \nspecific creature's name, you can speak " +
                                    ...
                                    "range from simple (fly us across the \nchasm, or help us fight " +
                                    "a battle) to complex (spy on \nour enemies, or protect us " +
                                    "during our foray into the \ndungeon). You must be able to " +
                                    "communicate with \nthe creature to bargain for its " +
                                    "services.\nPayment can take a variety of forms. A celestial " +
                                    "\nmight require a sizable donation of gold or magic \nitems to " +
                                    "an allied temple, while a fiend might \ndemand a living " +
                                    "sacrifice or a gift of treasure. Some \ncreatures might " +
                                    "exchange their service for a quest \nundertaken by you.\nAs a " +
                                    "rule of thumb, a task that can be measured in \nminutes " +
                                    "requires a payment worth 100 gp per \nminute. A task measured " +
                                    "in hours requires 1,000 gp \nper hour. And a task measured in " +
                                    "days (up to 10 \ndays) requires 10,000 gp per day. The GM can " +
                                    "adjust \nthese payments based on the circumstances under " +
                                    "\nwhich you cast the spell. If the task is aligned with\nthe " +
                                    "creature's ethos, the payment might be halved or \neven " +
                                    "waived. Nonhazardous tasks typically require \nonly half the " +
                                    "suggested payment, while especially \ndangerous tasks might " +
                                    "require a greater gift. \nCreatures rarely accept tasks that " +
                                    ...
                                    "to agree on a price for the \ncreature's service, the creature " +
                                    "immediately returns \nto its home plane.\nA creature enlisted " +
                                    "to join your group counts as a \nmember of it, receiving a " +
                                    "full share of experience \npoints awarded. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Planar Binding",
                         ...
                         description="With this spell, you attempt to bind a celestial, an " +
                                    ...
                                    "must be within range for the entire casting \nof the spell. " +
                                    "(Typically, the creature is first \nsummoned into the center " +
                                    "of an inverted magic \ncircle in order to keep it trapped " +
                                    "while this spell is \ncast.) At the completion of the casting, " +
                                    ...
                                    "strives to twist your \nwords to achieve its own objectives. " +
                                    "If the creature \ncarries out your instructions completely " +
                                    "before the \nspell ends, it travels to you to report this fact " +
    ...
    def __init__(self):
        super().__init__(name="Plane Shift",
                         ...
                         description="You and up to eight willing creatures who link hands \nin a " +
                                    ...
                                    "You can specify a target destination in \ngeneral terms, such " +
                                    "as the City of Brass on the \nElemental Plane of Fire or the " +
                                    "palace of Dispater on \nthe second level of the Nine Hells, " +
                                    "and you appear in \nor near that destination. If you are " +
                                    "trying to reach \nthe City of Brass, for example, you might " +
                                    "arrive in its \nStreet of Steel, before its Gate of Ashes, or " +
...
class Polymorph(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Polymorph",
                         ...
                         duration="1 hour",
                         description="This spell transforms a creature that you can see within " +
                                    "\nrange into a new form. An unwilling creature must \nmake a " +
                                    "Wisdom saving throw to avoid the effect. The \nspell has no " +
                                    "effect on a shapechanger or a creature \nwith 0 hit " +
                                    "points.\nThe transformation lasts for the duration, or until " +
                                    "\nthe target drops to 0 hit points or dies. The new form \ncan " +
                                    "be any beast whose challenge rating is equal to \nor less than " +
                                    "the target's (or the target's level, if it \ndoesn't have a " +
                                    ...
                                    "melds into the new form. The \ncreature can't activate, use, " +
    ...
    def __init__(self):
        super().__init__(name="Prestidigitation",
                         ...
                         description="This spell is a minor magical trick that novice \nspellcasters " +
                                    ...
                                    "make a color, a small mark, or a symbol \nappear on an object " +
                                    "or a surface for 1 hour.\n• You create a nonmagical trinket or " +
    ...
    def __init__(self):
        super().__init__(name="Prismatic Spray",
                         ...
                         description="Eight multicolored rays of light flash from your hand. \nEach " +
                                    ...
                                    "damage on a successful \none.\n2. Orange. The target takes " +
                                    "10d6 acid damage on \na failed save, or half as much damage on " +
                                    "a successful \none.\n3. Yellow. The target takes 10d6 " +
                                    ...
                                    "of each of its turns. If it successfully saves three \ntimes, " +
                                    ...
                                    "to be consecutive; keep track of both until the \ntarget " +
                                    "collects three of a kind.\n7. Violet. On a failed save, the " +
                                    "target is blinded. It \nmust then make a Wisdom saving throw " +
                                    ...
                                    "that is on a plane that isn't its home plane is \nbanished " +
                                    "home, while other creatures are usually \ncast into the Astral " +
                                    "or Ethereal planes.)\n8. Special. The target is struck by two " +
    ...
    def __init__(self):
        super().__init__(name="Prismatic Wall",
                         ...
                         description="A shimmering, multicolored plane of light forms a \nvertical " +
                                    ...
                                    "range. The wall remains in \nplace for the duration. If you " +
                                    "position the wall so that \nit passes through a space occupied " +
                                    "by a creature, the \nspell fails, and your action and the " +
                                    "spell slot are \nwasted.\nThe wall sheds bright light out to a " +
                                    ...
                                    "within 20 feet of it or starts its turn there, \nthe creature " +
                                    ...
                                    "time through all the wall's layers. As it passes or \nreaches " +
                                    "through each layer, the creature must make \na Dexterity " +
                                    "saving throw or be affected by that \nlayer's properties as " +
                                    "described below.\nThe wall can be destroyed, also one layer at " +
                                    "a time, \nin order from red to violet, by means specific to " +
                                    ...
                                    "\nfailed save, or half as much damage on a successful \none. " +
                                    "While this layer is in place, nonmagical ranged \nattacks " +
                                    "can't pass through the wall. The layer can be \ndestroyed by " +
                                    "dealing at least 25 cold damage to it.\n2. Orange. The " +
                                    "creature takes 10d6 acid damage \non a failed save, or half as " +
                                    "much damage on a \nsuccessful one. While this layer is in " +
                                    "place, magical \nranged attacks can't pass through the wall. " +
                                    ...
                                    "be destroyed by dealing at least \n25 fire damage to it.\n6. " +
                                    "Indigo. On a failed save, the creature is \nrestrained. It " +
                                    "must then make a Constitution saving \nthrow at the end of " +
                                    "each of its turns. If it successfully \nsaves three times, the " +
                                    "spell ends. If it fails its save \nthree times, it permanently " +
                                    "turns to stone and is \nsubjected to the petrified condition. " +
                                    ...
                                    "shed by a daylight spell or a similar spell of \nequal or " +
    ...
    def __init__(self):
        super().__init__(name="Private Sanctum",
                         ...
                         description="You make an area within range magically secure. \nThe area is " +
                                    "a cube that can be as small as 5 feet to as \nlarge as 100 " +
                                    "feet on each side. The spell lasts for the \nduration or until " +
                                    "you use an action to dismiss it.\nWhen you cast the spell, you " +
                                    "decide what sort of \nsecurity the spell provides, choosing " +
                                    "any or all of the \nfollowing properties:\n• Sound can't pass " +
                                    "through the barrier at the edge of \nthe warded area.\n• The " +
                                    "barrier of the warded area appears dark and \nfoggy, " +
                                    "preventing vision (including darkvision) \nthrough it.\n• " +
                                    "Sensors created by divination spells can't appear \ninside the " +
                                    "protected area or pass through the \nbarrier at its " +
                                    "perimeter.\n• Creatures in the area can't be targeted by " +
                                    "\ndivination spells.\n• Nothing can teleport into or out of " +
                                    "the warded \narea.\n• Planar travel is blocked within the " +
                                    "warded area.\nCasting this spell on the same spot every day " +
                                    "for a \nyear makes this effect permanent. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 5th level or " +
                                          "higher, you can increase the \nsize of the cube by 100 feet " +
                                          "for each slot level \nbeyond 4th. Thus you could protect a " +
                                          "cube that can \nbe up to 200 feet on one side by using a spell " +
                                          "slot of \n5th level. ")
    ...
    def __init__(self):
        super().__init__(name="Produce Flame",
                         ...
                         description="A flickering flame appears in your hand. The flame \nremains " +
                                    ...
                                    "can also attack with the flame, although doing \nso ends the " +
                                    "spell. When you cast this spell, or as an \naction on a later " +
                                    "turn, you can hurl the flame at a \ncreature within 30 feet of " +
                                    "you. Make a ranged spell \nattack. On a hit, the target takes " +
    ...
    def __init__(self):
        super().__init__(name="Programmed Illusion",
                         ...
                         description="You create an illusion of an object, a creature, or \nsome " +
                                    ...
                                    "until then. It must be no \nlarger than a 30-foot cube, and " +
                                    "you decide when you \ncast the spell how the illusion behaves " +
                                    ...
                                    "condition can be as general or as\ndetailed as you like, " +
                                    "though it must be based on \nvisual or audible conditions that " +
                                    "occur within 30 feet \nof the area. For example, you could " +
                                    "create an illusion \nof yourself to appear and warn off others " +
                                    ...
                                    "\nIntelligence (Investigation) check against your spell \nsave " +
                                    "DC. If a creature discerns the illusion for what it \nis, the " +
                                    "creature can see through the image, and any \nnoise it makes " +
    ...
    def __init__(self):
        super().__init__(name="Project Image",
                         ...
                         description="You create an illusory copy of yourself that lasts for \nthe " +
                                    ...
                                    "through its \nears as if you were in its space. On your turn " +
    ...
    def __init__(self):
        super().__init__(name="Protection from Evil and Good",
                         ...
                         description="Until the spell ends, one willing creature you touch is " +
                                    ...
                                    "protection grants several benefits. Creatures \nof those types " +
                                    "have disadvantage on attack rolls \nagainst the target. The " +
                                    "target also can't be charmed, \nfrightened, or possessed by " +
                                    "them. If the target is \nalready charmed, frightened, or " +
    ...
    def __init__(self):
        super().__init__(name="Raise Dead",
                         ...
                         description="You return a dead creature you touch to life, \nprovided that " +
                                    ...
                                    "doesn't, however, remove \nmagical diseases, curses, or " +
                                    "similar effects; if these \naren't first removed prior to " +
                                    "casting the spell, they \ntake effect when the creature " +
                                    "returns to life. The \nspell can't return an undead creature " +
                                    ...
                                    "the dead is an ordeal. The \ntarget takes a −4 penalty to all " +
                                    "attack rolls, saving \nthrows, and ability checks. Every time " +
    ...
    def __init__(self):
        super().__init__(name="Reincarnate",
                         ...
                         description="You touch a dead humanoid or a piece of a dead \nhumanoid. " +
                                    ...
                                    "new body for the creature to \ninhabit, which likely causes " +
                                    "the creature's race to \nchange. The GM rolls a d100 and " +
                                    ...
                                    "Halfling, stout\n77–96 Human\n97–00 Tiefling\nThe reincarnated " +
                                    "creature recalls its former life \nand experiences. It retains " +
                                    "the capabilities it had in \nits original form, except it " +
                                    "exchanges its original race \nfor the new one and changes its " +
                                    "racial traits \naccordingly. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Remove Curse",
                         ...
                         description="At your touch, all curses affecting one creature or \nobject " +
                                    ...
                                    "remains, but the spell breaks its owner's \nattunement to the " +
    ...
    def __init__(self):
        super().__init__(name="Resilient Sphere",
                         ...
                         description="A sphere of shimmering force encloses a creature or \nobject " +
                                    "of Large size or smaller within range. An \nunwilling creature " +
                                    ...
                                    "weightless and just large enough to \ncontain the creature or " +
                                    "object inside. An enclosed \ncreature can use its action to " +
                                    "push against the \nsphere's walls and thus roll the sphere at " +
    ...
    def __init__(self):
        super().__init__(name="Resurrection",
                         ...
                         description="You touch a dead creature that has been dead for no \nmore " +
                                    "than a century, that didn't die of old age, and \nthat isn't " +
                                    "undead. If its soul is free and willing, the \ntarget returns " +
                                    "to life with all its hit points.\nThis spell neutralizes any " +
                                    "poisons and cures \nnormal diseases afflicting the creature " +
    ...
    def __init__(self):
        super().__init__(name="Reverse Gravity",
                         ...
                         description="This spell reverses gravity in a 50-foot-radius, 100-\nfoot " +
                                    ...
                                    "ground in the area fall upward and \nreach the top of the area " +
                                    "when you cast this spell. A \ncreature can make a Dexterity " +
                                    "saving throw to grab \nonto a fixed object it can reach, thus " +
                                    ...
                                    "fall. If an object or creature reaches the \ntop of the area " +
                                    "without striking anything, it remains \nthere, oscillating " +
    ...
    def __init__(self):
        super().__init__(name="Rope Trick",
                         ...
                         description="You touch a length of rope that is up to 60 feet long. \nOne " +
                                    ...
                                    "can't cross through the entrance \ninto or out of the " +
                                    "extradimensional space, but those \ninside can see out of it " +
                                    "as if through a 3-foot-by-5-\nfoot window centered on the " +
    ...
    def __init__(self):
        super().__init__(name="Sanctuary",
                         ...
                         description="You ward a creature within range against attack. \nUntil the " +
                                    ...
                                    "with an attack or a harmful spell \nmust first make a Wisdom " +
                                    "saving throw. On a failed \nsave, the creature must choose a " +
    ...
    def __init__(self):
        super().__init__(name="Scrying",
                         ...
                         description="You can see and hear a particular creature you \nchoose that " +
                                    ...
                                    "make a Wisdom saving throw, \nwhich is modified by how well " +
                                    "you know the target \nand the sort of physical connection you " +
                                    "have to it. If \na target knows you're casting this spell, it " +
                                    ...
                                    "save, the spell creates an invisible \nsensor within 10 feet " +
                                    "of the target. You can see and \nhear through the sensor as if " +
    ...
    def __init__(self):
        super().__init__(name="Secret Chest",
                         ...
                         description="You hide a chest, and all its contents, on the Ethereal " +
                                    ...
                                    "that serves as a material component for the \nspell. The chest " +
                                    "can contain up to 12 cubic feet of \nnonliving material (3 " +
                                    "feet by 2 feet by 2 feet).\nWhile the chest remains on the " +
                                    "Ethereal Plane, you \ncan use an action and touch the replica " +
                                    "to recall the \nchest. It appears in an unoccupied space on " +
                                    "the \nground within 5 feet of you. You can send the chest " +
                                    "\nback to the Ethereal Plane by using an action and \ntouching " +
                                    "both the chest and the replica.\nAfter 60 days, there is a " +
                                    "cumulative 5 percent \nchance per day that the spell's effect " +
                                    "ends. This effect \nends if you cast this spell again, if the " +
                                    "smaller replica \nchest is destroyed, or if you choose to end " +
                                    "the spell \nas an action. If the spell ends and the larger " +
    ...
    def __init__(self):
        super().__init__(name="Seeming",
                         ...
                         description="This spell allows you to change the appearance of \nany number " +
                                    ...
                                    "the same basic arrangement of limbs. Otherwise, \nthe extent " +
                                    "of the illusion is up to you. The spell lasts \nfor the " +
                                    "duration, unless you use your action to \ndismiss it " +
                                    "sooner.\nThe changes wrought by this spell fail to hold up " +
                                    "\nto physical inspection. For example, if you use this \nspell " +
                                    "to add a hat to a creature's outfit, objects pass \nthrough " +
                                    "the hat, and anyone who touches it would \nfeel nothing or " +
                                    "would feel the creature's head and \nhair. If you use this " +
                                    "spell to appear thinner than you \nare, the hand of someone " +
                                    "who reaches out to touch \nyou would bump into you while it " +
                                    "was seemingly \nstill in midair.\nA creature can use its " +
                                    "action to inspect a target \nand make an Intelligence " +
                                    "(Investigation) check \nagainst your spell save DC. If it " +
    ...
    def __init__(self):
        super().__init__(name="Sending",
                         ...
                         description="You send a short message of twenty-five words or \nless to a " +
                                    ...
                                    "message in its mind, recognizes \nyou as the sender if it " +
                                    "knows you, and can answer in \na like manner immediately. The " +
                                    "spell enables \ncreatures with Intelligence scores of at least " +
                                    "1 to \nunderstand the meaning of your message.\nYou can send " +
                                    "the message across any distance and \neven to other planes of " +
    ...
    def __init__(self):
        super().__init__(name="Shapechange",
                         ...
                         description="You assume the form of a different creature for the " +
                                    ...
                                    "challenge rating equal to your level or lower. The \ncreature " +
                                    "can't be a construct or an undead, and you \nmust have seen " +
                                    "the sort of creature at least once. \nYou transform into an " +
                                    "average example of that \ncreature, one without any class " +
                                    "levels or the \nSpellcasting trait.\nYour game statistics are " +
                                    "replaced by the statistics \nof the chosen creature, though " +
    ...
    def __init__(self):
        super().__init__(name="Shocking Grasp",
                         ...
                         description="Lightning springs from your hand to deliver a shock \nto a " +
                                    ...
                                    "takes 1d8 lightning \ndamage, and it can't take reactions " +
                                    "until the start of \nits next turn.\nThe spell's damage " +
                                    "increases by 1d8 when you \nreach 5th level (2d8), 11th level " +
                                    "(3d8), and 17th \nlevel (4d8). ",
                         at_higher_levels="")
...
class SilentImage(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Silent Image",
                         ...
                         description="You create the image of an object, a creature, or \nsome other " +
                                    "visible phenomenon that is no larger \nthan a 15-foot cube. " +
                                    "The image appears at a spot \nwithin range and lasts for the " +
                                    "duration. The image is \npurely visual; it isn't accompanied " +
    ...
    def __init__(self):
        super().__init__(name="Simulacrum",
                         ...
                         description="You shape an illusory duplicate of one beast or \nhumanoid " +
                                    "that is within range for the entire casting \ntime of the " +
                                    "spell. The duplicate is a creature, partially \nreal and " +
                                    "formed from ice or snow, and it can take \nactions and " +
                                    "otherwise be affected as a normal \ncreature. It appears to be " +
                                    "the same as the original, \nbut it has half the creature's hit " +
                                    "point maximum and \nis formed without any equipment. " +
                                    "Otherwise, the \nillusion uses all the statistics of the " +
                                    "creature it \nduplicates.\nThe simulacrum is friendly to you " +
                                    "and creatures \nyou designate. It obeys your spoken commands, " +
                                    "\nmoving and acting in accordance with your wishes \nand " +
                                    "acting on your turn in combat. The simulacrum \nlacks the " +
                                    "ability to learn or become more powerful, \nso it never " +
                                    ...
                                    "this spell again, any currently active \nduplicates you " +
                                    "created with this spell are instantly \ndestroyed. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Sleep",
                         ...
                         description="This spell sends creatures into a magical slumber. \nRoll 5d8; " +
                                    ...
                                    "damage, or someone uses an action to \nshake or slap the " +
                                    "sleeper awake. Subtract each \ncreature's hit points from the " +
                                    "total before moving on \nto the creature with the next lowest " +
                                    "hit points. A \ncreature's hit points must be equal to or less " +
                                    "than \nthe remaining total for that creature to be " +
                                    "affected.\nUndead and creatures immune to being charmed " +
                                    "\naren't affected by this spell. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 2nd level or " +
                                          "higher, roll an additional \n2d8 for each slot level above " +
                                          "1st. ")
    ...
    def __init__(self):
        super().__init__(name="Sleet Storm",
                         ...
                         description="Until the spell ends, freezing rain and sleet fall in a " +
                                    ...
                                    "the area is covered with slick ice, \nmaking it difficult " +
                                    "terrain. When a creature enters \nthe spell's area for the " +
                                    "first time on a turn or starts \nits turn there, it must make " +
                                    "a Dexterity saving throw. \nOn a failed save, it falls " +
    ...
    def __init__(self):
        super().__init__(name="Slow",
                         ...
                         description="You alter time around up to six creatures of your \nchoice in " +
                                    "a 40-foot cube within range. Each target \nmust succeed on a " +
                                    ...
                                    "on that turn to complete the spell. If it can't, \nthe spell " +
    ...
    def __init__(self):
        super().__init__(name="Speak with Animals",
                         ...
                         description="You gain the ability to comprehend and verbally \ncommunicate " +
                                    ...
                                    "many beasts is limited \nby their intelligence, but at " +
                                    "minimum, beasts can \ngive you information about nearby " +
                                    "locations and \nmonsters, including whatever they can perceive " +
                                    "or \nhave perceived within the past day. You might be \nable " +
                                    "to persuade a beast to perform a small favor for \nyou, at the " +
                                    "GM's discretion. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Speak with Dead",
                         ...
                         description="You grant the semblance of life and intelligence to a \ncorpse " +
                                    ...
                                    "target of this spell within the last \n10 days.\nUntil the " +
                                    "spell ends, you can ask the corpse up to \nfive questions. The " +
                                    "corpse knows only what it knew \nin life, including the " +
                                    "languages it knew. Answers are \nusually brief, cryptic, or " +
                                    "repetitive, and the corpse is \nunder no compulsion to offer a " +
                                    "truthful answer if \nyou are hostile to it or it recognizes " +
                                    "you as an enemy. \nThis spell doesn't return the creature's " +
                                    "soul to its \nbody, only its animating spirit. Thus, the " +
    ...
    def __init__(self):
        super().__init__(name="Speak with Plants",
                         ...
                         description="You imbue plants within 30 feet of you with limited " +
                                    ...
                                    "can question plants about events in \nthe spell's area within " +
                                    "the past day, gaining \ninformation about creatures that have " +
                                    ...
                                    "they can freely move branches, tendrils, and \nstalks.\nIf a " +
                                    "plant creature is in the area, you can \ncommunicate with it " +
                                    "as if you shared a common \nlanguage, but you gain no magical " +
                                    "ability to influence \nit.\nThis spell can cause the plants " +
    ...
    def __init__(self):
        super().__init__(name="Spiritual Weapon",
                         ...
                         description="You create a floating, spectral weapon within range \nthat " +
                                    ...
                                    "turn, you can move the \nweapon up to 20 feet and repeat the " +
                                    "attack against a \ncreature within 5 feet of it.\nThe weapon " +
                                    "can take whatever form you choose. \nClerics of deities who " +
                                    "are associated with a \nparticular weapon (as St. Cuthbert is " +
                                    "known for his \nmace and Thor for his hammer) make this " +
                                    "spell's \neffect resemble that weapon. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 3rd level or " +
                                          "higher, the damage \nincreases by 1d8 for every two slot " +
                                          "levels above 2nd. ")
    ...
    def __init__(self):
        super().__init__(name="Stone Shape",
                         ...
                         description="You touch a stone object of Medium size or smaller \nor a " +
                                    ...
                                    "example, you could shape a large \nrock into a weapon, idol, " +
                                    "or coffer, or make a small \npassage through a wall, as long " +
                                    "as the wall is less \nthan 5 feet thick. You could also shape " +
    ...
    def __init__(self):
        super().__init__(name="Stoneskin",
                         ...
                         description="This spell turns the flesh of a willing creature you \ntouch " +
                                    "as hard as stone. Until the spell ends, the \ntarget has " +
    ...
    def __init__(self):
        super().__init__(name="Storm of Vengeance",
                         ...
                         description="A churning storm cloud forms, centered on a point \nyou can " +
                                    "see and spreading to a radius of 360 feet. \nLightning flashes " +
                                    "in the area, thunder booms, and \nstrong winds roar. Each " +
                                    "creature under the cloud \n(no more than 5,000 feet beneath " +
                                    "the cloud) when it \nappears must make a Constitution saving " +
                                    "throw. On \na failed save, a creature takes 2d6 thunder damage " +
                                    "\nand becomes deafened for 5 minutes.\nEach round you maintain " +
                                    "concentration on this \nspell, the storm produces additional " +
                                    "effects on your \nturn.\nRound 2. Acidic rain falls from the " +
                                    ...
                                    "\nRanged weapon attacks in \nthe area are impossible. The wind " +
                                    "and rain count as \na severe distraction for the purposes of " +
                                    "maintaining \nconcentration on spells. Finally, gusts of " +
                                    "strong wind \n(ranging from 20 to 50 miles per hour) " +
                                    "\nautomatically disperse fog, mists, and similar \nphenomena " +
                                    "in the area, whether mundane or \nmagical. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Suggestion",
                         ...
                         description="You suggest a course of activity (limited to a \nsentence or " +
                                    ...
                                    "you or any of your companions damage the \ntarget, the spell " +
                                    "ends. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Sunbeam",
                         ...
                         description="A beam of brilliant light flashes out from your hand \nin a " +
                                    ...
                                    "damage and isn't blinded by \nthis spell. Undead and oozes " +
                                    "have disadvantage on \nthis saving throw.\nYou can create a " +
                                    "new line of radiance as your \naction on any turn until the " +
    ...
    def __init__(self):
        super().__init__(name="Sunburst",
                         ...
                         description="Brilliant sunlight flashes in a 60-foot radius centered \non a " +
                                    ...
                                    "end of each of its \nturns. On a successful save, it is no " +
    ...
    def __init__(self):
        super().__init__(name="Symbol",
                         ...
                         description="When you cast this spell, you inscribe a harmful \nglyph " +
                                    "either on a surface (such as a section of floor, a \nwall, or " +
                                    "a table) or within an object that can be \nclosed to conceal " +
                                    "the glyph (such as a book, a scroll, \nor a treasure chest). " +
                                    "If you choose a surface, the \nglyph can cover an area of the " +
                                    "surface no larger than \n10 feet in diameter. If you choose an " +
                                    "object, that \nobject must remain in its place; if the object " +
                                    "is \nmoved more than 10 feet from where you cast this \nspell, " +
                                    "the glyph is broken, and the spell ends without \nbeing " +
                                    ...
                                    "that holds it. For glyphs \ninscribed within an object, the " +
                                    "most common \ntriggers are opening the object, approaching " +
                                    "within a \ncertain distance of it, or seeing or reading the " +
                                    "glyph.\nYou can further refine the trigger so the spell is " +
                                    "\nactivated only under certain circumstances or \naccording to " +
                                    "a creature's physical characteristics \n(such as height or " +
                                    "weight), or physical kind (for \nexample, the ward could be " +
                                    "set to affect hags or \nshapechangers). You can also specify " +
                                    "creatures that \ndon't trigger the glyph, such as those who " +
                                    ...
                                    "throw, taking 10d10 necrotic damage on a \nfailed save, or " +
                                    "half as much damage on a successful \nsave.\nDiscord. Each " +
                                    "target must make a Constitution \nsaving throw. On a failed " +
                                    "save, a target bickers and \nargues with other creatures for 1 " +
                                    "minute. During this \ntime, it is incapable of meaningful " +
                                    "communication \nand has disadvantage on attack rolls and " +
                                    "ability \nchecks.\nFear. Each target must make a Wisdom saving " +
                                    "\nthrow and becomes frightened for 1 minute on a \nfailed " +
                                    "save. While frightened, the target drops \nwhatever it is " +
                                    "holding and must move at least 30 feet \naway from the glyph " +
                                    "on each of its turns, if able.\nHopelessness. Each target must " +
                                    ...
                                    "target must make an Intelligence \nsaving throw. On a failed " +
                                    "save, the target is driven \ninsane for 1 minute. An insane " +
    ...
    def __init__(self):
        super().__init__(name="Telekinesis",
                         ...
                         description="You gain the ability to move or manipulate creatures \nor " +
                                    ...
                                    "causing the appropriate effect \nbelow. You can affect the " +
                                    "same target round after \nround, or choose a new one at any " +
                                    "time. If you switch \ntargets, the prior target is no longer " +
                                    ...
                                    "check. If you win the contest, you move the \ncreature up to " +
                                    "30 feet in any direction, including \nupward but not beyond " +
                                    "the range of this spell. Until \nthe end of your next turn, " +
                                    "the creature is restrained \nin your telekinetic grip. A " +
                                    "creature lifted upward is \nsuspended in mid-air.\nOn " +
                                    "subsequent rounds, you can use your action to \nattempt to " +
                                    "maintain your telekinetic grip on the \ncreature by repeating " +
                                    "the contest.\nObject. You can try to move an object that " +
                                    ...
                                    "object is worn or carried by a creature, you \nmust make an " +
                                    "ability check with your spellcasting \nability contested by " +
                                    "that creature's Strength check. If \nyou succeed, you pull the " +
                                    "object away from that \ncreature and can move it up to 30 feet " +
                                    ...
                                    "item from an open container, or pouring the \ncontents from a " +
                                    "vial. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Telepathic Bond",
                         ...
                         description="You forge a telepathic link among up to eight willing " +
                                    ...
                                    "each creature to all the others for the \nduration. Creatures " +
                                    "with Intelligence scores of 2 or \nless aren't affected by " +
                                    "this spell.\nUntil the spell ends, the targets can communicate " +
                                    "\ntelepathically through the bond whether or not they \nhave a " +
                                    "common language. The communication is \npossible over any " +
                                    "distance, though it can't extend to \nother planes of " +
                                    "existence. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Teleport",
                         ...
                         description="This spell instantly transports you and up to eight \nwilling " +
                                    ...
                                    "destination you select. If you \ntarget an object, it must be " +
                                    "able to fit entirely inside \na 10-foot cube, and it can't be " +
                                    "held or carried by an \nunwilling creature.\nThe destination " +
                                    "you choose must be known to you, \nand it must be on the same " +
                                    "plane of existence as you. \nYour familiarity with the " +
                                    "destination determines \nwhether you arrive there " +
                                    "successfully. The GM rolls \nd100 and consults the " +
                                    "table.\nFamiliarity Mishap\nSimilar \nArea\nOff \nTarget\nOn " +
                                    "\nTarget\nPermanent \ncircle\n— — — 01–100\nAssociated " +
                                    "\nobject\n— — — 01–100\nVery familiar 01–05 06–13 14–24 " +
                                    "25–100\nSeen casually 01–33 34–43 44–53 54–100\nViewed once " +
                                    "01–43 44–53 54–73 74–100\nDescription 01–43 44–53 54–73 " +
                                    "74–100\nFalse \ndestination\n01–50 51–100 — —\nFamiliarity. " +
                                    "“Permanent circle” means a \npermanent teleportation circle " +
                                    "whose sigil sequence \nyou know. “Associated object” means " +
                                    "that you \npossess an object taken from the desired " +
                                    "destination \nwithin the last six months, such as a book from " +
                                    "a \nwizard's library, bed linen from a royal suite, or a " +
                                    "\nchunk of marble from a lich's secret tomb.\n“Very familiar” " +
                                    "is a place you have been very often, \na place you have " +
                                    "carefully studied, or a place you can \nsee when you cast the " +
                                    "spell. “Seen casually” is \nsomeplace you have seen more than " +
                                    "once but with \nwhich you aren't very familiar. “Viewed once” " +
                                    "is a \nplace you have seen once, possibly using magic. " +
                                    "\n“Description” is a place whose location and \nappearance you " +
                                    "know through someone else's \ndescription, perhaps from a " +
                                    "map.\n“False destination” is a place that doesn't exist. " +
                                    "\nPerhaps you tried to scry an enemy's sanctum but \ninstead " +
                                    "viewed an illusion, or you are attempting to \nteleport to a " +
                                    "familiar location that no longer exists.\nOn Target. You and " +
                                    "your group (or the target \nobject) appear where you want " +
                                    "to.\nOff Target. You and your group (or the target \nobject) " +
                                    "appear a random distance away from the \ndestination in a " +
                                    "random direction. Distance off target \nis 1d10 × 1d10 percent " +
                                    "of the distance that was to be \ntraveled. For example, if you " +
                                    "tried to travel 120 \nmiles, landed off target, and rolled a 5 " +
                                    "and 3 on the \ntwo d10s, then you would be off target by 15 " +
                                    ...
                                    "be in trouble.\nSimilar Area. You and your group (or the " +
                                    ...
                                    "as your laboratory. Generally, \nyou appear in the closest " +
                                    "similar place, but since the \nspell has no range limit, you " +
                                    "could conceivably wind \nup anywhere on the plane.\nMishap. " +
                                    "The spell's unpredictable magic results in \na difficult " +
                                    "journey. Each teleporting creature (or the \ntarget object) " +
                                    "takes 3d10 force damage, and the GM \nrerolls on the table to " +
                                    "see where you wind up \n(multiple mishaps can occur, dealing " +
                                    "damage each \ntime). ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Teleportation Circle",
                         ...
                         description="As you cast the spell, you draw a 10-foot-diameter \ncircle on " +
                                    ...
                                    "a permanent teleportation circle of \nyour choice whose sigil " +
                                    ...
                                    "magical runes arranged in a particular \npattern. When you " +
                                    "first gain the ability to cast this \nspell, you learn the " +
                                    "sigil sequences for two \ndestinations on the Material Plane, " +
                                    "determined by \nthe GM. You can learn additional sigil " +
                                    "sequences \nduring your adventures. You can commit a new sigil " +
                                    "\nsequence to memory after studying it for 1 minute.\nYou can " +
                                    "create a permanent teleportation circle by \ncasting this " +
                                    "spell in the same location every day for \none year. You need " +
                                    "not use the circle to teleport \nwhen you cast the spell in " +
                                    "this way. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Thunderwave",
                         ...
                         description="A wave of thunderous force sweeps out from you. \nEach " +
                                    ...
                                    "takes 2d8 thunder damage and is \npushed 10 feet away from " +
                                    "you. On a successful save, \nthe creature takes half as much " +
                                    "damage and isn't \npushed.\nIn addition, unsecured objects " +
                                    "that are completely \nwithin the area of effect are " +
                                    "automatically pushed 10 \nfeet away from you by the spell's " +
                                    "effect, and the spell \nemits a thunderous boom audible out to " +
                                    "300 feet. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 2nd level or " +
                                          "higher, the damage \nincreases by 1d8 for each slot level " +
                                          "above 1st. ")
    ...
    def __init__(self):
        super().__init__(name="Tiny Hut",
                         ...
                         description="A 10-foot-radius immobile dome of force springs \ninto " +
                                    ...
                                    "the duration. The spell ends if you leave \nits area.\nNine " +
                                    ...
                                    "atmosphere inside the space is comfortable and \ndry, " +
                                    "regardless of the weather outside.\nUntil the spell ends, you " +
                                    "can command the interior \nto become dimly lit or dark. The " +
                                    "dome is opaque \nfrom the outside, of any color you choose, " +
    ...
    def __init__(self):
        super().__init__(name="Transport via Plants",
                         ...
                         description="This spell creates a magical link between a Large or \nlarger " +
                                    ...
                                    "the duration, any creature \ncan step into the target plant " +
                                    "and exit from the \ndestination plant by using 5 feet of " +
                                    "movement. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Tree Stride",
                         ...
                         description="You gain the ability to enter a tree and move from \ninside it " +
                                    ...
                                    "Both trees must be living and at \nleast the same size as you. " +
                                    "You must use 5 feet of \nmovement to enter a tree. You " +
                                    "instantly know the \nlocation of all other trees of the same " +
                                    ...
                                    "you appear within 5 feet of the tree \nyou entered.\nYou can " +
                                    "use this transportation ability once per \nround for the " +
    ...
    def __init__(self):
        super().__init__(name="True Polymorph",
                         ...
                         description="Choose one creature or nonmagical object that you \ncan see " +
                                    ...
                                    "another creature). The \ntransformation lasts for the " +
                                    "duration, or until the \ntarget drops to 0 hit points or dies. " +
                                    "If you \nconcentrate on this spell for the full duration, the " +
                                    "\ntransformation lasts until it is dispelled.\nThis spell has " +
                                    "no effect on a shapechanger or a \ncreature with 0 hit points. " +
                                    "An unwilling creature can \nmake a Wisdom saving throw, and if " +
                                    "it succeeds, it \nisn't affected by this spell.\nCreature into " +
                                    "Creature. If you turn a creature into \nanother kind of " +
                                    "creature, the new form can be any \nkind you choose whose " +
                                    "challenge rating is equal to \nor less than the target's (or " +
                                    "its level, if the target \ndoesn't have a challenge rating). " +
                                    "The target's game \nstatistics, including mental ability " +
                                    "scores, are \nreplaced by the statistics of the new form. It " +
                                    "retains \nits alignment and personality.\nThe target assumes " +
                                    "the hit points of its new form, \nand when it reverts to its " +
                                    "normal form, the creature \nreturns to the number of hit " +
                                    "points it had before it \ntransformed. If it reverts as a " +
                                    ...
                                    "object's size and the creature's \nchallenge rating is 9 or " +
                                    "lower. The creature is \nfriendly to you and your companions. " +
                                    "It acts on each \nof your turns. You decide what action it " +
                                    "takes and \nhow it moves. The GM has the creature's statistics " +
                                    "\nand resolves all of its actions and movement.\nIf the spell " +
                                    "becomes permanent, you no longer \ncontrol the creature. It " +
                                    "might remain friendly to you, \ndepending on how you have " +
                                    "treated it.\nCreature into Object. If you turn a creature into " +
                                    "\nan object, it transforms along with whatever it is \nwearing " +
                                    "and carrying into that form. The creature's \nstatistics " +
                                    "become those of the object, and the \ncreature has no memory " +
                                    "of time spent in this form, \nafter the spell ends and it " +
    ...
    def __init__(self):
        super().__init__(name="True Resurrection",
                         ...
                         description="You touch a creature that has been dead for no \nlonger than " +
                                    ...
                                    "the creature's soul is free and \nwilling, the creature is " +
                                    "restored to life with all its hit \npoints.\nThis spell closes " +
                                    "all wounds, neutralizes any \npoison, cures all diseases, and " +
    ...
    def __init__(self):
        super().__init__(name="True Seeing",
                         ...
                         description="This spell gives the willing creature you touch the \nability " +
                                    ...
                                    "magic, and can see into the Ethereal \nPlane, all out to a " +
                                    "range of 120 feet. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="True Strike",
                         ...
                         description="You extend your hand and point a finger at a target \nin " +
                                    "range. Your magic grants you a brief insight into \nthe " +
                                    "target's defenses. On your next turn, you gain \nadvantage on " +
                                    "your first attack roll against the target, \nprovided that " +
    ...
    def __init__(self):
        super().__init__(name="Unseen Servant",
                         ...
                         description="This spell creates an invisible, mindless, shapeless \nforce " +
                                    ...
                                    "bonus action, you \ncan mentally command the servant to move " +
                                    ...
                                    "give the command, the servant performs \nthe task to the best " +
                                    "of its ability until it completes the \ntask, then waits for " +
                                    "your next command.\nIf you command the servant to perform a " +
    ...
    def __init__(self):
        super().__init__(name="Vicious Mockery",
                         ...
                         description="You unleash a string of insults laced with subtle " +
                                    ...
                                    "the target can hear you (though it need not\nunderstand you), " +
                                    "it must succeed on a Wisdom \nsaving throw or take 1d4 psychic " +
                                    "damage and have \ndisadvantage on the next attack roll it " +
                                    "makes before \nthe end of its next turn.\nThis spell's damage " +
                                    "increases by 1d4 when you \nreach 5th level (2d4), 11th level " +
                                    "(3d4), and 17th \nlevel (4d4). ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Wall of Fire",
                         ...
                         description="You create a wall of fire on a solid surface within \nrange. " +
                                    ...
                                    "1 foot thick, or a ringed wall up to 20 \nfeet in diameter, 20 " +
                                    "feet high, and 1 foot thick. The \nwall is opaque and lasts " +
                                    ...
                                    "damage on a successful save.\nOne side of the wall, selected " +
                                    "by you when you \ncast this spell, deals 5d8 fire damage to " +
                                    "each \ncreature that ends its turn within 10 feet of that side " +
                                    "\nor inside the wall. A creature takes the same damage \nwhen " +
                                    "it enters the wall for the first time on a turn or \nends its " +
                                    "turn there. The other side of the wall deals \nno damage. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 5th level or " +
                                          "higher, the damage increases \nby 1d8 for each slot level " +
                                          "above 4th. ")
    ...
    def __init__(self):
        super().__init__(name="Wall of Force",
                         ...
                         description="An invisible wall of force springs into existence at a \npoint " +
                                    ...
                                    "angle. It can be free floating \nor resting on a solid " +
                                    "surface. You can form it into a \nhemispherical dome or a " +
                                    "sphere with a radius of up \nto 10 feet, or you can shape a " +
                                    "flat surface made up of \nten 10-foot-by-10-foot panels. Each " +
                                    "panel must be \ncontiguous with another panel. In any form, " +
                                    "the wall \nis 1/4 inch thick. It lasts for the duration. If " +
    ...
    def __init__(self):
        super().__init__(name="Wall of Ice",
                         ...
                         description="You create a wall of ice on a solid surface within \nrange. " +
                                    "You can form it into a hemispherical dome or \na sphere with a " +
                                    "radius of up to 10 feet, or you can \nshape a flat surface " +
                                    "made up of ten 10-foot-square \npanels. Each panel must be " +
                                    ...
                                    "frigid air for the first time on a turn must \nmake a " +
                                    "Constitution saving throw. That creature \ntakes 5d6 cold " +
                                    "damage on a failed save, or half as \nmuch damage on a " +
                                    "successful one. ",
                         at_higher_levels="When you cast this spell using a \nspell slot of 7th level or " +
    ...
    def __init__(self):
        super().__init__(name="Wall of Stone",
                         ...
                         description="A nonmagical wall of solid stone springs into \nexistence at a " +
                                    ...
                                    "and is composed of ten 10-footby-10-foot panels. Each panel " +
                                    "must be contiguous \nwith at least one other panel. " +
                                    "Alternatively, you can \ncreate 10-foot-by-20-foot panels that " +
                                    "are only 3 \ninches thick.\nIf the wall cuts through a " +
                                    "creature's space when it\nappears, the creature is pushed to " +
                                    ...
                                    "up to its speed so that it is no \nlonger enclosed by the " +
                                    "wall.\nThe wall can have any shape you desire, though it " +
                                    "\ncan't occupy the same space as a creature or object. \nThe " +
                                    "wall doesn't need to be vertical or rest on any \nfirm " +
                                    "foundation. It must, however, merge with and \nbe solidly " +
                                    "supported by existing stone. Thus, you can \nuse this spell to " +
                                    "bridge a chasm or create a ramp.\nIf you create a span greater " +
                                    "than 20 feet in length, \nyou must halve the size of each " +
                                    "panel to create \nsupports. You can crudely shape the wall to " +
                                    "create \ncrenellations, battlements, and so on.\nThe wall is " +
                                    "an object made of stone that can be \ndamaged and thus " +
                                    "breached. Each panel has AC 15 \nand 30 hit points per inch of " +
                                    "thickness. Reducing a \npanel to 0 hit points destroys it and " +
                                    "might cause \nconnected panels to collapse at the GM's " +
                                    "discretion.\nIf you maintain your concentration on this spell " +
                                    "\nfor its whole duration, the wall becomes permanent \nand " +
                                    "can't be dispelled. Otherwise, the wall \ndisappears when the " +
                                    "spell ends. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Warding Bond",
                         ...
                         description="This spell wards a willing creature you touch and \ncreates a " +
                                    ...
                                    "points or if you \nand the target become separated by more " +
                                    "than 60 \nfeet. It also ends if the spell is cast again on " +
    ...
    def __init__(self):
        super().__init__(name="Water Walk",
                         ...
                         description="This spell grants the ability to move across any \nliquid " +
                                    ...
                                    "lava—as if it were harmless solid \nground (creatures crossing " +
                                    "molten lava can still take \ndamage from the heat). Up to ten " +
                                    "willing creatures \nyou can see within range gain this ability " +
    ...
    def __init__(self):
        super().__init__(name="Web",
                         ...
                         description="You conjure a mass of thick, sticky webbing at a \npoint of " +
                                    ...
                                    "as long as it remains in the webs or \nuntil it breaks " +
                                    ...
                                    "Any 5-foot cube of webs \nexposed to fire burns away in 1 " +
                                    "round, dealing 2d4 \nfire damage to any creature that starts " +
                                    "its turn in the \nfire. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Weird",
                         ...
                         description="Drawing on the deepest fears of a group of creatures, \nyou " +
                                    ...
                                    "threat. At the end of each of the \nfrightened creature's " +
                                    "turns, it must succeed on a \nWisdom saving throw or take 4d10 " +
                                    "psychic damage. \nOn a successful save, the spell ends for " +
                                    "that creature. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Wind Walk",
                         ...
                         description="You and up to ten willing creatures you can see \nwithin range " +
                                    ...
                                    "of cloud. While in this cloud form, \na creature has a flying " +
                                    ...
                                    "ends, a creature can revert to cloud form, which \nalso " +
                                    "requires the 1-minute transformation.\nIf a creature is in " +
                                    "cloud form and flying when the \neffect ends, the creature " +
                                    "descends 60 feet per round \nfor 1 minute until it lands, " +
                                    "which it does safely. If it \ncan't land after 1 minute, the " +
                                    "creature falls the \nremaining distance. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Wind Wall",
                         ...
                         description="A wall of strong wind rises from the ground at a \npoint you " +
                                    ...
                                    "and other ordinary projectiles launched at \ntargets behind " +
                                    "the wall are deflected upward and \nautomatically miss. " +
                                    "(Boulders hurled by giants or \nsiege engines, and similar " +
                                    "projectiles, are \nunaffected.) Creatures in gaseous form " +
                                    "can't pass \nthrough it. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Wish",
                         ...
                         description="Wish is the mightiest spell a mortal creature can cast. \nBy " +
                                    ...
                                    "beyond the \nscope of the above examples. State your wish to " +
                                    "the \nGM as precisely as possible. The GM has great \nlatitude " +
                                    "in ruling what occurs in such an instance; \nthe greater the " +
                                    "wish, the greater the likelihood that \nsomething goes wrong. " +
                                    "This spell might simply fail, \nthe effect you desire might " +
                                    "only be partly achieved, \nor you might suffer some unforeseen " +
                                    "consequence as \na result of how you worded the wish. For " +
                                    ...
                                    "wishing for a legendary magic item or \nartifact might " +
                                    "instantly transport you to the \npresence of the item's " +
                                    ...
                                    "or prevented in any way. In \naddition, your Strength drops to " +
                                    "3, if it isn't 3 or \nlower already, for 2d4 days. For each of " +
    ...
    def __init__(self):
        super().__init__(name="Word of Recall",
                         ...
                         description="You and up to five willing creatures within 5 feet of \nyou " +
                                    ...
                                    "strongly linked to your deity. If you attempt to \ncast the " +
                                    "spell in this manner in an area that isn't \ndedicated to your " +
