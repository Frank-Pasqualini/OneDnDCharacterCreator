    ...
    def __init__(self):
        super().__init__(name="Alter Self",
                         ...
                         description="You assume a different form. When you cast the spell, choose " +
                                    ...
                                    "equal to your walking speed.\nChange Appearance. You transform " +
                                    ...
                                    "piercing, or slashing damage, as appropriate to the natural " +
                                    "weapon you chose, and you are proficient with your unarmed " +
                                    "strikes. Finally, the natural weapon is magic and you have a " +
    ...
    def __init__(self):
        super().__init__(name="Animal Shapes",
                         ...
                         description="Your magic turns others into beasts. Choose any number of " +
                                    ...
                                    "target, or until the target drops to 0 hit points or " +
                                    ...
                                    "target can't activate, wield, or otherwise benefit from any of " +
                                    "its equipment. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Animate Dead",
                         ...
                         description="This spell creates an undead servant. Choose a pile of bones " +
                                    ...
                                    "you chose bones or a zombie if you chose a corpse (the GM has " +
                                    "the creature's game statistics).\nOn each of your turns, you " +
                                    "can use a bonus action to mentally command any creature you " +
                                    "made with this spell if the creature is within 60 feet of you " +
    ...
    def __init__(self):
        super().__init__(name="Animate Objects",
                         ...
                         description="Objects come to life at your command. Choose up to ten " +
                                    ...
                                    "at the same time, issuing the same command to each one).\nYou " +
    ...
    def __init__(self):
        super().__init__(name="Antilife Shell",
                         ...
                         description="A shimmering barrier extends out from you in a 10- foot radius " +
                                    ...
                                    "through the barrier.\nIf you move so that an affected creature " +
    ...
    def __init__(self):
        super().__init__(name="Antimagic Field",
                         ...
                         description="A 10-foot-radius invisible sphere of antimagic surrounds you. " +
                                    ...
                                    "suppressed spell is consumed.\nWhile an effect is suppressed, " +
                                    "it doesn't function, but the time it spends suppressed counts " +
                                    "against its duration.\nTargeted Effects. Spells and other " +
                                    ...
                                    "a nonmagical longsword.\nA magic weapon's properties and " +
                                    "powers are suppressed if it is used against a target in the " +
                                    "sphere or wielded by an attacker in the sphere. If a magic " +
                                    "weapon or a piece of magic ammunition fully leaves the sphere " +
                                    "(for example, if you fire a magic arrow or throw a magic spear " +
                                    "at a target outside the sphere), the magic of the item ceases " +
                                    ...
                                    "for such magical travel. A portal to another location, world, " +
                                    "or plane of existence, as well as an opening to an " +
                                    "extradimensional space such as that created by the rope trick " +
                                    "spell, temporarily closes while in the sphere.\nCreatures and " +
                                    "Objects. A creature or object summoned or created by magic " +
                                    "temporarily winks out of existence in the sphere. Such a " +
                                    "creature instantly reappears once the space the creature " +
                                    "occupied is no longer within the sphere.\nDispel Magic. Spells " +
                                    "and magical effects such as dispel magic have no effect on the " +
                                    "sphere. Likewise, the spheres created by different antimagic " +
    ...
    def __init__(self):
        super().__init__(name="Antipathy/Sympathy",
                         ...
                         description="This spell attracts or repels creatures of your choice.\nYou " +
                                    ...
                                    "feet of it or able to see it.\nWhen such a creature can see " +
                                    "the target or comes within 60 feet of it, the creature must " +
                                    ...
                                    "away from the target.\nIf the target damages or otherwise " +
                                    "harms an affected creature, the affected creature can make a " +
                                    ...
                                    "save, the creature is no longer affected by the target and " +
                                    "recognizes the feeling of repugnance or attraction as magical. " +
                                    "In addition, a creature affected by the spell is allowed " +
                                    "another Wisdom saving throw every 24 hours while the spell " +
                                    "persists.\nA creature that successfully saves against this " +
                                    "effect is immune to it for 1 minute, after which time it can " +
                                    "be affected again. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Arcane Eye",
                         ...
                         description="You create an invisible, magical eye within range that hovers " +
                                    ...
                                    "in any direction. There is no limit to how far away from you " +
                                    "the eye can move, but it can't enter another plane of " +
                                    "existence. A solid barrier blocks the eye's movement, but the " +
                                    "eye can pass through an opening as small as 1 inch in " +
                                    "diameter. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Arcane Hand",
                         ...
                         description="You create a Large hand of shimmering, translucent force in an " +
                                    ...
                                    "bonus action on your subsequent turns, you can move the hand " +
                                    "up to 60 feet and then cause one of the following effects with " +
                                    ...
                                    "a check with the hand's Strength contested by the Strength " +
                                    ...
                                    "between you and a creature you choose until you give the hand " +
                                    "a different command. The hand moves to stay between you and " +
                                    "the target, providing you with half cover against the target. " +
                                    "The target can't move through the hand's space if its Strength " +
                                    "score is less than or equal to the hand's Strength score. If " +
                                    "its Strength score is higher than the hand's Strength score, " +
                                    "the target can move toward you through the hand's space, but " +
    ...
    def __init__(self):
        super().__init__(name="Arcanist's Magic Aura",
                         ...
                         description="You place an illusion on a creature or an object you touch so " +
                                    ...
                                    "that handles the item.\nMask. You change the way the target " +
    ...
    def __init__(self):
        super().__init__(name="Astral Projection",
                         ...
                         description="You and up to eight willing creatures within range project " +
                                    ...
                                    "end early for you or one of your companions. A successful " +
                                    "dispel magic spell used against an astral or physical body " +
                                    "ends the spell for that creature. If a creature's original " +
                                    "body or its astral form drops to 0 hit points, the spell ends " +
                                    "for that creature. If the spell ends and the silver cord is " +
                                    "intact, the cord pulls the creature's astral form back to its " +
                                    "body, ending its state of suspended animation.\nIf you are " +
                                    "returned to your body prematurely, your companions remain in " +
                                    "their astral forms and must find their own way back to their " +
    ...
    def __init__(self):
        super().__init__(name="Awaken",
                         ...
                         description="After spending the casting time tracing magical pathways " +
                                    ...
                                    "or plant is charmed by you for 30 days or until you or your " +
    ...
    def __init__(self):
        super().__init__(name="Bane",
                         ...
                         description="Up to three creatures of your choice that you can see within " +
                                    ...
                                    "that fails this saving throw makes an attack roll or a saving " +
    ...
    def __init__(self):
        super().__init__(name="Banishment",
                         ...
                         description="You attempt to send one creature that you can see within range " +
                                    ...
                                    "the target is native to a different plane of existence than " +
    ...
    def __init__(self):
        super().__init__(name="Black Tentacles",
                         ...
                         description="Squirming, ebony tentacles fill a 20-foot square on ground " +
                                    ...
                                    "bludgeoning damage.\nA creature restrained by the tentacles " +
                                    "can use its action to make a Strength or Dexterity check (its " +
                                    "choice) against your spell save DC. On a success, it frees " +
                                    "itself. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Blink",
                         ...
                         description="Roll a d20 at the end of each of your turns for the duration " +
                                    ...
                                    "on that plane).\nAt the start of your next turn, and when the " +
    ...
    def __init__(self):
        super().__init__(name="Call Lightning",
                         ...
                         description="A storm cloud appears in the shape of a cylinder that is 10 " +
                                    ...
                                    "are outdoors in stormy conditions when you cast this spell, " +
    ...
    def __init__(self):
        super().__init__(name="Calm Emotions",
                         ...
                         description="You attempt to suppress strong emotions in a group of people. " +
                                    ...
                                    "toward. This indifference ends if the target is attacked or " +
                                    "harmed by a spell or if it witnesses any of its friends being " +
                                    "harmed. When the spell ends, the creature becomes hostile " +
    ...
    def __init__(self):
        super().__init__(name="Clone",
                         ...
                         description="This spell grows an inert duplicate of a living creature as a " +
                                    ...
                                    "willing to return.\nThe clone is physically identical to the " +
    ...
    def __init__(self):
        super().__init__(name="Cloudkill",
                         ...
                         description="You create a 20-foot-radius sphere of poisonous, yellow-green " +
                                    ...
                                    "moves 10 feet away from you at the start of each of your " +
    ...
    def __init__(self):
        super().__init__(name="Command",
                         ...
                         description="You speak a one-word command to a creature you can see within " +
                                    ...
                                    "available means.\nGrovel. The target falls prone and then ends " +
    ...
    def __init__(self):
        super().__init__(name="Comprehend Languages",
                         ...
                         description="For the duration, you understand the literal meaning of any " +
                                    ...
                                    "in a text or a glyph, such as an arcane sigil, that isn't part " +
    ...
    def __init__(self):
        super().__init__(name="Conjure Elemental",
                         ...
                         description="You call forth an elemental servant. Choose an area of air, " +
                                    ...
                                    "companions for the duration. Roll initiative for the " +
                                    "elemental, which has its own turns. It obeys any verbal " +
                                    "commands that you issue to it (no action required by you). If " +
                                    "you don't issue any commands to the elemental, it defends " +
                                    "itself from hostile creatures but otherwise takes no " +
                                    "actions.\nIf your concentration is broken, the elemental " +
                                    "doesn't disappear. Instead, you lose control of the elemental, " +
                                    "it becomes hostile toward you and your companions, and it " +
                                    "might attack. An uncontrolled elemental can't be dismissed by " +
                                    "you, and it disappears 1 hour after you summoned it.\nThe GM " +
                                    "has the elemental's statistics. ",
                         at_higher_levels="When you cast this spell using a spell slot of 6th level or " +
    ...
    def __init__(self):
        super().__init__(name="Conjure Fey",
                         ...
                         description="You summon a fey creature of challenge rating 6 or lower, or a " +
                                    ...
                                    "creature, it becomes hostile toward you and your companions, " +
                                    "and it might attack. An uncontrolled fey creature can't be " +
                                    "dismissed by you, and it disappears 1 hour after you summoned " +
    ...
    def __init__(self):
        super().__init__(name="Conjure Minor Elementals",
                         ...
                         description="You summon elementals that appear in unoccupied spaces that " +
                                    ...
                                    "of challenge rating 1/4 or lower.\nAn elemental summoned by " +
                                    "this spell disappears when it drops to 0 hit points or when " +
                                    "the spell ends.\nThe summoned creatures are friendly to you " +
                                    "and your companions. Roll initiative for the summoned " +
                                    "creatures as a group, which has its own turns. They obey any " +
                                    "verbal commands that you issue to them (no action required by " +
    ...
    def __init__(self):
        super().__init__(name="Conjure Woodland Beings",
                         ...
                         description="You summon fey creatures that appear in unoccupied spaces that " +
                                    ...
                                    "a group, which have their own turns.\nThey obey any verbal " +
    ...
    def __init__(self):
        super().__init__(name="Contagion",
                         ...
                         description="Your touch inflicts disease. Make a melee spell attack against " +
                                    ...
                                    "checks and Intelligence saving throws, and the creature " +
                                    "behaves as if under the effects of the confusion spell during " +
                                    ...
                                    "Doom. The creature begins to bleed uncontrollably. The " +
    ...
    def __init__(self):
        super().__init__(name="Contingency",
                         ...
                         description="Choose a spell of 5th level or lower that you can cast, that " +
                                    ...
                                    "whether or not you want it to, and then contingency ends.\nThe " +
    ...
    def __init__(self):
        super().__init__(name="Control Water",
                         ...
                         description="Until the spell ends, you control any freestanding water " +
                                    ...
                                    "the flood effect lasts.\nPart Water. You cause water in the " +
                                    ...
                                    "choose a different effect.\nWhirlpool. This effect requires a " +
                                    ...
                                    "to 50 feet wide at the top, and 25 feet tall.\nAny creature or " +
    ...
    def __init__(self):
        super().__init__(name="Control Weather",
                         ...
                         description="You take control of the weather within 5 miles of you for the " +
                                    ...
                                    "conditions to take effect.\nOnce they do so, you can change " +
                                    "the conditions again.\nWhen the spell ends, the weather " +
                                    "gradually returns to normal.\nWhen you change the weather " +
                                    "conditions, find a current condition on the following tables " +
                                    "and change its stage by one, up or down. When changing the " +
                                    "wind, you can change its direction.\nPrecipitation Stage " +
                                    "Condition 1 Clear 2 Light clouds 3 Overcast or ground fog 4 " +
                                    "Rain, hail, or snow 5 Torrential rain, driving hail, or " +
                                    "blizzard Temperature Stage Condition 1 Unbearable heat 2 Hot 3 " +
                                    "Warm 4 Cool 5 Cold 6 Arctic cold Wind Stage Condition 1 Calm 2 " +
    ...
    def __init__(self):
        super().__init__(name="Creation",
                         ...
                         description="You pull wisps of shadow material from the Shadowfell to " +
                                    ...
                                    "the shortest duration.\nMaterial Duration Vegetable matter 1 " +
    ...
    def __init__(self):
        super().__init__(name="Death Ward",
                         ...
                         description="You touch a creature and grant it a measure of protection from " +
                                    ...
                                    "as a result of taking damage, the target instead drops to 1 " +
                                    "hit point, and the spell ends.\nIf the spell is still in " +
                                    "effect when the target is subjected to an effect that would " +
                                    "kill it instantaneously without dealing damage, that effect is " +
                                    "instead negated against the target, and the spell ends. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Delayed Blast Fireball",
                         ...
                         description="A beam of yellow light flashes from your pointing finger, then " +
                                    ...
                                    "flame that spreads around corners.\nEach creature in a " +
                                    ...
                                    "damage increases by 1d6.\nIf the glowing bead is touched " +
                                    "before the interval has expired, the creature touching it must " +
                                    "make a Dexterity saving throw. On a failed save, the spell " +
    ...
    def __init__(self):
        super().__init__(name="Demiplane",
                         ...
                         description="You create a shadowy door on a flat solid surface that you can " +
                                    ...
                                    "from the other side.\nEach time you cast this spell, you can " +
    ...
    def __init__(self):
        super().__init__(name="Dimension Door",
                         ...
                         description="You teleport yourself from your current location to any other " +
                                    ...
                                    "would arrive in a place already occupied by an object or a " +
                                    "creature, you and any creature traveling with you each take " +
    ...
    def __init__(self):
        super().__init__(name="Disintegrate",
                         ...
                         description="A thin green ray springs from your pointing finger to a target " +
                                    ...
                                    "created by wall of force.\nA creature targeted by this spell " +
    ...
    def __init__(self):
        super().__init__(name="Dispel Evil and Good",
                         ...
                         description="Shimmering energy surrounds and protects you from fey, undead, " +
                                    ...
                                    "the spell early by using either of the following special " +
                                    ...
                                    "your action, make a melee spell attack against a celestial, an " +
    ...
    def __init__(self):
        super().__init__(name="Divine Favor",
                         ...
                         description="Your prayer empowers you with divine radiance.\nUntil the " +
                                    "spell ends, your weapon attacks deal an extra 1d4 radiant " +
                                    "damage on a hit. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Divine Word",
                         ...
                         description="You utter a divine word, imbued with the power that shaped the " +
                                    ...
                                    "you can see within range.\nEach creature that can hear you " +
                                    "must make a Charisma saving throw. On a failed save, a " +
                                    "creature suffers an effect based on its current hit points: • " +
                                    "50 hit points or fewer: deafened for 1 minute • 40 hit points " +
                                    "or fewer: deafened and blinded for 10 minutes • 30 hit points " +
                                    "or fewer: blinded, deafened, and stunned for 1 hour • 20 hit " +
    ...
    def __init__(self):
        super().__init__(name="Dominate Monster",
                         ...
                         description="You attempt to beguile a creature that you can see within " +
                                    ...
                                    "best of its ability.\nYou can use your action to take total " +
                                    "and precise control of the target. Until the end of your next " +
                                    "turn, the creature takes only the actions you choose, and " +
                                    "doesn't do anything that you don't allow it to do.\nDuring " +
                                    "this time, you can also cause the creature to use a reaction, " +
                                    "but this requires you to use your own reaction as well.\nEach " +
                                    "time the target takes damage, it makes a new Wisdom saving " +
                                    "throw against the spell. If the saving throw succeeds, the " +
                                    "spell ends. ",
    ...
    def __init__(self):
        super().__init__(name="Dream",
                         ...
                         description="This spell shapes a creature's dreams. Choose a creature known " +
                                    ...
                                    "messenger.\nWhile in the trance, the messenger is aware of his " +
                                    "or her surroundings, but can't take actions or move.\nIf the " +
    ...
    def __init__(self):
        super().__init__(name="Earthquake",
                         ...
                         description="You create a seismic disturbance at a point on the ground that " +
                                    ...
                                    "with the ground in that area.\nThe ground in the area becomes " +
                                    ...
                                    "the GM.\nFissures. Fissures open throughout the spell's area " +
                                    "at the start of your next turn after you cast the spell. A " +
                                    "total of 1d6 such fissures open in locations chosen by the GM. " +
                                    "Each is 1d10 × 10 feet deep, 10 feet wide, and extends from " +
                                    "one edge of the spell's area to the opposite side. A creature " +
    ...
    def __init__(self):
        super().__init__(name="Enhance Ability",
                         ...
                         description="You touch a creature and bestow upon it a magical enhancement. " +
                                    ...
                                    "Intelligence checks.\nOwl's Wisdom. The target has advantage " +
                                    "on Wisdom checks. ",
                         at_higher_levels="When you cast this spell using a spell slot of 3rd level or " +
                                          "higher, you can target one additional creature for each slot " +
                                          "level above 2nd. ")
    ...
    def __init__(self):
        super().__init__(name="Enlarge/Reduce",
                         ...
                         description="You cause a creature or an object you can see within range to " +
                                    ...
                                    "normal size at once.\nEnlarge. The target's size doubles in " +
                                    "all dimensions, and its weight is multiplied by eight.\nThis " +
                                    "growth increases its size by one category— from Medium to " +
                                    ...
                                    "match its new size.\nWhile these weapons are reduced, the " +
    ...
    def __init__(self):
        super().__init__(name="Etherealness",
                         ...
                         description="You step into the border regions of the Ethereal Plane, in the " +
                                    ...
                                    "creatures on that plane.\nCreatures that aren't on the " +
                                    "Ethereal Plane can't perceive you and can't interact with you, " +
                                    "unless a special ability or magic has given them the ability " +
                                    "to do so.\nYou ignore all objects and effects that aren't on " +
                                    "the Ethereal Plane, allowing you to move through objects you " +
                                    "perceive on the plane you originated from.\nWhen the spell " +
                                    "ends, you immediately return to the plane you originated from " +
                                    "in the spot you currently occupy. If you occupy the same spot " +
                                    "as a solid object or creature when this happens, you are " +
    ...
    def __init__(self):
        super().__init__(name="Eyebite",
                         ...
                         description="For the spell's duration, your eyes become an inky void imbued " +
                                    ...
                                    "against this casting of eyebite.\nAsleep. The target falls " +
                                    "unconscious. It wakes up if it takes any damage or if another " +
                                    "creature uses its action to shake the sleeper " +
                                    "awake.\nPanicked. The target is frightened of you. On each of " +
                                    "its turns, the frightened creature must take the Dash action " +
                                    "and move away from you by the safest and shortest available " +
                                    "route, unless there is nowhere to move. If the target moves to " +
                                    "a place at least 60 feet away from you where it can no longer " +
                                    "see you, this effect ends.\nSickened. The target has " +
                                    "disadvantage on attack rolls and ability checks. At the end of " +
                                    "each of its turns, it can make another Wisdom saving throw. If " +
    ...
    def __init__(self):
        super().__init__(name="Faerie Fire",
                         ...
                         description="Each object in a 20-foot cube within range is outlined in " +
                                    ...
                                    "object has advantage if the attacker can see it, and the " +
    ...
    def __init__(self):
        super().__init__(name="Fear",
                         ...
                         description="You project a phantasmal image of a creature's worst fears. " +
                                    ...
                                    "a creature must take the Dash action and move away from you by " +
    ...
    def __init__(self):
        super().__init__(name="Find Familiar",
                         ...
                         description="You gain the service of a familiar, a spirit that takes an " +
                                    ...
                                    "regard to your own senses.\nAs an action, you can temporarily " +
    ...
    def __init__(self):
        super().__init__(name="Find Steed",
                         ...
                         description="You summon a spirit that assumes the form of an unusually " +
                                    ...
                                    "spell you cast that targets only you also target your " +
                                    ...
                                    "restored to its hit point maximum.\nWhile your steed is within " +
                                    "1 mile of you, you can communicate with it " +
                                    "telepathically.\nYou can't have more than one steed bonded by " +
                                    "this spell at a time. As an action, you can release the steed " +
    ...
    def __init__(self):
        super().__init__(name="Find Traps",
                         ...
                         description="You sense the presence of any trap within range that is within " +
                                    ...
                                    "do learn the general nature of the danger posed by a trap you " +
                                    "sense. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Flame Blade",
                         ...
                         description="You evoke a fiery blade in your free hand. The blade is " +
                                    ...
                                    "hit, the target takes 3d6 fire damage.\nThe flaming blade " +
    ...
    def __init__(self):
        super().__init__(name="Flesh to Stone",
                         ...
                         description="You attempt to turn one creature that you can see within range " +
                                    ...
                                    "from similar deformities if it reverts to its original " +
    ...
    def __init__(self):
        super().__init__(name="Forbiddance",
                         ...
                         description="You create a ward against magical travel that protects up to " +
                                    ...
                                    "another forbiddance spell. If you cast forbiddance every day " +
    ...
    def __init__(self):
        super().__init__(name="Forcecage",
                         ...
                         description="An immobile, invisible, cube-shaped prison composed of magical " +
                                    ...
                                    "inch apart.\nA prison in the shape of a box can be up to 10 " +
                                    "feet on a side, creating a solid barrier that prevents any " +
                                    "matter from passing through it and blocking any spells cast " +
                                    "into or out from the area.\nWhen you cast the spell, any " +
                                    "creature that is completely inside the cage's area is " +
                                    "trapped.\nCreatures only partially within the area, or those " +
                                    "too large to fit inside the area, are pushed away from the " +
                                    "center of the area until they are completely outside the " +
    ...
    def __init__(self):
        super().__init__(name="Freedom of Movement",
                         ...
                         description="You touch a willing creature. For the duration, the target's " +
                                    ...
                                    "target can also spend 5 feet of movement to automatically " +
    ...
    def __init__(self):
        super().__init__(name="Freezing Sphere",
                         ...
                         description="A frigid globe of cold energy streaks from your fingertips to " +
                                    ...
                                    "much damage.\nIf the globe strikes a body of water or a liquid " +
    ...
    def __init__(self):
        super().__init__(name="Gaseous Form",
                         ...
                         description="You transform a willing creature you touch, along with " +
                                    ...
                                    "otherwise incapacitated.\nWhile in the form of a misty cloud, " +
    ...
    def __init__(self):
        super().__init__(name="Gate",
                         ...
                         description="You conjure a portal linking an unoccupied space you can see " +
                                    ...
                                    "opening in their presence or anywhere within their " +
                                    "domains.\nWhen you cast this spell, you can speak the name of " +
                                    "a specific creature (a pseudonym, title, or nickname doesn't " +
    ...
    def __init__(self):
        super().__init__(name="Geas",
                         ...
                         description="You place a magical command on a creature that you can see " +
                                    ...
                                    "issue any command you choose, short of an activity that would " +
                                    "result in certain death. Should you issue a suicidal command, " +
                                    "the spell ends.\nYou can end the spell early by using an " +
                                    "action to dismiss it. A remove curse, greater restoration, or " +
    ...
    def __init__(self):
        super().__init__(name="Giant Insect",
                         ...
                         description="You transform up to ten centipedes, three spiders, five wasps, " +
                                    ...
                                    "on it.\nThe GM might allow you to choose different targets. " +
                                    "For example, if you transform a bee, its giant version might " +
    ...
    def __init__(self):
        super().__init__(name="Globe of Invulnerability",
                         ...
                         description="An immobile, faintly shimmering barrier springs into existence " +
                                    ...
                                    "spell can target creatures and objects within the barrier, but " +
                                    "the spell has no effect on them.\nSimilarly, the area within " +
                                    "the barrier is excluded from the areas affected by such " +
                                    "spells. ",
                         at_higher_levels="When you cast this spell using a spell slot of 7th level or " +
    ...
    def __init__(self):
        super().__init__(name="Glyph of Warding",
                         ...
                         description="When you cast this spell, you inscribe a glyph that harms " +
                                    ...
                                    "without being triggered.\nThe glyph is nearly invisible and " +
                                    ...
                                    "can further refine the trigger so the spell activates only " +
    ...
    def __init__(self):
        super().__init__(name="Guards and Wards",
                         ...
                         description="You create a ward that protects up to 2,500 square feet of " +
                                    ...
                                    "when spoken aloud, makes the speaker immune to these " +
                                    "effects.\nGuards and wards creates the following effects " +
                                    "within the warded area.\nCorridors. Fog fills all the warded " +
                                    "corridors, making them heavily obscured. In addition, at each " +
                                    ...
                                    "from the one it chooses.\nDoors. All doors in the warded area " +
                                    ...
                                    "illusion spell) to make them appear as plain sections of " +
                                    "wall.\nStairs. Webs fill all stairs in the warded area from " +
                                    "top to bottom, as the web spell. These strands regrow in 10 " +
                                    ...
                                    "vapors appear in the places you designate; they return within " +
                                    "10 minutes if dispersed by wind while guards and wards " +
                                    "lasts.\n• Place a constant gust of wind in one corridor or " +
                                    "room.\n• Place a suggestion in one location. You select an " +
                                    "area of up to 5 feet square, and any creature that enters or " +
                                    "passes through the area receives the suggestion mentally.\nThe " +
                                    "whole warded area radiates magic. A dispel magic cast on a " +
                                    "specific effect, if successful, removes only that effect.\nYou " +
                                    "can create a permanently guarded and warded structure by " +
    ...
    def __init__(self):
        super().__init__(name="Hallow",
                         ...
                         description="You touch a point and infuse an area around it with holy (or " +
                                    ...
                                    "fiends, and undead can't enter the area, nor can such " +
                                    "creatures charm, frighten, or possess creatures within it. Any " +
                                    "creature charmed, frightened, or possessed by such a creature " +
                                    "is no longer charmed, frightened, or possessed upon entering " +
                                    "the area. You can exclude one or more of those types of " +
                                    "creatures from this effect.\nSecond, you can bind an extra " +
                                    "effect to the area.\nChoose the effect from the following " +
                                    "list, or choose an effect offered by the GM. Some of these " +
                                    "effects apply to creatures in the area; you can designate " +
                                    "whether the effect applies to all creatures, creatures that " +
                                    "follow a specific deity or leader, or creatures of a specific " +
                                    "sort, such as orcs or trolls. When a creature that would be " +
                                    "affected enters the spell's area for the first time on a turn " +
                                    "or starts its turn there, it can make a Charisma saving throw. " +
                                    "On a success, the creature ignores the extra effect until it " +
                                    "leaves the area.\nCourage. Affected creatures can't be " +
                                    "frightened while in the area.\nDarkness. Darkness fills the " +
                                    "area. Normal light, as well as magical light created by spells " +
                                    "of a lower level than the slot you used to cast this spell, " +
                                    "can't illuminate the area.\nDaylight. Bright light fills the " +
                                    "area. Magical darkness created by spells of a lower level than " +
                                    "the slot you used to cast this spell can't extinguish the " +
                                    "light.\nEnergy Protection. Affected creatures in the area have " +
                                    "resistance to one damage type of your choice, except for " +
                                    "bludgeoning, piercing, or slashing.\nEnergy Vulnerability. " +
                                    "Affected creatures in the area have vulnerability to one " +
                                    "damage type of your choice, except for bludgeoning, piercing, " +
                                    "or slashing.\nEverlasting Rest. Dead bodies interred in the " +
                                    "area can't be turned into undead.\nExtradimensional " +
                                    "Interference. Affected creatures can't move or travel using " +
                                    "teleportation or by extradimensional or interplanar " +
                                    "means.\nFear. Affected creatures are frightened while in the " +
                                    "area.\nSilence. No sound can emanate from within the area, and " +
                                    "no sound can reach into it.\nTongues. Affected creatures can " +
                                    "communicate with any other creature in the area, even if they " +
    ...
    def __init__(self):
        super().__init__(name="Heroism",
                         ...
                         description="A willing creature you touch is imbued with bravery.\nUntil " +
                                    "the spell ends, the creature is immune to being frightened and " +
    ...
    def __init__(self):
        super().__init__(name="Imprisonment",
                         ...
                         description="You create a magical restraint to hold a creature that you can " +
                                    ...
                                    "for this version of the spell is a small mithral " +
                                    "orb.\nChaining. Heavy chains, firmly rooted in the ground, " +
                                    "hold the target in place. The target is restrained until the " +
                                    "spell ends, and it can't move or be moved by any means until " +
                                    "then.\nThe special component for this version of the spell is " +
                                    "a fine chain of precious metal.\nHedged Prison. The spell " +
                                    "transports the target into a tiny demiplane that is warded " +
                                    "against teleportation and planar travel. The demiplane can be " +
                                    "a labyrinth, a cage, a tower, or any similar confined " +
                                    "structure or area of your choice.\nThe special component for " +
                                    "this version of the spell is a miniature representation of the " +
                                    "prison made from jade.\nMinimus Containment. The target " +
                                    "shrinks to a height of 1 inch and is imprisoned inside a " +
                                    "gemstone or similar object. Light can pass through the " +
                                    "gemstone normally (allowing the target to see out and other " +
                                    "creatures to see in), but nothing else can pass through, even " +
                                    "by means of teleportation or planar travel. The gemstone can't " +
                                    ...
                                    "of the spell, in any of its versions, you can specify a " +
                                    "condition that will cause the spell to end and release the " +
                                    "target. The condition can be as specific or as elaborate as " +
                                    "you choose, but the GM must agree that the condition is " +
                                    ...
                                    "it is cast as a 9th-level spell, targeting either the prison " +
                                    "or the special component used to create it.\nYou can use a " +
                                    "particular special component to create only one prison at a " +
                                    "time. If you cast the spell again using the same component, " +
                                    "the target of the first casting is immediately freed from its " +
                                    "binding. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Incendiary Cloud",
                         ...
                         description="A swirling cloud of smoke shot through with whitehot embers " +
                                    ...
                                    "must make a Dexterity saving throw. A creature takes 10d8 fire " +
                                    "damage on a failed save, or half as much damage on a " +
    ...
    def __init__(self):
        super().__init__(name="Insect Plague",
                         ...
                         description="Swarming, biting locusts fill a 20-foot-radius sphere centered " +
                                    ...
                                    "lightly obscured. The sphere's area is difficult " +
                                    "terrain.\nWhen the area appears, each creature in it must make " +
                                    "a Constitution saving throw. A creature takes 4d10 piercing " +
                                    "damage on a failed save, or half as much damage on a " +
                                    "successful one. A creature must also make this saving throw " +
                                    "when it enters the spell's area for the first time on a turn " +
                                    "or ends its turn there. ",
    ...
    def __init__(self):
        super().__init__(name="Instant Summons",
                         ...
                         description="You touch an object weighing 10 pounds or less whose longest " +
                                    ...
                                    "holding or carrying the item, crushing the sapphire doesn't " +
                                    "transport the item to you, but instead you learn who the " +
                                    "creature possessing the object is and roughly where that " +
                                    "creature is located at that moment.\nDispel magic or a similar " +
                                    "effect successfully applied to the sapphire ends this spell's " +
                                    "effect. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Irresistible Dance",
                         ...
                         description="Choose one creature that you can see within range.\nThe target " +
                                    ...
                                    "charmed are immune to this spell.\nA dancing creature must use " +
                                    "all its movement to dance without leaving its space and has " +
    ...
    def __init__(self):
        super().__init__(name="Levitate",
                         ...
                         description="One creature or object of your choice that you can see within " +
                                    ...
                                    "on a Constitution saving throw is unaffected.\nThe target can " +
    ...
    def __init__(self):
        super().__init__(name="Light",
                         ...
                         description="You touch one object that is no larger than 10 feet in any " +
                                    ...
                                    "target an object held or worn by a hostile creature, that " +
    ...
    def __init__(self):
        super().__init__(name="Magic Circle",
                         ...
                         description="You create a 10-foot-radius, 20-foot-tall cylinder of magical " +
                                    ...
                                    "more of the following types of creatures: celestials, " +
                                    "elementals, fey, fiends, or undead. The circle affects a " +
                                    "creature of the chosen type in the following ways: • The " +
                                    "creature can't willingly enter the cylinder by nonmagical " +
                                    "means. If the creature tries to use teleportation or " +
                                    ...
                                    "within the cylinder can't be charmed, frightened, or possessed " +
                                    "by the creature.\nWhen you cast this spell, you can elect to " +
                                    "cause its magic to operate in the reverse direction, " +
    ...
    def __init__(self):
        super().__init__(name="Magic Jar",
                         ...
                         description="Your body falls into a catatonic state as your soul leaves it " +
                                    ...
                                    "it again for 24 hours.\nOnce you possess a creature's body, " +
                                    ...
                                    "use your action to return from the host body to the container " +
                                    "if it is within 100 feet of you, returning the host creature's " +
                                    "soul to its body. If the host body dies while you're in it, " +
                                    "the creature dies, and you must make a Charisma saving throw " +
    ...
    def __init__(self):
        super().__init__(name="Magnificent Mansion",
                         ...
                         description="You conjure an extradimensional dwelling in range that lasts " +
                                    ...
                                    "attends all who enter.\nYou decide the visual appearance of " +
    ...
    def __init__(self):
        super().__init__(name="Maze",
                         ...
                         description="You banish a creature that you can see within range into a " +
                                    ...
                                    "spell ends (a minotaur or goristro demon automatically " +
    ...
    def __init__(self):
        super().__init__(name="Meld into Stone",
                         ...
                         description="You step into a stone object or surface large enough to fully " +
                                    ...
                                    "to leave the stone where you entered it, which ends the " +
                                    "spell.\nYou otherwise can't move.\nMinor physical damage to " +
                                    "the stone doesn't harm you, but its partial destruction or a " +
                                    "change in its shape (to the extent that you no longer fit " +
                                    "within it) expels you and deals 6d6 bludgeoning damage to you. " +
                                    "The stone's complete destruction (or transmutation into a " +
    ...
    def __init__(self):
        super().__init__(name="Message",
                         ...
                         description="You point your finger toward a creature within range and " +
                                    ...
                                    "message and can reply in a whisper that only you can " +
    ...
    def __init__(self):
        super().__init__(name="Minor Illusion",
                         ...
                         description="You create a sound or an image of an object within range that " +
                                    ...
                                    "create an image of an object—such as a chair, muddy " +
    ...
    def __init__(self):
        super().__init__(name="Mirage Arcane",
                         ...
                         description="You make terrain in an area up to 1 mile square look, sound, " +
                                    ...
                                    "audible, visual, tactile, and olfactory elements, so it can " +
                                    "turn clear ground into difficult terrain (or vice versa) or " +
                                    "otherwise impede movement through the area. Any piece of the " +
                                    "illusory terrain (such as a rock or stick) that is removed " +
                                    "from the spell's area disappears immediately.\nCreatures with " +
                                    "truesight can see through the illusion to the terrain's true " +
                                    "form; however, all other elements of the illusion remain, so " +
                                    "while the creature is aware of the illusion's presence, the " +
    ...
    def __init__(self):
        super().__init__(name="Mirror Image",
                         ...
                         description="Three illusory duplicates of yourself appear in your space. " +
                                    ...
                                    "duplicates, you must roll an 8 or higher.\nWith one duplicate, " +
                                    "you must roll an 11 or higher.\nA duplicate's AC equals 10 + " +
    ...
    def __init__(self):
        super().__init__(name="Modify Memory",
                         ...
                         description="You attempt to reshape another creature's memories.\nOne " +
                                    ...
                                    "the duration.\nThe charmed target is incapacitated and unaware " +
                                    ...
                                    "memory doesn't necessarily affect how a creature behaves, " +
    ...
    def __init__(self):
        super().__init__(name="Moonbeam",
                         ...
                         description="A silvery beam of pale light shines down in a 5-footradius, " +
                                    ...
                                    "damage on a successful one.\nA shapechanger makes its saving " +
                                    "throw with disadvantage. If it fails, it also instantly " +
                                    "reverts to its original form and can't assume a different form " +
                                    "until it leaves the spell's light.\nOn each of your turns " +
                                    "after you cast this spell, you can use an action to move the " +
    ...
    def __init__(self):
        super().__init__(name="Planar Ally",
                         ...
                         description="You beseech an otherworldly entity for aid. The being must be " +
                                    ...
                                    "an elemental, or a fiend loyal to it to aid you, making the " +
                                    ...
                                    "get a different creature anyway (GM's choice).\nWhen the " +
                                    ...
                                    "items to an allied temple, while a fiend might demand a living " +
                                    "sacrifice or a gift of treasure. Some creatures might exchange " +
                                    "their service for a quest undertaken by you.\nAs a rule of " +
                                    "thumb, a task that can be measured in minutes requires a " +
                                    "payment worth 100 gp per minute. A task measured in hours " +
                                    "requires 1,000 gp per hour. And a task measured in days (up to " +
                                    "10 days) requires 10,000 gp per day. The GM can adjust these " +
                                    "payments based on the circumstances under which you cast the " +
                                    "spell. If the task is aligned with the creature's ethos, the " +
                                    ...
                                    "to the task and if possible.\nIf you are unable to agree on a " +
                                    "price for the creature's service, the creature immediately " +
                                    "returns to its home plane.\nA creature enlisted to join your " +
                                    "group counts as a member of it, receiving a full share of " +
    ...
    def __init__(self):
        super().__init__(name="Planar Binding",
                         ...
                         description="With this spell, you attempt to bind a celestial, an " +
                                    ...
                                    "creature must follow your instructions to the best of its " +
                                    "ability. You might command the creature to accompany you on an " +
                                    "adventure, to guard a location, or to deliver a message. The " +
    ...
    def __init__(self):
        super().__init__(name="Plane Shift",
                         ...
                         description="You and up to eight willing creatures who link hands in a " +
                                    ...
                                    "across the Sea of Fire, at the GM's " +
                                    "discretion.\nAlternatively, if you know the sigil sequence of " +
                                    "a teleportation circle on another plane of existence, this " +
                                    "spell can take you to that circle. If the teleportation circle " +
                                    "is too small to hold all the creatures you transported, they " +
                                    "appear in the closest unoccupied spaces next to the " +
                                    "circle.\nYou can use this spell to banish an unwilling " +
                                    "creature to another plane. Choose a creature within your reach " +
                                    "and make a melee spell attack against it.\nOn a hit, the " +
                                    "creature must make a Charisma saving throw. If the creature " +
                                    "fails this save, it is transported to a random location on the " +
                                    "plane of existence you specify. A creature so transported must " +
                                    "find its own way back to your current plane of existence. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Plant Growth",
                         ...
                         description="This spell channels vitality into plants within a specific " +
                                    ...
                                    "spell using 1 action, choose a point within range. All normal " +
                                    "plants in a 100-foot radius centered on that point become " +
                                    "thick and overgrown.\nA creature moving through the area must " +
                                    "spend 4 feet of movement for every 1 foot it moves.\nYou can " +
                                    "exclude one or more areas of any size within the spell's area " +
    ...
    def __init__(self):
        super().__init__(name="Polymorph",
                         ...
                         description="This spell transforms a creature that you can see within range " +
                                    ...
                                    "its normal form, the creature returns to the number of hit " +
                                    "points it had before it transformed. If it reverts as a result " +
    ...
    def __init__(self):
        super().__init__(name="Prestidigitation",
                         ...
                         description="This spell is a minor magical trick that novice spellcasters " +
                                    ...
                                    "cubic foot.\n• You chill, warm, or flavor up to 1 cubic foot " +
                                    "of nonliving material for 1 hour.\n• You make a color, a small " +
                                    "mark, or a symbol appear on an object or a surface for 1 " +
                                    ...
                                    "have up to three of its non-instantaneous effects active at a " +
    ...
    def __init__(self):
        super().__init__(name="Prismatic Spray",
                         ...
                         description="Eight multicolored rays of light flash from your hand.\nEach " +
                                    ...
                                    "failed save, or half as much damage on a successful one.\n4. " +
                                    "Green. The target takes 10d6 poison damage on a failed save, " +
                                    "or half as much damage on a successful one.\n5. Blue. The " +
                                    "target takes 10d6 cold damage on a failed save, or half as " +
                                    "much damage on a successful one.\n6. Indigo. On a failed save, " +
                                    "the target is restrained.\nIt must then make a Constitution " +
                                    ...
                                    "failed save, the target is blinded. It must then make a Wisdom " +
                                    "saving throw at the start of your next turn. A successful save " +
                                    "ends the blindness. If it fails that save, the creature is " +
                                    "transported to another plane of existence of the GM's choosing " +
                                    "and is no longer blinded. (Typically, a creature that is on a " +
                                    "plane that isn't its home plane is banished home, while other " +
                                    "creatures are usually cast into the Astral or Ethereal " +
                                    "planes.) 8. Special. The target is struck by two rays. Roll " +
    ...
    def __init__(self):
        super().__init__(name="Prismatic Wall",
                         ...
                         description="A shimmering, multicolored plane of light forms a vertical " +
                                    ...
                                    "is in place, magical ranged attacks can't pass through the " +
                                    "wall. The layer is destroyed by a strong wind.\n3. Yellow. The " +
                                    "creature takes 10d6 lightning damage on a failed save, or half " +
                                    "as much damage on a successful one. This layer can be " +
                                    "destroyed by dealing at least 60 force damage to it.\n4. " +
                                    "Green. The creature takes 10d6 poison damage on a failed save, " +
                                    "or half as much damage on a successful one. A passwall spell, " +
                                    "or another spell of equal or greater level that can open a " +
                                    "portal on a solid surface, destroys this layer.\n5. Blue. The " +
                                    "creature takes 10d6 cold damage on a failed save, or half as " +
                                    "much damage on a successful one. This layer can be destroyed " +
                                    ...
                                    "subjected to the petrified condition. The successes and " +
                                    "failures don't need to be consecutive; keep track of both " +
                                    "until the creature collects three of a kind.\nWhile this layer " +
                                    ...
                                    "failed save, the creature is blinded.\nIt must then make a " +
                                    "Wisdom saving throw at the start of your next turn. A " +
                                    "successful save ends the blindness. If it fails that save, the " +
                                    "creature is transported to another plane of the GM's choosing " +
                                    "and is no longer blinded. (Typically, a creature that is on a " +
                                    "plane that isn't its home plane is banished home, while other " +
                                    "creatures are usually cast into the Astral or Ethereal " +
                                    "planes.) This layer is destroyed by a dispel magic spell or a " +
                                    "similar spell of equal or higher level that can end spells and " +
                                    "magical effects. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Private Sanctum",
                         ...
                         description="You make an area within range magically secure.\nThe area is a " +
                                    ...
                                    "area can't be targeted by divination spells.\n• Nothing can " +
                                    "teleport into or out of the warded area.\n• Planar travel is " +
    ...
    def __init__(self):
        super().__init__(name="Programmed Illusion",
                         ...
                         description="You create an illusion of an object, a creature, or some other " +
                                    ...
                                    "time, the illusion can be activated again.\nThe triggering " +
                                    "condition can be as general or as detailed as you like, though " +
                                    "it must be based on visual or audible conditions that occur " +
                                    "within 30 feet of the area. For example, you could create an " +
                                    "illusion of yourself to appear and warn off others who attempt " +
                                    "to open a trapped door, or you could set the illusion to " +
                                    ...
                                    "can see through the image, and any noise it makes sounds " +
    ...
    def __init__(self):
        super().__init__(name="Project Image",
                         ...
                         description="You create an illusory copy of yourself that lasts for the " +
                                    ...
                                    "mannerisms perfectly.\nYou can see through its eyes and hear " +
                                    ...
                                    "to be an illusion, because things can pass through it. A " +
    ...
    def __init__(self):
        super().__init__(name="Reincarnate",
                         ...
                         description="You touch a dead humanoid or a piece of a dead humanoid. " +
                                    ...
                                    "or willing to do so, the spell fails.\nThe magic fashions a " +
                                    "new body for the creature to inhabit, which likely causes the " +
                                    "creature's race to change. The GM rolls a d100 and consults " +
                                    "the following table to determine what form the creature takes " +
                                    "when restored to life, or the GM chooses a form.\nd100 Race " +
    ...
    def __init__(self):
        super().__init__(name="Resilient Sphere",
                         ...
                         description="A sphere of shimmering force encloses a creature or object of " +
                                    ...
                                    "in or out, though a creature in the sphere can breathe " +
                                    "there.\nThe sphere is immune to all damage, and a creature or " +
                                    "object inside can't be damaged by attacks or effects " +
                                    "originating from outside, nor can a creature inside the sphere " +
                                    "damage anything outside it.\nThe sphere is weightless and just " +
                                    "large enough to contain the creature or object inside. An " +
                                    "enclosed creature can use its action to push against the " +
                                    "sphere's walls and thus roll the sphere at up to half the " +
                                    "creature's speed. Similarly, the globe can be picked up and " +
                                    "moved by other creatures.\nA disintegrate spell targeting the " +
                                    "globe destroys it without harming anything inside it. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Resurrection",
                         ...
                         description="You touch a dead creature that has been dead for no more than " +
                                    ...
                                    "the spell, they afflict the target on its return to " +
                                    "life.\nThis spell closes all mortal wounds and restores any " +
                                    "missing body parts.\nComing back from the dead is an ordeal. " +
                                    "The target takes a −4 penalty to all attack rolls, saving " +
                                    "throws, and ability checks. Every time the target finishes a " +
                                    "long rest, the penalty is reduced by 1 until it " +
                                    "disappears.\nCasting this spell to restore life to a creature " +
                                    "that has been dead for one year or longer taxes you greatly. " +
                                    "Until you finish a long rest, you can't cast spells again, and " +
                                    "you have disadvantage on all attack rolls, ability checks, and " +
                                    "saving throws. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Reverse Gravity",
                         ...
                         description="This spell reverses gravity in a 50-foot-radius, 100- foot " +
                                    ...
                                    "grab onto a fixed object it can reach, thus avoiding the " +
    ...
    def __init__(self):
        super().__init__(name="Rope Trick",
                         ...
                         description="You touch a length of rope that is up to 60 feet long.\nOne " +
                                    "end of the rope then rises into the air until the whole rope " +
                                    "hangs perpendicular to the ground. At the upper end of the " +
                                    "rope, an invisible entrance opens to an extradimensional space " +
                                    "that lasts until the spell ends.\nThe extradimensional space " +
                                    "can be reached by climbing to the top of the rope. The space " +
                                    "can hold as many as eight Medium or smaller creatures. The " +
                                    "rope can be pulled into the space, making the rope disappear " +
                                    "from view outside the space.\nAttacks and spells can't cross " +
                                    "through the entrance into or out of the extradimensional " +
                                    "space, but those inside can see out of it as if through a " +
                                    "3-foot-by-5- foot window centered on the rope.\nAnything " +
                                    "inside the extradimensional space drops out when the spell " +
                                    "ends. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Scrying",
                         ...
                         description="You can see and hear a particular creature you choose that is " +
                                    ...
                                    "observed.\nKnowledge Save Modifier Secondhand (you have heard " +
                                    "of the target) +5 Firsthand (you have met the target) +0 " +
                                    "Familiar (you know the target well) −5 Connection Save " +
                                    "Modifier Likeness or picture −2 Possession or garment −4 Body " +
                                    "part, lock of hair, bit of nail, or the like −10 On a " +
                                    "successful save, the target isn't affected, and you can't use " +
                                    "this spell against it again for 24 hours.\nOn a failed save, " +
                                    "the spell creates an invisible sensor within 10 feet of the " +
                                    "target. You can see and hear through the sensor as if you were " +
                                    "there. The sensor moves with the target, remaining within 10 " +
                                    "feet of it for the duration. A creature that can see invisible " +
                                    "objects sees the sensor as a luminous orb about the size of " +
    ...
    def __init__(self):
        super().__init__(name="Secret Chest",
                         ...
                         description="You hide a chest, and all its contents, on the Ethereal Plane. " +
                                    ...
                                    "chance per day that the spell's effect ends. This effect ends " +
                                    "if you cast this spell again, if the smaller replica chest is " +
    ...
    def __init__(self):
        super().__init__(name="Seeming",
                         ...
                         description="This spell allows you to change the appearance of any number " +
                                    ...
                                    "your action to dismiss it sooner.\nThe changes wrought by this " +
    ...
    def __init__(self):
        super().__init__(name="Sequester",
                         ...
                         description="By means of this spell, a willing creature or an object can be " +
                                    ...
                                    "is a creature, it falls into a state of suspended animation. " +
                                    "Time ceases to flow for it, and it doesn't grow older.\nYou " +
                                    "can set a condition for the spell to end early.\nThe condition " +
                                    "can be anything you choose, but it must occur or be visible " +
                                    "within 1 mile of the target.\nExamples include “after 1,000 " +
    ...
    def __init__(self):
        super().__init__(name="Shapechange",
                         ...
                         description="You assume the form of a different creature for the duration. " +
                                    ...
                                    "actions of the new form.\nYou assume the hit points and Hit " +
                                    ...
                                    "sense. You can only speak if the creature can normally " +
                                    ...
                                    "duration, you can use your action to assume a different form " +
                                    "following the same restrictions and rules for the original " +
                                    "form, with one exception: if your new form has more hit points " +
                                    "than your current one, your hit points remain at their current " +
                                    "value. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Sleet Storm",
                         ...
                         description="Until the spell ends, freezing rain and sleet fall in a " +
                                    ...
                                    "creature is concentrating in the spell's area, the creature " +
                                    "must make a successful Constitution saving throw against your " +
    ...
    def __init__(self):
        super().__init__(name="Slow",
                         ...
                         description="You alter time around up to six creatures of your choice in a " +
                                    ...
                                    "attack during its turn.\nIf the creature attempts to cast a " +
                                    ...
                                    "to complete the spell. If it can't, the spell is wasted.\nA " +
    ...
    def __init__(self):
        super().__init__(name="Speak with Plants",
                         ...
                         description="You imbue plants within 30 feet of you with limited sentience " +
                                    ...
                                    "other circumstances.\nYou can also turn difficult terrain " +
                                    ...
                                    "able to perform other tasks on your behalf, at the GM's " +
                                    "discretion. The spell doesn't enable plants to uproot " +
                                    ...
                                    "can cause the plants created by the entangle spell to release " +
    ...
    def __init__(self):
        super().__init__(name="Stinking Cloud",
                         ...
                         description="You create a 20-foot-radius sphere of yellow, nauseating gas " +
                                    ...
                                    "in the air for the duration.\nEach creature that is completely " +
    ...
    def __init__(self):
        super().__init__(name="Storm of Vengeance",
                         ...
                         description="A churning storm cloud forms, centered on a point you can see " +
                                    ...
                                    "beneath the cloud. A given creature or object can't be struck " +
                                    "by more than one bolt. A struck creature must make a Dexterity " +
                                    "saving throw. The creature takes 10d6 lightning damage on a " +
                                    ...
                                    "attacks in the area are impossible. The wind and rain count as " +
                                    "a severe distraction for the purposes of maintaining " +
                                    "concentration on spells. Finally, gusts of strong wind " +
                                    "(ranging from 20 to 50 miles per hour) automatically disperse " +
                                    "fog, mists, and similar phenomena in the area, whether mundane " +
                                    "or magical. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Suggestion",
                         ...
                         description="You suggest a course of activity (limited to a sentence or " +
                                    ...
                                    "spell ends when the subject finishes what it was asked to " +
    ...
    def __init__(self):
        super().__init__(name="Sunbeam",
                         ...
                         description="A beam of brilliant light flashes out from your hand in a " +
                                    ...
                                    "this saving throw.\nYou can create a new line of radiance as " +
                                    "your action on any turn until the spell ends.\nFor the " +
    ...
    def __init__(self):
        super().__init__(name="Symbol",
                         ...
                         description="When you cast this spell, you inscribe a harmful glyph either " +
                                    ...
                                    "or reading the glyph.\nYou can further refine the trigger so " +
                                    ...
                                    "throw, taking 10d10 necrotic damage on a failed save, or half " +
                                    "as much damage on a successful save.\nDiscord. Each target " +
                                    "must make a Constitution saving throw. On a failed save, a " +
                                    "target bickers and argues with other creatures for 1 minute. " +
                                    "During this time, it is incapable of meaningful communication " +
                                    ...
                                    "Charisma saving throw. On a failed save, the target is " +
                                    "overwhelmed with despair for 1 minute. During this time, it " +
                                    ...
                                    "target is driven insane for 1 minute. An insane creature can't " +
                                    "take actions, can't understand what other creatures say, can't " +
                                    "read, and speaks only in gibberish. The GM controls its " +
                                    "movement, which is erratic.\nPain. Each target must make a " +
                                    "Constitution saving throw and becomes incapacitated with " +
                                    "excruciating pain for 1 minute on a failed save.\nSleep. Each " +
                                    "target must make a Wisdom saving throw and falls unconscious " +
                                    "for 10 minutes on a failed save. A creature awakens if it " +
                                    "takes damage or if someone uses an action to shake or slap it " +
    ...
    def __init__(self):
        super().__init__(name="Telekinesis",
                         ...
                         description="You gain the ability to move or manipulate creatures or " +
                                    ...
                                    "repeating the contest.\nObject. You can try to move an object " +
    ...
    def __init__(self):
        super().__init__(name="Teleport",
                         ...
                         description="This spell instantly transports you and up to eight willing " +
                                    ...
                                    "d100 and consults the table.\nFamiliarity Mishap Similar Area " +
                                    ...
                                    "once” is a place you have seen once, possibly using " +
                                    ...
                                    "and your group (or the target object) appear where you want " +
                                    ...
                                    "at sea, you could be in trouble.\nSimilar Area. You and your " +
                                    "group (or the target object) wind up in a different area " +
                                    "that's visually or thematically similar to the target area. If " +
                                    "you are heading for your home laboratory, for example, you " +
                                    "might wind up in another wizard's laboratory or in an " +
    ...
    def __init__(self):
        super().__init__(name="Teleportation Circle",
                         ...
                         description="As you cast the spell, you draw a 10-foot-diameter circle on " +
                                    ...
                                    "and other important places have permanent teleportation " +
                                    "circles inscribed somewhere within their confines. Each such " +
                                    "circle includes a unique sigil sequence—a string of magical " +
                                    "runes arranged in a particular pattern. When you first gain " +
                                    "the ability to cast this spell, you learn the sigil sequences " +
                                    "for two destinations on the Material Plane, determined by the " +
                                    "GM. You can learn additional sigil sequences during your " +
                                    "adventures. You can commit a new sigil sequence to memory " +
                                    "after studying it for 1 minute.\nYou can create a permanent " +
    ...
    def __init__(self):
        super().__init__(name="Thaumaturgy",
                         ...
                         description="You manifest a minor wonder, a sign of supernatural power, " +
                                    ...
                                    "tremors in the ground for 1 minute.\n• You create an " +
                                    ...
                                    "unlocked door or window to fly open or slam shut.\n• You alter " +
                                    "the appearance of your eyes for 1 minute.\nIf you cast this " +
    ...
    def __init__(self):
        super().__init__(name="Tiny Hut",
                         ...
                         description="A 10-foot-radius immobile dome of force springs into existence " +
                                    ...
                                    "Medium size or smaller can fit inside the dome with you. The " +
                                    "spell fails if its area includes a larger creature or more " +
                                    "than nine creatures. Creatures and objects within the dome " +
                                    "when you cast this spell can move through it freely.\nAll " +
                                    "other creatures and objects are barred from passing through " +
                                    "it. Spells and other magical effects can't extend through the " +
                                    ...
                                    "to become dimly lit or dark. The dome is opaque from the " +
                                    "outside, of any color you choose, but it is transparent from " +
                                    "the inside. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Tree Stride",
                         ...
                         description="You gain the ability to enter a tree and move from inside it " +
                                    ...
                                    "tree you entered.\nYou can use this transportation ability " +
                                    "once per round for the duration. You must end each turn " +
                                    "outside a tree. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="True Polymorph",
                         ...
                         description="Choose one creature or nonmagical object that you can see " +
                                    ...
                                    "alignment and personality.\nThe target assumes the hit points " +
                                    ...
                                    "becomes permanent, you no longer control the creature. It " +
                                    "might remain friendly to you, depending on how you have " +
                                    "treated it.\nCreature into Object. If you turn a creature into " +
                                    "an object, it transforms along with whatever it is wearing and " +
    ...
    def __init__(self):
        super().__init__(name="True Resurrection",
                         ...
                         description="You touch a creature that has been dead for no longer than 200 " +
                                    ...
                                    "any curses affecting the creature when it died. The spell " +
                                    "replaces damaged or missing organs and limbs.\nThe spell can " +
                                    "even provide a new body if the original no longer exists, in " +
                                    "which case you must speak the creature's name. The creature " +
                                    "then appears in an unoccupied space you choose within 10 feet " +
                                    "of you. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Unseen Servant",
                         ...
                         description="This spell creates an invisible, mindless, shapeless force " +
                                    ...
                                    "points, the spell ends.\nOnce on each of your turns as a bonus " +
                                    ...
                                    "serving food, and pouring wine.\nOnce you give the command, " +
                                    "the servant performs the task to the best of its ability until " +
                                    "it completes the task, then waits for your next command.\nIf " +
                                    "you command the servant to perform a task that would move it " +
    ...
    def __init__(self):
        super().__init__(name="Vicious Mockery",
                         ...
                         description="You unleash a string of insults laced with subtle enchantments " +
                                    ...
                                    "hear you (though it need not understand you), it must succeed " +
                                    "on a Wisdom saving throw or take 1d4 psychic damage and have " +
                                    "disadvantage on the next attack roll it makes before the end " +
                                    "of its next turn.\nThis spell's damage increases by 1d4 when " +
    ...
    def __init__(self):
        super().__init__(name="Wall of Ice",
                         ...
                         description="You create a wall of ice on a solid surface within range. You " +
                                    ...
                                    "lasts for the duration.\nIf the wall cuts through a creature's " +
    ...
    def __init__(self):
        super().__init__(name="Wall of Stone",
                         ...
                         description="A nonmagical wall of solid stone springs into existence at a " +
                                    ...
                                    "wall (your choice). If a creature would be surrounded on all " +
                                    "sides by the wall (or the wall and another solid surface), " +
                                    "that creature can make a Dexterity saving throw. On a success, " +
                                    "it can use its reaction to move up to its speed so that it is " +
                                    "no longer enclosed by the wall.\nThe wall can have any shape " +
                                    "you desire, though it can't occupy the same space as a " +
                                    "creature or object.\nThe wall doesn't need to be vertical or " +
                                    "rest on any firm foundation. It must, however, merge with and " +
                                    "be solidly supported by existing stone. Thus, you can use this " +
                                    "spell to bridge a chasm or create a ramp.\nIf you create a " +
                                    "span greater than 20 feet in length, you must halve the size " +
                                    "of each panel to create supports. You can crudely shape the " +
                                    "wall to create crenellations, battlements, and so on.\nThe " +
                                    "wall is an object made of stone that can be damaged and thus " +
    ...
    def __init__(self):
        super().__init__(name="Wall of Thorns",
                         ...
                         description="You create a wall of tough, pliable, tangled brush bristling " +
                                    ...
                                    "wall appears, each creature within its area must make a " +
    ...
    def __init__(self):
        super().__init__(name="Warding Bond",
                         ...
                         description="This spell wards a willing creature you touch and creates a " +
                                    ...
                                    "amount of damage.\nThe spell ends if you drop to 0 hit points " +
    ...
    def __init__(self):
        super().__init__(name="Web",
                         ...
                         description="You conjure a mass of thick, sticky webbing at a point of your " +
                                    ...
                                    "on itself, and the spell ends at the start of your next " +
    ...
    def __init__(self):
        super().__init__(name="Wind Walk",
                         ...
                         description="You and up to ten willing creatures you can see within range " +
                                    ...
                                    "cloud form, which also requires the 1-minute " +
                                    "transformation.\nIf a creature is in cloud form and flying " +
                                    "when the effect ends, the creature descends 60 feet per round " +
                                    "for 1 minute until it lands, which it does safely. If it can't " +
                                    "land after 1 minute, the creature falls the remaining " +
                                    "distance. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Wish",
                         ...
                         description="Wish is the mightiest spell a mortal creature can cast.\nBy " +
                                    ...
                                    "including costly components. The spell simply takes " +
                                    ...
                                    "twenty creatures that you can see to regain all hit points, " +
                                    "and you end all effects on them described in the greater " +
                                    "restoration spell.\n• You grant up to ten creatures that you " +
                                    "can see resistance to a damage type you choose.\n• You grant " +
                                    "up to ten creatures you can see immunity to a single spell or " +
                                    "other magical effect for 8 hours. For instance, you could make " +
                                    ...
                                    "item's current owner.\nThe stress of casting this spell to " +
    ...
    def __init__(self):
        super().__init__(name="Word of Recall",
                         ...
                         description="You and up to five willing creatures within 5 feet of you " +
                                    ...
                                    "must designate a sanctuary by casting this spell within a " +
    ...
    def __init__(self):
        super().__init__(name="Zone of Truth",
                         ...
                         description="You create a magical zone that guards against deception in a " +
                                    ...
                                    "thus avoid answering questions to which it would normally " +
                                    "respond with a lie. Such a creature can be evasive in its " +
                                    "answers as long as it remains within the boundaries of the " +
                                    "truth ",
                         at_higher_levels="")
