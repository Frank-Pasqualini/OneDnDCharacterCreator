...
class Clone(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Clone",
                         ...
                         "such as a huge urn, coffin, mudfilled cyst " +
...
class DancingLights(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Dancing Lights",
                         ...
                         verbal_components=True,
                         somatic_components=True,
                         material_components_list="a bit of phosphorus or wychwood, or a " +
                         "glowworm \n",
                         duration="1 minute",
...
class DivineWord(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Divine Word",
                         ...
                         "minutes • 30 hit points or fewer: blinded, deafened, and " +
                         "stunned for 1 hour • 20 hit points or fewer: killed instantly " +
