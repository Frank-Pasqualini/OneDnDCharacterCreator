    ...
    def __init__(self):
        super().__init__(name="Acid Splash",
                         ...
                         description="You hurl a bubble of acid. Choose one creature within range, " +
                                     ...
                                     "or take 1d6 acid damage. This spell's damage increases by 1d6 " +
...
class Alarm(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Alarm",
                         ...
                         duration="8 hours",
                         description="You set an alarm against unwanted intrusion. Choose a door, a " +
                                     ...
                                     "whether the alarm is mental or audible. A mental alarm alerts " +
                                     "you with a ping in your mind if you are within 1 mile of the " +
                                     "warded area. This ping awakens you if you are sleeping. An " +
                                     "audible alarm produces the sound of a hand bell for 10 seconds " +
                                     "within 60 feet. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Alter Self",
                         ...
                         description="You assume a different form. When you cast the spell, choose " +
                                     ...
                                     "one. Aquatic Adaptation. You adapt your body to an aquatic " +
                                     "environment, sprouting gills and growing webbing between your " +
                                     "fingers. You can breathe underwater and gain a swimming speed " +
                                     "equal to your walking speed. Change Appearance. You transform " +
                                     "your appearance. You decide what you look like, including your " +
                                     "height, weight, facial features, sound of your voice, hair " +
                                     "length, coloration, and distinguishing characteristics, if " +
                                     "any. You can make yourself appear as a member of another race, " +
                                     ...
                                     "spell to become quadrupedal, for instance. At any time for the " +
                                     "duration of the spell, you can use your action to change your " +
                                     "appearance in this way again. Natural Weapons. You grow claws, " +
                                     "fangs, spines, horns, or a different natural weapon of your " +
                                     "choice. Your unarmed strikes deal 1d6 bludgeoning, piercing, " +
                                     "or slashing damage, as appropriate to the natural weapon you " +
    ...
    def __init__(self):
        super().__init__(name="Animal Shapes",
                         ...
                         description="Your magic turns others into beasts. Choose any number of " +
                                     ...
                                     "forms. The transformation lasts for the duration for each " +
                                     "target, or until the target drops to 0 hit points or dies. You " +
                                     "can choose a different form for each target. A target's game " +
                                     "statistics are replaced by the statistics of the chosen beast, " +
                                     "though the target retains its alignment and Intelligence, " +
                                     "Wisdom, and Charisma scores. The target assumes the hit points " +
                                     "of its new form, and when it reverts to its normal form, it " +
                                     "returns to the number of hit points it had before it " +
                                     "transformed. If it reverts as a result of dropping to 0 hit " +
                                     "points, any excess damage carries over to its normal form. As " +
                                     "long as the excess damage doesn't reduce the creature's normal " +
                                     "form to 0 hit points, it isn't knocked unconscious. The " +
                                     "creature is limited in the actions it can perform by the " +
                                     "nature of its new form, and it can't speak or cast spells. The " +
                                     "target's gear melds into the new form. The target can't " +
    ...
    def __init__(self):
        super().__init__(name="Animate Dead",
                         ...
                         description="This spell creates an undead servant. Choose a pile of bones " +
                                     ...
                                     "it as an undead creature. The target becomes a skeleton if you " +
                                     "chose bones or a zombie if you chose a corpse (the GM has the " +
                                     "creature's game statistics). On each of your turns, you can " +
                                     "use a bonus action to mentally command any creature you made " +
                                     "with this spell if the creature is within 60 feet of you (if " +
                                     ...
                                     "creature is under your control for 24 hours, after which it " +
    ...
    def __init__(self):
        super().__init__(name="Animate Objects",
                         ...
                         description="Objects come to life at your command. Choose up to ten " +
                                     ...
                                     "spell ends or until reduced to 0 hit points. As a bonus " +
                                     "action, you can mentally command any creature you made with " +
                                     "this spell if the creature is within 500 feet of you (if you " +
                                     "control multiple creatures, you can command any or all of them " +
                                     "at the same time, issuing the same command to each one). You " +
                                     ...
                                     "issue no commands, the creature only defends itself against " +
                                     "hostile creatures. Once given an order, the creature continues " +
                                     "to follow it until its task is complete. Animated Object " +
                                     "Statistics Size HP AC Attack Str Dex Tiny 20 18 +8 to hit, 1d4 " +
                                     "+ 4 damage 4 18 Small 25 16 +6 to hit, 1d8 + 2 damage 6 14 " +
                                     "Medium 40 13 +5 to hit, 2d6 + 1 damage 10 12 Large 50 10 +6 to " +
                                     "hit, 2d10 + 2 damage 14 10 Huge 80 10 +8 to hit, 2d12 + 4 " +
                                     "damage 18 6 An animated object is a construct with AC, hit " +
                                     "points, attacks, Strength, and Dexterity determined by its " +
                                     "size. Its Constitution is 10 and its Intelligence and Wisdom " +
                                     ...
                                     "remaining damage carries over to its original object form. If " +
                                     "you command an object to attack, it can make a single melee " +
    ...
    def __init__(self):
        super().__init__(name="Antilife Shell",
                         ...
                         description="A shimmering barrier extends out from you in a 10- foot radius " +
                                     ...
                                     "for the duration. The barrier prevents an affected creature " +
                                     "from passing or reaching through. An affected creature can " +
                                     "cast spells or make attacks with ranged or reach weapons " +
                                     "through the barrier. If you move so that an affected creature " +
    ...
    def __init__(self):
        super().__init__(name="Antimagic Field",
                         ...
                         description="A 10-foot-radius invisible sphere of antimagic surrounds you. " +
                                     ...
                                     "mundane. Until the spell ends, the sphere moves with you, " +
                                     "centered on you. Spells and other magical effects, except " +
                                     "those created by an artifact or a deity, are suppressed in the " +
                                     "sphere and can't protrude into it. A slot expended to cast a " +
                                     "suppressed spell is consumed. While an effect is suppressed, " +
                                     "it doesn't function, but the time it spends suppressed counts " +
                                     "against its duration. Targeted Effects. Spells and other " +
                                     "magical effects, such as magic missile and charm person, that " +
                                     "target a creature or an object in the sphere have no effect on " +
                                     "that target. Areas of Magic. The area of another spell or " +
                                     "magical effect, such as fireball, can't extend into the " +
                                     "sphere. If the sphere overlaps an area of magic, the part of " +
                                     "the area that is covered by the sphere is suppressed. For " +
                                     "example, the flames created by a wall of fire are suppressed " +
                                     "within the sphere, creating a gap in the wall if the overlap " +
                                     "is large enough. Spells. Any active spell or other magical " +
                                     "effect on a creature or an object in the sphere is suppressed " +
                                     "while the creature or object is in it. Magic Items. The " +
                                     "properties and powers of magic items are suppressed in the " +
                                     "sphere. For example, a +1 longsword in the sphere functions as " +
                                     "a nonmagical longsword. A magic weapon's properties and powers " +
                                     "are suppressed if it is used against a target in the sphere or " +
                                     "wielded by an attacker in the sphere. If a magic weapon or a " +
                                     "piece of magic ammunition fully leaves the sphere (for " +
                                     "example, if you fire a magic arrow or throw a magic spear at a " +
                                     "target outside the sphere), the magic of the item ceases to be " +
                                     "suppressed as soon as it exits. Magical Travel. Teleportation " +
                                     "and planar travel fail to work in the sphere, whether the " +
                                     "sphere is the destination or the departure point for such " +
                                     "magical travel. A portal to another location, world, or plane " +
                                     "of existence, as well as an opening to an extradimensional " +
                                     "space such as that created by the rope trick spell, " +
                                     "temporarily closes while in the sphere. Creatures and Objects. " +
                                     "A creature or object summoned or created by magic temporarily " +
                                     "winks out of existence in the sphere. Such a creature " +
                                     "instantly reappears once the space the creature occupied is no " +
                                     "longer within the sphere. Dispel Magic. Spells and magical " +
                                     "effects such as dispel magic have no effect on the sphere. " +
                                     "Likewise, the spheres created by different antimagic field " +
    ...
    def __init__(self):
        super().__init__(name="Antipathy/Sympathy",
                         ...
                         description="This spell attracts or repels creatures of your choice. You " +
                                     ...
                                     "aura that either attracts or repels the specified creatures " +
                                     "for the duration. Choose antipathy or sympathy as the aura's " +
                                     "effect. Antipathy. The enchantment causes creatures of the " +
                                     "kind you designated to feel an intense urge to leave the area " +
                                     "and avoid the target. When such a creature can see the target " +
                                     "or comes within 60 feet of it, the creature must succeed on a " +
                                     "Wisdom saving throw or become frightened. The creature remains " +
                                     ...
                                     "feet of it or able to see it. When such a creature can see the " +
                                     "target or comes within 60 feet of it, the creature must " +
                                     "succeed on a Wisdom saving throw or use its movement on each " +
                                     "of its turns to enter the area or move within reach of the " +
                                     "target. When the creature has done so, it can't willingly move " +
                                     "away from the target. If the target damages or otherwise harms " +
                                     "an affected creature, the affected creature can make a Wisdom " +
                                     "saving throw to end the effect, as described below. Ending the " +
                                     "Effect. If an affected creature ends its turn while not within " +
                                     "60 feet of the target or able to see it, the creature makes a " +
                                     "Wisdom saving throw. On a successful save, the creature is no " +
                                     "longer affected by the target and recognizes the feeling of " +
                                     ...
                                     "successfully saves against this effect is immune to it for 1 " +
    ...
    def __init__(self):
        super().__init__(name="Arcane Eye",
                         ...
                         description="You create an invisible, magical eye within range that hovers " +
                                     "in the air for the duration. You mentally receive visual " +
                                     "information from the eye, which has normal vision and " +
                                     "darkvision out to 30 feet. The eye can look in every " +
                                     "direction. As an action, you can move the eye up to 30 feet in " +
                                     "any direction. There is no limit to how far away from you the " +
                                     "eye can move, but it can't enter another plane of existence. A " +
    ...
    def __init__(self):
        super().__init__(name="Arcane Hand",
                         ...
                         description="You create a Large hand of shimmering, translucent force in an " +
                                     ...
                                     "mimicking the movements of your own hand. The hand is an " +
                                     "object that has AC 20 and hit points equal to your hit point " +
                                     "maximum. If it drops to 0 hit points, the spell ends. It has a " +
                                     "Strength of 26 (+8) and a Dexterity of 10 (+0). The hand " +
                                     "doesn't fill its space. When you cast the spell and as a bonus " +
                                     "action on your subsequent turns, you can move the hand up to " +
                                     "60 feet and then cause one of the following effects with it. " +
                                     ...
                                     "damage. Forceful Hand. The hand attempts to push a creature " +
                                     "within 5 feet of it in a direction you choose. Make a check " +
                                     "with the hand's Strength contested by the Strength (Athletics) " +
                                     "check of the target. If the target is Medium or smaller, you " +
                                     "have advantage on the check. If you succeed, the hand pushes " +
                                     "the target up to 5 feet plus a number of feet equal to five " +
                                     "times your spellcasting ability modifier. The hand moves with " +
                                     "the target to remain within 5 feet of it. Grasping Hand. The " +
                                     "hand attempts to grapple a Huge or smaller creature within 5 " +
                                     "feet of it. You use the hand's Strength score to resolve the " +
                                     "grapple. If the target is Medium or smaller, you have " +
                                     "advantage on the check. While the hand is grappling the " +
                                     "target, you can use a bonus action to have the hand crush it. " +
                                     "When you do so, the target takes bludgeoning damage equal to " +
                                     "2d6 + your spellcasting ability modifier. Interposing Hand. " +
                                     "The hand interposes itself between you and a creature you " +
                                     "choose until you give the hand a different command. The hand " +
                                     "moves to stay between you and the target, providing you with " +
                                     "half cover against the target. The target can't move through " +
                                     "the hand's space if its Strength score is less than or equal " +
                                     "to the hand's Strength score. If its Strength score is higher " +
                                     "than the hand's Strength score, the target can move toward you " +
                                     "through the hand's space, but that space is difficult terrain " +
                                     "for the target. ",
    ...
    def __init__(self):
        super().__init__(name="Arcane Lock",
                         ...
                         description="You touch a closed door, window, gate, chest, or other " +
                                     ...
                                     "minute. Otherwise, it is impassable until it is broken or the " +
                                     "spell is dispelled or suppressed. Casting knock on the object " +
                                     "suppresses arcane lock for 10 minutes. While affected by this " +
                                     "spell, the object is more difficult to break or force open; " +
    ...
    def __init__(self):
        super().__init__(name="Arcane Sword",
                         ...
                         description="You create a sword-shaped plane of force that hovers within " +
                                     ...
                                     "make a melee spell attack against a target of your choice " +
                                     "within 5 feet of the sword. On a hit, the target takes 3d10 " +
                                     "force damage. Until the spell ends, you can use a bonus action " +
                                     "on each of your turns to move the sword up to 20 feet to a " +
                                     "spot you can see and repeat this attack against the same " +
    ...
    def __init__(self):
        super().__init__(name="Arcanist's Magic Aura",
                         ...
                         description="You place an illusion on a creature or an object you touch so " +
                                     ...
                                     "carried or worn by another creature. When you cast the spell, " +
                                     "choose one or both of the following effects. The effect lasts " +
                                     "for the duration. If you cast this spell on the same creature " +
                                     "or object every day for 30 days, placing the same effect on it " +
                                     "each time, the illusion lasts until it is dispelled. False " +
                                     "Aura. You change the way the target appears to spells and " +
                                     ...
                                     "that handles the item. Mask. You change the way the target " +
                                     "appears to spells and magical effects that detect creature " +
                                     "types, such as a paladin's Divine Sense or the trigger of a " +
                                     "symbol spell. You choose a creature type and other spells and " +
                                     "magical effects treat the target as if it were a creature of " +
    ...
    def __init__(self):
        super().__init__(name="Astral Projection",
                         ...
                         description="You and up to eight willing creatures within range project " +
                                     ...
                                     "doesn't age. Your astral body resembles your mortal form in " +
                                     "almost every way, replicating your game statistics and " +
                                     "possessions. The principal difference is the addition of a " +
                                     "silvery cord that extends from between your shoulder blades " +
                                     "and trails behind you, fading to invisibility after 1 foot. " +
                                     "This cord is your tether to your material body. As long as the " +
                                     "tether remains intact, you can find your way home. If the cord " +
                                     "is cut—something that can happen only when an effect " +
                                     "specifically states that it does—your soul and body are " +
                                     "separated, killing you instantly. Your astral form can freely " +
                                     "travel through the Astral Plane and can pass through portals " +
                                     "there leading to any other plane. If you enter a new plane or " +
                                     "return to the plane you were on when casting this spell, your " +
                                     "body and possessions are transported along the silver cord, " +
                                     "allowing you to re-enter your body as you enter the new plane. " +
                                     "Your astral form is a separate incarnation. Any damage or " +
                                     "other effects that apply to it have no effect on your physical " +
                                     "body, nor do they persist when you return to it. The spell " +
                                     "ends for you and your companions when you use your action to " +
                                     "dismiss it. When the spell ends, the affected creature returns " +
                                     "to its physical body, and it awakens. The spell might also end " +
                                     "early for you or one of your companions. A successful dispel " +
                                     "magic spell used against an astral or physical body ends the " +
                                     "spell for that creature. If a creature's original body or its " +
                                     "astral form drops to 0 hit points, the spell ends for that " +
                                     "creature. If the spell ends and the silver cord is intact, the " +
                                     "cord pulls the creature's astral form back to its body, ending " +
                                     "its state of suspended animation. If you are returned to your " +
                                     "body prematurely, your companions remain in their astral forms " +
                                     "and must find their own way back to their bodies, usually by " +
    ...
    def __init__(self):
        super().__init__(name="Augury",
                         ...
                         description="By casting gem-inlaid sticks, rolling dragon bones, laying out " +
                                     ...
                                     "possible omens: • Weal, for good results • Woe, for bad " +
                                     "results • Weal and woe, for both good and bad results • " +
                                     ...
                                     "additional spells or the loss or gain of a companion. If you " +
                                     "cast the spell two or more times before completing your next " +
    ...
    def __init__(self):
        super().__init__(name="Awaken",
                         ...
                         description="After spending the casting time tracing magical pathways " +
                                     ...
                                     "the awakened shrub or the awakened tree. The awakened beast or " +
                                     "plant is charmed by you for 30 days or until you or your " +
                                     "companions do anything harmful to it. When the charmed " +
                                     "condition ends, the awakened creature chooses whether to " +
                                     "remain friendly to you, based on how you treated it while it " +
                                     "was charmed. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Banishment",
                         ...
                         description="You attempt to send one creature that you can see within range " +
                                     ...
                                     "Charisma saving throw or be banished. If the target is native " +
                                     "to the plane of existence you're on, you banish the target to " +
                                     "a harmless demiplane. While there, the target is " +
                                     "incapacitated. The target remains there until the spell ends, " +
                                     "at which point the target reappears in the space it left or in " +
                                     "the nearest unoccupied space if that space is occupied. If the " +
                                     "target is native to a different plane of existence than the " +
                                     "one you're on, the target is banished with a faint popping " +
    ...
    def __init__(self):
        super().__init__(name="Bestow Curse",
                         ...
                         description="You touch a creature, and that creature must succeed on a " +
                                     ...
                                     "and saving throws made with that ability score. • While " +
                                     "cursed, the target has disadvantage on attack rolls against " +
                                     "you. • While cursed, the target must make a Wisdom saving " +
                                     "throw at the start of each of its turns. If it fails, it " +
                                     "wastes its action that turn doing nothing. • While the target " +
                                     "is cursed, your attacks and spells deal an extra 1d8 necrotic " +
                                     "damage to the target. A remove curse spell ends this effect. " +
                                     "At the GM's option, you may choose an alternative curse " +
                                     "effect, but it should be no more powerful than those described " +
    ...
    def __init__(self):
        super().__init__(name="Black Tentacles",
                         ...
                         description="Squirming, ebony tentacles fill a 20-foot square on ground " +
                                     ...
                                     "a Dexterity saving throw or take 3d6 bludgeoning damage and be " +
                                     "restrained by the tentacles until the spell ends. A creature " +
                                     "that starts its turn in the area and is already restrained by " +
                                     "the tentacles takes 3d6 bludgeoning damage. A creature " +
                                     "restrained by the tentacles can use its action to make a " +
                                     "Strength or Dexterity check (its choice) against your spell " +
    ...
    def __init__(self):
        super().__init__(name="Blade Barrier",
                         ...
                         description="You create a vertical wall of whirling, razor-sharp blades " +
                                     ...
                                     "its space is difficult terrain. When a creature enters the " +
                                     "wall's area for the first time on a turn or starts its turn " +
                                     "there, the creature must make a Dexterity saving throw. On a " +
                                     "failed save, the creature takes 6d10 slashing damage. On a " +
    ...
    def __init__(self):
        super().__init__(name="Blight",
                         ...
                         description="Necromantic energy washes over a creature of your choice that " +
                                     ...
                                     "undead or constructs. If you target a plant creature or a " +
                                     "magical plant, it makes the saving throw with disadvantage, " +
                                     "and the spell deals maximum damage to it. If you target a " +
                                     "nonmagical plant that isn't a creature, such as a tree or " +
                                     "shrub, it doesn't make a saving throw; it simply withers and " +
                                     "dies. ",
                         at_higher_levels="When you cast this spell using a spell slot of 5th level or " +
    ...
    def __init__(self):
        super().__init__(name="Blink",
                         ...
                         description="Roll a d20 at the end of each of your turns for the duration " +
                                     ...
                                     "on that plane). At the start of your next turn, and when the " +
                                     "spell ends if you are on the Ethereal Plane, you return to an " +
                                     "unoccupied space of your choice that you can see within 10 " +
                                     ...
                                     "equally near). You can dismiss this spell as an action. While " +
                                     "on the Ethereal Plane, you can see and hear the plane you " +
    ...
    def __init__(self):
        super().__init__(name="Blur",
                         ...
                         description="Your body becomes blurred, shifting and wavering to all who " +
                                     ...
                                     "on attack rolls against you. An attacker is immune to this " +
                                     "effect if it doesn't rely on sight, as with blindsight, or can " +
                                     "see through illusions, as with truesight. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Call Lightning",
                         ...
                         description="A storm cloud appears in the shape of a cylinder that is 10 " +
                                     ...
                                     "cloud). When you cast the spell, choose a point you can see " +
                                     ...
                                     "again, targeting the same point or a different one. If you are " +
                                     "outdoors in stormy conditions when you cast this spell, the " +
                                     "spell gives you control over the existing storm instead of " +
    ...
    def __init__(self):
        super().__init__(name="Calm Emotions",
                         ...
                         description="You attempt to suppress strong emotions in a group of people. " +
                                     ...
                                     "two effects. You can suppress any effect causing a target to " +
                                     "be charmed or frightened. When this spell ends, any suppressed " +
                                     "effect resumes, provided that its duration has not expired in " +
                                     "the meantime. Alternatively, you can make a target indifferent " +
    ...
    def __init__(self):
        super().__init__(name="Chain Lightning",
                         ...
                         description="You create a bolt of lightning that arcs toward a target of " +
                                     ...
                                     "can be a creature or an object and can be targeted by only one " +
                                     "of the bolts. A target must make a Dexterity saving throw. The " +
                                     "target takes 10d8 lightning damage on a failed save, or half " +
    ...
    def __init__(self):
        super().__init__(name="Chill Touch",
                         ...
                         description="You create a ghostly, skeletal hand in the space of a creature " +
                                     ...
                                     "to the target. If you hit an undead target, it also has " +
                                     "disadvantage on attack rolls against you until the end of your " +
                                     "next turn. This spell's damage increases by 1d8 when you reach " +
    ...
    def __init__(self):
        super().__init__(name="Clairvoyance",
                         ...
                         description="You create an invisible sensor within range in a location " +
                                     ...
                                     "attacked or otherwise interacted with. When you cast the " +
                                     "spell, you choose seeing or hearing. You can use the chosen " +
                                     "sense through the sensor as if you were in its space. As your " +
                                     "action, you can switch between seeing and hearing. A creature " +
                                     "that can see the sensor (such as a creature benefiting from " +
                                     "see invisibility or truesight) sees a luminous, intangible orb " +
    ...
    def __init__(self):
        super().__init__(name="Clone",
                         ...
                         description="This spell grows an inert duplicate of a living creature as a " +
                                     ...
                                     "long as its vessel remains undisturbed. At any time after the " +
                                     "clone matures, if the original creature dies, its soul " +
                                     "transfers to the clone, provided that the soul is free and " +
                                     "willing to return. The clone is physically identical to the " +
                                     "original and has the same personality, memories, and " +
    ...
    def __init__(self):
        super().__init__(name="Cloudkill",
                         ...
                         description="You create a 20-foot-radius sphere of poisonous, yellow-green " +
                                     ...
                                     "heavily obscured. When a creature enters the spell's area for " +
                                     "the first time on a turn or starts its turn there, that " +
                                     "creature must make a Constitution saving throw. The creature " +
                                     "takes 5d8 poison damage on a failed save, or half as much " +
                                     "damage on a successful one. Creatures are affected even if " +
                                     "they hold their breath or don't need to breathe. The fog moves " +
                                     "10 feet away from you at the start of each of your turns, " +
                                     "rolling along the surface of the ground. The vapors, being " +
                                     "heavier than air, sink to the lowest level of the land, even " +
    ...
    def __init__(self):
        super().__init__(name="Color Spray",
                         ...
                         description="A dazzling array of flashing, colored light springs from your " +
                                     ...
                                     "can't see). Starting with the creature that has the lowest " +
                                     "current hit points, each creature affected by this spell is " +
                                     "blinded until the spell ends. Subtract each creature's hit " +
    ...
    def __init__(self):
        super().__init__(name="Command",
                         ...
                         description="You speak a one-word command to a creature you can see within " +
                                     ...
                                     "language, or if your command is directly harmful to it. Some " +
                                     "typical commands and their effects follow. You might issue a " +
                                     "command other than one described here. If you do so, the GM " +
                                     "determines how the target behaves. If the target can't follow " +
                                     "your command, the spell ends. Approach. The target moves " +
                                     "toward you by the shortest and most direct route, ending its " +
                                     "turn if it moves within 5 feet of you. Drop. The target drops " +
                                     "whatever it is holding and then ends its turn. Flee. The " +
                                     "target spends its turn moving away from you by the fastest " +
                                     "available means. Grovel. The target falls prone and then ends " +
                                     "its turn. Halt. The target doesn't move and takes no actions. " +
    ...
    def __init__(self):
        super().__init__(name="Commune",
                         ...
                         description="You contact your deity or a divine proxy and ask up to three " +
                                     ...
                                     "answer for each question. Divine beings aren't necessarily " +
                                     "omniscient, so you might receive “unclear” as an answer if a " +
                                     "question pertains to information that lies beyond the deity's " +
                                     "knowledge. In a case where a one-word answer could be " +
                                     "misleading or contrary to the deity's interests, the GM might " +
                                     "offer a short phrase as an answer instead. If you cast the " +
                                     "spell two or more times before finishing your next long rest, " +
                                     "there is a cumulative 25 percent chance for each casting after " +
                                     "the first that you get no answer. The GM makes this roll in " +
                                     "secret. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Commune with Nature",
                         ...
                         description="You briefly become one with nature and gain knowledge of the " +
                                     ...
                                     "replaced by construction, such as in dungeons and towns. You " +
                                     "instantly gain knowledge of up to three facts of your choice " +
                                     "about any of the following subjects as they relate to the " +
                                     "area: • terrain and bodies of water • prevalent plants, " +
                                     "minerals, animals, or peoples • powerful celestials, fey, " +
                                     "fiends, elementals, or undead • influence from other planes of " +
    ...
    def __init__(self):
        super().__init__(name="Comprehend Languages",
                         ...
                         description="For the duration, you understand the literal meaning of any " +
                                     ...
                                     "one page of text. This spell doesn't decode secret messages in " +
                                     "a text or a glyph, such as an arcane sigil, that isn't part of " +
                                     "a written language. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Compulsion",
                         ...
                         description="Creatures of your choice that you can see within range and " +
                                     ...
                                     "take its action before it moves. After moving in this way, it " +
                                     "can make another Wisdom saving to try to end the effect. A " +
                                     "target isn't compelled to move into an obviously deadly " +
    ...
    def __init__(self):
        super().__init__(name="Cone of Cold",
                         ...
                         description="A blast of cold air erupts from your hands. Each creature in a " +
                                     ...
                                     "on a successful one. A creature killed by this spell becomes a " +
    ...
    def __init__(self):
        super().__init__(name="Confusion",
                         ...
                         description="This spell assaults and twists creatures' minds, spawning " +
                                     ...
                                     "spell or be affected by it. An affected target can't take " +
                                     "reactions and must roll a d10 at the start of each of its " +
                                     "turns to determine its behavior for that turn. d10 Behavior 1 " +
                                     "The creature uses all its movement to move in a random " +
                                     "direction. To determine the direction, roll a d8 and assign a " +
                                     "direction to each die face. The creature doesn't take an " +
                                     "action this turn. 2–6 The creature doesn't move or take " +
                                     "actions this turn. 7–8 The creature uses its action to make a " +
                                     "melee attack against a randomly determined creature within its " +
                                     "reach. If there is no creature within its reach, the creature " +
                                     "does nothing this turn. 9–10 The creature can act and move " +
                                     "normally. At the end of each of its turns, an affected target " +
                                     "can make a Wisdom saving throw. If it succeeds, this effect " +
    ...
    def __init__(self):
        super().__init__(name="Conjure Animals",
                         ...
                         description="You summon fey spirits that take the form of beasts and appear " +
                                     ...
                                     "of the following options for what appears: • One beast of " +
                                     "challenge rating 2 or lower • Two beasts of challenge rating 1 " +
                                     ...
                                     "points or when the spell ends. The summoned creatures are " +
                                     "friendly to you and your companions. Roll initiative for the " +
                                     "summoned creatures as a group, which has its own turns. They " +
                                     "obey any verbal commands that you issue to them (no action " +
                                     "required by you). If you don't issue any commands to them, " +
                                     "they defend themselves from hostile creatures, but otherwise " +
                                     "take no actions. The GM has the creatures' statistics. ",
    ...
    def __init__(self):
        super().__init__(name="Conjure Celestial",
                         ...
                         description="You summon a celestial of challenge rating 4 or lower, which " +
                                     ...
                                     "the spell ends. The celestial is friendly to you and your " +
                                     "companions for the duration. Roll initiative for the " +
                                     "celestial, which has its own turns. It obeys any verbal " +
                                     "commands that you issue to it (no action required by you), as " +
                                     "long as they don't violate its alignment. If you don't issue " +
                                     "any commands to the celestial, it defends itself from hostile " +
                                     "creatures but otherwise takes no actions. The GM has the " +
    ...
    def __init__(self):
        super().__init__(name="Conjure Elemental",
                         ...
                         description="You call forth an elemental servant. Choose an area of air, " +
                                     ...
                                     "and an earth elemental rises up from the ground. The elemental " +
                                     "disappears when it drops to 0 hit points or when the spell " +
                                     "ends. The elemental is friendly to you and your companions for " +
                                     "the duration. Roll initiative for the elemental, which has its " +
                                     "own turns. It obeys any verbal commands that you issue to it " +
                                     "(no action required by you). If you don't issue any commands " +
                                     "to the elemental, it defends itself from hostile creatures but " +
                                     "otherwise takes no actions. If your concentration is broken, " +
                                     "the elemental doesn't disappear. Instead, you lose control of " +
                                     "the elemental, it becomes hostile toward you and your " +
                                     "companions, and it might attack. An uncontrolled elemental " +
                                     "can't be dismissed by you, and it disappears 1 hour after you " +
                                     "summoned it. The GM has the elemental's statistics. ",
                         at_higher_levels="When you cast this spell using a spell slot of 6th level or " +
    ...
    def __init__(self):
        super().__init__(name="Conjure Fey",
                         ...
                         description="You summon a fey creature of challenge rating 6 or lower, or a " +
                                     ...
                                     "hit points or when the spell ends. The fey creature is " +
                                     "friendly to you and your companions for the duration. Roll " +
                                     "initiative for the creature, which has its own turns. It obeys " +
                                     "any verbal commands that you issue to it (no action required " +
                                     "by you), as long as they don't violate its alignment. If you " +
                                     "don't issue any commands to the fey creature, it defends " +
                                     ...
                                     "you, and it disappears 1 hour after you summoned it. The GM " +
                                     "has the fey creature's statistics. ",
                         at_higher_levels="When you cast this spell using a spell slot of 7th level or " +
                                          "higher, the challenge rating increases by 1 for each slot " +
                                          "level above 6th. ")
    ...
    def __init__(self):
        super().__init__(name="Conjure Minor Elementals",
                         ...
                         description="You summon elementals that appear in unoccupied spaces that " +
                                     ...
                                     "of challenge rating 1/4 or lower. An elemental summoned by " +
                                     "this spell disappears when it drops to 0 hit points or when " +
                                     "the spell ends. The summoned creatures are friendly to you and " +
                                     "your companions. Roll initiative for the summoned creatures as " +
                                     "a group, which has its own turns. They obey any verbal " +
    ...
    def __init__(self):
        super().__init__(name="Conjure Woodland Beings",
                         ...
                         description="You summon fey creatures that appear in unoccupied spaces that " +
                                     ...
                                     "for what appears: • One fey creature of challenge rating 2 or " +
                                     "lower • Two fey creatures of challenge rating 1 or lower • " +
                                     "Four fey creatures of challenge rating 1/2 or lower • Eight " +
                                     "fey creatures of challenge rating 1/4 or lower A summoned " +
                                     "creature disappears when it drops to 0 hit points or when the " +
                                     "spell ends. The summoned creatures are friendly to you and " +
                                     "your companions. Roll initiative for the summoned creatures as " +
    ...
    def __init__(self):
        super().__init__(name="Contact Other Plane",
                         ...
                         description="You mentally contact a demigod, the spirit of a long-dead sage, " +
                                     ...
                                     "are insane until you finish a long rest. While insane, you " +
                                     "can't take actions, can't understand what other creatures say, " +
                                     "can't read, and speak only in gibberish. A greater restoration " +
                                     "spell cast on you ends this effect. On a successful save, you " +
                                     "can ask the entity up to five questions. You must ask your " +
                                     "questions before the spell ends. The GM answers each question " +
                                     "with one word, such as “yes,” “no,” “maybe,” “never,” " +
                                     "“irrelevant,” or “unclear” (if the entity doesn't know the " +
                                     "answer to the question). If a one-word answer would be " +
                                     "misleading, the GM might instead offer a short phrase as an " +
                                     "answer. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Contagion",
                         ...
                         description="Your touch inflicts disease. Make a melee spell attack against " +
                                     ...
                                     "described below. At the end of each of the target's turns, it " +
                                     "must make a Constitution saving throw. After failing three of " +
                                     "these saving throws, the disease's effects last for the " +
                                     "duration, and the creature stops making these saves. After " +
                                     "succeeding on three of these saving throws, the creature " +
                                     "recovers from the disease, and the spell ends. Since this " +
                                     "spell induces a natural disease in its target, any effect that " +
                                     "removes a disease or otherwise ameliorates a disease's effects " +
                                     "apply to it. Blinding Sickness. Pain grips the creature's " +
                                     "mind, and its eyes turn milky white. The creature has " +
                                     "disadvantage on Wisdom checks and Wisdom saving throws and is " +
                                     "blinded. Filth Fever. A raging fever sweeps through the " +
                                     "creature's body. The creature has disadvantage on Strength " +
                                     "checks, Strength saving throws, and attack rolls that use " +
                                     "Strength. Flesh Rot. The creature's flesh decays. The creature " +
                                     "has disadvantage on Charisma checks and vulnerability to all " +
                                     "damage. Mindfire. The creature's mind becomes feverish. The " +
                                     ...
                                     "Seizure. The creature is overcome with shaking. The creature " +
                                     "has disadvantage on Dexterity checks, Dexterity saving throws, " +
                                     "and attack rolls that use Dexterity. Slimy Doom. The creature " +
                                     "begins to bleed uncontrollably. The creature has disadvantage " +
                                     "on Constitution checks and Constitution saving throws. In " +
    ...
    def __init__(self):
        super().__init__(name="Contingency",
                         ...
                         description="Choose a spell of 5th level or lower that you can cast, that " +
                                     ...
                                     "water or a similar liquid. The contingent spell takes effect " +
                                     "immediately after the circumstance is met for the first time, " +
                                     "whether or not you want it to, and then contingency ends. The " +
                                     "contingent spell takes effect only on you, even if it can " +
                                     ...
                                     "contingency spell on you ends. Also, contingency ends on you " +
    ...
    def __init__(self):
        super().__init__(name="Control Water",
                         ...
                         description="Until the spell ends, you control any freestanding water " +
                                     ...
                                     "the same effect or choose a different one. Flood. You cause " +
                                     "the water level of all standing water in the area to rise by " +
                                     "as much as 20 feet. If the area includes a shore, the flooding " +
                                     "water spills over onto dry land. If you choose an area in a " +
                                     "large body of water, you instead create a 20-foot tall wave " +
                                     ...
                                     "capsizing. The water level remains elevated until the spell " +
                                     "ends or you choose a different effect. If this effect produced " +
                                     "a wave, the wave repeats on the start of your next turn while " +
                                     "the flood effect lasts. Part Water. You cause water in the " +
                                     "area to move apart and create a trench. The trench extends " +
                                     "across the spell's area, and the separated water forms a wall " +
                                     "to either side. The trench remains until the spell ends or you " +
                                     "choose a different effect. The water then slowly fills in the " +
                                     "trench over the course of the next round until the normal " +
                                     "water level is restored. Redirect Flow. You cause flowing " +
                                     "water in the area to move in a direction you choose, even if " +
                                     "the water has to flow over obstacles, up walls, or in other " +
                                     "unlikely directions. The water in the area moves as you direct " +
                                     "it, but once it moves beyond the spell's area, it resumes its " +
                                     "flow based on the terrain conditions. The water continues to " +
                                     "move in the direction you chose until the spell ends or you " +
                                     "choose a different effect. Whirlpool. This effect requires a " +
                                     "body of water at least 50 feet square and 25 feet deep. You " +
                                     "cause a whirlpool to form in the center of the area. The " +
                                     "whirlpool forms a vortex that is 5 feet wide at the base, up " +
                                     "to 50 feet wide at the top, and 25 feet tall. Any creature or " +
                                     "object in the water and within 25 feet of the vortex is pulled " +
                                     "10 feet toward it. A creature can swim away from the vortex by " +
                                     "making a Strength (Athletics) check against your spell save " +
                                     "DC. When a creature enters the vortex for the first time on a " +
                                     ...
                                     "to do so. The first time each turn that an object enters the " +
    ...
    def __init__(self):
        super().__init__(name="Control Weather",
                         ...
                         description="You take control of the weather within 5 miles of you for the " +
                                     ...
                                     "spell early. When you cast the spell, you change the current " +
                                     "weather conditions, which are determined by the GM based on " +
                                     "the climate and season. You can change precipitation, " +
                                     "temperature, and wind. It takes 1d4 × 10 minutes for the new " +
                                     "conditions to take effect. Once they do so, you can change the " +
                                     "conditions again. When the spell ends, the weather gradually " +
                                     "returns to normal. When you change the weather conditions, " +
                                     "find a current condition on the following tables and change " +
                                     "its stage by one, up or down. When changing the wind, you can " +
                                     "change its direction. Precipitation Stage Condition 1 Clear 2 " +
                                     "Light clouds 3 Overcast or ground fog 4 Rain, hail, or snow 5 " +
    ...
    def __init__(self):
        super().__init__(name="Create or Destroy Water",
                         ...
                         description="You either create or destroy water. Create Water. You create " +
                                     ...
                                     "open container within range. Alternatively, you destroy fog in " +
    ...
    def __init__(self):
        super().__init__(name="Creation",
                         ...
                         description="You pull wisps of shadow material from the Shadowfell to " +
                                     ...
                                     "have seen before. The duration depends on the object's " +
                                     "material. If the object is composed of multiple materials, use " +
                                     "the shortest duration. Material Duration Vegetable matter 1 " +
                                     "day Stone or crystal 12 hours Precious metals 1 hour Gems 10 " +
                                     "minutes Adamantine or mithral 1 minute Using any material " +
                                     "created by this spell as another spell's material component " +
    ...
    def __init__(self):
        super().__init__(name="Dancing Lights",
                         ...
                         description="You create up to four torch-sized lights within range, making " +
                                     "them appear as torches, lanterns, or glowing orbs that hover " +
                                     ...
                                     "foot radius. As a bonus action on your turn, you can move the " +
                                     "lights up to 60 feet to a new spot within range. A light must " +
                                     "be within 20 feet of another light created by this spell, and " +
    ...
    def __init__(self):
        super().__init__(name="Darkness",
                         ...
                         description="Magical darkness spreads from a point you choose within range " +
                                     ...
                                     "it. If the point you choose is on an object you are holding or " +
                                     ...
                                     "or a helm, blocks the darkness. If any of this spell's area " +
    ...
    def __init__(self):
        super().__init__(name="Daylight",
                         ...
                         description="A 60-foot-radius sphere of light spreads out from a point you " +
                                     ...
                                     "light for an additional 60 feet. If you chose a point on an " +
                                     "object you are holding or one that isn't being worn or " +
                                     "carried, the light shines from the object and moves with it. " +
                                     "Completely covering the affected object with an opaque object, " +
                                     "such as a bowl or a helm, blocks the light. If any of this " +
                                     "spell's area overlaps with an area of darkness created by a " +
    ...
    def __init__(self):
        super().__init__(name="Death Ward",
                         ...
                         description="You touch a creature and grant it a measure of protection from " +
                                     ...
                                     "point, and the spell ends. If the spell is still in effect " +
    ...
    def __init__(self):
        super().__init__(name="Delayed Blast Fireball",
                         ...
                         description="A beam of yellow light flashes from your pointing finger, then " +
                                     ...
                                     "glowing bead for the duration. When the spell ends, either " +
                                     "because your concentration is broken or because you decide to " +
                                     "end it, the bead blossoms with a low roar into an explosion of " +
                                     "flame that spreads around corners. Each creature in a " +
                                     "20-foot-radius sphere centered on that point must make a " +
                                     "Dexterity saving throw. A creature takes fire damage equal to " +
                                     "the total accumulated damage on a failed save, or half as much " +
                                     "damage on a successful one. The spell's base damage is 12d6. " +
                                     "If at the end of your turn the bead has not yet detonated, the " +
                                     "damage increases by 1d6. If the glowing bead is touched before " +
                                     "the interval has expired, the creature touching it must make a " +
                                     ...
                                     "ends, and the bead explodes. The fire damages objects in the " +
                                     "area and ignites flammable objects that aren't being worn or " +
                                     "carried. ",
    ...
    def __init__(self):
        super().__init__(name="Demiplane",
                         ...
                         description="You create a shadowy door on a flat solid surface that you can " +
                                     ...
                                     "from the other side. Each time you cast this spell, you can " +
                                     "create a new demiplane, or have the shadowy door connect to a " +
                                     "demiplane you created with a previous casting of this spell. " +
                                     "Additionally, if you know the nature and contents of a " +
                                     "demiplane created by a casting of this spell by another " +
                                     "creature, you can have the shadowy door connect to its " +
                                     "demiplane instead. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Detect Magic",
                         ...
                         description="For the duration, you sense the presence of magic within 30 " +
                                     ...
                                     "of magic, if any. The spell can penetrate most barriers, but " +
                                     "it is blocked by 1 foot of stone, 1 inch of common metal, a " +
    ...
    def __init__(self):
        super().__init__(name="Detect Poison and Disease",
                         ...
                         description="For the duration, you can sense the presence and location of " +
                                     ...
                                     "or disease in each case. The spell can penetrate most " +
    ...
    def __init__(self):
        super().__init__(name="Detect Thoughts",
                         ...
                         description="For the duration, you can read the thoughts of certain " +
                                     ...
                                     "doesn't speak any language, the creature is unaffected. You " +
                                     "initially learn the surface thoughts of the creature—what is " +
                                     ...
                                     "deeper, the target must make a Wisdom saving throw. If it " +
                                     "fails, you gain insight into its reasoning (if any), its " +
                                     "emotional state, and something that looms large in its mind " +
                                     "(such as something it worries over, loves, or hates). If it " +
                                     "succeeds, the spell ends. Either way, the target knows that " +
                                     "you are probing into its mind, and unless you shift your " +
                                     "attention to another creature's thoughts, the creature can use " +
                                     "its action on its turn to make an Intelligence check contested " +
                                     ...
                                     "particularly effective as part of an interrogation. You can " +
                                     "also use this spell to detect the presence of thinking " +
                                     ...
                                     "language. Once you detect the presence of a creature in this " +
    ...
    def __init__(self):
        super().__init__(name="Dimension Door",
                         ...
                         description="You teleport yourself from your current location to any other " +
                                     ...
                                     "be within 5 feet of you when you cast this spell. If you would " +
                                     "arrive in a place already occupied by an object or a creature, " +
                                     "you and any creature traveling with you each take 4d6 force " +
    ...
    def __init__(self):
        super().__init__(name="Disguise Self",
                         ...
                         description="You make yourself—including your clothing, armor, weapons, and " +
                                     ...
                                     "the extent of the illusion is up to you. The changes wrought " +
                                     "by this spell fail to hold up to physical inspection. For " +
                                     "example, if you use this spell to add a hat to your outfit, " +
                                     "objects pass through the hat, and anyone who touches it would " +
                                     "feel nothing or would feel your head and hair. If you use this " +
                                     "spell to appear thinner than you are, the hand of someone who " +
                                     "reaches out to touch you would bump into you while it was " +
                                     "seemingly still in midair. To discern that you are disguised, " +
                                     "a creature can use its action to inspect your appearance and " +
    ...
    def __init__(self):
        super().__init__(name="Dispel Evil and Good",
                         ...
                         description="Shimmering energy surrounds and protects you from fey, undead, " +
                                     ...
                                     "have disadvantage on attack rolls against you. You can end the " +
                                     "spell early by using either of the following special " +
                                     "functions. Break Enchantment. As your action, you touch a " +
                                     "creature you can reach that is charmed, frightened, or " +
                                     "possessed by a celestial, an elemental, a fey, a fiend, or an " +
                                     "undead. The creature you touch is no longer charmed, " +
                                     "frightened, or possessed by such creatures. Dismissal. As your " +
                                     "action, make a melee spell attack against a celestial, an " +
                                     "elemental, a fey, a fiend, or an undead you can reach. On a " +
                                     "hit, you attempt to drive the creature back to its home plane. " +
                                     "The creature must succeed on a Charisma saving throw or be " +
                                     "sent back to its home plane (if it isn't there already). If " +
                                     "they aren't on their home plane, undead are sent to the " +
                                     "Shadowfell, and fey are sent to the Feywild. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Divination",
                         ...
                         description="Your magic and an offering put you in contact with a god or a " +
                                     ...
                                     "a cryptic rhyme, or an omen. The spell doesn't take into " +
                                     "account any possible circumstances that might change the " +
                                     "outcome, such as the casting of additional spells or the loss " +
                                     "or gain of a companion. If you cast the spell two or more " +
                                     "times before finishing your next long rest, there is a " +
                                     "cumulative 25 percent chance for each casting after the first " +
                                     "that you get a random reading. The GM makes this roll in " +
                                     "secret. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Divine Word",
                         ...
                         description="You utter a divine word, imbued with the power that shaped the " +
                                     ...
                                     "suffers an effect based on its current hit points: • 50 hit " +
                                     "points or fewer: deafened for 1 minute • 40 hit points or " +
                                     "fewer: deafened and blinded for 10 minutes • 30 hit points or " +
                                     "fewer: blinded, deafened, and stunned for 1 hour • 20 hit " +
                                     "points or fewer: killed instantly Regardless of its current " +
                                     "hit points, a celestial, an elemental, a fey, or a fiend that " +
                                     "fails its save is forced back to its plane of origin (if it " +
                                     "isn't there already) and can't return to your current plane " +
    ...
    def __init__(self):
        super().__init__(name="Dominate Beast",
                         ...
                         description="You attempt to beguile a beast that you can see within range. " +
                                     ...
                                     "are fighting it, it has advantage on the saving throw. While " +
                                     "the beast is charmed, you have a telepathic link with it as " +
                                     "long as the two of you are on the same plane of existence. You " +
                                     "can use this telepathic link to issue commands to the creature " +
                                     "while you are conscious (no action required), which it does " +
                                     "its best to obey. You can specify a simple and general course " +
                                     "of action, such as “Attack that creature,” “Run over there,” " +
                                     "or “Fetch that object.” If the creature completes the order " +
                                     "and doesn't receive further direction from you, it defends and " +
                                     "preserves itself to the best of its ability. You can use your " +
                                     "action to take total and precise control of the target. Until " +
                                     "the end of your next turn, the creature takes only the actions " +
                                     "you choose, and doesn't do anything that you don't allow it to " +
                                     "do. During this time, you can also cause the creature to use a " +
                                     "reaction, but this requires you to use your own reaction as " +
                                     "well. Each time the target takes damage, it makes a new Wisdom " +
    ...
    def __init__(self):
        super().__init__(name="Dominate Monster",
                         ...
                         description="You attempt to beguile a creature that you can see within " +
                                     ...
                                     "defends and preserves itself to the best of its ability. You " +
                                     "can use your action to take total and precise control of the " +
                                     "target. Until the end of your next turn, the creature takes " +
                                     ...
                                     "own reaction as well. Each time the target takes damage, it " +
    ...
    def __init__(self):
        super().__init__(name="Dream",
                         ...
                         description="This spell shapes a creature's dreams. Choose a creature known " +
                                     ...
                                     "same plane of existence as you. Creatures that don't sleep, " +
                                     "such as elves, can't be contacted by this spell. You, or a " +
                                     "willing creature you touch, enters a trance state, acting as a " +
                                     "messenger. While in the trance, the messenger is aware of his " +
                                     "or her surroundings, but can't take actions or move. If the " +
                                     "target is asleep, the messenger appears in the target's dreams " +
                                     "and can converse with the target as long as it remains asleep, " +
                                     "through the duration of the spell. The messenger can also " +
                                     "shape the environment of the dream, creating landscapes, " +
                                     ...
                                     "the target's dreams. You can make the messenger appear " +
                                     "monstrous and terrifying to the target. If you do, the " +
                                     "messenger can deliver a message of no more than ten words and " +
                                     "then the target must make a Wisdom saving throw. On a failed " +
                                     "save, echoes of the phantasmal monstrosity spawn a nightmare " +
                                     "that lasts the duration of the target's sleep and prevents the " +
                                     "target from gaining any benefit from that rest. In addition, " +
                                     "when the target wakes up, it takes 3d6 psychic damage. If you " +
                                     "have a body part, lock of hair, clipping from a nail, or " +
    ...
    def __init__(self):
        super().__init__(name="Druidcraft",
                         ...
                         description="Whispering to the spirits of nature, you create one of the " +
                                     ...
                                     "round. • You instantly make a flower blossom, a seed pod open, " +
                                     "or a leaf bud bloom. • You create an instantaneous, harmless " +
                                     "sensory effect, such as falling leaves, a puff of wind, the " +
                                     "sound of a small animal, or the faint odor of skunk. The " +
                                     "effect must fit in a 5-foot cube. • You instantly light or " +
                                     "snuff out a candle, a torch, or a small campfire. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Earthquake",
                         ...
                         description="You create a seismic disturbance at a point on the ground that " +
                                     ...
                                     "with the ground in that area. The ground in the area becomes " +
                                     "difficult terrain. Each creature on the ground that is " +
                                     "concentrating must make a Constitution saving throw. On a " +
                                     "failed save, the creature's concentration is broken. When you " +
                                     "cast this spell and at the end of each turn you spend " +
                                     "concentrating on it, each creature on the ground in the area " +
                                     "must make a Dexterity saving throw. On a failed save, the " +
                                     "creature is knocked prone. This spell can have additional " +
                                     "effects depending on the terrain in the area, as determined by " +
                                     "the GM. Fissures. Fissures open throughout the spell's area at " +
                                     "the start of your next turn after you cast the spell. A total " +
                                     "of 1d6 such fissures open in locations chosen by the GM. Each " +
                                     "is 1d10 × 10 feet deep, 10 feet wide, and extends from one " +
                                     ...
                                     "automatically collapse (see below). Structures. The tremor " +
                                     "deals 50 bludgeoning damage to any structure in contact with " +
                                     "the ground in the area when you cast the spell and at the " +
                                     "start of each of your turns until the spell ends. If a " +
                                     "structure drops to 0 hit points, it collapses and potentially " +
                                     "damages nearby creatures. A creature within half the distance " +
                                     "of a structure's height must make a Dexterity saving throw. On " +
                                     "a failed save, the creature takes 5d6 bludgeoning damage, is " +
    ...
    def __init__(self):
        super().__init__(name="Enhance Ability",
                         ...
                         description="You touch a creature and bestow upon it a magical enhancement. " +
                                     ...
                                     "effect until the spell ends. Bear's Endurance. The target has " +
                                     "advantage on Constitution checks. It also gains 2d6 temporary " +
                                     "hit points, which are lost when the spell ends. Bull's " +
                                     "Strength. The target has advantage on Strength checks, and his " +
                                     "or her carrying capacity doubles. Cat's Grace. The target has " +
                                     "advantage on Dexterity checks. It also doesn't take damage " +
                                     "from falling 20 feet or less if it isn't incapacitated. " +
                                     "Eagle's Splendor. The target has advantage on Charisma checks. " +
                                     "Fox's Cunning. The target has advantage on Intelligence " +
                                     "checks. Owl's Wisdom. The target has advantage on Wisdom " +
                                     "checks. ",
                         at_higher_levels="When you cast this spell using a spell slot of 3rd level or " +
                                          "higher, you can target one additional creature for each slot " +
                                          "level above 2nd. ")
    ...
    def __init__(self):
        super().__init__(name="Enlarge/Reduce",
                         ...
                         description="You cause a creature or an object you can see within range to " +
                                     ...
                                     "On a success, the spell has no effect. If the target is a " +
                                     "creature, everything it is wearing and carrying changes size " +
                                     "with it. Any item dropped by an affected creature returns to " +
                                     "normal size at once. Enlarge. The target's size doubles in all " +
                                     "dimensions, and its weight is multiplied by eight. This growth " +
                                     "increases its size by one category— from Medium to Large, for " +
                                     "example. If there isn't enough room for the target to double " +
                                     "its size, the creature or object attains the maximum possible " +
                                     "size in the space available. Until the spell ends, the target " +
                                     "also has advantage on Strength checks and Strength saving " +
                                     "throws. The target's weapons also grow to match its new size. " +
                                     "While these weapons are enlarged, the target's attacks with " +
                                     "them deal 1d4 extra damage. Reduce. The target's size is " +
                                     "halved in all dimensions, and its weight is reduced to " +
                                     "one-eighth of normal. This reduction decreases its size by one " +
                                     "category—from Medium to Small, for example. Until the spell " +
                                     "ends, the target also has disadvantage on Strength checks and " +
                                     "Strength saving throws. The target's weapons also shrink to " +
                                     "match its new size. While these weapons are reduced, the " +
                                     "target's attacks with them deal 1d4 less damage (this can't " +
    ...
    def __init__(self):
        super().__init__(name="Entangle",
                         ...
                         description="Grasping weeds and vines sprout from the ground in a 20-foot " +
                                     ...
                                     "these plants turn the ground in the area into difficult " +
                                     "terrain. A creature in the area when you cast the spell must " +
                                     "succeed on a Strength saving throw or be restrained by the " +
                                     "entangling plants until the spell ends. A creature restrained " +
                                     "by the plants can use its action to make a Strength check " +
    ...
    def __init__(self):
        super().__init__(name="Etherealness",
                         ...
                         description="You step into the border regions of the Ethereal Plane, in the " +
                                     ...
                                     "can't see anything more than 60 feet away. While on the " +
                                     "Ethereal Plane, you can only affect and be affected by other " +
                                     "creatures on that plane. Creatures that aren't on the Ethereal " +
                                     "Plane can't perceive you and can't interact with you, unless a " +
                                     ...
                                     "the plane you originated from. When the spell ends, you " +
                                     "immediately return to the plane you originated from in the " +
                                     "spot you currently occupy. If you occupy the same spot as a " +
                                     ...
                                     "feet you are moved. This spell has no effect if you cast it " +
                                     "while you are on the Ethereal Plane or a plane that doesn't " +
    ...
    def __init__(self):
        super().__init__(name="Eyebite",
                         ...
                         description="For the spell's duration, your eyes become an inky void imbued " +
                                     ...
                                     "against this casting of eyebite. Asleep. The target falls " +
                                     "unconscious. It wakes up if it takes any damage or if another " +
                                     "creature uses its action to shake the sleeper awake. Panicked. " +
                                     "The target is frightened of you. On each of its turns, the " +
                                     "frightened creature must take the Dash action and move away " +
                                     "from you by the safest and shortest available route, unless " +
                                     "there is nowhere to move. If the target moves to a place at " +
                                     "least 60 feet away from you where it can no longer see you, " +
                                     "this effect ends. Sickened. The target has disadvantage on " +
                                     "attack rolls and ability checks. At the end of each of its " +
                                     "turns, it can make another Wisdom saving throw. If it " +
    ...
    def __init__(self):
        super().__init__(name="Fabricate",
                         ...
                         description="You convert raw materials into products of the same material. " +
                                     ...
                                     "wool. Choose raw materials that you can see within range. You " +
                                     ...
                                     "materials. Creatures or magic items can't be created or " +
    ...
    def __init__(self):
        super().__init__(name="Faerie Fire",
                         ...
                         description="Each object in a 20-foot cube within range is outlined in " +
                                     ...
                                     "and affected creatures shed dim light in a 10-foot radius. Any " +
    ...
    def __init__(self):
        super().__init__(name="Faithful Hound",
                         ...
                         description="You conjure a phantom watchdog in an unoccupied space that you " +
                                     ...
                                     "feet away from it. The hound is invisible to all creatures " +
                                     "except you and can't be harmed. When a Small or larger " +
                                     "creature comes within 30 feet of it without first speaking the " +
                                     "password that you specify when you cast this spell, the hound " +
                                     "starts barking loudly. The hound sees invisible creatures and " +
                                     "can see into the Ethereal Plane. It ignores illusions. At the " +
                                     "start of each of your turns, the hound attempts to bite one " +
                                     "creature within 5 feet of it that is hostile to you. The " +
    ...
    def __init__(self):
        super().__init__(name="Fear",
                         ...
                         description="You project a phantasmal image of a creature's worst fears. " +
                                     ...
                                     "frightened for the duration. While frightened by this spell, a " +
                                     "creature must take the Dash action and move away from you by " +
                                     "the safest available route on each of its turns, unless there " +
                                     "is nowhere to move. If the creature ends its turn in a " +
                                     "location where it doesn't have line of sight to you, the " +
                                     "creature can make a Wisdom saving throw. On a successful save, " +
    ...
    def __init__(self):
        super().__init__(name="Feeblemind",
                         ...
                         description="You blast the mind of a creature that you can see within " +
                                     ...
                                     "Intelligence saving throw. On a failed save, the creature's " +
                                     "Intelligence and Charisma scores become 1. The creature can't " +
                                     "cast spells, activate magic items, understand language, or " +
                                     "communicate in any intelligible way. The creature can, " +
                                     "however, identify its friends, follow them, and even protect " +
                                     "them. At the end of every 30 days, the creature can repeat its " +
    ...
    def __init__(self):
        super().__init__(name="Find Familiar",
                         ...
                         description="You gain the service of a familiar, a spirit that takes an " +
                                     ...
                                     "raven, sea horse, spider, or weasel. Appearing in an " +
                                     "unoccupied space within range, the familiar has the statistics " +
                                     "of the chosen form, though it is a celestial, fey, or fiend " +
                                     "(your choice) instead of a beast. Your familiar acts " +
                                     "independently of you, but it always obeys your commands. In " +
                                     "combat, it rolls its own initiative and acts on its own turn. " +
                                     "A familiar can't attack, but it can take other actions as " +
                                     "normal. When the familiar drops to 0 hit points, it " +
                                     ...
                                     "familiar's eyes and hear what it hears until the start of your " +
                                     "next turn, gaining the benefits of any special senses that the " +
                                     "familiar has. During this time, you are deaf and blind with " +
                                     "regard to your own senses. As an action, you can temporarily " +
                                     "dismiss your familiar. It disappears into a pocket dimension " +
                                     "where it awaits your summons. Alternatively, you can dismiss " +
                                     "it forever. As an action while it is temporarily dismissed, " +
                                     "you can cause it to reappear in any unoccupied space within 30 " +
                                     "feet of you. You can't have more than one familiar at a time. " +
                                     "If you cast this spell while you already have a familiar, you " +
                                     "instead cause it to adopt a new form. Choose one of the forms " +
                                     "from the above list. Your familiar transforms into the chosen " +
    ...
    def __init__(self):
        super().__init__(name="Find Steed",
                         ...
                         description="You summon a spirit that assumes the form of an unusually " +
                                     ...
                                     "understand one language of your choice that you speak. Your " +
                                     "steed serves you as a mount, both in combat and out, and you " +
                                     ...
                                     "restored to its hit point maximum. While your steed is within " +
                                     "1 mile of you, you can communicate with it telepathically. You " +
    ...
    def __init__(self):
        super().__init__(name="Find Traps",
                         ...
                         description="You sense the presence of any trap within range that is within " +
                                     ...
                                     "sinkhole. This spell merely reveals that a trap is present. " +
    ...
    def __init__(self):
        super().__init__(name="Finger of Death",
                         ...
                         description="You send negative energy coursing through a creature that you " +
                                     ...
                                     "damage on a failed save, or half as much damage on a " +
                                     "successful one. A humanoid killed by this spell rises at the " +
                                     "start of your next turn as a zombie that is permanently under " +
                                     "your command, following your verbal orders to the best of its " +
                                     "ability. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Fire Bolt",
                         ...
                         description="You hurl a mote of fire at a creature or object within range. " +
                                     ...
                                     "damage increases by 1d10 when you reach 5th level (2d10), 11th " +
    ...
    def __init__(self):
        super().__init__(name="Fire Shield",
                         ...
                         description="Thin and wispy flames wreathe your body for the duration, " +
                                     ...
                                     "action to dismiss it. The flames provide you with a warm " +
                                     "shield or a chill shield, as you choose. The warm shield " +
                                     "grants you resistance to cold damage, and the chill shield " +
                                     "grants you resistance to fire damage. In addition, whenever a " +
                                     "creature within 5 feet of you hits you with a melee attack, " +
                                     "the shield erupts with flame. The attacker takes 2d8 fire " +
                                     "damage from a warm shield, or 2d8 cold damage from a cold " +
                                     "shield. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Fire Storm",
                         ...
                         description="A storm made up of sheets of roaring flame appears in a " +
                                     ...
                                     "the face of another cube. Each creature in the area must make " +
                                     "a Dexterity saving throw. It takes 7d10 fire damage on a " +
                                     "failed save, or half as much damage on a successful one. The " +
                                     "fire damages objects in the area and ignites flammable objects " +
                                     "that aren't being worn or carried. If you choose, plant life " +
    ...
    def __init__(self):
        super().__init__(name="Flame Blade",
                         ...
                         description="You evoke a fiery blade in your free hand. The blade is " +
                                     ...
                                     "can evoke the blade again as a bonus action. You can use your " +
                                     "action to make a melee spell attack with the fiery blade. On a " +
                                     "hit, the target takes 3d6 fire damage. The flaming blade sheds " +
    ...
    def __init__(self):
        super().__init__(name="Flaming Sphere",
                         ...
                         description="A 5-foot-diameter sphere of fire appears in an unoccupied " +
                                     ...
                                     "successful one. As a bonus action, you can move the sphere up " +
                                     "to 30 feet. If you ram the sphere into a creature, that " +
                                     "creature must make the saving throw against the sphere's " +
                                     "damage, and the sphere stops moving this turn. When you move " +
                                     "the sphere, you can direct it over barriers up to 5 feet tall " +
                                     "and jump it across pits up to 10 feet wide. The sphere ignites " +
                                     "flammable objects not being worn or carried, and it sheds " +
    ...
    def __init__(self):
        super().__init__(name="Flesh to Stone",
                         ...
                         description="You attempt to turn one creature that you can see within range " +
                                     ...
                                     "successful save, the creature isn't affected. A creature " +
                                     "restrained by this spell must make another Constitution saving " +
                                     "throw at the end of each of its turns. If it successfully " +
                                     "saves against this spell three times, the spell ends. If it " +
                                     "fails its saves three times, it is turned to stone and " +
                                     "subjected to the petrified condition for the duration. The " +
                                     "successes and failures don't need to be consecutive; keep " +
                                     "track of both until the target collects three of a kind. If " +
                                     "the creature is physically broken while petrified, it suffers " +
    ...
    def __init__(self):
        super().__init__(name="Floating Disk",
                         ...
                         description="This spell creates a circular, horizontal plane of force, 3 " +
                                     ...
                                     "could it leave such a pit if it was created at the bottom. If " +
                                     "you move more than 100 feet from the disk (typically because " +
                                     "it can't move around an obstacle to follow you), the spell " +
                                     "ends. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Forbiddance",
                         ...
                         description="You create a ward against magical travel that protects up to " +
                                     ...
                                     "Shadowfell, or the plane shift spell. In addition, the spell " +
                                     "damages types of creatures that you choose when you cast it. " +
                                     "Choose one or more of the following: celestials, elementals, " +
                                     "fey, fiends, and undead. When a chosen creature enters the " +
                                     "spell's area for the first time on a turn or starts its turn " +
                                     "there, the creature takes 5d10 radiant or necrotic damage " +
                                     "(your choice when you cast this spell). When you cast this " +
                                     "spell, you can designate a password. A creature that speaks " +
                                     "the password as it enters the area takes no damage from the " +
    ...
    def __init__(self):
        super().__init__(name="Forcecage",
                         ...
                         description="An immobile, invisible, cube-shaped prison composed of magical " +
                                     ...
                                     "area. When you cast the spell, any creature that is completely " +
                                     ...
                                     "completely outside the area. A creature inside the cage can't " +
                                     "leave it by nonmagical means. If the creature tries to use " +
                                     "teleportation or interplanar travel to leave the cage, it must " +
                                     "first make a Charisma saving throw. On a success, the creature " +
                                     "can use that magic to exit the cage. On a failure, the " +
                                     "creature can't exit the cage and wastes the use of the spell " +
                                     "or effect. The cage also extends into the Ethereal Plane, " +
                                     "blocking ethereal travel. This spell can't be dispelled by " +
                                     "dispel magic. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Freedom of Movement",
                         ...
                         description="You touch a willing creature. For the duration, the target's " +
                                     ...
                                     "nor cause the target to be paralyzed or restrained. The target " +
                                     "can also spend 5 feet of movement to automatically escape from " +
                                     "nonmagical restraints, such as manacles or a creature that has " +
                                     "it grappled. Finally, being underwater imposes no penalties on " +
    ...
    def __init__(self):
        super().__init__(name="Freezing Sphere",
                         ...
                         description="A frigid globe of cold energy streaks from your fingertips to " +
                                     ...
                                     "much damage. If the globe strikes a body of water or a liquid " +
                                     "that is principally water (not including water-based " +
                                     "creatures), it freezes the liquid to a depth of 6 inches over " +
                                     "an area 30 feet square. This ice lasts for 1 minute. Creatures " +
                                     "that were swimming on the surface of frozen water are trapped " +
                                     "in the ice. A trapped creature can use an action to make a " +
                                     "Strength check against your spell save DC to break free. You " +
                                     "can refrain from firing the globe after completing the spell, " +
                                     ...
                                     "of 40 feet) or hurl it with a sling (to the sling's normal " +
    ...
    def __init__(self):
        super().__init__(name="Gaseous Form",
                         ...
                         description="You transform a willing creature you touch, along with " +
                                     ...
                                     "points. An incorporeal creature isn't affected. While in this " +
                                     "form, the target's only method of movement is a flying speed " +
                                     "of 10 feet. The target can enter and occupy the space of " +
                                     "another creature. The target has resistance to nonmagical " +
                                     ...
                                     "liquids as though they were solid surfaces. The target can't " +
                                     "fall and remains hovering in the air even when stunned or " +
                                     "otherwise incapacitated. While in the form of a misty cloud, " +
                                     "the target can't talk or manipulate objects, and any objects " +
                                     "it was carrying or holding can't be dropped, used, or " +
                                     "otherwise interacted with. The target can't attack or cast " +
                                     "spells. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Gate",
                         ...
                         description="You conjure a portal linking an unoccupied space you can see " +
                                     ...
                                     "their presence or anywhere within their domains. When you cast " +
                                     "this spell, you can speak the name of a specific creature (a " +
                                     "pseudonym, title, or nickname doesn't work). If that creature " +
                                     "is on a plane other than the one you are on, the portal opens " +
                                     "in the named creature's immediate vicinity and draws the " +
                                     "creature through it to the nearest unoccupied space on your " +
                                     "side of the portal. You gain no special power over the " +
    ...
    def __init__(self):
        super().__init__(name="Geas",
                         ...
                         description="You place a magical command on a creature that you can see " +
                                     ...
                                     "can't understand you is unaffected by the spell. You can issue " +
                                     "any command you choose, short of an activity that would result " +
                                     "in certain death. Should you issue a suicidal command, the " +
                                     "spell ends. You can end the spell early by using an action to " +
                         ...
                         at_higher_levels="When you cast this spell using a spell slot of 7th or 8th " +
                                          "level, the duration is 1 year. When you cast this spell using " +
                                          "a spell slot of 9th level, the spell lasts until it is ended " +
    ...
    def __init__(self):
        super().__init__(name="Gentle Repose",
                         ...
                         description="You touch a corpse or other remains. For the duration, the " +
                                     ...
                                     "spell also effectively extends the time limit on raising the " +
                                     "target from the dead, since days spent under the influence of " +
                                     "this spell don't count against the time limit of spells such " +
                                     "as raise dead. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Giant Insect",
                         ...
                         description="You transform up to ten centipedes, three spiders, five wasps, " +
                                     ...
                                     "giant wasp, and a scorpion becomes a giant scorpion. Each " +
                                     "creature obeys your verbal commands, and in combat, they act " +
                                     "on your turn each round. The GM has the statistics for these " +
                                     "creatures and resolves their actions and movement. A creature " +
                                     "remains in its giant size for the duration, until it drops to " +
                                     "0 hit points, or until you use an action to dismiss the effect " +
                                     "on it. The GM might allow you to choose different targets. For " +
    ...
    def __init__(self):
        super().__init__(name="Glibness",
                         ...
                         description="Until the spell ends, when you make a Charisma check, you can " +
                                     ...
                                     "what you say, magic that would determine if you are telling " +
                                     "the truth indicates that you are being truthful. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Globe of Invulnerability",
                         ...
                         description="An immobile, faintly shimmering barrier springs into existence " +
                                     ...
                                     "is cast using a higher level spell slot. Such a spell can " +
                                     "target creatures and objects within the barrier, but the spell " +
                                     "has no effect on them. Similarly, the area within the barrier " +
    ...
    def __init__(self):
        super().__init__(name="Glyph of Warding",
                         ...
                         description="When you cast this spell, you inscribe a glyph that harms " +
                                     ...
                                     "without being triggered. The glyph is nearly invisible and " +
                                     "requires a successful Intelligence (Investigation) check " +
                                     "against your spell save DC to be found. You decide what " +
                                     "triggers the glyph when you cast the spell. For glyphs " +
                                     "inscribed on a surface, the most typical triggers include " +
                                     "touching or standing on the glyph, removing another object " +
                                     "covering the glyph, approaching within a certain distance of " +
                                     "the glyph, or manipulating the object on which the glyph is " +
                                     "inscribed. For glyphs inscribed within an object, the most " +
                                     "common triggers include opening that object, approaching " +
                                     "within a certain distance of the object, or seeing or reading " +
                                     "the glyph. Once a glyph is triggered, this spell ends. You can " +
                                     ...
                                     "(such as height or weight), creature kind (for example, the " +
                                     "ward could be set to affect aberrations or drow), or " +
                                     "alignment. You can also set conditions for creatures that " +
                                     "don't trigger the glyph, such as those who say a certain " +
                                     "password. When you inscribe the glyph, choose explosive runes " +
                                     "or a spell glyph. Explosive Runes. When triggered, the glyph " +
                                     "erupts with magical energy in a 20-foot-radius sphere centered " +
                                     "on the glyph. The sphere spreads around corners. Each creature " +
                                     "in the area must make a Dexterity saving throw. A creature " +
                                     "takes 5d8 acid, cold, fire, lightning, or thunder damage on a " +
                                     "failed saving throw (your choice when you create the glyph), " +
                                     "or half as much damage on a successful one. Spell Glyph. You " +
                                     "can store a prepared spell of 3rd level or lower in the glyph " +
                                     "by casting it as part of creating the glyph. The spell must " +
                                     "target a single creature or an area. The spell being stored " +
                                     "has no immediate effect when cast in this way. When the glyph " +
                                     "is triggered, the stored spell is cast. If the spell has a " +
                                     "target, it targets the creature that triggered the glyph. If " +
                                     "the spell affects an area, the area is centered on that " +
                                     "creature. If the spell summons hostile creatures or creates " +
                                     "harmful objects or traps, they appear as close as possible to " +
    ...
    def __init__(self):
        super().__init__(name="Grease",
                         ...
                         description="Slick grease covers the ground in a 10-foot square centered on " +
                                     ...
                                     "the duration. When the grease appears, each creature standing " +
                                     "in its area must succeed on a Dexterity saving throw or fall " +
                                     "prone. A creature that enters the area or ends its turn there " +
    ...
    def __init__(self):
        super().__init__(name="Guardian of Faith",
                         ...
                         description="A Large spectral guardian appears and hovers for the duration " +
                                     ...
                                     "symbol of your deity. Any creature hostile to you that moves " +
                                     "to a space within 10 feet of the guardian for the first time " +
                                     "on a turn must succeed on a Dexterity saving throw. The " +
                                     "creature takes 20 radiant damage on a failed save, or half as " +
                                     "much damage on a successful one. The guardian vanishes when it " +
    ...
    def __init__(self):
        super().__init__(name="Guards and Wards",
                         ...
                         description="You create a ward that protects up to 2,500 square feet of " +
                                     ...
                                     "you are casting the spell. When you cast this spell, you can " +
                                     "specify individuals that are unaffected by any or all of the " +
                                     "effects that you choose. You can also specify a password that, " +
                                     "when spoken aloud, makes the speaker immune to these effects. " +
                                     "Guards and wards creates the following effects within the " +
                                     "warded area. Corridors. Fog fills all the warded corridors, " +
                                     "making them heavily obscured. In addition, at each " +
                                     "intersection or branching passage offering a choice of " +
                                     "direction, there is a 50 percent chance that a creature other " +
                                     "than you will believe it is going in the opposite direction " +
                                     "from the one it chooses. Doors. All doors in the warded area " +
                                     "are magically locked, as if sealed by an arcane lock spell. In " +
                                     "addition, you can cover up to ten doors with an illusion " +
                                     "(equivalent to the illusory object function of the minor " +
                                     ...
                                     "stronghold. • Place dancing lights in four corridors. You can " +
                                     "designate a simple program that the lights repeat as long as " +
                                     "guards and wards lasts. • Place magic mouth in two locations. " +
                                     "• Place stinking cloud in two locations. The vapors appear in " +
                                     "the places you designate; they return within 10 minutes if " +
                                     "dispersed by wind while guards and wards lasts. • Place a " +
                                     "constant gust of wind in one corridor or room. • Place a " +
                                     "suggestion in one location. You select an area of up to 5 feet " +
                                     "square, and any creature that enters or passes through the " +
                                     "area receives the suggestion mentally. The whole warded area " +
                                     "radiates magic. A dispel magic cast on a specific effect, if " +
                                     "successful, removes only that effect. You can create a " +
                                     "permanently guarded and warded structure by casting this spell " +
    ...
    def __init__(self):
        super().__init__(name="Gust of Wind",
                         ...
                         description="A line of strong wind 60 feet long and 10 feet wide blasts " +
                                     ...
                                     "a direction following the line. Any creature in the line must " +
                                     "spend 2 feet of movement for every 1 foot it moves when moving " +
                                     "closer to you. The gust disperses gas or vapor, and it " +
                                     "extinguishes candles, torches, and similar unprotected flames " +
                                     "in the area. It causes protected flames, such as those of " +
                                     "lanterns, to dance wildly and has a 50 percent chance to " +
                                     "extinguish them. As a bonus action on each of your turns " +
                                     "before the spell ends, you can change the direction in which " +
    ...
    def __init__(self):
        super().__init__(name="Hallow",
                         ...
                         description="You touch a point and infuse an area around it with holy (or " +
                                     ...
                                     "following effects. First, celestials, elementals, fey, fiends, " +
                                     "and undead can't enter the area, nor can such creatures charm, " +
                                     "frighten, or possess creatures within it. Any creature " +
                                     "charmed, frightened, or possessed by such a creature is no " +
                                     "longer charmed, frightened, or possessed upon entering the " +
                                     "area. You can exclude one or more of those types of creatures " +
                                     "from this effect. Second, you can bind an extra effect to the " +
                                     "area. Choose the effect from the following list, or choose an " +
                                     ...
                                     "area. Darkness. Darkness fills the area. Normal light, as well " +
                                     "as magical light created by spells of a lower level than the " +
                                     ...
                                     "cast this spell can't extinguish the light. Energy Protection. " +
                                     "Affected creatures in the area have resistance to one damage " +
                                     "type of your choice, except for bludgeoning, piercing, or " +
                                     "slashing. Energy Vulnerability. Affected creatures in the area " +
                                     "have vulnerability to one damage type of your choice, except " +
                                     "for bludgeoning, piercing, or slashing. Everlasting Rest. Dead " +
                                     "bodies interred in the area can't be turned into undead. " +
                                     "Extradimensional Interference. Affected creatures can't move " +
                                     "or travel using teleportation or by extradimensional or " +
                                     "interplanar means. Fear. Affected creatures are frightened " +
                                     "while in the area. Silence. No sound can emanate from within " +
                                     "the area, and no sound can reach into it. Tongues. Affected " +
                                     "creatures can communicate with any other creature in the area, " +
    ...
    def __init__(self):
        super().__init__(name="Hallucinatory Terrain",
                         ...
                         description="You make natural terrain in a 150-foot cube in range look, " +
                                     ...
                                     "within the area aren't changed in appearance. The tactile " +
                                     "characteristics of the terrain are unchanged, so creatures " +
                                     "entering the area are likely to see through the illusion. If " +
                                     "the difference isn't obvious by touch, a creature carefully " +
                                     "examining the illusion can attempt an Intelligence " +
    ...
    def __init__(self):
        super().__init__(name="Haste",
                         ...
                         description="Choose a willing creature that you can see within range. Until " +
                                     ...
                                     "only), Dash, Disengage, Hide, or Use an Object action. When " +
                                     "the spell ends, the target can't move or take actions until " +
    ...
    def __init__(self):
        super().__init__(name="Heat Metal",
                         ...
                         description="Choose a manufactured metal object, such as a metal weapon or " +
                                     ...
                                     "again. If a creature is holding or wearing the object and " +
    ...
    def __init__(self):
        super().__init__(name="Heroes' Feast",
                         ...
                         description="You bring forth a great feast, including magnificent food and " +
                                     ...
                                     "until this hour is over. Up to twelve other creatures can " +
                                     "partake of the feast. A creature that partakes of the feast " +
                                     "gains several benefits. The creature is cured of all diseases " +
                                     "and poison, becomes immune to poison and being frightened, and " +
                                     "makes all Wisdom saving throws with advantage. Its hit point " +
                                     "maximum also increases by 2d10, and it gains the same number " +
    ...
    def __init__(self):
        super().__init__(name="Heroism",
                         ...
                         description="A willing creature you touch is imbued with bravery. Until the " +
                                     ...
                                     "gains temporary hit points equal to your spellcasting ability " +
                                     "modifier at the start of each of its turns. When the spell " +
                                     "ends, the target loses any remaining temporary hit points from " +
                                     "this spell. ",
                         at_higher_levels="When you cast this spell using a spell slot of 2nd level or " +
                                          "higher, you can target one additional creature for each slot " +
                                          "level above 1st. ")
    ...
    def __init__(self):
        super().__init__(name="Hideous Laughter",
                         ...
                         description="A creature of your choice that you can see within range " +
                                     ...
                                     "Intelligence score of 4 or less isn't affected. At the end of " +
                                     "each of its turns, and each time it takes damage, the target " +
                                     "can make another Wisdom saving throw. The target has advantage " +
                                     "on the saving throw if it's triggered by damage. On a success, " +
                                     "the spell ends. ",
                         at_higher_levels="")
...
class HoldPerson(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Hold Person",
                         ...
                         material_components_list="a small, straight piece of iron",
                         duration="1 minute",
                         description="Choose a humanoid that you can see within range. The target " +
                                     "must succeed on a Wisdom saving throw or be paralyzed for the " +
                         ...
                         at_higher_levels="When you cast this spell using a spell slot of 3rd level or " +
                                          ...
                                          "level above 2nd. The humanoids must be within 30 feet of each " +
                                          "other when you target them. ")
    ...
    def __init__(self):
        super().__init__(name="Holy Aura",
                         ...
                         description="Divine light washes out from you and coalesces in a soft " +
                                     ...
                                     "choice in that radius when you cast this spell shed dim light " +
                                     "in a 5-foot radius and have advantage on all saving throws, " +
                                     "and other creatures have disadvantage on attack rolls against " +
                                     "them until the spell ends. In addition, when a fiend or an " +
                                     "undead hits an affected creature with a melee attack, the aura " +
                                     "flashes with brilliant light. The attacker must succeed on a " +
    ...
    def __init__(self):
        super().__init__(name="Hypnotic Pattern",
                         ...
                         description="You create a twisting pattern of colors that weaves through " +
                                     ...
                                     "failed save, the creature becomes charmed for the duration. " +
                                     "While charmed by this spell, the creature is incapacitated and " +
                                     "has a speed of 0. The spell ends for an affected creature if " +
                                     "it takes any damage or if someone else uses an action to shake " +
    ...
    def __init__(self):
        super().__init__(name="Ice Storm",
                         ...
                         description="A hail of rock-hard ice pounds to the ground in a 20- " +
                                     ...
                                     "successful one. Hailstones turn the storm's area of effect " +
                                     "into difficult terrain until the end of your next turn. ",
                         at_higher_levels="When you cast this spell using a spell slot of 5th level or " +
    ...
    def __init__(self):
        super().__init__(name="Identify",
                         ...
                         description="You choose one object that you must touch throughout the " +
                                     ...
                                     "touch a creature throughout the casting, you learn what " +
    ...
    def __init__(self):
        super().__init__(name="Illusory Script",
                         ...
                         description="You write on parchment, paper, or some other suitable writing " +
                                     ...
                                     "the duration. To you and any creatures you designate when you " +
                                     "cast the spell, the writing appears normal, written in your " +
                                     "hand, and conveys whatever meaning you intended when you wrote " +
                                     "the text. To all others, the writing appears as if it were " +
                                     "written in an unknown or magical script that is " +
                                     "unintelligible. Alternatively, you can cause the writing to " +
                                     "appear to be an entirely different message, written in a " +
                                     "different hand and language, though the language must be one " +
                                     "you know. Should the spell be dispelled, the original script " +
                                     "and the illusion both disappear. A creature with truesight can " +
    ...
    def __init__(self):
        super().__init__(name="Imprisonment",
                         ...
                         description="You create a magical restraint to hold a creature that you can " +
                                     ...
                                     "the target. When you cast the spell, you choose one of the " +
                                     "following forms of imprisonment. Burial. The target is " +
                                     "entombed far beneath the earth in a sphere of magical force " +
                                     "that is just large enough to contain the target. Nothing can " +
                                     "pass through the sphere, nor can any creature teleport or use " +
                                     "planar travel to get into or out of it. The special component " +
                                     "for this version of the spell is a small mithral orb. " +
                                     ...
                                     "chain of precious metal. Hedged Prison. The spell transports " +
                                     "the target into a tiny demiplane that is warded against " +
                                     "teleportation and planar travel. The demiplane can be a " +
                                     "labyrinth, a cage, a tower, or any similar confined structure " +
                                     "or area of your choice. The special component for this version " +
                                     "of the spell is a miniature representation of the prison made " +
                                     "from jade. Minimus Containment. The target shrinks to a height " +
                                     ...
                                     "nothing else can pass through, even by means of teleportation " +
                                     "or planar travel. The gemstone can't be cut or broken while " +
                                     "the spell remains in effect. The special component for this " +
                                     "version of the spell is a large, transparent gemstone, such as " +
                                     "a corundum, diamond, or ruby. Slumber. The target falls asleep " +
                                     "and can't be awoken. The special component for this version of " +
                                     "the spell consists of rare soporific herbs. Ending the Spell. " +
                                     "During the casting of the spell, in any of its versions, you " +
                                     "can specify a condition that will cause the spell to end and " +
                                     "release the target. The condition can be as specific or as " +
                                     "elaborate as you choose, but the GM must agree that the " +
                                     "condition is reasonable and has a likelihood of coming to " +
                                     "pass. The conditions can be based on a creature's name, " +
                                     "identity, or deity but otherwise must be based on observable " +
                                     "actions or qualities and not based on intangibles such as " +
                                     "level, class, or hit points. A dispel magic spell can end the " +
                                     "spell only if it is cast as a 9th-level spell, targeting " +
                                     "either the prison or the special component used to create it. " +
    ...
    def __init__(self):
        super().__init__(name="Insect Plague",
                         ...
                         description="Swarming, biting locusts fill a 20-foot-radius sphere centered " +
                                     ...
                                     "lightly obscured. The sphere's area is difficult terrain. When " +
                                     "the area appears, each creature in it must make a Constitution " +
                                     "saving throw. A creature takes 4d10 piercing damage on a " +
    ...
    def __init__(self):
        super().__init__(name="Instant Summons",
                         ...
                         description="You touch an object weighing 10 pounds or less whose longest " +
                                     ...
                                     "the spell ends. If another creature is holding or carrying the " +
                                     "item, crushing the sapphire doesn't transport the item to you, " +
                                     "but instead you learn who the creature possessing the object " +
                                     "is and roughly where that creature is located at that moment. " +
    ...
    def __init__(self):
        super().__init__(name="Irresistible Dance",
                         ...
                         description="Choose one creature that you can see within range. The target " +
                                     ...
                                     "and capering for the duration. Creatures that can't be charmed " +
                                     "are immune to this spell. A dancing creature must use all its " +
                                     "movement to dance without leaving its space and has " +
                                     "disadvantage on Dexterity saving throws and attack rolls. " +
                                     "While the target is affected by this spell, other creatures " +
                                     "have advantage on attack rolls against it. As an action, a " +
                                     "dancing creature makes a Wisdom saving throw to regain control " +
                                     "of itself. On a successful save, the spell ends. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Knock",
                         ...
                         description="Choose an object that you can see within range. The object can " +
                                     ...
                                     "prevents access. A target that is held shut by a mundane lock " +
                                     "or that is stuck or barred becomes unlocked, unstuck, or " +
                                     "unbarred. If the object has multiple locks, only one of them " +
                                     "is unlocked. If you choose a target that is held shut with " +
                                     "arcane lock, that spell is suppressed for 10 minutes, during " +
                                     "which time the target can be opened and shut normally. When " +
                                     "you cast the spell, a loud knock, audible from as far away as " +
    ...
    def __init__(self):
        super().__init__(name="Legend Lore",
                         ...
                         description="Name or describe a person, place, or object. The spell brings " +
                                     ...
                                     "already have about the thing, the more precise and detailed " +
                                     "the information you receive is. The information you learn is " +
                                     "accurate but might be couched in figurative language. For " +
                                     "example, if you have a mysterious magic axe on hand, the spell " +
                                     "might yield this information: “Woe to the evildoer whose hand " +
                                     "touches the axe, for even the haft slices the hand of the evil " +
                                     "ones. Only a true Child of Stone, lover and beloved of " +
                                     "Moradin, may awaken the true powers of the axe, and only with " +
    ...
    def __init__(self):
        super().__init__(name="Levitate",
                         ...
                         description="One creature or object of your choice that you can see within " +
                                     ...
                                     "weighs up to 500 pounds. An unwilling creature that succeeds " +
                                     "on a Constitution saving throw is unaffected. The target can " +
                                     "move only by pushing or pulling against a fixed object or " +
                                     "surface within reach (such as a wall or a ceiling), which " +
                                     "allows it to move as if it were climbing. You can change the " +
                                     "target's altitude by up to 20 feet in either direction on your " +
                                     "turn. If you are the target, you can move up or down as part " +
                                     "of your move. Otherwise, you can use your action to move the " +
                                     "target, which must remain within the spell's range. When the " +
                                     "spell ends, the target floats gently to the ground if it is " +
                                     "still aloft. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Light",
                         ...
                         description="You touch one object that is no larger than 10 feet in any " +
                                     ...
                                     "if you cast it again or dismiss it as an action. If you target " +
                                     "an object held or worn by a hostile creature, that creature " +
    ...
    def __init__(self):
        super().__init__(name="Lightning Bolt",
                         ...
                         description="A stroke of lightning forming a line 100 feet long and 5 feet " +
                                     ...
                                     "as much damage on a successful one. The lightning ignites " +
...
class LocateCreature(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Locate Creature",
                         ...
                         material_components_list="a bit of fur from a bloodhound",
                         duration="1 hour",
                         description="Describe or name a creature that is familiar to you. You sense " +
                                     "the direction to the creature's location, as long as that " +
                                     "creature is within 1,000 feet of you. If the creature is " +
                                     "moving, you know the direction of its movement. The spell can " +
                                     "locate a specific creature known to you, or the nearest " +
                                     "creature of a specific kind (such as a human or a unicorn), so " +
                                     "long as you have seen such a creature up close—within 30 " +
                                     "feet—at least once. If the creature you described or named is " +
                                     "in a different form, such as being under the effects of a " +
                                     "polymorph spell, this spell doesn't locate the creature. This " +
                                     "spell can't locate a creature if running water at least 10 " +
...
class LocateObject(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Locate Object",
                         ...
                         duration="10 minutes",
                         description="Describe or name an object that is familiar to you. You sense " +
                                     "the direction to the object's location, as long as that object " +
                                     "is within 1,000 feet of you. If the object is in motion, you " +
                                     "know the direction of its movement. The spell can locate a " +
                                     "specific object known to you, as long as you have seen it up " +
                                     "close—within 30 feet—at least once. Alternatively, the spell " +
                                     "can locate the nearest object of a particular kind, such as a " +
    ...
    def __init__(self):
        super().__init__(name="Mage Hand",
                         ...
                         description="A spectral, floating hand appears at a point you choose within " +
                                     ...
                                     "feet away from you or if you cast this spell again. You can " +
                                     "use your action to control the hand. You can use the hand to " +
                                     "manipulate an object, open an unlocked door or container, stow " +
                                     "or retrieve an item from an open container, or pour the " +
                                     "contents out of a vial. You can move the hand up to 30 feet " +
                                     "each time you use it. The hand can't attack, activate magic " +
    ...
    def __init__(self):
        super().__init__(name="Magic Circle",
                         ...
                         description="You create a 10-foot-radius, 20-foot-tall cylinder of magical " +
                                     ...
                                     "intersects with the floor or other surface. Choose one or more " +
                                     "of the following types of creatures: celestials, elementals, " +
                                     "fey, fiends, or undead. The circle affects a creature of the " +
                                     "chosen type in the following ways: • The creature can't " +
                                     "willingly enter the cylinder by nonmagical means. If the " +
                                     "creature tries to use teleportation or interplanar travel to " +
                                     "do so, it must first succeed on a Charisma saving throw. • The " +
                                     "creature has disadvantage on attack rolls against targets " +
                                     "within the cylinder. • Targets within the cylinder can't be " +
                                     "charmed, frightened, or possessed by the creature. When you " +
                                     "cast this spell, you can elect to cause its magic to operate " +
                                     "in the reverse direction, preventing a creature of the " +
    ...
    def __init__(self):
        super().__init__(name="Magic Jar",
                         ...
                         description="Your body falls into a catatonic state as your soul leaves it " +
                                     ...
                                     "the spell) or attempting to possess a humanoids body. You can " +
                                     "attempt to possess any humanoid within 100 feet of you that " +
                                     ...
                                     "it again for 24 hours. Once you possess a creature's body, you " +
                                     "control it. Your game statistics are replaced by the " +
                                     "statistics of the creature, though you retain your alignment " +
                                     "and your Intelligence, Wisdom, and Charisma scores. You retain " +
                                     "the benefit of your own class features. If the target has any " +
                                     ...
                                     "actions at all. While possessing a body, you can use your " +
                                     "action to return from the host body to the container if it is " +
                                     "within 100 feet of you, returning the host creature's soul to " +
                                     "its body. If the host body dies while you're in it, the " +
                                     "creature dies, and you must make a Charisma saving throw " +
                                     "against your own spellcasting DC. On a success, you return to " +
                                     "the container if it is within 100 feet of you. Otherwise, you " +
                                     "die. If the container is destroyed or the spell ends, your " +
                                     "soul immediately returns to your body. If your body is more " +
                                     "than 100 feet away from you or if your body is dead when you " +
                                     ...
                                     "Otherwise, that creature dies. When the spell ends, the " +
    ...
    def __init__(self):
        super().__init__(name="Magic Mouth",
                         ...
                         description="You implant a message within an object in range, a message " +
                                     ...
                                     "the spell to deliver your message. When that circumstance " +
                                     "occurs, a magical mouth appears on the object and recites the " +
                                     "message in your voice and at the same volume you spoke. If the " +
                                     "object you chose has a mouth or something that looks like a " +
                                     "mouth (for example, the mouth of a statue), the magical mouth " +
                                     "appears there so that the words appear to come from the " +
                                     "object's mouth. When you cast this spell, you can have the " +
                                     "spell end after it delivers its message, or it can remain and " +
                                     "repeat its message whenever the trigger occurs. The triggering " +
                                     "circumstance can be as general or as detailed as you like, " +
                                     "though it must be based on visual or audible conditions that " +
                                     "occur within 30 feet of the object. For example, you could " +
                                     "instruct the mouth to speak when any creature moves within 30 " +
                                     "feet of the object or when a silver bell rings within 30 feet " +
                                     "of it. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Magnificent Mansion",
                         ...
                         description="You conjure an extradimensional dwelling in range that lasts " +
                                     ...
                                     "invisible. Beyond the portal is a magnificent foyer with " +
                                     "numerous chambers beyond. The atmosphere is clean, fresh, and " +
                                     "warm. You can create any floor plan you like, but the space " +
                                     ...
                                     "these servants and their attire. They are completely obedient " +
                                     "to your orders. Each servant can perform any task a normal " +
                                     "human servant could perform, but they can't attack or take any " +
                                     "action that would directly harm another creature. Thus the " +
                                     "servants can fetch things, clean, mend, fold clothes, light " +
                                     "fires, serve food, pour wine, and so on. The servants can go " +
                                     "anywhere in the mansion but can't leave it. Furnishings and " +
                                     "other objects created by this spell dissipate into smoke if " +
                                     "removed from the mansion. When the spell ends, any creatures " +
                                     "inside the extradimensional space are expelled into the open " +
    ...
    def __init__(self):
        super().__init__(name="Major Image",
                         ...
                         description="You create the image of an object, a creature, or some other " +
                                     ...
                                     "lasts for the duration. It seems completely real, including " +
                                     "sounds, smells, and temperature appropriate to the thing " +
                                     "depicted. You can't create sufficient heat or cold to cause " +
                                     "damage, a sound loud enough to deal thunder damage or deafen a " +
                                     "creature, or a smell that might sicken a creature (like a " +
                                     "troglodyte's stench). As long as you are within range of the " +
                                     "illusion, you can use your action to cause the image to move " +
                                     "to any other spot within range. As the image changes location, " +
                                     "you can alter its appearance so that its movements appear " +
                                     "natural for the image. For example, if you create an image of " +
                                     "a creature and move it, you can alter the image so that it " +
                                     "appears to be walking. Similarly, you can cause the illusion " +
                                     "to make different sounds at different times, even making it " +
                                     "carry on a conversation, for example. Physical interaction " +
                                     "with the image reveals it to be an illusion, because things " +
                                     "can pass through it. A creature that uses its action to " +
                                     ...
                                     "is, the creature can see through the image, and its other " +
    ...
    def __init__(self):
        super().__init__(name="Mass Cure Wounds",
                         ...
                         description="A wave of healing energy washes out from a point of your " +
                                     ...
                                     "regains hit points equal to 3d8 + your spellcasting ability " +
                                     "modifier. This spell has no effect on undead or constructs. ",
                         at_higher_levels="When you cast this spell using a spell slot of 6th level or " +
                                          "higher, the healing increases by 1d8 for each slot level above " +
                                          "5th. ")
    ...
    def __init__(self):
        super().__init__(name="Mass Suggestion",
                         ...
                         description="You suggest a course of activity (limited to a sentence or " +
                                     ...
                                     "understand you. Creatures that can't be charmed are immune to " +
                                     "this effect. The suggestion must be worded in such a manner as " +
                                     "to make the course of action sound reasonable. Asking the " +
                                     "creature to stab itself, throw itself onto a spear, immolate " +
                                     "itself, or do some other obviously harmful act automatically " +
                                     "negates the effect of the spell. Each target must make a " +
                                     "Wisdom saving throw. On a failed save, it pursues the course " +
                                     "of action you described to the best of its ability. The " +
                                     "suggested course of action can continue for the entire " +
                                     "duration. If the suggested activity can be completed in a " +
                                     "shorter time, the spell ends when the subject finishes what it " +
                                     "was asked to do. You can also specify conditions that will " +
                                     "trigger a special activity during the duration. For example, " +
                                     "you might suggest that a group of soldiers give all their " +
                                     "money to the first beggar they meet. If the condition isn't " +
                                     "met before the spell ends, the activity isn't performed. If " +
                                     "you or any of your companions damage a creature affected by " +
    ...
    def __init__(self):
        super().__init__(name="Maze",
                         ...
                         description="You banish a creature that you can see within range into a " +
                                     ...
                                     "duration or until it escapes the maze. The target can use its " +
                                     "action to attempt to escape. When it does so, it makes a DC 20 " +
                                     "Intelligence check. If it succeeds, it escapes, and the spell " +
                                     "ends (a minotaur or goristro demon automatically succeeds). " +
    ...
    def __init__(self):
        super().__init__(name="Meld into Stone",
                         ...
                         description="You step into a stone object or surface large enough to fully " +
                                     ...
                                     "nonmagical senses. While merged with the stone, you can't see " +
                                     "what occurs outside it, and any Wisdom (Perception) checks you " +
                                     "make to hear sounds outside it are made with disadvantage. You " +
                                     "remain aware of the passage of time and can cast spells on " +
                                     "yourself while merged in the stone. You can use your movement " +
                                     "to leave the stone where you entered it, which ends the spell. " +
                                     "You otherwise can't move. Minor physical damage to the stone " +
                                     "doesn't harm you, but its partial destruction or a change in " +
                                     "its shape (to the extent that you no longer fit within it) " +
                                     "expels you and deals 6d6 bludgeoning damage to you. The " +
                                     "stone's complete destruction (or transmutation into a " +
                                     "different substance) expels you and deals 50 bludgeoning " +
                                     "damage to you. If expelled, you fall prone in an unoccupied " +
    ...
    def __init__(self):
        super().__init__(name="Mending",
                         ...
                         description="This spell repairs a single break or tear in an object you " +
                                     ...
                                     "it, leaving no trace of the former damage. This spell can " +
                                     "physically repair a magic item or construct, but the spell " +
    ...
    def __init__(self):
        super().__init__(name="Message",
                         ...
                         description="You point your finger toward a creature within range and " +
                                     ...
                                     "message and can reply in a whisper that only you can hear. You " +
                                     "can cast this spell through solid objects if you are familiar " +
                                     "with the target and know it is beyond the barrier. Magical " +
                                     "silence, 1 foot of stone, 1 inch of common metal, a thin sheet " +
                                     "of lead, or 3 feet of wood blocks the spell. The spell doesn't " +
                                     "have to follow a straight line and can travel freely around " +
    ...
    def __init__(self):
        super().__init__(name="Meteor Swarm",
                         ...
                         description="Blazing orbs of fire plummet to the ground at four different " +
                                     ...
                                     "fiery burst is affected only once. The spell damages objects " +
                                     "in the area and ignites flammable objects that aren't being " +
                                     "worn or carried. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Minor Illusion",
                         ...
                         description="You create a sound or an image of an object within range that " +
                                     ...
                                     "it as an action or cast this spell again. If you create a " +
                                     "sound, its volume can range from a whisper to a scream. It can " +
                                     "be your voice, someone else's voice, a lion's roar, a beating " +
                                     "of drums, or any other sound you choose. The sound continues " +
                                     "unabated throughout the duration, or you can make discrete " +
                                     "sounds at different times before the spell ends. If you create " +
                                     "an image of an object—such as a chair, muddy footprints, or a " +
                                     "small chest—it must be no larger than a 5-foot cube. The image " +
                                     "can't create sound, light, smell, or any other sensory effect. " +
                                     "Physical interaction with the image reveals it to be an " +
                                     "illusion, because things can pass through it. If a creature " +
                                     ...
                                     "If a creature discerns the illusion for what it is, the " +
    ...
    def __init__(self):
        super().__init__(name="Mirage Arcane",
                         ...
                         description="You make terrain in an area up to 1 mile square look, sound, " +
                                     ...
                                     "conceal, or add creatures. The illusion includes audible, " +
                                     "visual, tactile, and olfactory elements, so it can turn clear " +
                                     "ground into difficult terrain (or vice versa) or otherwise " +
                                     "impede movement through the area. Any piece of the illusory " +
                                     "terrain (such as a rock or stick) that is removed from the " +
                                     "spell's area disappears immediately. Creatures with truesight " +
                                     "can see through the illusion to the terrain's true form; " +
    ...
    def __init__(self):
        super().__init__(name="Mirror Image",
                         ...
                         description="Three illusory duplicates of yourself appear in your space. " +
                                     ...
                                     "illusory duplicates. Each time a creature targets you with an " +
                                     "attack during the spell's duration, roll a d20 to determine " +
                                     "whether the attack instead targets one of your duplicates. If " +
                                     "you have three duplicates, you must roll a 6 or higher to " +
                                     "change the attack's target to a duplicate. With two " +
                                     "duplicates, you must roll an 8 or higher. With one duplicate, " +
                                     "you must roll an 11 or higher. A duplicate's AC equals 10 + " +
                                     "your Dexterity modifier. If an attack hits a duplicate, the " +
                                     "duplicate is destroyed. A duplicate can be destroyed only by " +
                                     "an attack that hits it. It ignores all other damage and " +
                                     "effects. The spell ends when all three duplicates are " +
                                     "destroyed. A creature is unaffected by this spell if it can't " +
    ...
    def __init__(self):
        super().__init__(name="Mislead",
                         ...
                         description="You become invisible at the same time that an illusory double " +
                                     ...
                                     "a spell. You can use your action to move your illusory double " +
                                     "up to twice your speed and make it gesture, speak, and behave " +
                                     "in whatever way you choose. You can see through its eyes and " +
                                     "hear through its ears as if you were located where it is. On " +
                                     "each of your turns as a bonus action, you can switch from " +
                                     "using its senses to using your own, or back again. While you " +
                                     "are using its senses, you are blinded and deafened in regard " +
    ...
    def __init__(self):
        super().__init__(name="Modify Memory",
                         ...
                         description="You attempt to reshape another creature's memories. One " +
                                     ...
                                     "you are fighting the creature, it has advantage on the saving " +
                                     "throw. On a failed save, the target becomes charmed by you for " +
                                     "the duration. The charmed target is incapacitated and unaware " +
                                     "of its surroundings, though it can still hear you. If it takes " +
                                     "any damage or is targeted by another spell, this spell ends, " +
                                     "and none of the target's memories are modified. While this " +
                                     "charm lasts, you can affect the target's memory of an event " +
                                     "that it experienced within the last 24 hours and that lasted " +
                                     "no more than 10 minutes. You can permanently eliminate all " +
                                     "memory of the event, allow the target to recall the event with " +
                                     "perfect clarity and exacting detail, change its memory of the " +
                                     ...
                                     "memories take hold when the spell ends. A modified memory " +
                                     "doesn't necessarily affect how a creature behaves, " +
                                     "particularly if the memory contradicts the creature's natural " +
                                     "inclinations, alignment, or beliefs. An illogical modified " +
                                     "memory, such as implanting a memory of how much the creature " +
                                     "enjoyed dousing itself in acid, is dismissed, perhaps as a bad " +
                                     "dream. The GM might deem a modified memory too nonsensical to " +
                                     "affect a creature in a significant manner. A remove curse or " +
                                     "greater restoration spell cast on the target restores the " +
    ...
    def __init__(self):
        super().__init__(name="Moonbeam",
                         ...
                         description="A silvery beam of pale light shines down in a 5-foot-radius, " +
                                     ...
                                     "its turn there, it is engulfed in ghostly flames that cause " +
                                     "searing pain, and it must make a Constitution saving throw. It " +
                                     "takes 2d10 radiant damage on a failed save, or half as much " +
                                     "damage on a successful one. A shapechanger makes its saving " +
                                     "throw with disadvantage. If it fails, it also instantly " +
                                     "reverts to its original form and can't assume a different form " +
                                     "until it leaves the spell's light. On each of your turns after " +
                                     "you cast this spell, you can use an action to move the beam 60 " +
    ...
    def __init__(self):
        super().__init__(name="Move Earth",
                         ...
                         description="Choose an area of terrain no larger than 40 feet on a side " +
                                     ...
                                     "minutes for these changes to complete. At the end of every 10 " +
                                     "minutes you spend concentrating on the spell, you can choose a " +
                                     "new area of terrain to affect. Because the terrain's " +
                                     "transformation occurs slowly, creatures in the area can't " +
                                     "usually be trapped or injured by the ground's movement. This " +
                                     "spell can't manipulate natural stone or stone construction. " +
                                     ...
                                     "it might collapse. Similarly, this spell doesn't directly " +
                                     "affect plant growth. The moved earth carries any plants along " +
                                     "with it. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Pass without Trace",
                         ...
                         description="A veil of shadows and silence radiates from you, masking you " +
                                     ...
                                     "except by magical means. A creature that receives this bonus " +
    ...
    def __init__(self):
        super().__init__(name="Passwall",
                         ...
                         description="A passage appears at a point of your choice that you can see " +
                                     ...
                                     "a structure surrounding it. When the opening disappears, any " +
                                     "creatures or objects still in the passage created by the spell " +
                                     "are safely ejected to an unoccupied space nearest to the " +
    ...
    def __init__(self):
        super().__init__(name="Phantom Steed",
                         ...
                         description="A Large quasi-real, horselike creature appears on the ground " +
                                     ...
                                     "away from the steed. For the duration, you or a creature you " +
                                     "choose can ride the steed. The creature uses the statistics " +
                                     "for a riding horse, except it has a speed of 100 feet and can " +
                                     "travel 10 miles in an hour, or 13 miles at a fast pace. When " +
                                     "the spell ends, the steed gradually fades, giving the rider 1 " +
                                     "minute to dismount. The spell ends if you use an action to " +
    ...
    def __init__(self):
        super().__init__(name="Planar Ally",
                         ...
                         description="You beseech an otherworldly entity for aid. The being must be " +
                                     ...
                                     "creature appear in an unoccupied space within range. If you " +
                                     "know a specific creature's name, you can speak that name when " +
                                     "you cast this spell to request that creature, though you might " +
                                     "get a different creature anyway (GM's choice). When the " +
                                     "creature appears, it is under no compulsion to behave in any " +
                                     "particular way. You can ask the creature to perform a service " +
                                     "in exchange for payment, but it isn't obliged to do so. The " +
                                     "requested task could range from simple (fly us across the " +
                                     ...
                                     "its services. Payment can take a variety of forms. A celestial " +
                                     "might require a sizable donation of gold or magic items to an " +
                                     "allied temple, while a fiend might demand a living sacrifice " +
                                     "or a gift of treasure. Some creatures might exchange their " +
                                     "service for a quest undertaken by you. As a rule of thumb, a " +
                                     "task that can be measured in minutes requires a payment worth " +
                                     "100 gp per minute. A task measured in hours requires 1,000 gp " +
                                     "per hour. And a task measured in days (up to 10 days) requires " +
                                     "10,000 gp per day. The GM can adjust these payments based on " +
                                     "the circumstances under which you cast the spell. If the task " +
                                     "is aligned with the creature's ethos, the payment might be " +
                                     "halved or even waived. Nonhazardous tasks typically require " +
                                     "only half the suggested payment, while especially dangerous " +
                                     "tasks might require a greater gift. Creatures rarely accept " +
                                     "tasks that seem suicidal. After the creature completes the " +
                                     "task, or when the agreed-upon duration of service expires, the " +
                                     "creature returns to its home plane after reporting back to " +
                                     "you, if appropriate to the task and if possible. If you are " +
                                     "unable to agree on a price for the creature's service, the " +
                                     "creature immediately returns to its home plane. A creature " +
                                     "enlisted to join your group counts as a member of it, " +
    ...
    def __init__(self):
        super().__init__(name="Planar Binding",
                         ...
                         description="With this spell, you attempt to bind a celestial, an " +
                                     ...
                                     "extended to match the duration of this spell. A bound creature " +
                                     "must follow your instructions to the best of its ability. You " +
                                     "might command the creature to accompany you on an adventure, " +
                                     "to guard a location, or to deliver a message. The creature " +
                                     "obeys the letter of your instructions, but if the creature is " +
                                     "hostile to you, it strives to twist your words to achieve its " +
                                     "own objectives. If the creature carries out your instructions " +
                                     "completely before the spell ends, it travels to you to report " +
                                     "this fact if you are on the same plane of existence. If you " +
                                     "are on a different plane of existence, it returns to the place " +
    ...
    def __init__(self):
        super().__init__(name="Plane Shift",
                         ...
                         description="You and up to eight willing creatures who link hands in a " +
                                     ...
                                     "across the Sea of Fire, at the GM's discretion. Alternatively, " +
                                     "if you know the sigil sequence of a teleportation circle on " +
                                     "another plane of existence, this spell can take you to that " +
                                     "circle. If the teleportation circle is too small to hold all " +
                                     "the creatures you transported, they appear in the closest " +
                                     "unoccupied spaces next to the circle. You can use this spell " +
                                     "to banish an unwilling creature to another plane. Choose a " +
                                     "creature within your reach and make a melee spell attack " +
                                     "against it. On a hit, the creature must make a Charisma saving " +
                                     "throw. If the creature fails this save, it is transported to a " +
                                     "random location on the plane of existence you specify. A " +
    ...
    def __init__(self):
        super().__init__(name="Plant Growth",
                         ...
                         description="This spell channels vitality into plants within a specific " +
                                     ...
                                     "using 1 action, choose a point within range. All normal plants " +
                                     "in a 100-foot radius centered on that point become thick and " +
                                     "overgrown. A creature moving through the area must spend 4 " +
                                     "feet of movement for every 1 foot it moves. You can exclude " +
                                     "one or more areas of any size within the spell's area from " +
                                     "being affected. If you cast this spell over 8 hours, you " +
                                     "enrich the land. All plants in a half-mile radius centered on " +
                                     "a point within range become enriched for 1 year. The plants " +
    ...
    def __init__(self):
        super().__init__(name="Poison Spray",
                         ...
                         description="You extend your hand toward a creature you can see within " +
                                     ...
                                     "1d12 poison damage. This spell's damage increases by 1d12 when " +
    ...
    def __init__(self):
        super().__init__(name="Polymorph",
                         ...
                         description="This spell transforms a creature that you can see within range " +
                                     ...
                                     "shapechanger or a creature with 0 hit points. The " +
                                     "transformation lasts for the duration, or until the target " +
                                     ...
                                     "beast. It retains its alignment and personality. The target " +
                                     "assumes the hit points of its new form. When it reverts to its " +
                                     "normal form, the creature returns to the number of hit points " +
                                     "it had before it transformed. If it reverts as a result of " +
                                     ...
                                     "perform by the nature of its new form, and it can't speak, " +
                                     "cast spells, or take any other action that requires hands or " +
                                     "speech. The target's gear melds into the new form. The " +
                                     "creature can't activate, use, wield, or otherwise benefit from " +
    ...
    def __init__(self):
        super().__init__(name="Power Word Stun",
                         ...
                         description="You speak a word of power that can overwhelm the mind of one " +
                                     ...
                                     "Otherwise, the spell has no effect. The stunned target must " +
    ...
    def __init__(self):
        super().__init__(name="Prestidigitation",
                         ...
                         description="This spell is a minor magical trick that novice spellcasters " +
                                     ...
                                     "faint musical notes, or an odd odor. • You instantaneously " +
                                     "light or snuff out a candle, a torch, or a small campfire. • " +
                                     "You instantaneously clean or soil an object no larger than 1 " +
                                     "cubic foot. • You chill, warm, or flavor up to 1 cubic foot of " +
                                     "nonliving material for 1 hour. • You make a color, a small " +
                                     "mark, or a symbol appear on an object or a surface for 1 hour. " +
                                     "• You create a nonmagical trinket or an illusory image that " +
                                     "can fit in your hand and that lasts until the end of your next " +
                                     "turn. If you cast this spell multiple times, you can have up " +
    ...
    def __init__(self):
        super().__init__(name="Prismatic Spray",
                         ...
                         description="Eight multicolored rays of light flash from your hand. Each " +
                                     ...
                                     "color ray affects it. 1. Red. The target takes 10d6 fire " +
                                     "damage on a failed save, or half as much damage on a " +
                                     "successful one. 2. Orange. The target takes 10d6 acid damage " +
                                     "on a failed save, or half as much damage on a successful one. " +
                                     "3. Yellow. The target takes 10d6 lightning damage on a failed " +
                                     "save, or half as much damage on a successful one. 4. Green. " +
                                     "The target takes 10d6 poison damage on a failed save, or half " +
                                     "as much damage on a successful one. 5. Blue. The target takes " +
                                     "10d6 cold damage on a failed save, or half as much damage on a " +
                                     "successful one. 6. Indigo. On a failed save, the target is " +
                                     "restrained. It must then make a Constitution saving throw at " +
                                     "the end of each of its turns. If it successfully saves three " +
                                     "times, the spell ends. If it fails its save three times, it " +
                                     "permanently turns to stone and is subjected to the petrified " +
    ...
    def __init__(self):
        super().__init__(name="Prismatic Wall",
                         ...
                         description="A shimmering, multicolored plane of light forms a vertical " +
                                     ...
                                     "are wasted. The wall sheds bright light out to a range of 100 " +
                                     "feet and dim light for an additional 100 feet. You and " +
                                     "creatures you designate at the time you cast the spell can " +
                                     "pass through and remain near the wall without harm. If another " +
                                     "creature that can see the wall moves to within 20 feet of it " +
                                     "or starts its turn there, the creature must succeed on a " +
                                     "Constitution saving throw or become blinded for 1 minute. The " +
                                     "wall consists of seven layers, each with a different color. " +
                                     ...
                                     "that layer's properties as described below. The wall can be " +
                                     "destroyed, also one layer at a time, in order from red to " +
                                     "violet, by means specific to each layer. Once a layer is " +
                                     "destroyed, it remains so for the duration of the spell. A rod " +
                                     "of cancellation destroys a prismatic wall, but an antimagic " +
                                     "field has no effect on it. 1. Red. The creature takes 10d6 " +
                                     "fire damage on a failed save, or half as much damage on a " +
                                     "successful one. While this layer is in place, nonmagical " +
                                     "ranged attacks can't pass through the wall. The layer can be " +
                                     "destroyed by dealing at least 25 cold damage to it. 2. Orange. " +
                                     "The creature takes 10d6 acid damage on a failed save, or half " +
                                     "as much damage on a successful one. While this layer is in " +
                                     "place, magical ranged attacks can't pass through the wall. The " +
                                     "layer is destroyed by a strong wind. 3. Yellow. The creature " +
                                     "takes 10d6 lightning damage on a failed save, or half as much " +
                                     "damage on a successful one. This layer can be destroyed by " +
                                     "dealing at least 60 force damage to it. 4. Green. The creature " +
                                     "takes 10d6 poison damage on a failed save, or half as much " +
                                     "damage on a successful one. A passwall spell, or another spell " +
                                     "of equal or greater level that can open a portal on a solid " +
                                     "surface, destroys this layer. 5. Blue. The creature takes 10d6 " +
                                     "cold damage on a failed save, or half as much damage on a " +
                                     "successful one. This layer can be destroyed by dealing at " +
                                     "least 25 fire damage to it. 6. Indigo. On a failed save, the " +
                                     "creature is restrained. It must then make a Constitution " +
                                     "saving throw at the end of each of its turns. If it " +
                                     "successfully saves three times, the spell ends. If it fails " +
                                     ...
                                     "until the creature collects three of a kind. While this layer " +
                                     "is in place, spells can't be cast through the wall. The layer " +
                                     "is destroyed by bright light shed by a daylight spell or a " +
                                     "similar spell of equal or higher level. 7. Violet. On a failed " +
                                     "save, the creature is blinded. It must then make a Wisdom " +
                                     "saving throw at the start of your next turn. A successful save " +
                                     "ends the blindness. If it fails that save, the creature is " +
                                     "transported to another plane of the GM's choosing and is no " +
                                     "longer blinded. (Typically, a creature that is on a plane that " +
                                     "isn't its home plane is banished home, while other creatures " +
                                     "are usually cast into the Astral or Ethereal planes.) This " +
                                     "layer is destroyed by a dispel magic spell or a similar spell " +
    ...
    def __init__(self):
        super().__init__(name="Private Sanctum",
                         ...
                         description="You make an area within range magically secure. The area is a " +
                                     ...
                                     "each side. The spell lasts for the duration or until you use " +
                                     "an action to dismiss it. When you cast the spell, you decide " +
                                     "what sort of security the spell provides, choosing any or all " +
                                     "of the following properties: • Sound can't pass through the " +
                                     "barrier at the edge of the warded area. • The barrier of the " +
                                     "warded area appears dark and foggy, preventing vision " +
                                     "(including darkvision) through it. • Sensors created by " +
                                     "divination spells can't appear inside the protected area or " +
                                     "pass through the barrier at its perimeter. • Creatures in the " +
                                     "area can't be targeted by divination spells. • Nothing can " +
                                     "teleport into or out of the warded area. • Planar travel is " +
                                     "blocked within the warded area. Casting this spell on the same " +
    ...
    def __init__(self):
        super().__init__(name="Produce Flame",
                         ...
                         description="A flickering flame appears in your hand. The flame remains " +
                                     ...
                                     "dismiss it as an action or if you cast it again. You can also " +
                                     "attack with the flame, although doing so ends the spell. When " +
                                     "you cast this spell, or as an action on a later turn, you can " +
                                     "hurl the flame at a creature within 30 feet of you. Make a " +
                                     "ranged spell attack. On a hit, the target takes 1d8 fire " +
                                     "damage. This spell's damage increases by 1d8 when you reach " +
                                     "5th level (2d8), 11th level (3d8), and 17th level (4d8). ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Programmed Illusion",
                         ...
                         description="You create an illusion of an object, a creature, or some other " +
                                     ...
                                     "dormant for 10 minutes. After this time, the illusion can be " +
                                     "activated again. The triggering condition can be as general or " +
                                     "as detailed as you like, though it must be based on visual or " +
                                     "audible conditions that occur within 30 feet of the area. For " +
                                     "example, you could create an illusion of yourself to appear " +
                                     "and warn off others who attempt to open a trapped door, or you " +
                                     "could set the illusion to trigger only when a creature says " +
                                     "the correct word or phrase. Physical interaction with the " +
                                     "image reveals it to be an illusion, because things can pass " +
                                     "through it. A creature that uses its action to examine the " +
                                     "image can determine that it is an illusion with a successful " +
                                     "Intelligence (Investigation) check against your spell save DC. " +
                                     "If a creature discerns the illusion for what it is, the " +
                                     "creature can see through the image, and any noise it makes " +
    ...
    def __init__(self):
        super().__init__(name="Project Image",
                         ...
                         description="You create an illusory copy of yourself that lasts for the " +
                                     ...
                                     "and the spell ends. You can use your action to move this " +
                                     "illusion up to twice your speed, and make it gesture, speak, " +
                                     "and behave in whatever way you choose. It mimics your " +
                                     "mannerisms perfectly. You can see through its eyes and hear " +
                                     "through its ears as if you were in its space. On your turn as " +
                                     "a bonus action, you can switch from using its senses to using " +
    ...
    def __init__(self):
        super().__init__(name="Protection from Evil and Good",
                         ...
                         description="Until the spell ends, one willing creature you touch is " +
                                     ...
                                     "protection grants several benefits. Creatures of those types " +
                                     "have disadvantage on attack rolls against the target. The " +
                                     "target also can't be charmed, frightened, or possessed by " +
    ...
    def __init__(self):
        super().__init__(name="Protection from Poison",
                         ...
                         description="You touch a creature. If it is poisoned, you neutralize the " +
                                     ...
                                     "neutralize one at random. For the duration, the target has " +
    ...
    def __init__(self):
        super().__init__(name="Raise Dead",
                         ...
                         description="You return a dead creature you touch to life, provided that it " +
                                     ...
                                     "creature returns to life with 1 hit point. This spell also " +
                                     "neutralizes any poisons and cures nonmagical diseases that " +
                                     "affected the creature at the time it died. This spell doesn't, " +
                                     "however, remove magical diseases, curses, or similar effects; " +
                                     "if these aren't first removed prior to casting the spell, they " +
                                     "take effect when the creature returns to life. The spell can't " +
                                     "return an undead creature to life. This spell closes all " +
                                     "mortal wounds, but it doesn't restore missing body parts. If " +
                                     "the creature is lacking body parts or organs integral for its " +
    ...
    def __init__(self):
        super().__init__(name="Ray of Enfeeblement",
                         ...
                         description="A black beam of enervating energy springs from your finger " +
                                     ...
                                     "ends. At the end of each of the target's turns, it can make a " +
    ...
    def __init__(self):
        super().__init__(name="Ray of Frost",
                         ...
                         description="A frigid beam of blue-white light streaks toward a creature " +
                                     ...
                                     "by 10 feet until the start of your next turn. The spell's " +
                                     "damage increases by 1d8 when you reach 5th level (2d8), 11th " +
    ...
    def __init__(self):
        super().__init__(name="Regenerate",
                         ...
                         description="You touch a creature and stimulate its natural healing " +
                                     ...
                                     "start of each of its turns (10 hit points each minute). The " +
                                     "target's severed body members (fingers, legs, tails, and so " +
    ...
    def __init__(self):
        super().__init__(name="Reincarnate",
                         ...
                         description="You touch a dead humanoid or a piece of a dead humanoid. " +
                                     ...
                                     "the soul to enter that body. If the target's soul isn't free " +
                                     "or willing to do so, the spell fails. The magic fashions a new " +
                                     "body for the creature to inhabit, which likely causes the " +
                                     "creature's race to change. The GM rolls a d100 and consults " +
                                     "the following table to determine what form the creature takes " +
                                     "when restored to life, or the GM chooses a form. d100 Race " +
                                     "01–04 Dragonborn 05–13 Dwarf, hill 14–21 Dwarf, mountain 22–25 " +
                                     "Elf, dark 26–34 Elf, high 35–42 Elf, wood 43–46 Gnome, forest " +
                                     "47–52 Gnome, rock 53–56 Half-elf 57–60 Half-orc 61–68 " +
                                     "Halfling, lightfoot 69–76 Halfling, stout 77–96 Human 97–00 " +
                                     "Tiefling The reincarnated creature recalls its former life and " +
                                     "experiences. It retains the capabilities it had in its " +
                                     "original form, except it exchanges its original race for the " +
                                     "new one and changes its racial traits accordingly. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Resilient Sphere",
                         ...
                         description="A sphere of shimmering force encloses a creature or object of " +
                                     ...
                                     "energy, or other spell effects—can pass through the barrier, " +
                                     "in or out, though a creature in the sphere can breathe there. " +
                                     ...
                                     "outside it. The sphere is weightless and just large enough to " +
                                     "contain the creature or object inside. An enclosed creature " +
                                     "can use its action to push against the sphere's walls and thus " +
                                     "roll the sphere at up to half the creature's speed. Similarly, " +
                                     "the globe can be picked up and moved by other creatures. A " +
                                     "disintegrate spell targeting the globe destroys it without " +
    ...
    def __init__(self):
        super().__init__(name="Resurrection",
                         ...
                         description="You touch a dead creature that has been dead for no more than " +
                                     ...
                                     "with all its hit points. This spell neutralizes any poisons " +
                                     "and cures normal diseases afflicting the creature when it " +
                                     "died. It doesn't, however, remove magical diseases, curses, " +
                                     "and the like; if such effects aren't removed prior to casting " +
                                     "the spell, they afflict the target on its return to life. This " +
                                     "spell closes all mortal wounds and restores any missing body " +
                                     "parts. Coming back from the dead is an ordeal. The target " +
                                     "takes a −4 penalty to all attack rolls, saving throws, and " +
                                     "ability checks. Every time the target finishes a long rest, " +
                                     "the penalty is reduced by 1 until it disappears. Casting this " +
                                     "spell to restore life to a creature that has been dead for one " +
                                     "year or longer taxes you greatly. Until you finish a long " +
                                     "rest, you can't cast spells again, and you have disadvantage " +
    ...
    def __init__(self):
        super().__init__(name="Reverse Gravity",
                         ...
                         description="This spell reverses gravity in a 50-foot-radius, 100- foot " +
                                     "high cylinder centered on a point within range. All creatures " +
                                     "and objects that aren't somehow anchored to the ground in the " +
                                     "area fall upward and reach the top of the area when you cast " +
                                     "this spell. A creature can make a Dexterity saving throw to " +
...
class RopeTrick(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Rope Trick",
                         ...
                         duration="1 hour",
                         description="You touch a length of rope that is up to 60 feet long. One end " +
                                     ...
                                     "invisible entrance opens to an extradimensional space that " +
                                     "lasts until the spell ends. The extradimensional space can be " +
                                     "reached by climbing to the top of the rope. The space can hold " +
                                     "as many as eight Medium or smaller creatures. The rope can be " +
                                     "pulled into the space, making the rope disappear from view " +
                                     "outside the space. Attacks and spells can't cross through the " +
                                     "entrance into or out of the extradimensional space, but those " +
                                     "inside can see out of it as if through a 3-foot-by-5- foot " +
                                     "window centered on the rope. Anything inside the " +
                                     "extradimensional space drops out when the spell ends. ",
                         at_higher_levels="")
...
class Sanctuary(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Sanctuary",
                         ...
                         duration="1 minute",
                         description="You ward a creature within range against attack. Until the " +
                                     "spell ends, any creature who targets the warded creature with " +
                                     "an attack or a harmful spell must first make a Wisdom saving " +
                                     "throw. On a failed save, the creature must choose a new target " +
                                     "or lose the attack or spell. This spell doesn't protect the " +
                                     "warded creature from area effects, such as the explosion of a " +
                                     "fireball. If the warded creature makes an attack or casts a " +
    ...
    def __init__(self):
        super().__init__(name="Scrying",
                         ...
                         description="You can see and hear a particular creature you choose that is " +
                                     ...
                                     "the target and the sort of physical connection you have to it. " +
                                     "If a target knows you're casting this spell, it can fail the " +
                                     "saving throw voluntarily if it wants to be observed. Knowledge " +
                                     "Save Modifier Secondhand (you have heard of the target) +5 " +
                                     "Firsthand (you have met the target) +0 Familiar (you know the " +
                                     "target well) −5 Connection Save Modifier Likeness or picture " +
                                     "−2 Possession or garment −4 Body part, lock of hair, bit of " +
                                     "nail, or the like −10 On a successful save, the target isn't " +
                                     "affected, and you can't use this spell against it again for 24 " +
                                     "hours. On a failed save, the spell creates an invisible sensor " +
                                     "within 10 feet of the target. You can see and hear through the " +
                                     "sensor as if you were there. The sensor moves with the target, " +
                                     "remaining within 10 feet of it for the duration. A creature " +
                                     "that can see invisible objects sees the sensor as a luminous " +
                                     "orb about the size of your fist. Instead of targeting a " +
                                     "creature, you can choose a location you have seen before as " +
                                     "the target of this spell. When you do, the sensor appears at " +
    ...
    def __init__(self):
        super().__init__(name="Secret Chest",
                         ...
                         description="You hide a chest, and all its contents, on the Ethereal Plane. " +
                                     ...
                                     "2 feet). While the chest remains on the Ethereal Plane, you " +
                                     "can use an action and touch the replica to recall the chest. " +
                                     "It appears in an unoccupied space on the ground within 5 feet " +
                                     "of you. You can send the chest back to the Ethereal Plane by " +
                                     "using an action and touching both the chest and the replica. " +
    ...
    def __init__(self):
        super().__init__(name="Seeming",
                         ...
                         description="This spell allows you to change the appearance of any number " +
                                     ...
                                     "it is unaffected by this spell. The spell disguises physical " +
                                     "appearance as well as clothing, armor, weapons, and equipment. " +
                                     "You can make each creature seem 1 foot shorter or taller and " +
                                     "appear thin, fat, or in between. You can't change a target's " +
                                     "body type, so you must choose a form that has the same basic " +
                                     "arrangement of limbs. Otherwise, the extent of the illusion is " +
                                     "up to you. The spell lasts for the duration, unless you use " +
                                     "your action to dismiss it sooner. The changes wrought by this " +
                                     "spell fail to hold up to physical inspection. For example, if " +
                                     "you use this spell to add a hat to a creature's outfit, " +
                                     "objects pass through the hat, and anyone who touches it would " +
                                     "feel nothing or would feel the creature's head and hair. If " +
                                     "you use this spell to appear thinner than you are, the hand of " +
                                     "someone who reaches out to touch you would bump into you while " +
                                     "it was seemingly still in midair. A creature can use its " +
                                     "action to inspect a target and make an Intelligence " +
                                     "(Investigation) check against your spell save DC. If it " +
    ...
    def __init__(self):
        super().__init__(name="Sending",
                         ...
                         description="You send a short message of twenty-five words or less to a " +
                                     ...
                                     "understand the meaning of your message. You can send the " +
                                     "message across any distance and even to other planes of " +
                                     "existence, but if the target is on a different plane than you, " +
    ...
    def __init__(self):
        super().__init__(name="Sequester",
                         ...
                         description="By means of this spell, a willing creature or an object can be " +
                                     ...
                                     "scrying sensors created by divination spells. If the target is " +
                                     "a creature, it falls into a state of suspended animation. Time " +
                                     "ceases to flow for it, and it doesn't grow older. You can set " +
                                     "a condition for the spell to end early. The condition can be " +
                                     "anything you choose, but it must occur or be visible within 1 " +
                                     "mile of the target. Examples include “after 1,000 years” or " +
                                     "“when the tarrasque awakens.” This spell also ends if the " +
    ...
    def __init__(self):
        super().__init__(name="Shapechange",
                         ...
                         description="You assume the form of a different creature for the duration. " +
                                     ...
                                     "creature at least once. You transform into an average example " +
                                     "of that creature, one without any class levels or the " +
                                     "Spellcasting trait. Your game statistics are replaced by the " +
                                     "statistics of the chosen creature, though you retain your " +
                                     "alignment and Intelligence, Wisdom, and Charisma scores. You " +
                                     "also retain all of your skill and saving throw proficiencies, " +
                                     "in addition to gaining those of the creature. If the creature " +
                                     "has the same proficiency as you and the bonus listed in its " +
                                     "statistics is higher than yours, use the creature's bonus in " +
                                     "place of yours. You can't use any legendary actions or lair " +
                                     "actions of the new form. You assume the hit points and Hit " +
                                     "Dice of the new form. When you revert to your normal form, you " +
                                     "return to the number of hit points you had before you " +
                                     "transformed. If you revert as a result of dropping to 0 hit " +
                                     "points, any excess damage carries over to your normal form. As " +
                                     "long as the excess damage doesn't reduce your normal form to 0 " +
                                     "hit points, you aren't knocked unconscious. You retain the " +
                                     "benefit of any features from your class, race, or other source " +
                                     "and can use them, provided that your new form is physically " +
                                     "capable of doing so. You can't use any special senses you have " +
                                     "(for example, darkvision) unless your new form also has that " +
                                     "sense. You can only speak if the creature can normally speak. " +
                                     ...
                                     "in that state. During this spell's duration, you can use your " +
                                     "action to assume a different form following the same " +
                                     "restrictions and rules for the original form, with one " +
                                     "exception: if your new form has more hit points than your " +
                                     "current one, your hit points remain at their current value. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Shatter",
                         ...
                         description="A sudden loud ringing noise, painfully intense, erupts from a " +
                                     ...
                                     "Constitution saving throw. A creature takes 3d8 thunder damage " +
                                     "on a failed save, or half as much damage on a successful one. " +
                                     "A creature made of inorganic material such as stone, crystal, " +
                                     "or metal has disadvantage on this saving throw. A nonmagical " +
    ...
    def __init__(self):
        super().__init__(name="Shocking Grasp",
                         ...
                         description="Lightning springs from your hand to deliver a shock to a " +
                                     ...
                                     "the start of its next turn. The spell's damage increases by " +
    ...
    def __init__(self):
        super().__init__(name="Silent Image",
                         ...
                         description="You create the image of an object, a creature, or some other " +
                                     ...
                                     "sound, smell, or other sensory effects. You can use your " +
                                     "action to cause the image to move to any spot within range. As " +
                                     "the image changes location, you can alter its appearance so " +
                                     "that its movements appear natural for the image. For example, " +
    ...
    def __init__(self):
        super().__init__(name="Simulacrum",
                         ...
                         description="You shape an illusory duplicate of one beast or humanoid that " +
                                     ...
                                     "statistics of the creature it duplicates. The simulacrum is " +
                                     "friendly to you and creatures you designate. It obeys your " +
                                     "spoken commands, moving and acting in accordance with your " +
                                     "wishes and acting on your turn in combat. The simulacrum lacks " +
                                     "the ability to learn or become more powerful, so it never " +
                                     "increases its level or other abilities, nor can it regain " +
                                     "expended spell slots. If the simulacrum is damaged, you can " +
                                     "repair it in an alchemical laboratory, using rare herbs and " +
                                     "minerals worth 100 gp per hit point it regains. The simulacrum " +
                                     "lasts until it drops to 0 hit points, at which point it " +
                                     "reverts to snow and melts instantly. If you cast this spell " +
                                     "again, any currently active duplicates you created with this " +
                                     "spell are instantly destroyed. ",
                         at_higher_levels="")
...
class Sleep(spells.Spell):
    ...
    def __init__(self):
        super().__init__(name="Sleep",
                         ...
                         duration="1 minute",
                         description="This spell sends creatures into a magical slumber. Roll 5d8; " +
                                     ...
                                     "points (ignoring unconscious creatures). Starting with the " +
                                     "creature that has the lowest current hit points, each creature " +
                                     "affected by this spell falls unconscious until the spell ends, " +
                                     "the sleeper takes damage, or someone uses an action to shake " +
                                     "or slap the sleeper awake. Subtract each creature's hit points " +
                                     ...
                                     "affected. Undead and creatures immune to being charmed aren't " +
    ...
    def __init__(self):
        super().__init__(name="Sleet Storm",
                         ...
                         description="Until the spell ends, freezing rain and sleet fall in a " +
                                     ...
                                     "and exposed flames in the area are doused. The ground in the " +
                                     "area is covered with slick ice, making it difficult terrain. " +
                                     "When a creature enters the spell's area for the first time on " +
                                     "a turn or starts its turn there, it must make a Dexterity " +
                                     "saving throw. On a failed save, it falls prone. If a creature " +
                                     "is concentrating in the spell's area, the creature must make a " +
    ...
    def __init__(self):
        super().__init__(name="Slow",
                         ...
                         description="You alter time around up to six creatures of your choice in a " +
                                     ...
                                     "duration. An affected target's speed is halved, it takes a −2 " +
                                     ...
                                     "attack during its turn. If the creature attempts to cast a " +
                                     "spell with a casting time of 1 action, roll a d20. On an 11 or " +
                                     "higher, the spell doesn't take effect until the creature's " +
                                     "next turn, and the creature must use its action on that turn " +
                                     "to complete the spell. If it can't, the spell is wasted. A " +
                                     "creature affected by this spell makes another Wisdom saving " +
    ...
    def __init__(self):
        super().__init__(name="Speak with Plants",
                         ...
                         description="You imbue plants within 30 feet of you with limited sentience " +
                                     ...
                                     "other circumstances. You can also turn difficult terrain " +
                                     "caused by plant growth (such as thickets and undergrowth) into " +
                                     "ordinary terrain that lasts for the duration. Or you can turn " +
                                     "ordinary terrain where plants are present into difficult " +
                                     "terrain that lasts for the duration, causing vines and " +
                                     "branches to hinder pursuers, for example. Plants might be able " +
                                     "to perform other tasks on your behalf, at the GM's discretion. " +
                                     "The spell doesn't enable plants to uproot themselves and move " +
                                     "about, but they can freely move branches, tendrils, and " +
                                     "stalks. If a plant creature is in the area, you can " +
                                     "communicate with it as if you shared a common language, but " +
                                     "you gain no magical ability to influence it. This spell can " +
                                     "cause the plants created by the entangle spell to release a " +
                                     "restrained creature. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Spike Growth",
                         ...
                         description="The ground in a 20-foot radius centered on a point within " +
                                     ...
                                     "for every 5 feet it travels. The transformation of the ground " +
                                     "is camouflaged to look natural. Any creature that can't see " +
                                     "the area at the time the spell is cast must make a Wisdom " +
                                     "(Perception) check against your spell save DC to recognize the " +
    ...
    def __init__(self):
        super().__init__(name="Spirit Guardians",
                         ...
                         description="You call forth spirits to protect you. They flit around you to " +
                                     ...
                                     "choice). If you are evil, they appear fiendish. When you cast " +
                                     "this spell, you can designate any number of creatures you can " +
                                     "see to be unaffected by it. An affected creature's speed is " +
                                     "halved in the area, and when the creature enters the area for " +
    ...
    def __init__(self):
        super().__init__(name="Spiritual Weapon",
                         ...
                         description="You create a floating, spectral weapon within range that lasts " +
                                     ...
                                     "modifier. As a bonus action on your turn, you can move the " +
                                     "weapon up to 20 feet and repeat the attack against a creature " +
                                     "within 5 feet of it. The weapon can take whatever form you " +
                                     "choose. Clerics of deities who are associated with a " +
                                     "particular weapon (as St. Cuthbert is known for his mace and " +
                                     "Thor for his hammer) make this spell's effect resemble that " +
                                     "weapon. ",
                         at_higher_levels="When you cast this spell using a spell slot of 3rd level or " +
    ...
    def __init__(self):
        super().__init__(name="Stinking Cloud",
                         ...
                         description="You create a 20-foot-radius sphere of yellow, nauseating gas " +
                                     ...
                                     "in the air for the duration. Each creature that is completely " +
                                     "within the cloud at the start of its turn must make a " +
                                     "Constitution saving throw against poison. On a failed save, " +
                                     "the creature spends its action that turn retching and reeling. " +
                                     "Creatures that don't need to breathe or are immune to poison " +
                                     "automatically succeed on this saving throw. A moderate wind " +
                                     "(at least 10 miles per hour) disperses the cloud after 4 " +
                                     "rounds. A strong wind (at least 20 miles per hour) disperses " +
                                     "it after 1 round. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Storm of Vengeance",
                         ...
                         description="A churning storm cloud forms, centered on a point you can see " +
                                     ...
                                     "the area, thunder booms, and strong winds roar. Each creature " +
                                     "under the cloud (no more than 5,000 feet beneath the cloud) " +
                                     "when it appears must make a Constitution saving throw. On a " +
                                     "failed save, a creature takes 2d6 thunder damage and becomes " +
                                     "deafened for 5 minutes. Each round you maintain concentration " +
                                     "on this spell, the storm produces additional effects on your " +
                                     "turn. Round 2. Acidic rain falls from the cloud. Each creature " +
                                     "and object under the cloud takes 1d6 acid damage. Round 3. You " +
                                     "call six bolts of lightning from the cloud to strike six " +
                                     "creatures or objects of your choice beneath the cloud. A given " +
                                     "creature or object can't be struck by more than one bolt. A " +
                                     "struck creature must make a Dexterity saving throw. The " +
                                     "creature takes 10d6 lightning damage on a failed save, or half " +
                                     "as much damage on a successful one. Round 4. Hailstones rain " +
                                     "down from the cloud. Each creature under the cloud takes 2d6 " +
                                     "bludgeoning damage. Round 5–10. Gusts and freezing rain assail " +
                                     "the area under the cloud. The area becomes difficult terrain " +
                                     "and is heavily obscured. Each creature there takes 1d6 cold " +
                                     "damage. Ranged weapon attacks in the area are impossible. The " +
    ...
    def __init__(self):
        super().__init__(name="Suggestion",
                         ...
                         description="You suggest a course of activity (limited to a sentence or " +
                                     ...
                                     "harmful act ends the spell. The target must make a Wisdom " +
                                     "saving throw. On a failed save, it pursues the course of " +
                                     "action you described to the best of its ability. The suggested " +
                                     "course of action can continue for the entire duration. If the " +
                                     "suggested activity can be completed in a shorter time, the " +
                                     ...
                                     "activity isn't performed. If you or any of your companions " +
    ...
    def __init__(self):
        super().__init__(name="Sunbeam",
                         ...
                         description="A beam of brilliant light flashes out from your hand in a " +
                                     ...
                                     "this saving throw. You can create a new line of radiance as " +
                                     "your action on any turn until the spell ends. For the " +
                                     "duration, a mote of brilliant radiance shines in your hand. It " +
    ...
    def __init__(self):
        super().__init__(name="Sunburst",
                         ...
                         description="Brilliant sunlight flashes in a 60-foot radius centered on a " +
                                     ...
                                     "disadvantage on this saving throw. A creature blinded by this " +
                                     "spell makes another Constitution saving throw at the end of " +
                                     "each of its turns. On a successful save, it is no longer " +
                                     "blinded. This spell dispels any darkness in its area that was " +
                                     "created by a spell. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Symbol",
                         ...
                         description="When you cast this spell, you inscribe a harmful glyph either " +
                                     ...
                                     "broken, and the spell ends without being triggered. The glyph " +
                                     "is nearly invisible, requiring an Intelligence (Investigation) " +
                                     "check against your spell save DC to find it. You decide what " +
                                     "triggers the glyph when you cast the spell. For glyphs " +
                                     "inscribed on a surface, the most typical triggers include " +
                                     ...
                                     "or reading the glyph. You can further refine the trigger so " +
                                     "the spell is activated only under certain circumstances or " +
                                     "according to a creature's physical characteristics (such as " +
                                     "height or weight), or physical kind (for example, the ward " +
                                     "could be set to affect hags or shapechangers). You can also " +
                                     "specify creatures that don't trigger the glyph, such as those " +
                                     "who say a certain password. When you inscribe the glyph, " +
                                     "choose one of the options below for its effect. Once " +
                                     "triggered, the glyph glows, filling a 60-foot-radius sphere " +
                                     "with dim light for 10 minutes, after which time the spell " +
                                     ...
                                     "damage on a successful save. Discord. Each target must make a " +
                                     "Constitution saving throw. On a failed save, a target bickers " +
                                     "and argues with other creatures for 1 minute. During this " +
                                     "time, it is incapable of meaningful communication and has " +
                                     "disadvantage on attack rolls and ability checks. Fear. Each " +
                                     "target must make a Wisdom saving throw and becomes frightened " +
                                     "for 1 minute on a failed save. While frightened, the target " +
                                     "drops whatever it is holding and must move at least 30 feet " +
                                     ...
                                     "effects. Insanity. Each target must make an Intelligence " +
                                     "saving throw. On a failed save, the target is driven insane " +
                                     "for 1 minute. An insane creature can't take actions, can't " +
                                     "understand what other creatures say, can't read, and speaks " +
                                     "only in gibberish. The GM controls its movement, which is " +
                                     "erratic. Pain. Each target must make a Constitution saving " +
                                     "throw and becomes incapacitated with excruciating pain for 1 " +
                                     "minute on a failed save. Sleep. Each target must make a Wisdom " +
                                     "saving throw and falls unconscious for 10 minutes on a failed " +
                                     "save. A creature awakens if it takes damage or if someone uses " +
                                     "an action to shake or slap it awake. Stunning. Each target " +
                                     "must make a Wisdom saving throw and becomes stunned for 1 " +
    ...
    def __init__(self):
        super().__init__(name="Telekinesis",
                         ...
                         description="You gain the ability to move or manipulate creatures or " +
                                     ...
                                     "spell. Creature. You can try to move a Huge or smaller " +
                                     ...
                                     "mid-air. On subsequent rounds, you can use your action to " +
                                     "attempt to maintain your telekinetic grip on the creature by " +
                                     "repeating the contest. Object. You can try to move an object " +
                                     "that weighs up to 1,000 pounds. If the object isn't being worn " +
                                     "or carried, you automatically move it up to 30 feet in any " +
                                     "direction, but not beyond the range of this spell. If the " +
                                     "object is worn or carried by a creature, you must make an " +
                                     ...
                                     "direction but not beyond the range of this spell. You can " +
                                     "exert fine control on objects with your telekinetic grip, such " +
    ...
    def __init__(self):
        super().__init__(name="Telepathic Bond",
                         ...
                         description="You forge a telepathic link among up to eight willing " +
                                     ...
                                     "spell. Until the spell ends, the targets can communicate " +
    ...
    def __init__(self):
        super().__init__(name="Teleport",
                         ...
                         description="This spell instantly transports you and up to eight willing " +
                                     ...
                                     "carried by an unwilling creature. The destination you choose " +
                                     "must be known to you, and it must be on the same plane of " +
                                     "existence as you. Your familiarity with the destination " +
                                     "determines whether you arrive there successfully. The GM rolls " +
                                     "d100 and consults the table. Familiarity Mishap Similar Area " +
                                     "Off Target On Target Permanent circle — — — 01–100 Associated " +
                                     "object — — — 01–100 Very familiar 01–05 06–13 14–24 25–100 " +
                                     "Seen casually 01–33 34–43 44–53 54–100 Viewed once 01–43 44–53 " +
                                     "54–73 74–100 Description 01–43 44–53 54–73 74–100 False " +
                                     "destination 01–50 51–100 — — Familiarity. “Permanent circle” " +
                                     "means a permanent teleportation circle whose sigil sequence " +
                                     "you know. “Associated object” means that you possess an object " +
                                     "taken from the desired destination within the last six months, " +
                                     "such as a book from a wizard's library, bed linen from a royal " +
                                     "suite, or a chunk of marble from a lich's secret tomb. “Very " +
                                     "familiar” is a place you have been very often, a place you " +
                                     "have carefully studied, or a place you can see when you cast " +
                                     "the spell. “Seen casually” is someplace you have seen more " +
                                     "than once but with which you aren't very familiar. “Viewed " +
                                     ...
                                     "tried to scry an enemy's sanctum but instead viewed an " +
                                     "illusion, or you are attempting to teleport to a familiar " +
                                     "location that no longer exists. On Target. You and your group " +
                                     "(or the target object) appear where you want to. Off Target. " +
                                     "You and your group (or the target object) appear a random " +
                                     "distance away from the destination in a random direction. " +
                                     "Distance off target is 1d10 × 1d10 percent of the distance " +
                                     "that was to be traveled. For example, if you tried to travel " +
                                     "120 miles, landed off target, and rolled a 5 and 3 on the two " +
                                     "d10s, then you would be off target by 15 percent, or 18 miles. " +
                                     "The GM determines the direction off target randomly by rolling " +
                                     "a d8 and designating 1 as north, 2 as northeast, 3 as east, " +
                                     "and so on around the points of the compass. If you were " +
                                     "teleporting to a coastal city and wound up 18 miles out at " +
                                     "sea, you could be in trouble. Similar Area. You and your group " +
                                     "(or the target object) wind up in a different area that's " +
                                     "visually or thematically similar to the target area. If you " +
                                     "are heading for your home laboratory, for example, you might " +
                                     "wind up in another wizard's laboratory or in an alchemical " +
                                     "supply shop that has many of the same tools and implements as " +
                                     "your laboratory. Generally, you appear in the closest similar " +
                                     "place, but since the spell has no range limit, you could " +
                                     "conceivably wind up anywhere on the plane. Mishap. The spell's " +
                                     "unpredictable magic results in a difficult journey. Each " +
                                     "teleporting creature (or the target object) takes 3d10 force " +
                                     "damage, and the GM rerolls on the table to see where you wind " +
                                     "up (multiple mishaps can occur, dealing damage each time). ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Teleportation Circle",
                         ...
                         description="As you cast the spell, you draw a 10-foot-diameter circle on " +
                                     ...
                                     "space is occupied. Many major temples, guilds, and other " +
                                     "important places have permanent teleportation circles " +
                                     "inscribed somewhere within their confines. Each such circle " +
                                     "includes a unique sigil sequence—a string of magical runes " +
                                     "arranged in a particular pattern. When you first gain the " +
                                     "ability to cast this spell, you learn the sigil sequences for " +
                                     "two destinations on the Material Plane, determined by the GM. " +
                                     "You can learn additional sigil sequences during your " +
                                     "adventures. You can commit a new sigil sequence to memory " +
                                     "after studying it for 1 minute. You can create a permanent " +
                                     "teleportation circle by casting this spell in the same " +
                                     "location every day for one year. You need not use the circle " +
                                     "to teleport when you cast the spell in this way. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Thaumaturgy",
                         ...
                         description="You manifest a minor wonder, a sign of supernatural power, " +
                                     ...
                                     "normal for 1 minute. • You cause flames to flicker, brighten, " +
                                     "dim, or change color for 1 minute. • You cause harmless " +
                                     "tremors in the ground for 1 minute. • You create an " +
                                     "instantaneous sound that originates from a point of your " +
                                     "choice within range, such as a rumble of thunder, the cry of a " +
                                     "raven, or ominous whispers. • You instantaneously cause an " +
                                     "unlocked door or window to fly open or slam shut. • You alter " +
                                     "the appearance of your eyes for 1 minute. If you cast this " +
                                     "spell multiple times, you can have up to three of its 1-minute " +
                                     "effects active at a time, and you can dismiss such an effect " +
                                     "as an action. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Thunderwave",
                         ...
                         description="A wave of thunderous force sweeps out from you. Each creature " +
                                     ...
                                     "10 feet away from you by the spell's effect, and the spell " +
    ...
    def __init__(self):
        super().__init__(name="Time Stop",
                         ...
                         description="You briefly stop the flow of time for everyone but yourself. " +
                                     ...
                                     "normal. This spell ends if one of the actions you use during " +
    ...
    def __init__(self):
        super().__init__(name="Tiny Hut",
                         ...
                         description="A 10-foot-radius immobile dome of force springs into existence " +
                                     ...
                                     "The spell ends if you leave its area. Nine creatures of Medium " +
                                     "size or smaller can fit inside the dome with you. The spell " +
                                     "fails if its area includes a larger creature or more than nine " +
                                     "creatures. Creatures and objects within the dome when you cast " +
                                     "this spell can move through it freely. All other creatures and " +
                                     "objects are barred from passing through it. Spells and other " +
                                     "magical effects can't extend through the dome or be cast " +
                                     "through it. The atmosphere inside the space is comfortable and " +
                                     "dry, regardless of the weather outside. Until the spell ends, " +
                                     "you can command the interior to become dimly lit or dark. The " +
                                     "dome is opaque from the outside, of any color you choose, but " +
                                     "it is transparent from the inside. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Transport via Plants",
                         ...
                         description="This spell creates a magical link between a Large or larger " +
                                     ...
                                     "distance, on the same plane of existence. You must have seen " +
                                     "or touched the destination plant at least once before. For the " +
                                     "duration, any creature can step into the target plant and exit " +
                                     "from the destination plant by using 5 feet of movement. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Tree Stride",
                         ...
                         description="You gain the ability to enter a tree and move from inside it " +
                                     ...
                                     "tree you entered. You can use this transportation ability once " +
                                     "per round for the duration. You must end each turn outside a " +
                                     "tree. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="True Polymorph",
                         ...
                         description="Choose one creature or nonmagical object that you can see " +
                                     ...
                                     "transformation lasts until it is dispelled. This spell has no " +
                                     "effect on a shapechanger or a creature with 0 hit points. An " +
                                     "unwilling creature can make a Wisdom saving throw, and if it " +
                                     "succeeds, it isn't affected by this spell. Creature into " +
                                     "Creature. If you turn a creature into another kind of " +
                                     "creature, the new form can be any kind you choose whose " +
                                     "challenge rating is equal to or less than the target's (or its " +
                                     "level, if the target doesn't have a challenge rating). The " +
                                     "target's game statistics, including mental ability scores, are " +
                                     "replaced by the statistics of the new form. It retains its " +
                                     "alignment and personality. The target assumes the hit points " +
                                     "of its new form, and when it reverts to its normal form, the " +
                                     "creature returns to the number of hit points it had before it " +
                                     "transformed. If it reverts as a result of dropping to 0 hit " +
                                     "points, any excess damage carries over to its normal form. As " +
                                     "long as the excess damage doesn't reduce the creature's normal " +
                                     "form to 0 hit points, it isn't knocked unconscious. The " +
                                     ...
                                     "its new form is capable of such actions. The target's gear " +
                                     "melds into the new form. The creature can't activate, use, " +
                                     "wield, or otherwise benefit from any of its equipment. Object " +
                                     "into Creature. You can turn an object into any kind of " +
                                     ...
                                     "resolves all of its actions and movement. If the spell becomes " +
                                     "permanent, you no longer control the creature. It might remain " +
    ...
    def __init__(self):
        super().__init__(name="True Resurrection",
                         ...
                         description="You touch a creature that has been dead for no longer than 200 " +
                                     ...
                                     "to life with all its hit points. This spell closes all wounds, " +
                                     "neutralizes any poison, cures all diseases, and lifts any " +
                                     "curses affecting the creature when it died. The spell replaces " +
                                     "damaged or missing organs and limbs. The spell can even " +
                                     "provide a new body if the original no longer exists, in which " +
                                     "case you must speak the creature's name. The creature then " +
                                     "appears in an unoccupied space you choose within 10 feet of " +
                                     "you. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Unseen Servant",
                         ...
                         description="This spell creates an invisible, mindless, shapeless force " +
                                     ...
                                     "points, the spell ends. Once on each of your turns as a bonus " +
                                     "action, you can mentally command the servant to move up to 15 " +
                                     "feet and interact with an object. The servant can perform " +
                                     "simple tasks that a human servant could do, such as fetching " +
                                     "things, cleaning, mending, folding clothes, lighting fires, " +
                                     "serving food, and pouring wine. Once you give the command, the " +
                                     "servant performs the task to the best of its ability until it " +
                                     "completes the task, then waits for your next command. If you " +
                                     "command the servant to perform a task that would move it more " +
    ...
    def __init__(self):
        super().__init__(name="Vampiric Touch",
                         ...
                         description="The touch of your shadow-wreathed hand can siphon life force " +
                                     ...
                                     "takes 3d6 necrotic damage, and you regain hit points equal to " +
                                     "half the amount of necrotic damage dealt. Until the spell " +
                                     "ends, you can make the attack again on each of your turns as " +
                                     "an action. ",
                         at_higher_levels="When you cast this spell using a spell slot of 4th level or " +
                                          "higher, the damage increases by 1d6 for each slot level above " +
                                          "3rd. ")
    ...
    def __init__(self):
        super().__init__(name="Vicious Mockery",
                         ...
                         description="You unleash a string of insults laced with subtle enchantments " +
                                     ...
                                     "of its next turn. This spell's damage increases by 1d4 when " +
    ...
    def __init__(self):
        super().__init__(name="Wall of Fire",
                         ...
                         description="You create a wall of fire on a solid surface within range. You " +
                                     ...
                                     "duration. When the wall appears, each creature within its area " +
                                     "must make a Dexterity saving throw. On a failed save, a " +
                                     "creature takes 5d8 fire damage, or half as much damage on a " +
                                     "successful save. One side of the wall, selected by you when " +
                                     "you cast this spell, deals 5d8 fire damage to each creature " +
                                     "that ends its turn within 10 feet of that side or inside the " +
                                     "wall. A creature takes the same damage when it enters the wall " +
                                     "for the first time on a turn or ends its turn there. The other " +
    ...
    def __init__(self):
        super().__init__(name="Wall of Ice",
                         ...
                         description="You create a wall of ice on a solid surface within range. You " +
                                     ...
                                     "space when it appears, the creature within its area is pushed " +
                                     "to one side of the wall and must make a Dexterity saving " +
                                     "throw. On a failed save, the creature takes 10d6 cold damage, " +
                                     "or half as much damage on a successful save. The wall is an " +
                                     "object that can be damaged and thus breached. It has AC 12 and " +
                                     "30 hit points per 10-foot section, and it is vulnerable to " +
                                     "fire damage. Reducing a 10-foot section of wall to 0 hit " +
                                     "points destroys it and leaves behind a sheet of frigid air in " +
                                     "the space the wall occupied. A creature moving through the " +
    ...
    def __init__(self):
        super().__init__(name="Wall of Stone",
                         ...
                         description="A nonmagical wall of solid stone springs into existence at a " +
                                     ...
                                     "it appears, the creature is pushed to one side of the wall " +
                                     "(your choice). If a creature would be surrounded on all sides " +
                                     "by the wall (or the wall and another solid surface), that " +
                                     "creature can make a Dexterity saving throw. On a success, it " +
                                     "can use its reaction to move up to its speed so that it is no " +
                                     "longer enclosed by the wall. The wall can have any shape you " +
                                     "desire, though it can't occupy the same space as a creature or " +
                                     "object. The wall doesn't need to be vertical or rest on any " +
                                     "firm foundation. It must, however, merge with and be solidly " +
                                     ...
                                     "panel has AC 15 and 30 hit points per inch of thickness. " +
                                     "Reducing a panel to 0 hit points destroys it and might cause " +
                                     "connected panels to collapse at the GM's discretion. If you " +
                                     "maintain your concentration on this spell for its whole " +
    ...
    def __init__(self):
        super().__init__(name="Wall of Thorns",
                         ...
                         description="You create a wall of tough, pliable, tangled brush bristling " +
                                     ...
                                     "and 5 feet thick. The wall blocks line of sight. When the wall " +
                                     "appears, each creature within its area must make a Dexterity " +
                                     "saving throw. On a failed save, a creature takes 7d8 piercing " +
                                     "damage, or half as much damage on a successful save. A " +
                                     "creature can move through the wall, albeit slowly and " +
    ...
    def __init__(self):
        super().__init__(name="Warding Bond",
                         ...
                         description="This spell wards a willing creature you touch and creates a " +
                                     ...
                                     "amount of damage. The spell ends if you drop to 0 hit points " +
                                     "or if you and the target become separated by more than 60 " +
                                     "feet. It also ends if the spell is cast again on either of the " +
                                     "connected creatures. You can also dismiss the spell as an " +
                                     "action. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Water Walk",
                         ...
                         description="This spell grants the ability to move across any liquid " +
                                     ...
                                     "duration. If you target a creature submerged in a liquid, the " +
    ...
    def __init__(self):
        super().__init__(name="Web",
                         ...
                         description="You conjure a mass of thick, sticky webbing at a point of your " +
                                     ...
                                     "lightly obscure their area. If the webs aren't anchored " +
                                     "between two solid masses (such as walls or trees) or layered " +
                                     "across a floor, wall, or ceiling, the conjured web collapses " +
                                     "on itself, and the spell ends at the start of your next turn. " +
                                     "Webs layered over a flat surface have a depth of 5 feet. Each " +
                                     "creature that starts its turn in the webs or that enters them " +
                                     "during its turn must make a Dexterity saving throw. On a " +
                                     "failed save, the creature is restrained as long as it remains " +
                                     "in the webs or until it breaks free. A creature restrained by " +
                                     "the webs can use its action to make a Strength check against " +
                                     "your spell save DC. If it succeeds, it is no longer " +
                                     "restrained. The webs are flammable. Any 5-foot cube of webs " +
                                     "exposed to fire burns away in 1 round, dealing 2d4 fire damage " +
    ...
    def __init__(self):
        super().__init__(name="Wind Walk",
                         ...
                         description="You and up to ten willing creatures you can see within range " +
                                     ...
                                     "the Dash action or to revert to its normal form. Reverting " +
                                     "takes 1 minute, during which time a creature is incapacitated " +
                                     "and can't move. Until the spell ends, a creature can revert to " +
                                     "cloud form, which also requires the 1-minute transformation. " +
    ...
    def __init__(self):
        super().__init__(name="Wind Wall",
                         ...
                         description="A wall of strong wind rises from the ground at a point you " +
                                     ...
                                     "way you choose so long as it makes one continuous path along " +
                                     ...
                                     "failed save, or half as much damage on a successful one. The " +
                                     "strong wind keeps fog, smoke, and other gases at bay. Small or " +
    ...
    def __init__(self):
        super().__init__(name="Wish",
                         ...
                         description="Wish is the mightiest spell a mortal creature can cast. By " +
                                     ...
                                     "spell is to duplicate any other spell of 8th level or lower. " +
                                     ...
                                     "space you can see on the ground. • You allow up to twenty " +
                                     "creatures that you can see to regain all hit points, and you " +
                                     "end all effects on them described in the greater restoration " +
                                     "spell. • You grant up to ten creatures that you can see " +
                                     "resistance to a damage type you choose. • You grant up to ten " +
                                     "creatures you can see immunity to a single spell or other " +
                                     "magical effect for 8 hours. For instance, you could make " +
                                     "yourself and all your companions immune to a lich's life drain " +
                                     "attack. • You undo a single recent event by forcing a reroll " +
                                     "of any roll made within the last round (including your last " +
                                     "turn). Reality reshapes itself to accommodate the new result. " +
                                     "For example, a wish spell could undo an opponent's successful " +
                                     ...
                                     "roll. You might be able to achieve something beyond the scope " +
                                     ...
                                     "item's current owner. The stress of casting this spell to " +
                                     "produce any effect other than duplicating another spell " +
                                     "weakens you. After enduring that stress, each time you cast a " +
                                     "spell until you finish a long rest, you take 1d10 necrotic " +
                                     "damage per level of that spell. This damage can't be reduced " +
                                     "or prevented in any way. In addition, your Strength drops to " +
                                     "3, if it isn't 3 or lower already, for 2d4 days. For each of " +
    ...
    def __init__(self):
        super().__init__(name="Word of Recall",
                         ...
                         description="You and up to five willing creatures within 5 feet of you " +
                                     ...
                                     "first preparing a sanctuary, the spell has no effect. You must " +
                                     "designate a sanctuary by casting this spell within a location, " +
                                     "such as a temple, dedicated to or strongly linked to your " +
                                     "deity. If you attempt to cast the spell in this manner in an " +
                                     "area that isn't dedicated to your deity, the spell has no " +
                                     "effect. ",
                         at_higher_levels="")
    ...
    def __init__(self):
        super().__init__(name="Zone of Truth",
                         ...
                         description="You create a magical zone that guards against deception in a " +
                                     ...
                                     "throw. An affected creature is aware of the spell and can thus " +
